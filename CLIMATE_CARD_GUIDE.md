...
Available chip types: `hvac_action`, `overlay`, `preset`, `humidity`, `open_window`, `window_predicted`, `mold_risk`, `condensation`, `comfort_level`, `preheat_now`, `battery`, `battery_all`, `valve_control`, `temp_source`, `heating_circuit`.
