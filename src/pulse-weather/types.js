 ...
 * @property {'short'|'long'} [horizon] - Meteogram: time horizon ('short' = 12h, 'long' = 24h). Brand-mark toggle target.
 ...
 * @property {string} [location_label] - Overview: custom location label (defaults to 'Now').
 * @property {boolean} [pro] - Per-section opt-out for the brand-mark pro toggle. Set to false to demote the brand mark to a static decorator and disable the A/B view swap. Defaults to true.
 */
