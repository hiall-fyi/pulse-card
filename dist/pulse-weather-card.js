...
`;var Aa=[{type:"overview"}],oo={overview:{},forecast:{mode:"both"},wind:{speed_mode:"speed"},air_quality:{scale:"eu"},astro:{},alerts:{},atmosphere:{}};function mt(e){if(!e)return{type:"overview"};if(typeof e=="string")return mt({type:e});if(typeof e!="object")return{type:"overview"};let t=fa.includes(e.type)?e.type:"overview";return{...oo[t]||{},...e,type:t}}function Ea(e){if(!e||typeof e!="object")return{type:"custom:pulse-weather-card",sections:Aa.map(mt)};let t=e,a=Array.isArray(t.sections)&&t.sections.length>0?t.sections.map(mt):Aa.map(mt);return{type:t.type||"custom:pulse-weather-card",weather_entity:t.weather_entity||void 0,atmos_source:t.atmos_source||void 0,sections:a}}function g(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function k(e){return e==null||e===""?"":String(e).replace(/[;{}]/g,"").replace(/url\s*\(/gi,"").replace(/expression\s*\(/gi,"").replace(/-moz-binding\s*:/gi,"")}function Ze(e){return`${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}`}var Ut=0;function Na(e="pulse-id"){return Ut=Ut+1>>>0,`${e}-${Ut.toString(36)}`}function Vt(e){let t=e.replace(/^weather\./,"");return t.endsWith(Bt)&&(t=t.slice(0,-Bt.length)),t}function Ra(e,t){let a=t.weather_entity||Object.keys(e).find(c=>c.startsWith("weather."))||"",r=t.atmos_source||Vt(a),o={};for(let c of $a){let s=`sensor.${r}_${c}`;s in e&&(o[c]=s)}let i=Object.keys(o).length>=Sa,n=i?o:{},l=[];if(t.alert_entities&&t.alert_entities.length>0)for(let c of t.alert_entities)c in e&&l.push(c);else if(i){for(let d of ka){let u=`sensor.${r}_${d}`,f=`sensor.${r}_warnings_${d}`;u in e?l.push(u):f in e&&l.push(f)}let c=`binary_sensor.${r}_alert_active`,s=`binary_sensor.${r}_warnings_alert_active`;c in e?l.push(c):s in e&&l.push(s)}let p="sun.sun"in e?"sun.sun":null;return{weatherEntityId:a,atmosCe:n,sunEntityId:p,atmosSource:i?r:null,alertEntityIds:l}}function no(e){if(typeof e!="string")return null;let t=e.trim().replace(/^#/,"");return t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t.length!==6||/[^0-9a-f]/i.test(t)?null:{r:parseInt(t.slice(0,2),16),g:parseInt(t.slice(2,4),16),b:parseInt(t.slice(4,6),16)}}function Me(e,t){if(typeof e!="string")return String(e);let a=Math.max(0,Math.min(1,Number(t))),r=no(e);if(r)return`rgba(${r.r},${r.g},${r.b},${a})`;let o=/^rgb\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*\)$/i.exec(e.trim());return o?`rgba(${o[1]},${o[2]},${o[3]},${a})`:e}function za(e,t){return e.filter(a=>Number.isFinite(t(a)))}function K(e,t=0){let a=Number(e);return Number.isFinite(a)?a:t}function ft(e,t,a,r,o,i=0){if(t?.[r]){let n=Number(e?.states?.[t[r]]?.state);if(Number.isFinite(n))return n}return Number(a?.[o]??i)||i}function Da(e,t,a,r){return t?.[a]&&e?.states?.[t[a]]?.attributes?.unit_of_measurement||r}function Ue(e,t,a=0){let r=t?e?.states?.[t]:null;if(!r)return{value:a,unit:void 0,entity:null};let o=Number(r.state);return{value:Number.isFinite(o)?o:a,unit:r.attributes?.unit_of_measurement,entity:r}}function ht(e,t,a){let r=t?.state||"sunny",o=a?.sunEntityId?e?.states?.[a.sunEntityId]?.state:null;return{condition:r,isNight:r==="clear-night"||o==="below_horizon"}}function Je(e="pw-id"){return Na(e)}function Ia(e){return`${e}, linear-gradient(180deg, var(--pw-sky-top) 0%, var(--pw-sky-mid) 45%, var(--pw-sky-bot) 100%)`}function gt(e,t,a=36e5){let r=(t?t.getTime():Date.now())-a;return e.filter(o=>{let i=o.datetime;if(!i)return!1;let n=new Date(i).getTime();return Number.isFinite(n)&&n>=r})}function Te(e){let t=Number(e);for(let a of pt)if(t<=a.max)return a.color;return pt[pt.length-1].color}function jt(e){let t=Number(e);for(let a of dt)if(t<=a.max)return a.tier;return dt[dt.length-1].tier}function Oa(e){return We[jt(e)]||We.calm}function wt(e){let t=Number(e);for(let a of ut)if(t<=a.max)return a;return ut[ut.length-1]}function bt(e){let t=(Number(e)%360+360)%360,a=Math.round(t/22.5)%16;return xa[a]}function Pa(e){return e<=12?"#30d158":e<=50?"#5ac8fa":e<=87?"#ff9f0a":"#ff453a"}function Ha(e){return e<10?"#5ac8fa":e<16?"#30d158":e<19?"#ffd60a":e<22?"#ff9f0a":"#ff453a"}function Ve(e,t,a){if(!t||!a)return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let r=new Date(t),o=new Date(a);if(isNaN(r.getTime())||isNaN(o.getTime()))return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let i=r.getTime()>e.getTime()?new Date(r.getTime()-864e5):r,n=o.getTime()>e.getTime()?o:new Date(o.getTime()-864e5);n.getTime()>i.getTime()+864e5&&(n=new Date(n.getTime()-864e5)),i.getTime()>n.getTime()&&(i=new Date(i.getTime()-864e5));let l=r.getTime()>e.getTime()?r:new Date(r.getTime()+864e5);return{todaySunrise:i,todaySunset:n,tomorrowSunrise:l}}function Z(e,t){if(!e||isNaN(e.getTime()))return null;if(!t)return e;let a=t.getTime(),r=[e,new Date(e.getTime()-864e5),new Date(e.getTime()+864e5)],o=r[0],i=Math.abs(o.getTime()-a);for(let n=1;n<r.length;n+=1){let l=Math.abs(r[n].getTime()-a);l<i&&(o=r[n],i=l)}return o}function pe(e,t,a){let r=t?Object.entries(t).map(([o,i])=>` ${o}="${i}"`).join(""):"";return a!=null?`<${e}${r}>${a}</${e}>`:`<${e}${r}/>`}function vt(e){return Ma[e]||"\u{1F324}\uFE0F"}var La={"clear-night":"Clear Night",cloudy:"Cloudy",exceptional:"Exceptional",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning Rainy",partlycloudy:"Partly Cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy Rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy Variant"};function Wa(e){return Object.hasOwn(La,e)?La[e]:e.replace(/-/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function le(e,t,a){let r=document.createElement(e);if(r.className=t,a)for(let[o,i]of Object.entries(a))r.style.setProperty(o,i);return r}function F(e,t){return Math.random()*(t-e)+e}function et(e,t=60,a=1,r=2){let o=Math.min(t,ga);for(let i=0;i<o;i++){let n=le("div","pw-rain-drop"),l=F(15,30),p=F(.4,.8)/a;Object.assign(n.style,{left:`${F(0,100)}%`,top:`${F(-10,20)}%`,width:`${r}px`,height:`${l}px`,borderRadius:`0 0 ${r}px ${r}px`,background:"linear-gradient(to bottom, transparent, rgba(120,180,255,0.6))",animation:`pw-rainFall ${p}s linear ${F(0,2)}s infinite`,animationFillMode:"backwards",position:"absolute"}),e.appendChild(n)}}function qt(e,t=40){let a=Math.min(t,wa);for(let r=0;r<a;r++){let o=le("div","pw-snowflake"),i=F(2,5);Object.assign(o.style,{left:`${F(0,100)}%`,top:`${F(-5,10)}%`,width:`${i}px`,height:`${i}px`,borderRadius:"50%",background:"rgba(255,255,255,0.7)",animation:`pw-snowFall ${F(3,6)}s linear ${F(0,4)}s infinite`,animationFillMode:"backwards",position:"absolute"}),e.appendChild(o)}}function io(e){for(let t=0;t<4;t++){let a=le("div","pw-fog-layer");Object.assign(a.style,{position:"absolute",width:"200%",height:"40px",top:`${30+t*20}%`,left:"0",background:"linear-gradient(to right, transparent 0%, rgba(200,200,200,0.06) 20%, rgba(200,200,200,0.1) 50%, rgba(200,200,200,0.06) 80%, transparent 100%)",animation:`pw-fogDrift ${F(15,25)}s linear ${t*2}s infinite`,animationFillMode:"backwards"}),e.appendChild(a)}}function xt(e){for(let t=0;t<8;t++){let a=le("div","pw-sun-ray");Object.assign(a.style,{position:"absolute",top:"-20px",left:`${10+t*12}%`,width:"2px",height:"120px",background:"linear-gradient(to bottom, rgba(255,220,100,0.08), transparent)",transformOrigin:"top center",transform:`rotate(${-15+t*4}deg)`,animation:`pw-rayPulse ${F(3,5)}s ease-in-out ${F(0,2)}s infinite`,animationFillMode:"backwards"}),e.appendChild(a)}}function J(e,t=4,a=1){let r=Math.min(t,Pt);for(let o=0;o<r;o++){let i=le("div","pw-cloud"),n=F(80,160),l=F(30,60),p=F(20,40)/a;Object.assign(i.style,{position:"absolute",width:`${n}px`,height:`${l}px`,top:`${F(5,50)}%`,left:"0",borderRadius:"50%",background:"radial-gradient(ellipse, rgba(255,255,255,0.05) 0%, transparent 70%)",animation:`pw-cloudDrift ${p}s linear ${F(0,15)}s infinite`,animationFillMode:"backwards"}),e.appendChild(i)}}function Gt(e){for(let t=0;t<ba;t++){let a=le("div","pw-star"),r=F(1,3);Object.assign(a.style,{position:"absolute",left:`${F(0,100)}%`,top:`${F(0,70)}%`,width:`${r}px`,height:`${r}px`,borderRadius:"50%",background:"#fff",animation:`pw-twinkle ${F(2,5)}s ease-in-out ${F(0,3)}s infinite`,animationFillMode:"backwards"}),e.appendChild(a)}}function so(e,t){let a=[],r=e,o=0,i=Math.floor(F(4,8)),n=t/i;a.push(`${r},${o}`);for(let l=0;l<i;l++)r+=F(-15,15),o+=n,a.push(`${r},${o}`);return a.join(" ")}function Ba(e,t=2,a){let r=a||Array.from({length:t},(i,n)=>n*3),o=le("div","pw-lightning-flash");Object.assign(o.style,{position:"absolute",inset:"0",background:"rgba(255,255,255,0.15)",animation:`pw-flash 6s ease-in-out ${r[0]||0}s infinite`,animationFillMode:"backwards",pointerEvents:"none"}),e.appendChild(o);for(let i=0;i<t;i++){let n="http://www.w3.org/2000/svg",l=document.createElementNS(n,"svg");l.setAttribute("class","pw-lightning-bolt"),l.setAttribute("width","60"),l.setAttribute("height","200"),l.setAttribute("viewBox","0 0 60 200"),l.style.position="absolute",l.style.top="0",l.style.left=`${F(15,75)}%`,l.style.pointerEvents="none",l.style.zIndex="2",l.style.animation=`pw-boltStrike 6s ease-in-out ${r[i]||0}s infinite`,l.style.animationFillMode="backwards";let p=so(30,180),c=document.createElementNS(n,"polyline");c.setAttribute("points",p),c.setAttribute("fill","none"),c.setAttribute("stroke","rgba(200,220,255,0.4)"),c.setAttribute("stroke-width","6"),c.setAttribute("stroke-linecap","round"),c.setAttribute("stroke-linejoin","round"),l.appendChild(c);let s=document.createElementNS(n,"polyline");s.setAttribute("points",p),s.setAttribute("fill","none"),s.setAttribute("stroke","#fff"),s.setAttribute("stroke-width","2"),s.setAttribute("stroke-linecap","round"),s.setAttribute("stroke-linejoin","round"),l.appendChild(s),e.appendChild(l)}}function lo(e){let t=le("div","pw-heat-shimmer");Object.assign(t.style,{position:"absolute",inset:"0",pointerEvents:"none",background:"linear-gradient(0deg, transparent 0%, rgba(255,200,100,0.03) 30%, transparent 50%, rgba(255,180,80,0.02) 70%, transparent 100%)",backgroundSize:"100% 200%",animation:"pw-shimmer 3s ease-in-out infinite"}),e.appendChild(t);let a=le("div","pw-heat-ripple");Object.assign(a.style,{position:"absolute",bottom:"0",left:"0",right:"0",height:"60px",pointerEvents:"none",background:"repeating-linear-gradient(0deg, transparent, rgba(255,200,100,0.02) 2px, transparent 4px)",animation:"pw-rippleWave 2s ease-in-out infinite"}),e.appendChild(a)}function Ua(e,t,a){let r=Math.min(1,(t/75+a/150)/2);if(r<.05)return;let o=le("div","pw-smog-overlay");o.style.background=`rgba(120,110,80,${.05+r*.15})`,e.appendChild(o);let i=le("div","pw-haze-vignette");i.style.background=`radial-gradient(ellipse at center, transparent 40%, rgba(80,70,50,${r*.3}) 100%)`,e.appendChild(i);let n=Math.floor(r*20);for(let p=0;p<n;p++){let c=le("div","pw-dust-particle"),s=F(1,3+r*3);Object.assign(c.style,{left:`${F(0,100)}%`,top:`${F(10,90)}%`,width:`${s}px`,height:`${s}px`,animationDelay:`${F(0,8)}s`,animationFillMode:"backwards"}),e.appendChild(c)}let l=Math.floor(r*5);for(let p=0;p<l;p++){let c=le("div","pw-haze-blob"),s=F(60,120);Object.assign(c.style,{left:`${F(-10,80)}%`,top:`${F(10,70)}%`,width:`${s}px`,height:`${s*.6}px`,animationDelay:`${F(0,12)}s`,animationFillMode:"backwards"}),e.appendChild(c)}}function Va(e,t,a){let r=document.createDocumentFragment();try{t&&Gt(r);let o=a?Math.round(a.total/100*Pt):0;switch(e){case"sunny":t||xt(r),a&&o>0&&J(r,o);break;case"clear-night":a&&o>0&&J(r,o);break;case"partlycloudy":t||xt(r),J(r,a?o:3);break;case"cloudy":J(r,a?Math.max(o,4):6);break;case"rainy":et(r,40,1,2),J(r,a?Math.max(o,3):4);break;case"pouring":et(r,80,1.5,3),J(r,a?Math.max(o,5):6);break;case"snowy":qt(r,40),J(r,a?Math.max(o,3):4);break;case"snowy-rainy":qt(r,20),et(r,20,.8,1),J(r,a?Math.max(o,3):4);break;case"hail":et(r,30,1.2,3),qt(r,15),J(r,a?Math.max(o,4):5);break;case"lightning":Ba(r,2,[0,3]),J(r,a?Math.max(o,5):6);break;case"lightning-rainy":Ba(r,3,[0,2,4]),et(r,60,1.3,2),J(r,a?Math.max(o,5):6);break;case"fog":io(r);break;case"windy":case"windy-variant":J(r,a?o:3,1.5);break;case"exceptional":lo(r);break;default:a&&o>0&&J(r,o);break}}catch(o){console.warn(`${we} buildConditionFx threw \u2014 atmospheric FX will be partial or absent for this condition. Please share the error below when reporting.`,o)}return r}function tt(e,t,a){return a===t?0:Math.max(0,Math.min(1,(e-t)/(a-t)))}function Xt(e,t,a="ellipse"){let r=Math.max(0,Math.min(1,t)),o=Math.round(3+r*50),i=Math.round(2+r*25),n=Math.round(50+r*30),l=p=>p.toString(16).padStart(2,"0");return`radial-gradient(${a} at 50% 30%, ${e}${l(o)} 0%, ${e}${l(i)} ${n}%, transparent 90%)`}function ja(e,t=6,a=1.2){let r=Math.max(0,Math.min(1,e));return t-r*(t-a)}function qa(e,t){let a=Math.max(0,Math.min(1,t)),r=Math.round(4+a*20),o=Math.round(a*8),n=Math.round((.15+a*.55)*255).toString(16).padStart(2,"0");return`0 0 ${r}px ${o}px ${e}${n}`}function Ga(e,t="0,0,0"){let a=Math.max(0,Math.min(1,e));if(a<.1)return"";let r=Math.round(60-a*30),o=(a*.5).toFixed(2);return`radial-gradient(ellipse at center, transparent ${r}%, rgba(${t},${o}) 100%)`}function Xa(e,t=8,a=2){let r=Math.max(0,Math.min(1,e));return t-r*(t-a)}var co="#a83d2a",Ya="#7a2d20",Ae="#fdf6e3",po='<svg viewBox="0 0 40 40" width="38" height="38" aria-hidden="true">',uo="</svg>";function Ka(e){let t=["day","cloudy","rain","night"].includes(e)?e:"day",r=`<circle class="mc" cx="20" cy="20" r="18" fill="${t==="night"?Ya:co}" opacity="0.92"/>`,o=`<line class="mh" x1="6" y1="22" x2="34" y2="22" stroke="${Ae}" stroke-width="0.8" opacity="0.85"/>`,i="";return t==="day"?i=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.95"/>`:t==="cloudy"?i=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.45"/>`:t==="rain"?i=[`<line class="mg" x1="14" y1="11" x2="13" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="20" y1="11" x2="19" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="26" y1="11" x2="25" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`].join(""):t==="night"&&(i=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.95"/><circle class="md-cut" cx="21.4" cy="13.4" r="1.8" fill="${Ya}"/>`),`${po}${r}${o}${i}${uo}`}function re(e,t){return t?"night":["rainy","pouring","snowy","snowy-rainy","hail","lightning-rainy"].includes(e)?"rain":["cloudy","fog"].includes(e)?"cloudy":"day"}var y={kicker(e){return`<div class="pw-t-kicker">${g(e)}</div>`},heroTier(e,{flavor:t="aqi",color:a=""}={}){let r=t==="atmos"?"pw-t-hero-tier-atmos":"pw-t-hero-tier-aqi",o=a?` style="color:${k(a)}"`:"";return`<div class="pw-t-hero-tier ${r}"${o}>${g(e)}</div>`},display(e,{color:t="",suffix:a=""}={}){let r=t?` style="color:${k(t)}"`:"",o=a?`<span class="pw-t-display-suf">${g(a)}</span>`:"";return`<div class="pw-t-display"${r}>${g(String(e))}${o}</div>`},narrative(e){return`<div class="pw-t-narrative">${g(e)}</div>`},gloss(e){return`<div class="pw-t-gloss">${g(e)}</div>`},meta(e){return`<div class="pw-t-meta">${g(e)}</div>`},chartCaption(e){return`<div class="pw-t-chart-caption">${g(e)}</div>`},stat(e,t,{data:a=!1,valueColor:r=""}={}){let o=r?` style="color:${k(r)}"`:"",i=a?"pw-t-stat-l pw-t-data":"pw-t-stat-l";return`<div class="pw-t-stat"><div class="pw-t-stat-v"${o}>${g(String(e))}</div><div class="${i}">${g(t)}</div></div>`},statLabel(e){return`<span class="pw-t-stat-l">${g(e)}</span>`},dataToken(e){return`<span class="pw-t-data">${e}</span>`},heroBlock({tier:e="",tierFlavor:t="aqi",tierColor:a="",value:r="",valueSuffix:o="",valueColor:i="",narrative:n=""}={}){let l=e?this.heroTier(e,{flavor:t,color:a}):"",p=r!==""?this.display(r,{color:i,suffix:o}):"",c=n?this.narrative(n):"";return`<div class="pw-hero-block">${l}${p}${c}</div>`},statsRow(e,{columns:t=4,divided:a=!1}={}){let r=e.filter(Boolean);return r.length?`<div class="pulse-stats-row" data-cols="${t}"${a?' data-divided="true"':""}>${r.join("")}</div>`:""}};function Q({sectionClass:e,ariaLabel:t,brandVariant:a,kicker:r="",narrative:o="",preContent:i="",extraSectionClass:n="",sectionStyle:l="",body:p,proView:c="",proInitial:s=!1,proAction:d="view-swap",proAriaLabel:u="Toggle pro view",pro:f=!0}){f===!1&&(c="",d="view-swap",s=!1);let m=l?` style="${l}"`:"",h=`pw-section pw-cartouche ${e}${n?` ${n}`:""}`,v=Ka(a),w=[r?y.kicker(r):"",o?y.narrative(o):""].filter(Boolean).join(""),b=w?`<div class="pw-t-marg">${w}</div>`:"",$=!!c,_=$||d!=="view-swap",S=$?`<div class="pw-view pw-view-default">${p}</div><div class="pw-view pw-view-pro">${c}</div>`:p,E=s?"true":"false",M=_?`<button class="pw-brand-mark-corner" aria-label="${g(u)}" aria-pressed="${E}" type="button">${v}</button>`:`<div class="pw-brand-mark-corner" aria-hidden="true">${v}</div>`;return`
    <div class="${h}" data-pro="${E}" data-pro-action="${d}"${m} role="region" aria-label="${g(t)}">
      ${i}
      ${M}
      <div class="pw-content">
    ...
    </div>`}var Yt=Object.freeze({none:{label:"Stable",color:"#30d158",desc:"No thunderstorm risk"},marginal:{label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"},slight:{label:"Slight",color:"#ff9f0a",desc:"Brief storms possible"},enhanced:{label:"Enhanced",color:"#ff6b35",desc:"Organized storms likely"},moderate:{label:"Moderate",color:"#ff453a",desc:"Severe storms expected"},high:{label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"},unknown:{label:"Unknown",color:"#888888",desc:"Insufficient data"}}),mo=Object.freeze({none:5,marginal:20,slight:40,enhanced:60,moderate:80,high:100,unknown:0});function fo(e,t){let a=Math.min(100,e/4e3*100),r=Math.min(100,Math.max(0,(6-t)/12*100));return Math.round(a*.6+r*.4)}function ho(e){return e<=10?{tierKey:"none",label:"Stable",color:"#30d158",desc:"No thunderstorm risk"}:e<=30?{tierKey:"marginal",label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"}:e<=55?{tierKey:"slight",label:"Moderate",color:"#ff9f0a",desc:"Scattered storms likely"}:e<=80?{tierKey:"moderate",label:"High",color:"#ff453a",desc:"Severe storms expected"}:{tierKey:"high",label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"}}function go(e,t){let a=t.atmosCe,r=a.cape&&e.states[a.cape]&&Number(e.states[a.cape].state)||0,o=a.lifted_index&&e.states[a.lifted_index]&&Number(e.states[a.lifted_index].state)||0,i=!!(a.cape&&e.states[a.cape]),n=!!(a.lifted_index&&e.states[a.lifted_index]),l=i||n?fo(r,o):null;if(a.stability_assessment&&e.states[a.stability_assessment]){let c=e.states[a.stability_assessment].state,s=e.states[a.stability_assessment].attributes||{},d=Yt[c];if(d){let u=mo[c]??0;return{tierKey:c,...d,score:u,source:"composite",attrs:s,capeValue:r,liValue:o,hasCape:i,hasLI:n}}}let p=l!==null?ho(l):null;return{tierKey:p?.tierKey||"unknown",label:p?.label||"Unknown",color:p?.color||"#888888",desc:p?.desc||"",score:l,source:"fallback",attrs:null,capeValue:r,liValue:o,hasCape:i,hasLI:n}}function wo(e){return Math.max(0,Math.min(100,e))}function Qa(e,t=5e3){return t<=0?0:Math.max(0,Math.min(100,e/t*100))}function bo(e,t){let i=Math.max(e,t),n=5e3;i>5e3*.8&&(n=Math.max(5e3,Math.ceil(i*1.25/1e3)*1e3));let l=Math.ceil(n/5e3)*1e3;n=Math.ceil(n/l)*l;let p=[];for(let c=n;c>=0;c-=l)p.push(c);return{scaleMax:n,labelInterval:l,labels:p}}var vo=Object.freeze({none:0,unknown:0,marginal:1,slight:2,enhanced:3,moderate:4,high:5});function xo(e){if(!e)return null;let t=a=>vo[String(e[a]||"none")]??0;return{maxThermal:Math.max(t("cape_tier"),t("lifted_index_tier"),t("lapse_rate_tier")),shearTier:t("wind_shear_tier")}}function yo({tierKey:e,tierDesc:t,hourly:a,now:r,todaySunset:o,attrs:i}){if(e==="none"||e==="unknown")return"Atmosphere settled \xB7 no convective signals";let n=xo(i);if(n&&n.maxThermal===0&&n.shearTier>=2)return"Wind shear elevated \xB7 atmosphere thermally quiet";let l=o&&!isNaN(o.getTime())?o.getTime():null,p=r.getTime(),c=l!==null&&p>=l,s=Array.isArray(a)?a.slice(0,6):[],d=s.map(b=>Number(b&&b.cape)||0),u=d.some(b=>Number.isFinite(b)&&b>0),f=null,m=null;if(u){let b=Math.max(...d);if(b>0){let $=s[d.indexOf(b)],_=$?$.datetime:null,S=_?new Date(String(_)):null;S&&!isNaN(S.getTime())&&(f=S.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1}),m=S.getTime())}}if(f===null||m===null){let b=t||"Storm risk active";return c?`${b} \xB7 calming overnight`:b}let h=1800*1e3,v=m<p-h,w=m>=p-h&&m<=p+h;return v?c?`Storm risk easing \u2014 peaked ${f}, calming overnight`:`Storm risk easing \u2014 peaked ${f}`:w?c?"Storm risk peaking now, calming overnight":l!==null?"Storm risk peaking now, calming after sunset":"Storm risk peaking now":l!==null&&m<l?`Storm risk peaks ${f}, calming after sunset`:l!==null?`Storm risk peaks ${f} (after sunset)`:`Storm risk peaks ${f}`}var pi=Object.freeze([Object.freeze({max:30,tier:"none"}),Object.freeze({max:40,tier:"marginal"}),Object.freeze({max:50,tier:"slight"}),Object.freeze({max:60,tier:"enhanced"}),Object.freeze({max:75,tier:"moderate"})]);var di=Object.freeze([Object.freeze({max:6,tier:"none"}),Object.freeze({max:6.5,tier:"marginal"}),Object.freeze({max:7.5,tier:"slight"}),Object.freeze({max:8,tier:"enhanced"}),Object.freeze({max:9,tier:"moderate"})]);function _o(e){let t=Math.max(0,Math.min(100,e)),a=t/100;return{count:t<=10?0:Math.round(2+a*6),minSize:2+Math.round(a),maxSize:3+Math.round(a),minDur:4-a*2.2,maxDur:4-a*1.2}}function Za(e,t,a=Math.random){let r=document.createDocumentFragment(),o=_o(e);if(o.count===0)return r;let i=k(t);for(let n=0;n<o.count;n++){let l=document.createElement("div");l.className="pw-thermal-particle";let p=o.minSize+a()*(o.maxSize-o.minSize),c=10+a()*80,s=a()*30,d=o.minDur+a()*(o.maxDur-o.minDur),u=a()*d,f=.4+a()*.3,m=-(50+a()*60);l.setAttribute("style",[`width:${p.toFixed(1)}px`,`height:${p.toFixed(1)}px`,`left:${c.toFixed(1)}%`,`bottom:${s.toFixed(1)}%`,`background:${i}`,`--rise-dur:${d.toFixed(2)}s`,`--rise-dist:${m.toFixed(0)}px`,`--peak-op:${f.toFixed(2)}`,`animation-delay:${u.toFixed(2)}s`].join(";")),r.appendChild(l)}return r}function Ja({hass:e,config:t,discovery:a,forecastData:r}){let o=a.atmosCe;if(!o.cape&&!o.lifted_index&&!o.freezing_level_height)return console.debug(`${we} Atmosphere section requires Atmos CE sensors (cape / lifted_index / freezing_level_height) \u2014 section skipped. Install Atmos CE integration if you want the atmospheric stability column.`),null;let i=go(e,a),{capeValue:n,liValue:l,hasCape:p,hasLI:c,score:s}=i,d=O=>{let ee=o[O];if(!ee||!e.states[ee])return{value:null,unit:""};let ie=Number(e.states[ee].state);if(!Number.isFinite(ie))return{value:null,unit:""};let fe=String(e.states[ee].attributes?.unit_of_measurement||"");return{value:ie,unit:fe}},u=d("wind_shear_0_6_km"),f=d("lapse_rate_700_500_hpa"),m=d("freezing_level_height"),h=d("lcl_height"),v=i.tierKey,w={label:i.label,color:i.color,desc:i.desc},$=["slight","enhanced","moderate","high"].includes(v)?"rain":"cloudy",_=new Date,S=a.sunEntityId?e.states[a.sunEntityId]:null,{todaySunset:E}=Ve(_,S?.attributes?.next_rising,S?.attributes?.next_setting),M=yo({tierKey:v,tierDesc:w.desc,hourly:r?.hourly||[],now:_,todaySunset:E,attrs:i.attrs}),C=m.value??0,R=h.value??0,{scaleMax:D,labels:B}=bo(C,R),A=s!==null?wo(s):0,P=w.color,I=p||c?`
          <div class="pw-atmos-cape-fill" style="height:${Number(A)}%;background:linear-gradient(to top, ${k(P)}66, ${k(P)}11)"></div>`:"",U=m.unit||"m",x=m.value!==null?(()=>{let O=Qa(m.value,D);return`
          <div class="pw-atmos-freeze-marker" style="bottom:${Number(O)}%">
            <span class="pw-atmos-freeze-label">\u2744 ${g(String(Math.round(m.value)))}${g(U)}</span>
            <div class="pw-atmos-freeze-line"></div>
          </div>`})():"",N=h.unit||"m",V=h.value!==null?(()=>{let O=Qa(h.value,D);return`
        ...
        </div>`,ne=y.heroBlock({tier:w.label,tierFlavor:"atmos",tierColor:"var(--pw-vermilion)",narrative:M}),de=[p?y.stat(`${Math.round(n)}`,"cape J/kg"):"",c?y.stat(l.toFixed(1),"lifted idx"):"",u.value!==null?y.stat(`${Math.round(u.value)}`,`shear ${u.unit||"km/h"}`):"",f.value!==null?y.stat(f.value.toFixed(1),`lapse ${f.unit||"\xB0C/km"}`):""],xe=y.statsRow(de,{columns:4,divided:!0}),j=`
        ${ne}
        ${oe}
        ${xe}`;return Q({sectionClass:"pw-atmosphere-v2",ariaLabel:"Atmospheric stability",brandVariant:$,kicker:"atmospheric stability",body:j,pro:t?.pro!==!1})}function er(e){let t=e.getHours();return t>=6&&t<12?"this morning":t>=12&&t<17?"this afternoon":t>=17&&t<21?"this evening":"tonight"}function $o(e,t){return e==="sunny"||e==="clear-night"?"Clear skies":e==="rainy"||e==="pouring"?"Rain":e==="snowy"||e==="snowy-rainy"?"Snow":e==="lightning"||e==="lightning-rainy"?"Storms":e==="fog"?"Fog":t>=88?"Overcast":t>=50?"Mostly cloudy":t>=12?"Some sun":"Sunny"}function ko(e){let t=e.slots.slice(0,6);if(t.length===0)return null;let a=Number(t[t.length-1].cloud_coverage),r=Number.isFinite(a)?a-e.cloudCoverNow:0,o=t.reduce((c,s)=>Math.max(c,Number(s.precipitation_probability)||0),0),i=t.reduce((c,s)=>Math.max(c,Number(s.snowfall)||0),0),l=t.reduce((c,s)=>Math.max(c,Number(s.wind_speed)||0),e.windSpeed)-e.windSpeed;return["moderate","high"].includes(e.stabilityState)?"with thunderstorms developing":o>=60?i>0?"with snow likely":"with rain likely":o>=40?i>0?"with snow possible":"with a brief shower or two":r>=30?"then increasing clouds":r<=-30?"then clearing":l>=8?"with wind firming":null}function tr(e){let t=$o(e.conditionNow,Number(e.cloudCoverNow)||0),a=ko(e),r=a?er(e.now):null,o;return a?a.startsWith("then ")?o=`${t}, ${a} ${r}.`:o=`${t}, then ${a} ${r}.`:o=`${t} ${er(e.now)}.`,{initial:t,transition:a,anchor:r,sentence:o}}var So={sunny:"linear-gradient(180deg, #1a4a7a 0%, #2a6aaa 40%, transparent 100%)","clear-night":"linear-gradient(180deg, #050510 0%, #0a0a1a 50%, transparent 100%)",partlycloudy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",cloudy:"linear-gradient(180deg, #2a2a3a 0%, #3a3a4a 50%, transparent 100%)",rainy:"linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",pouring:"linear-gradient(180deg, #0a1a2a 0%, #1a2a3a 50%, transparent 100%)",snowy:"linear-gradient(180deg, #2a3040 0%, #3a4050 50%, transparent 100%)","snowy-rainy":"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",hail:"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",lightning:"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)","lightning-rainy":"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)",fog:"linear-gradient(180deg, #2a2a2e 0%, #3a3a3e 50%, transparent 100%)",windy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)","windy-variant":"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",exceptional:"linear-gradient(180deg, #4a2a1a 0%, #6a3a1a 40%, transparent 100%)"},Mo="linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",ar={dry:"#30d158",comfortable:"#30d158",slightly_humid:"#ffd60a",humid:"#ff9f0a",oppressive:"#ff453a",clear:"#30d158",good:"#30d158",moderate:"#ffd60a",poor:"#ff9f0a",fog:"#ff453a"};function To(e){return e<=30?"#5ac8fa":e<=60?"#30d158":e<=80?"#ff9f0a":"#ff453a"}function Fo(e,t){if(e==null)return"Press";let a=Math.abs(Number(e));if(a<=1)return"Press";let r=t==="rising"?"Rising":t==="falling"?"Falling":"Press";return a>3?`${r} rapidly`:r}function Co(e,t,a){let r=e.map(s=>{let d=Number(s.cape);return Number.isFinite(d)?d:0}),o=Math.max(...r,300),i=Math.max(...r),n=r.indexOf(i),p=r.map((s,d)=>({x:d/Math.max(e.length-1,1)*t,y:a-s/o*a})).map((s,d)=>`${d===0?"M":"L"}${s.x.toFixed(1)},${s.y.toFixed(1)}`).join(" "),c=`${p} L${t},${a} L0,${a} Z`;return{svgPath:p,areaPath:c,peakValue:i,peakIndex:n,maxCape:o}}function Ao(e,t,a,r,o,i,n,l){let p=[];return n>0&&p.push({name:"Snow",value:n,unit:l}),a>0&&p.push({name:"Rain",value:a,unit:r}),o>0&&p.push({name:"Showers",value:o,unit:i}),p.length>0?`${p.map(s=>`${g(s.name)} ${g(s.value.toFixed(1))} ${g(s.unit)}`).join(" \xB7 ")} now`:e>0?`Precipitation \u2014 next 12h \xB7 ${g(e.toFixed(1))} ${g(t)} now`:"Precipitation \u2014 next 12h"}function yt(e){return!e||isNaN(e.getTime())?"":Ze(e)}function rr({hass:e,config:t,discovery:a,weatherEntity:r,forecastData:o}){let i=r.attributes,n=a.atmosCe,l=a.sunEntityId||"",{condition:p,isNight:c}=ht(e,r,a),s=(L,z)=>ft(e,n,i,L,z),d=(L,z)=>Da(e,n,L,z),u=s("temperature","temperature"),f=s("apparent_temperature","apparent_temperature")||u,m=s("humidity","humidity"),h=s("wind_speed","wind_speed"),v=s("wind_direction","wind_bearing"),w=s("wind_gusts","wind_gust_speed")||s("wind_gusts","wind_gusts"),b=s("dew_point","dew_point"),$=s("visibility","visibility"),_=s("pressure","pressure"),S=d("temperature","\xB0C"),E=d("visibility","km"),M=d("pressure","hPa"),C=d("dew_point","\xB0C"),R=o?.daily,D=o?.hourly,B=i.forecast,A=u,P=u;if(R&&R.length>0){let L=R[0],z=Number(L.templow),T=Number(L.temperature);Number.isFinite(z)&&Number.isFinite(T)&&(A=Math.min(z,T),P=Math.max(z,T))}else if(D&&D.length>0){let L=Date.now(),z=new Date;z.setHours(23,59,59,999);let T=z.getTime(),X=1/0,Y=-1/0;for(let _e of D.slice(0,24)){let ce=Date.parse(String(_e.datetime??""));if(Number.isFinite(ce)&&(ce<L||ce>T))continue;let H=Number(_e.temperature);Number.isFinite(H)&&(H<X&&(X=H),H>Y&&(Y=H))}Number.isFinite(X)&&Number.isFinite(Y)&&X!==Y&&(A=Math.min(X,u),P=Math.max(Y,u))}else if(B&&B.length>0){let L=B[0],z=Number(L.templow),T=Number(L.temperature);Number.isFinite(z)&&Number.isFinite(T)&&(A=Math.min(z,T),P=Math.max(z,T))}let I=a.atmosCe.uv_index,U=I?Number(e.states[I]?.state)||0:Number(i.uv_index??0),{value:x,unit:N}=Ue(e,n.precipitation),V=N||"mm",{value:G,unit:oe}=Ue(e,n.rain),{value:ne,unit:de}=Ue(e,n.showers),{value:xe,unit:j}=Ue(e,n.snowfall),O=oe||"mm",ee=de||"mm",ie=j||"cm",{value:fe,entity:ye}=Ue(e,n.uv_index_clear_sky),Ne=n.dew_point_comfort?e.states[n.dew_point_comfort]:null,Re=n.visibility_category?e.states[n.visibility_category]:null,Le=n.feels_like_context?e.states[n.feels_like_context]:null,te=n.pressure_trend?e.states[n.pressure_trend]:null,ze=new Date,De=l?e.states[l]:null,Mt=De?.attributes?.next_rising,Tt=De?.attributes?.next_setting,{todaySunrise:Ge,todaySunset:Ce,tomorrowSunrise:Xe}=Ve(ze,Mt,Tt),he=null;a.atmosCe.cloud_cover&&(he={total:Number(e.states[a.atmosCe.cloud_cover]?.state)||0,low:Number(e.states[a.atmosCe.cloud_cover_low]?.state)||0,mid:Number(e.states[a.atmosCe.cloud_cover_mid]?.state)||0,high:Number(e.states[a.atmosCe.cloud_cover_high]?.state)||0});let Ie=n.freezing_level_height?e.states[n.freezing_level_height]:null,ot=Ie&&Number(Ie.state)||0,Oe=(n.stability_assessment?e.states[n.stability_assessment]:null)?.state||"",Ye=n.lifted_index?e.states[n.lifted_index]:null,ge=Ye&&Number(Ye.state)||0,nt=k(So[p]||Mo),Ft=Math.max(P-A,1),gn=Math.max(0,Math.min(100,(u-A)/Ft*100)),ea=bt(v),Fr=`data-condition="${g(p)}" data-night="${c}" data-cloud='${g(JSON.stringify(he||""))}'`,Cr=tt(u,20,42),Ar=tt(u,15,-10),Ct=Math.max(Cr,Ar),Er=Te(u),wn=Ct>.05?`text-shadow: 0 2px 20px rgba(0,0,0,0.3), ${qa(Er,Ct)}`:"text-shadow: 0 2px 20px rgba(0,0,0,0.3)",ta=Ga(Ct),Nr=ta?`<div class="pw-tension-vignette" style="background: ${k(ta)}"></div>`:"",bn=xe>0?`<div class="pw-snow-badge" style="color:var(--pw-color-freeze, #5ac8fa)">\u2744 ${g(xe.toFixed(1))} ${g(ie)}</div>`:"",aa=Le?.state||"",Pe=Le?.attributes?.difference,it="";aa==="wind_chill"&&Pe!==null&&Pe!==void 0?it=`<div class="pw-feels-context">Wind chill ${g(String(Math.round(Number(Pe))))}\xB0</div>`:aa==="heat_index"&&Pe!==null&&Pe!==void 0&&(it=`<div class="pw-feels-context">Heat index +${g(String(Math.round(Number(Pe))))}\xB0</div>`);let Rr=["marginal","slight","enhanced","moderate","high"],Lr="";if(Oe&&Rr.includes(Oe)){let L=Yt[Oe];if(L){let z=k(L.color),T=`\u26A1 ${g(L.label)}`;if(Ye&&ge<0){let X=Qe.find(Y=>ge>=Y.min)||Qe[Qe.length-1];T+=` \xB7 <span style="color:${k(X.color)}">LI ${g(String(ge))}</span>`}Lr=` <span class="pw-stability-badge" style="background:${z}33; color:${z}">${T}</span>`}}let At=Re?.state||"",vn=At&&!["unavailable","unknown"].includes(At)&&ar[At]||"",st=Ne?.state||"",xn=st&&!["unavailable","unknown"].includes(st)&&ar[st]||"",ra=te?.attributes?.trend_symbol||"",oa=te?.state==="rising"?"#30d158":te?.state==="falling"?"#ff9f0a":te?.state==="steady"?"#5ac8fa":"",zr=ye&&Math.abs(fe-U)>=.5,Et=te?.attributes?.change_3h,Nt=Fo(Et!=null?Number(Et):null,te?.state||"");if(Nt==="Press"&&te?.state){let L=te.state;L==="rising"?Nt="Rising":L==="falling"&&(Nt="Falling")}let yn=oa||(te?"#5ac8fa":""),Dr=Oa(h),_n=wt(h),Rt=w>h+5,Ir=h>0&&w/h>1.5,Or=Rt?Ir?` / <b>${g(Math.round(w))}</b>`:` / ${g(Math.round(w))}`:"",Pr=`<svg width="10" height="10" viewBox="0 0 10 10" style="vertical-align:middle;transform:rotate(${Number(v)||0}deg)"><polygon points="5,0 3,8 5,6 7,8" fill="${k(Dr)}" opacity="0.8"/></svg>`,$n=`${g(Math.round(h))}${Or} ${Pr}${g(ea)}`,kn=`linear-gradient(to right, ${k(Te(A))}, ${k(Te(P))})`,Hr="";if(Ie&&ot<5e3&&A<=0){let L=Math.max(0,Math.min(100,(0-A)/Ft*100)),z=Ie?.attributes?.unit_of_measurement||"m";Hr=`<div class="pw-arc-freeze" style="left:${Number(L)}%">
            <div class="pw-arc-freeze-label">\u2744 ${g(String(Math.round(ot)))}${g(z)}</div>
            <div class="pw-arc-freeze-line"></div>
          </div>`}let na="",ia=l?e.states[l]:null;if(ia&&Ge&&Ce&&Xe){let L=ze.getTime(),z=ia.state==="above_horizon",T,X,Y,_e,ce;if(z){let W=Ge.getTime(),se=Ce.getTime(),Se=Math.max(se-W,1);T=Math.max(0,Math.min(100,(L-W)/Se*100)),X=yt(Ge),Y=yt(Ce),_e="background: linear-gradient(to right, #ff9f0a, #ffd60a)",ce="#ff9f0a"}else{let W=Ce.getTime(),se=Xe.getTime(),Se=Math.max(se-W,1);T=Math.max(0,Math.min(100,(L-W)/Se*100)),X=yt(Ce),Y=yt(Xe),_e="background: linear-gradient(to right, #1a3050, #5ac8fa)",ce="#5ac8fa"}let H=`left:${Number(T)}%; background:${k(ce)}; box-shadow: 0 0 6px ${k(ce)}66`,ke=` style="color:${k(ce)}"`,q=z?"1":"0.85",$e=z?"":"\u{1F319}";na=`
      <div class="pw-day-arc" style="opacity:${q}">
        <span class="pw-day-arc-label"${ke}>${g(X)}</span>
        <div class="pw-day-arc-bar">
          <div class="pw-day-arc-fill" style="width:${Number(T)}%; ${_e}"></div>
          <div class="pw-day-arc-marker" style="${H}">${$e}</div>
        </div>
        <span class="pw-day-arc-label"${ke}>${g(Y)}</span>
      </div>`}let Wr="",Br="",Ur="",lt="",sa=o?.hourly||[];if(sa.length>0){let T=gt(sa,new Date).slice(0,12),X=T.some(H=>Number(H.precipitation_probability)>0),Y=Ao(x,V,G,O,ne,ee,xe,ie);if(x>0)lt=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        <span style="font-size:14px">\u{1F327}</span> ${Y}
      </div>`;else{let H=tr({now:new Date,cloudCoverNow:he?he.total:0,conditionNow:p,slots:T,windSpeed:h,uvIndex:U,stabilityState:Oe});lt=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        ${g(H.sentence)}
      </div>`}if(X){let H=T.map($e=>{let W=Math.min(100,Math.max(0,Number($e.precipitation_probability)||0)),se=Number($e.snowfall)||0,Se=(Number($e.rain)||0)+(Number($e.showers)||0),Ke=se>0;if(Ke&&Se>0){let to=se+Se,da=Math.round(W*se/to),ao=W-da;return`<div class="pulse-precip-slot"><div class="pulse-precip-fill" style="height:${Number(ao)}%"></div><div class="pulse-precip-fill pw-precip-snow" style="height:${Number(da)}%"></div></div>`}return`<div class="pulse-precip-slot"><div class="${Ke?"pulse-precip-fill pw-precip-snow":"pulse-precip-fill"}" style="height: ${W}%"></div></div>`}).join(""),q=T[Math.floor(T.length/2)]?`+${Math.floor(T.length/2)}h`:"";Wr=`
      <div style="position: relative; z-index: 2; margin: 16px var(--pulse-space-card-wide) 0;">
        ...
        <div class="pw-precip-times"><span>Now</span><span>${g(q)}</span><span>+${g(String(T.length))}h</span></div>
      </div>`}if(T.some(H=>Number(H.cape)>300)){let q=Co(T,200,24),$e=q.peakIndex/Math.max(T.length-1,1)*200,W=q.peakValue>=1e3?`${(q.peakValue/1e3).toFixed(1)}k`:String(Math.round(q.peakValue)),se=T[q.peakIndex]?.datetime?new Date(T[q.peakIndex].datetime):null,Se=se?Ze(se):"",Ke=Je("pw-cape-grad");Br=`
      ...
      </div>`}T.some(H=>H.dew_point!==void 0&&H.dew_point!==null)&&(Ur=`
      <div style="position: relative; z-index: 2; margin: 2px var(--pulse-space-card-wide) 0;">
        ...
        <div class="pw-comfort-bar">${T.map(ke=>{let q=Number(ke.dew_point)||0;return`<div class="pw-comfort-slot" style="background:${k(Ha(q))}"></div>`}).join("")}</div>
      </div>`)}let Sn=Te(f),Mn=he!==null?Pa(he.total):"",Tn=To(m),Fn=`${g(Math.round(_))} ${g(M)}${ra?` <span style="color:${k(oa)}">${g(ra)}</span>`:""}`,Cn=`${g(Math.round(U))}${zr?` <span style="opacity:0.5">/ ${g(String(Math.round(fe)))}</span>`:""}`;function Vr(){return Ze(new Date)}let jr=Wa(p),qr=re(p,c),Gr=t?.location_label||"Now",la=it?it.replace(/<[^>]*>/g,"").trim():"",Xr=lt?lt.replace(/<[^>]*>/g,"").trim():"",Yr=he?Math.round(he.total)+"%":"--",Kr=`
        <div class="pw-loc-stamp">${g(Gr)} \xB7 ${g(Vr())}</div>
        <div class="pw-hero-block">
          ${y.display(Math.round(u),{suffix:S})}
          ${y.gloss(`${jr}${la?" \xB7 "+la:""}`)}
        </div>`,Qr=y.statsRow([y.stat(`${Math.round(A)}/${Math.round(P)}\xB0`,"range"),y.stat(`${Math.round(h)}${Rt?` / ${Math.round(w)}`:""} ${ea}`,Rt?"wind / gust":"wind"),y.stat(Math.round(U),"uv"),y.stat(Yr,"cloud")],{columns:4}),ct=(o?.daily||[]).slice(0,7),Lt="";if(ct.length>=2){let T=ct.map(W=>Number(W.temperature)||0),X=ct.map(W=>Number(W.templow??W.temperature)||0),Y=Math.min(...X),_e=Math.max(...T),ce=Math.max(_e-Y,1),H=W=>W/(ct.length-1)*320,ke=W=>38-(W-Y)/ce*34-2,q=T.map((W,se)=>`${se===0?"M":"L"}${H(se).toFixed(1)},${ke(W).toFixed(1)}`).join(" ");Lt=`<svg viewBox="0 0 320 38" preserveAspectRatio="none">
    ...
    </svg>`}let Zr=Lt?`<div class="pw-overview-spark-block">
        ${y.chartCaption("7-day temperature trend")}
        <div class="pw-overview-spark">${Lt}</div>
      </div>`:"",ca=Re?.state||"",zt=te?.state||"",Jr=[Number.isFinite(m)&&m>0,Number.isFinite(b)&&b!==0,!!ca,!!zt].filter(Boolean).length>=2,pa="";if(Jr){let L=Number.isFinite(m)&&m>0?y.stat(`${Math.round(m)}%`,st||"humidity"):y.stat("\u2014","humidity"),z=Number.isFinite(b)?y.stat(`${Math.round(b)}${C}`,"dew point"):y.stat("\u2014","dew point"),T=Number.isFinite(_)&&_>0?y.stat(`${Math.round(_)}`,zt?`${M} ${zt}`:M):y.stat("\u2014","pressure"),X=Number.isFinite($)&&$>0?y.stat(`${$.toFixed($<10?1:0)}${E}`,ca||"visibility"):y.stat("\u2014","visibility");pa=y.statsRow([L,z,T,X],{columns:4})}let eo=`
        ${Kr}
        ${y.narrative(Xr)}
        ${na}
        ${Zr}
        ${Qr}
        ${pa}`;return Q({sectionClass:"pw-overview-v2",ariaLabel:"Current weather overview",brandVariant:qr,preContent:`${Nr}<div class="pw-fx" ${Fr} role="img" aria-label="${g(p)} weather effects"></div>`,body:eo,pro:t?.pro!==!1})}function Eo(e){if(!e||e.length===0)return"Forecast unavailable";let t=0;for(let n=1;n<e.length;n++)Number(e[n].temperature)>Number(e[t].temperature)&&(t=n);let a=e.findIndex(n=>Number(n.precipitation_probability)>=50),r=n=>n===0?"today":new Date(String(e[n].datetime||"")).toLocaleDateString([],{weekday:"short"}).toLowerCase(),o=r(t),i=Math.round(Number(e[t].temperature));return a>=0&&a!==t?`Warmest ${o} (${i}\xB0) \xB7 rain ${r(a)}`:a>=0?`Wet stretch \xB7 warmest ${o} (${i}\xB0)`:`Warmest ${o} (${i}\xB0) \xB7 dry through the week`}function or({hass:e,config:t,discovery:a,forecastData:r,weatherEntity:o}){let i=r?.daily||[];if(i.length===0)return null;let n=a.atmosCe,p=(n.temperature?e.states[n.temperature]:null)?.attributes?.unit_of_measurement||"\xB0C",c=i.slice(0,7),s=c.flatMap(S=>[K(S.temperature,0),K(S.templow,0)]),d=Math.min(...s),u=Math.max(...s),f=Math.max(u-d,1),m=Number(o?.attributes?.temperature),h=c.map((S,E)=>{let M=K(S.temperature,0),C=K(S.templow,0),R=Math.round(Number(S.precipitation_probability)||0),D=E===0,B=D?"today":new Date(String(S.datetime||"")).toLocaleDateString([],{weekday:"short"}).toLowerCase(),A=vt(String(S.condition||"")),P=R>=50?`<span class="pw-fc-pop">${g(String(R))}%</span>`:'<span class="pw-fc-pop"></span>',I=(C-d)/f*100,U=(M-C)/f*100,x=D&&Number.isFinite(m)?`<span class="pw-fc-now" style="left:${k(((m-d)/f*100).toFixed(2)+"%")}"></span>`:"";return`
      <div class="pw-fc-row${D?" is-today":""}">
        <span class="pw-fc-day">${g(B)}</span>
        <span class="pw-fc-icon" aria-hidden="true">${A}</span>
        ${P}
        <span class="pw-fc-bar" aria-label="High ${Math.round(M)}${g(p)}, low ${Math.round(C)}${g(p)}">
        ...
        <span class="pw-fc-range">
          ...
          <span class="pw-fc-hi">${g(String(Math.round(M)))}\xB0</span>
        </span>
      </div>`}).join(""),{condition:v,isNight:w}=ht(e,o,a),b=re(v,w),$=Eo(c),_=`
        <div class="pw-fc-list" role="list">
          ${h}
        </div>`;return Q({sectionClass:"pw-forecast-v2",ariaLabel:"Seven-day forecast",brandVariant:b,kicker:"the week ahead",narrative:$,body:_,pro:t?.pro!==!1})}var je=240,be=je/2,ve=je/2,at=90,nr=.12,_t=6,$t=.5,ir=.25,No=.3,Ro=6,sr=.7,Lo=.2,zo=4,Do=3.3,Io=15,Oo=35,Po=.08,Ho=.2,Wo=[{l:"N",a:0},{l:"NE",a:45},{l:"E",a:90},{l:"SE",a:135},{l:"S",a:180},{l:"SW",a:225},{l:"W",a:270},{l:"NW",a:315}];function lr(e){return(e-90)*Math.PI/180}function Bo(e){let t=e*Math.PI/180;return{x:Math.sin(t),y:-Math.cos(t)}}function Fe(e,t){return{x:be+t*Math.cos(e),y:ve+t*Math.sin(e)}}function Uo(e,t,a,r){let o=Math.min(e/Be,1)*at,i=Fe(t-ir,o),n=Fe(t+ir,o),l=a>No?"pw-gust-sweep":"",p=Math.max(.6,2.5-a*2).toFixed(2),c=(.15+a*.3).toFixed(2),s=`transform-origin:${be}px ${ve}px;--gust-dur:${p}s;--gust-peak:${c}`;return pe("path",{class:l,d:`M${be},${ve} L${i.x.toFixed(1)},${i.y.toFixed(1)} L${n.x.toFixed(1)},${n.y.toFixed(1)} Z`,fill:r,opacity:.15,style:s})}function Vo(e,t,a,r){let o=Math.min(e/Be,1)*at,i=Fe(t,o),n=Fe(t-nr,o*.7),l=Fe(t+nr,o*.7),p={x:i.x-_t*Math.cos(t-$t),y:i.y-_t*Math.sin(t-$t)},c={x:i.x-_t*Math.cos(t+$t),y:i.y-_t*Math.sin(t+$t)},s=a*Ro,d=Math.max(.4,4-a*3.6),u=s>Lo?`animation:pw-arrowSway ${d.toFixed(2)}s ease-in-out infinite;--sway-fwd:${(s*sr).toFixed(2)}deg;--sway-back:${(-s*(1-sr)).toFixed(2)}deg`:"",f=`transform-origin:${be}px ${ve}px;filter:drop-shadow(0 0 6px ${Me(r,.38)});${u}`,m=pe("path",{d:`M${be},${ve} L${n.x.toFixed(1)},${n.y.toFixed(1)} L${i.x.toFixed(1)},${i.y.toFixed(1)} L${l.x.toFixed(1)},${l.y.toFixed(1)} Z`,fill:r,opacity:.5}),h=pe("line",{x1:be,y1:ve,x2:i.x.toFixed(1),y2:i.y.toFixed(1),stroke:r,"stroke-width":2.5,"stroke-linecap":"round"}),v=pe("path",{d:`M${i.x.toFixed(1)},${i.y.toFixed(1)} L${p.x.toFixed(1)},${p.y.toFixed(1)} L${c.x.toFixed(1)},${c.y.toFixed(1)} Z`,fill:r});return pe("g",{style:f},m+h+v)}function cr({hass:e,config:t,discovery:a,weatherEntity:r}){let o=r.attributes,i=a.atmosCe,n=t.speed_mode||"speed",l=(j,O)=>ft(e,i,o,j,O),p=l("wind_speed","wind_speed"),c=l("wind_gusts","wind_gust_speed")||l("wind_gusts","wind_gusts")||p,s=l("wind_direction","wind_bearing"),u=(i.wind_speed?e.states[i.wind_speed]:null)?.attributes?.unit_of_measurement||o.wind_speed_unit||"km/h",f=n==="gust"?c:p,m=Math.min(p/Be,1),h=wt(f),v=jt(f),w=We[v]||We.calm,b=bt(s),$=lr(s),_=Bo(s),S=Math.round(m*ha),E=zo-m*Do,M=Po+m*Ho,C=Io+m*Oo,R=-_.y,D=_.x,B=[];for(let j=0;j<S;j++){let O=(Math.random()-.5)*400,ee=-120-Math.random()*60,ie=420+Math.random()*60,fe=(C*(.6+Math.random()*.8)).toFixed(1),ye=(E+Math.random()*E*.5).toFixed(2),Ne=(Math.random()*3).toFixed(2),Re=(M*(.5+Math.random()*.5)).toFixed(3),Le=(ee*_.x+O*R).toFixed(1),te=(ee*_.y+O*D).toFixed(1),ze=(ie*_.x+O*R).toFixed(1),De=(ie*_.y+O*D).toFixed(1);B.push(`<div class="pw-streak" style="left:50%;top:50%;width:${fe}px;height:1px;transform:rotate(${s-90}deg);animation-duration:${ye}s;animation-delay:${Ne}s;opacity:${Re};background:linear-gradient(to right, transparent, ${Me(w,.27)}, transparent);--sx:${Le}px;--sy:${te}px;--ex:${ze}px;--ey:${De}px"></div>`)}let A=[];for(let j=1;j<=3;j++)A.push(pe("circle",{cx:be,cy:ve,r:j*30,fill:"none",stroke:w,"stroke-width":.5,opacity:.08+j*.02}));for(let j of Wo){let O=lr(j.a),ee=Fe(O,20),ie=Fe(O,at+4),fe=Fe(O,at+16),ye=j.l.length===1;A.push(pe("line",{x1:ee.x.toFixed(1),y1:ee.y.toFixed(1),x2:ie.x.toFixed(1),y2:ie.y.toFixed(1),stroke:w,"stroke-width":.5,opacity:.12})),A.push(pe("text",{x:fe.x.toFixed(1),y:fe.y.toFixed(1),"text-anchor":"middle","dominant-baseline":"central",fill:ye?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.3)","font-size":ye?11:9,"font-weight":ye?600:400},g(j.l)))}A.push(Uo(c,$,m,w)),A.push(Vo(f,$,m,w)),(f>Be||c>Be)&&A.push(pe("circle",{cx:be,cy:ve,r:at+2,fill:"none",stroke:"#ff453a","stroke-width":1.5,"stroke-dasharray":"4 4",opacity:.7})),A.push(pe("circle",{cx:be,cy:ve,r:18,fill:w,opacity:.06})),A.push(pe("circle",{cx:be,cy:ve,r:3,fill:w}));let I=m>Ot?(m-Ot)*5:0,U=Math.max(.15,.4-m*.25),x="";I>.1&&(x=`--dx:${(I*_.x).toFixed(2)}px;--dy:${(I*_.y).toFixed(2)}px;animation:pw-roseShake ${U.toFixed(2)}s ease-in-out infinite`);let N=Math.round(12+m*50).toString(16).padStart(2,"0"),V=Math.round(6+m*25).toString(16).padStart(2,"0"),G=Ia(`radial-gradient(ellipse at 50% 50%, ${w}${N} 0%, ${w}${V} 40%, transparent 85%)`),oe=re(r?.state||"sunny",!1),ne=n==="gust",de=ne?"wind \xB7 gust":"wind",xe=`
        <div class="pw-wind-streaks">${B.join("")}</div>
        <div class="pw-rose-wrap" style="${x}">
          <svg class="pw-rose-svg" width="${je}" height="${je}" viewBox="0 0 ${je} ${je}" style="display:block" role="img" aria-label="Wind compass rose showing ${g(Math.round(f))} ${g(u)} from ${g(b)}">
            <title>Wind direction compass</title>
            ${A.join("")}
          </svg>
          <div class="pw-wind-center">
            <div class="pw-wind-speed" style="color: ${k(w)}">${g(Math.round(f))}</div>
            <div class="pw-wind-unit">${g(u)} \xB7 ${g(Math.round(s))}\xB0 ${g(b)}</div>
            <div class="pw-wind-beaufort" style="color: ${k(w)}">${g(h.name)}</div>
            <div class="pw-wind-beaufort-desc">${g(h.desc)}</div>
          </div>
        </div>`;return Q({sectionClass:"pw-wind-v2",ariaLabel:"Wind compass and speed",brandVariant:oe,kicker:de,sectionStyle:`background: ${k(G)}`,body:xe,proAction:"wind-mode",proInitial:ne,proAriaLabel:"Toggle speed and gust mode",pro:t.pro!==!1})}function jo(e,t,a,r){if(a&&r){let n=(t==="us"?It:Dt).find(l=>l.label.toLowerCase()===a.toLowerCase());return{label:a,color:r,desc:n?.desc||""}}let o=t==="us"?It:Dt;for(let i of o)if(e<=i.max)return i;return o[o.length-1]}function qo(e){let t=(e||"").toLowerCase();return t.includes("very unhealthy")||t.includes("hazardous")||t.includes("extremely poor")?"very_unhealthy":t.includes("sensitive")?"unhealthy_sg":t.includes("unhealthy")||t.includes("very poor")?"unhealthy":t.includes("moderate")||t.includes("fair")||t.includes("poor")?"moderate":t.includes("good")?"good":"unknown"}var pr=Object.freeze({good:"var(--pw-good-green)",moderate:"var(--pw-warn-yellow)",unhealthy_sg:"var(--pw-warn-amber)",unhealthy:"var(--pw-warn-red)",very_unhealthy:"#8b0000",unknown:"var(--pw-ink-cream)"});function dr({hass:e,config:t,discovery:a,weatherEntity:r}){let o=t.scale||"eu",i=o==="us"?"us_aqi":"european_aqi",n=t.aqi_entity||a.atmosCe[i];if(!n||!e.states[n])return null;let l=e.states[n],p=Number(l.state)||0,c=l.attributes?.category||null,s=l.attributes?.color||null,d=jo(p,o,c,s),u=I=>{let U=a.atmosCe[I];if(!U||!e.states[U])return null;let x=Number(e.states[U].state);return Number.isFinite(x)?x:null},f=u("pm2_5"),m=u("pm10"),h=u("ozone"),v=u("nitrogen_dioxide"),w=u("sulphur_dioxide"),b=u("carbon_monoxide"),$=qo(d.label),_=pr[$]||pr.unknown,S=re("cloudy",!1),E=o==="us",C=Math.min(100,Math.max(0,p/(E?300:100)*100)),R=E?"air quality \xB7 us":"air quality",D=y.heroBlock({value:Math.round(p),valueColor:_,tier:d.label,tierFlavor:"aqi",tierColor:_}),B=`
        ...
        <div class="pw-aq-band-labels">
          ...
          <span>unhealthy</span>
          <span>v.unh</span>
        </div>`,A=y.statsRow([f!==null?y.stat(Math.round(f),"PM2.5",{data:!0}):"",m!==null?y.stat(Math.round(m),"PM10",{data:!0}):"",h!==null?y.stat(Math.round(h),"O\u2083",{data:!0}):"",v!==null?y.stat(Math.round(v),"NO\u2082",{data:!0}):"",w!==null?y.stat(Math.round(w),"SO\u2082",{data:!0}):"",b!==null?y.stat(b.toFixed(1),"CO",{data:!0}):""],{columns:3}),P=`
        ${D}
        ${B}
        ${A}`;return Q({sectionClass:"pw-air-quality-v2",ariaLabel:"Air quality index",brandVariant:S,kicker:R,body:P,proAction:"aqi-scale",proInitial:E,proAriaLabel:"Toggle EU and US AQI scale",pro:t.pro!==!1})}function Go(e){let t=(e%ae+ae)%ae;return Ta[Math.floor(t/ae*8)%8]}function Xo(e){return(e%ae+ae)%ae<ae/2}var Kt=864e5;function ue(e){return!e||isNaN(e.getTime())?"--:--":e.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})}function Yo(e,t,a,r,o){if(r==null)return`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${a}" fill="#c8d0e0"/>`;let i=Math.max(0,Math.min(1,r/100)),n=o!=null?Xo(o):!0,l=`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${a}" fill="#2a2a3a"/>`;if(i>=.99)l+=`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${a}" fill="#e8e0d0"/>`;else if(i>.01){let p=t-a,c=t+a,s=(a*Math.abs(2*i-1)).toFixed(1),d=i>.5?1:0,u;n?u=`M${e.toFixed(1)},${p.toFixed(1)} A${a},${a} 0 0 1 ${e.toFixed(1)},${c.toFixed(1)} A${s},${a} 0 0 ${d} ${e.toFixed(1)},${p.toFixed(1)} Z`:u=`M${e.toFixed(1)},${p.toFixed(1)} A${a},${a} 0 0 0 ${e.toFixed(1)},${c.toFixed(1)} A${s},${a} 0 0 ${1-d} ${e.toFixed(1)},${p.toFixed(1)} Z`,l+=`<path d="${u}" fill="#e8e0d0"/>`}return l}var kt="#050510",ur="#0a1226",mr="#172b4f",fr="#1f3d6e",hr="#3a6fa8",gr="#d97a3a",wr="#ff9f0a",br="#ffc560",vr="#7eaedb",xr="#2c5a8e",yr="#ffd60a";function Ko(e,t,a,r,o,i,n,l,p,c){let s=new Date(e.getTime());s.setHours(0,0,0,0);let d=e.getTime(),u=t.getTime(),f=(a??new Date(d-35*6e4)).getTime(),m=(r??new Date(d-30*6e4)).getTime(),h=(o??new Date(d-6*6e4)).getTime(),v=(i??new Date(d+30*6e4)).getTime(),w=(n??new Date(u-30*6e4)).getTime(),b=(l??new Date(u+6*6e4)).getTime(),$=(p??new Date(u+30*6e4)).getTime(),_=(c??new Date(u+35*6e4)).getTime(),S=(d+u)/2,E=P=>Math.max(0,Math.min(100,P)),M=P=>E((P-s.getTime())/Kt*100),C=(P,I)=>M((P+I)/2),R=Math.min(60,(u-d)/8)*6e4,D=S-R,B=S+R;return`linear-gradient(to right, ${[`${kt} 0%`,`${kt} ${M(f).toFixed(2)}%`,`${ur} ${C(f,m).toFixed(2)}%`,`${mr} ${M(m).toFixed(2)}%`,`${fr} ${C(m,h).toFixed(2)}%`,`${hr} ${M(h).toFixed(2)}%`,`${gr} ${C(h,d).toFixed(2)}%`,`${wr} ${M(d).toFixed(2)}%`,`${br} ${C(d,v).toFixed(2)}%`,`${vr} ${M(v).toFixed(2)}%`,`${xr} ${C(v,D).toFixed(2)}%`,`${yr} ${M(D).toFixed(2)}%`,`${yr} ${M(B).toFixed(2)}%`,`${xr} ${C(B,w).toFixed(2)}%`,`${vr} ${M(w).toFixed(2)}%`,`${br} ${C(w,u).toFixed(2)}%`,`${wr} ${M(u).toFixed(2)}%`,`${gr} ${C(u,b).toFixed(2)}%`,`${hr} ${M(b).toFixed(2)}%`,`${fr} ${C(b,$).toFixed(2)}%`,`${mr} ${M($).toFixed(2)}%`,`${ur} ${C($,_).toFixed(2)}%`,`${kt} ${M(_).toFixed(2)}%`,`${kt} 100%`].join(", ")})`}function _r(e){if(!e||isNaN(e)||e<=0)return"--";let t=Math.round(e/6e4),a=Math.floor(t/60),r=t%60;return`${a}h ${String(r).padStart(2,"0")}m`}function $r({hass:e,config:t,discovery:a}){let r=new Date,o=a.sunEntityId?e.states[a.sunEntityId]:null;if(!o)return null;let i=o.attributes||{},n=i.next_rising||i.sunrise,l=i.next_setting||i.sunset;if(!n||!l)return null;let p=new Date(r);p.setHours(12,0,0,0);let c=Z(new Date(n),p),s=Z(new Date(l),p);if(!c||!s||isNaN(c.getTime())||isNaN(s.getTime()))return null;let d=a.atmosCe,u=ge=>d[ge]?new Date(String(e.states[d[ge]]?.state)):null,f=Z(u("golden_hour_morning_start"),c),m=Z(u("golden_hour_morning_end"),c),h=Z(u("blue_hour_morning_start"),c),v=Z(u("golden_hour_evening_start"),s),w=Z(u("golden_hour_evening_end"),s),b=Z(u("blue_hour_evening_end"),s),$=i.next_dawn,_=i.next_dusk,S=$?Z(new Date($),c):null,E=_?Z(new Date(_),s):null,M=d.moon_phase?e.states[d.moon_phase]:null,C=M?.attributes||{},R=C.moon_age!==void 0?Number(C.moon_age):null,D=C.illumination!==void 0?Number(C.illumination):null,B=R!==null?Go(R):M?.state||null,A=Z(u("moonrise"),r),P=Z(u("moonset"),r),I=r.getTime()>=c.getTime()&&r.getTime()<=s.getTime(),U=ue(c),x=ue(s),N=(c.getTime()+s.getTime())/2,V=ue(new Date(N)),G=s.getTime()-c.getTime(),oe=Kt-G,ne=_r(G),de=_r(oe),xe=I?"Daylight":"Night",j=I?ne:de,O=new Date(c.getTime());O.setHours(0,0,0,0);let ee=Math.max(0,Math.min(100,(r.getTime()-O.getTime())/Kt*100)),ie=Ko(c,s,S,h,f,m,v,w,b,E),ye=`
      ...
      </div>`,Ne=D!=null?Math.round(D):null,Re=B||"Moon",Le=Yo(24,24,22,D,R),te=Ne!==null?`<span class="pw-astro-moon-illum">${g(`${Ne}%`)}</span> illuminated`:"",ze=R!=null?`${R.toFixed(1)}d old`:"",De=R!=null?(()=>{let ge=ae/2,nt=(R%ae+ae)%ae;return`${(nt<=ge?ge-nt:ae-nt+ge).toFixed(1)}d to full`})():"",Mt=[te,ze,De].filter(Boolean).join(" \xB7 "),Tt=`
      ...
      ${y.narrative(Ge)}`,Xe=ue(A),he=ue(P),Ie=y.statsRow([y.stat(ue(S),"civil dawn"),y.stat(ue(f),"golden start",{valueColor:"var(--pw-warn-amber)"}),y.stat(ue(h),"blue start",{valueColor:"var(--pw-wind)"}),y.stat(Xe,"moonrise")],{columns:4,divided:!0}),ot=y.statsRow([y.stat(ue(E),"civil dusk"),y.stat(ue(w),"golden end",{valueColor:"var(--pw-warn-amber)"}),y.stat(ue(b),"blue end",{valueColor:"var(--pw-wind)"}),y.stat(he,"moonset")],{columns:4,divided:!0}),Jt=`
      ${Ce}
      ${Tt}
      ${ye}
      ${Ie}
      ${ot}`,Oe=re(I?"sunny":"clear-night",!I),Ye=`<div class="pw-fx" data-astro-stars="${!I}" data-astro-day="${I}" role="img" aria-label="Sky atmospheric effects"></div>`;return Q({sectionClass:"pw-astro-v2",extraSectionClass:I?"":"is-night",ariaLabel:"Astronomy: sun and moon",brandVariant:Oe,kicker:"today's sky",preContent:Ye,body:Jt,pro:t?.pro!==!1})}function Qo(e,t){let a=(e?.state||"").toLowerCase();if(!e||a==="none"||a==="no alerts"||a==="unavailable"||a==="0"||a==="off")return[];let r=e.entity_id||"";if(r.endsWith("_alert_count")||r.startsWith("binary_sensor."))return[];let o=e.attributes,i=[],n=o.alert_type||o.type||"wind",l=Number(o.level),p=Number.isFinite(l)&&l>0?l:1,c=typeof o.severity=="string"?o.severity.toLowerCase():"",s=_a[c]||Wt[p]||Wt[1],d=ya[n]||"mdi:alert",u=Number(o.progress)||0,f=Array.isArray(o.locations)?o.locations:[],m=o.end_time??"",h=null,v=null,w=!1;if(m==="")w=!0;else if(m){let b=new Date(m),$=new Date,_=b.getTime()-$.getTime();if(_/(1e3*60*60*24)>va)w=!0;else if(t)h=Math.max(0,_/(1e3*60*60));else{let E=o.start_time||o.datetime;if(E){let M=new Date(String(E));v=Math.max(0,(M.getTime()-$.getTime())/(1e3*60*60))}}}return i.push({type:n,icon:d,severity:p,color:s,summary:String(o.headline||o.summary||e.state||""),desc:String(o.description||""),active:t,hoursLeft:h,hoursUntil:v,progress:u,locations:f,link:o.link?String(o.link):null,endTime:String(m),isUntilFurtherNotice:w}),i}function Zo(e){let t=e.severity>=4?"red":"amber",a="";e.isUntilFurtherNotice?a="UNTIL FURTHER NOTICE":e.active&&e.hoursLeft!==null?a=`${Math.round(e.hoursLeft)}H LEFT`:e.hoursUntil!==null?a=`IN ${Math.round(e.hoursUntil)}H`:e.active&&(a="ACTIVE");let r=String(e.type||"").toUpperCase(),o=String(e.summary||e.desc||"").toUpperCase().trim(),i=e.locations.length>0?e.locations.join(", ").toUpperCase():"",l=[a,r,o,i].filter(Boolean).join(" \xB7 ");return`
    <div class="pw-alert-ticker pw-alert-${t}">
      <span class="pw-alert-tri">\u25B6</span>
      <span class="pw-alert-text">${g(l)}</span>
    </div>`}function kr({hass:e,config:t,discovery:a,proPersisted:r=!1}){let o=[];a.atmosCe.active_alert&&e.states[a.atmosCe.active_alert];for(let x of a.alertEntityIds){let N=e.states[x];if(!N)continue;let V=x.includes("active")||N.state==="on";o.push(...Qo(N,V))}let n=o.length>0,l=n?o.reduce((x,N)=>N.severity>x.severity?N:x,o[0]).severity:0,p=n?o.reduce((x,N)=>N.severity>x.severity?N:x,o[0]).color:"#30d158",c=tt(l,0,4),s=n?Math.min(1.5,1+(o.length-1)*.15):1,d=Xa(c,3,1.2).toFixed(2),u=ja(c).toFixed(2),f=n?Xt(p,c*s):Xt("#30d158",.08),m=140,h=m/2,v=m/2,w=n?{bgInner:l>=4?"#1a0000":l>=3?"#1a0e00":"#1a1500",bgOuter:l>=4?"#0a0000":l>=3?"#0a0500":"#0a0800",ring:k(Me(p,.15)),line:k(Me(p,.08)),sweep:k(Me(p,.4))}:{bgInner:"#001a00",bgOuter:"#000800",ring:"rgba(80,255,0,0.15)",line:"rgba(80,255,0,0.08)",sweep:"rgba(80,255,0,0.35)"},b=o.map((x,N)=>{let V=x.active?18+N*7:40+N*7,G=N*137.5*Math.PI/180,oe=h+Math.cos(G)*V,ne=v+Math.sin(G)*V,de=(N*137.5%360/360*Number(d)).toFixed(2);return x.active?`<div class="pw-radar-blip" style="left:${oe.toFixed(1)}px;top:${ne.toFixed(1)}px;--pw-blip-color:${k(x.color)};animation-delay:${de}s"></div>`:`<div style="position:absolute;left:${oe.toFixed(1)}px;top:${ne.toFixed(1)}px;width:4px;height:4px;border-radius:var(--pulse-radius-circle);background:${k(x.color)};opacity:0.2;transform:translate(-50%,-50%)"></div>`}).join(""),$=`
    <div style="display:flex;justify-content:center;padding:12px var(--pulse-space-card-wide);position:relative;z-index:2">
      <div class="pw-radar" style="--pw-radar-bg-inner:${w.bgInner};--pw-radar-bg-outer:${w.bgOuter};--pw-radar-color:${w.ring};--pw-radar-line:${w.line};--pw-radar-sweep:${w.sweep};--pw-radar-dur:${d}s" role="img" aria-label="${n?`${o.length} weather alerts`:"No active alerts"}">
        ${b}
      </div>
    </div>`,_=(()=>{if(!n)return"";let x=null;for(let N of o){if(N.isUntilFurtherNotice)return"further notice";if(N.endTime){let V=new Date(N.endTime);!isNaN(V.getTime())&&(!x||V>x)&&(x=V)}}return x?x.toLocaleString([],{hour:"2-digit",minute:"2-digit",month:"short",day:"numeric"}):"further notice"})(),S=re(n?"rainy":"sunny",!1),E=o.map(Zo).join(""),M=n?"":'<div class="pw-all-clear-v2"><strong>All Clear</strong>last 7 days clean</div>',C=n?`<div class="pw-alert-timestamp pw-alert-${l>=4?"red":"amber"}">${o.length} active \xB7 valid through ${g(_)}</div>`:"",D=l>=4?`border-top: 2px solid ${k(p)};`:"",B=l>=4?"pw-alerts-red":l>0?"pw-alerts-amber":"pw-alerts-green",A=`<div class="pw-tension-wash${n?" breathing":""}" style="background: ${k(f)}; --breathe-dur: ${u}s"></div>`,P=`
        ${$}
        ${M}
        ...
        ${M}
        ${I}
        ${C}`:void 0;return Q({sectionClass:"pw-alerts-v2",extraSectionClass:B,ariaLabel:"Active weather alerts",brandVariant:S,kicker:n?`active alerts (${o.length})`:"no active alerts",preContent:A,sectionStyle:D,body:P,proView:U,proInitial:r,pro:t?.pro!==!1})}var me=600,Jo=280,St=8,Qt=80,qe=200,rt=220,en=254,Sr=12,tn=30,an=.9,rn=3;function Ee(e,t){return t<=1?me/2:St+e/(t-1)*(me-2*St)}function Mr(e,t,a){if(!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(a))return(Qt+qe)/2;let r=a-t||1;return Qt+(a-e)/r*(qe-Qt)}function on(e){try{let t=new Date(e);return isNaN(t.getTime())?"":String(t.getHours()).padStart(2,"0")}catch{return""}}var nn=500;function sn(e,t=24){if(!Array.isArray(e))return null;let a=e.slice(0,nn),o=gt(a,new Date).slice(0,t);if(o.length<2)return null;let i=o[0],n="cloud_cover"in i,l="cloud_cover_low"in i&&"cloud_cover_mid"in i&&"cloud_cover_high"in i,p="wind_speed"in i&&("wind_bearing"in i||"wind_direction"in i),c=o.map(h=>{let v=Number(h.temperature),w=K(h.precipitation_probability,0),b=K(h.snowfall,0),$=K(h.rain,0),_=K(h.showers,0),S=String(h.condition||""),E=b>0||S==="snowy"||S==="snowy-rainy"?"snow":"rain",M=E==="snow"?b:$+_;return{temp:v,precip:w,precipMm:M,precipType:E,condition:S,cloudCover:n?K(h.cloud_cover,0):null,cloudLow:l?K(h.cloud_cover_low,0):null,cloudMid:l?K(h.cloud_cover_mid,0):null,cloudHigh:l?K(h.cloud_cover_high,0):null,windSpeed:p?K(h.wind_speed,0):null,windBearing:p?K(h.wind_bearing??h.wind_direction,0):null,timeLabel:on(String(h.datetime||"")),datetime:String(h.datetime||"")}}),s=za(c,h=>h.temp);if(s.length<2)return null;let d=s.map(h=>h.temp),u=Math.min(...d),f=Math.max(...d),m=Math.max(...s.map(h=>h.precipMm),0);return{points:s,n:s.length,min:u,max:f,minIdx:d.indexOf(u),maxIdx:d.indexOf(f),maxPrecipMm:m,hasCloud:n,hasLayeredCloud:l,hasWind:p}}function ln(e){let{points:t,n:a,hasLayeredCloud:r}=e;if(a<=0)return"";let o=a>1?(me-2*St)/(a-1)/2:me/2,i="";for(let n=0;n<a;n++){let l=Ee(n,a),p=n===0?0:l-o,s=(n===a-1?me:l+o)-p,d=p/me*100,u=s/me*100,f;if(r){let m=(Number(t[n].cloudHigh)||0)/100*.06,h=(Number(t[n].cloudMid)||0)/100*.08,v=(Number(t[n].cloudLow)||0)/100*.1;f=Math.min(m+h+v,.15)}else f=(Number(t[n].cloudCover)||0)/100*.12;f<=0||(i+=`<div class="pw-meteogram-cloud-slot" style="left:${d.toFixed(2)}%;width:${u.toFixed(2)}%;opacity:${f.toFixed(3)}"></div>`)}return i?`<div class="pw-meteogram-cloud-bg" aria-hidden="true">${i}</div>`:""}function cn(e){let{points:t,n:a,maxPrecipMm:r}=e,o=rt-qe,i=(me-2*St)/(a-1)*an,n=r>0,l=n?Math.max(r,2):100,p="";for(let c=0;c<a;c++){let{precipMm:s,precip:d,precipType:u}=t[c],f=n?s:d;if(f<=0)continue;let m=f/l*o,h=Ee(c,a)-i/2,v=i;h<0&&(v+=h,h=0),h+v>me&&(v=me-h);let w=rt-m,b=u==="snow"?"rgba(200,220,240,0.45)":"rgba(90,200,250,0.4)";p+=`<rect x="${h.toFixed(1)}" y="${w.toFixed(1)}" width="${v.toFixed(1)}" height="${m.toFixed(1)}" fill="${b}" rx="1"/>`}return p}function pn(e){let{points:t,n:a,maxPrecipMm:r}=e,o=rt-qe,i=r>0,n=i?Math.max(r,2):100,l="";for(let p=0;p<a;p++){let{precipMm:c,precip:s}=t[p],d=i?c:s;if(d<=0)continue;let u=Ee(p,a),f=d/n*o,m=rt-f-2,h=i?c>=10?String(Math.round(c)):c.toFixed(1):`${Math.round(s)}%`;l+=`<text x="${u.toFixed(1)}" y="${m.toFixed(1)}" text-anchor="middle" fill="rgba(90,200,250,0.9)" font-size="13" font-weight="600">${g(h)}</text>`}return l}function dn(e){let{points:t,n:a,min:r,max:o}=e,i=t.map(f=>parseFloat(f.temp.toFixed(1))),n=t.map((f,m)=>({x:Ee(m,a),y:Mr(i[m],r,o)})),l=n.map((f,m)=>`${m===0?"M":"L"}${f.x.toFixed(1)},${f.y.toFixed(1)}`).join(" "),p=`${l} L${n[n.length-1].x.toFixed(1)},${qe} L${n[0].x.toFixed(1)},${qe} Z`,c=Je("pw-meteogram-grad"),s=Te(o),d=Te(r),u=`<defs><linearGradient id="${c}" x1="0" y1="0" x2="0" y2="1">`;return u+=`<stop offset="0%" stop-color="${k(s)}" stop-opacity="0.25"/>`,u+=`<stop offset="100%" stop-color="${k(d)}" stop-opacity="0.03"/>`,u+="</linearGradient></defs>",u+=`<path d="${p}" fill="url(#${c})"/>`,u+=`<path d="${l}" fill="none" stroke="rgba(255,255,255,0.7)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>`,u}function un(e){let{points:t,n:a}=e,r="";for(let o=0;o<a;o+=rn){let i=Ee(o,a);r+=`<text x="${i.toFixed(1)}" y="${en}" text-anchor="middle" fill="var(--pw-ink-cream-dim)" font-size="15" font-weight="600">${g(t[o].timeLabel)}</text>`}return r}function mn(e,t,a,r){let o=a/1.852,i=((r+180)%360-90+360)%360,n=Math.round(o/5)*5,l=Math.floor(n/50);n-=l*50;let p=Math.floor(n/10);n-=p*10;let c=Math.floor(n/5),s=18,d="var(--pw-ink-cream-muted)",u="",f=-s;for(let m=0;m<l;m++)u+=`<polygon points="0,${f.toFixed(1)} 9,${(f+3).toFixed(1)} 0,${(f+6).toFixed(1)}" fill="${d}"/>`,f+=6;for(let m=0;m<p;m++)u+=`<line x1="0" y1="${f.toFixed(1)}" x2="9" y2="${(f+4.5).toFixed(1)}" stroke="${d}" stroke-width="1.4" stroke-linecap="round"/>`,f+=4.5;for(let m=0;m<c;m++)u+=`<line x1="0" y1="${f.toFixed(1)}" x2="4.5" y2="${(f+2.25).toFixed(1)}" stroke="${d}" stroke-width="1.4" stroke-linecap="round"/>`;return`<g transform="translate(${e.toFixed(1)},${t}) rotate(${i})"><line x1="0" y1="0" x2="0" y2="${-s}" stroke="${d}" stroke-width="1.4" stroke-linecap="round"/>${u}</g>`}function fn(e){let{points:t,n:a,min:r,max:o,minIdx:i,maxIdx:n}=e,l=0,p=1,c=2,s="";for(let d=0;d<a;d++){let u=d===i||d===n,f=u?l:d%3,m=Ee(d,a),h=Mr(t[d].temp,r,o);if(f===l){let v=t[d].temp,w=u?String(Math.round(v)):v.toFixed(1),b=d===i?"var(--pw-wind)":d===n?"var(--pw-vermilion)":"var(--pw-ink-cream)",$=u?17:15,_=h-Sr;s+=`<text x="${m.toFixed(1)}" y="${_.toFixed(1)}" text-anchor="middle" fill="${b}" font-size="${$}" font-weight="600">${w}\xB0</text>`}else if(f===p){let v=vt(t[d].condition),w=h-Sr;s+=`<text x="${m.toFixed(1)}" y="${w.toFixed(1)}" text-anchor="middle" font-size="20">${v}</text>`}else if(f===c){let v=Number(t[d].windSpeed),w=Number(t[d].windBearing);if(!Number.isFinite(v)||v<1||!Number.isFinite(w))continue;let b=h-tn;s+=mn(m,b,v,w)}}return s}function Tr({config:e,forecastData:t}){let a=t?.hourly||[];if(a.length<2)return null;let r=Number(e.hours),o=e.horizon==="long"?"long":"short",i=Number.isFinite(r)&&r>0?Math.max(4,Math.min(48,r)):o==="long"?24:12,n=sn(a,i);if(!n)return null;let p=(e.show_cloud==="auto"||e.show_cloud===void 0?n.hasCloud:!!e.show_cloud)&&n.hasCloud?ln(n):"",c=re(n.points[0]?.condition||"sunny",!1),s=[];s.push(cn(n)),s.push(pn(n)),s.push(dn(n)),s.push(fn(n));let d=Ee(0,n.n).toFixed(1);s.push(`<line x1="${d}" y1="0" x2="${d}" y2="${rt}" stroke="var(--pw-vermilion)" stroke-width="0.8" stroke-dasharray="2 3" opacity="0.7"/>`),s.push(un(n));let u=n.n,f=`${u}-hour meteogram showing temperature, condition, wind, and precipitation`,m=u<=12?"next twelve hours":`next ${u===24?"twenty-four":u} hours`,h=Je("pw-meteogram-title"),v=`
        <div class="pw-meteogram-chart" aria-labelledby="${h}">
          <svg viewBox="0 0 ${me} ${Jo}" style="width:100%; height:auto" role="img" aria-label="${g(f)}">
            <title id="${h}">${g(f)}</title>
            ${s.join(`
`)}
          </svg>
        </div>`;return Q({sectionClass:"pw-meteogram-v2",ariaLabel:f,brandVariant:c,kicker:m,preContent:p,body:v,proAction:"meteo-horizon",proInitial:i>=18,proAriaLabel:"Toggle 12-hour and 24-hour view",pro:e.pro!==!1})}var hn={overview:rr,forecast:or,wind:cr,air_quality:dr,astro:$r,alerts:kr,atmosphere:Ja,meteogram:Tr},Zt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null,this._lastWeatherState=null,this._atmosExpanded=!1,this._forecastData=null,this._forecastLastFetch=0,this._subscribedEntityId=null,this._atmosConfigEntryId=null,this._discovery=null,this._forecastFetching=!1,this._phaseTimer=null,this._countdownTimer=null,this._minuteTimer=null,this._warnedMissingEntity=null,this._warnedMissingAtmosCe=null,this._proState={}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._cleanupTimers(),this._config=Ea(t),this._warnedMissingEntity=null,this._warnedMissingAtmosCe=null,this._discovery=null,this._proState={},this._hass&&this._fullRender()}_getDiscovery(){return this._discovery||(this._discovery=Ra(this._hass.states,this._config)),this._discovery}_getCeFingerprint(t){let r=this._getDiscovery().atmosCe,o=[];for(let i of Object.keys(r)){let n=r[i],l=t.states[n];l&&o.push(`${i}=${l.state}`)}return o.join("|")}_warnIfAtmosCeMissing(t,a){let r=new Set(["atmosphere","air_quality","meteogram"]);if(!t.some(p=>r.has(p.type))||Object.keys(a.atmosCe).length>0)return;let i=this._config,n=i.atmos_source||Vt(a.weatherEntityId||"");if(this._warnedMissingAtmosCe===n)return;this._warnedMissingAtmosCe=n;let l=i.atmos_source?`Set atmos_source matches no sensor.${n}_* entities \u2014 check the slug.`:`Derived slug "${n}" matches no sensor.${n}_* entities. If you renamed your weather entity after installing Atmos CE, set atmos_source manually in the card config.`;console.warn(`${we} atmosphere / air_quality / meteogram sections configured but no Atmos CE sensors discovered. ${l}`)}_cleanupTimers(){this._phaseTimer&&(clearTimeout(this._phaseTimer),this._phaseTimer=null),this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=null),this._minuteTimer&&(clearInterval(this._minuteTimer),this._minuteTimer=null)}set hass(t){if(this._hass=t,!this._config)return;let a=this._config.weather_entity,r=a||Object.keys(t.states).find(p=>p.startsWith("weather."))||"",o=t.states[r];if(!o){a&&this._warnedMissingEntity!==a&&(console.warn(`${we} weather_entity "${a}" not found in hass.states. Check the entity_id in your card config (likely a typo, or the integration was removed).`),this._warnedMissingEntity=a);return}let i=this._getCeFingerprint(t),n=`${o.state}|${JSON.stringify(o.attributes)}|${i}`;n!==this._lastWeatherState&&(this._lastWeatherState=n,this._fullRender()),this._subscribeForecast(t,r)}async _subscribeForecast(t,a){let r=Date.now()-this._forecastLastFetch>=Ht;if(!(this._subscribedEntityId===a&&this._forecastData&&!r)&&!this._forecastFetching){this._forecastFetching=!0,this._subscribedEntityId=a;try{if(!t.callWS)return;let o=null;if(this._discovery?.atmosSource)try{if(!this._atmosConfigEntryId){let d=(await t.callWS({type:"config/entity_registry/list"}).catch(()=>[])).find(u=>u.platform==="atmos_ce");this._atmosConfigEntryId=d?.config_entry_id||null}if(this._atmosConfigEntryId){let u=(await t.callWS({type:"call_service",domain:"atmos_ce",service:"get_extended_forecast",service_data:{config_entry_id:this._atmosConfigEntryId,type:"hourly"},return_response:!0}).catch(()=>null))?.response;u?.forecast&&(o=u.forecast)}}catch(s){console.debug(`${we} extended forecast fetch failed, falling back to standard hourly`,s)}let i=null;a&&t.states[a]&&(i=await t.callWS({type:"call_service",domain:"weather",service:"get_forecasts",target:{entity_id:a},service_data:{type:"daily"},return_response:!0}).catch(()=>null));let n=null;!o&&a&&t.states[a]&&(n=(await t.callWS({type:"call_service",domain:"weather",service:"get_forecasts",target:{entity_id:a},service_data:{type:"hourly"},return_response:!0}).catch(()=>null))?.response?.[a]?.forecast||[]);let c=i?.response?.[a];this._forecastData={hourly:o||n||[],daily:c?.forecast||[]},this._forecastLastFetch=Date.now(),this._fullRender()}catch(o){console.warn(`${we} forecast fetch failed; retries throttled to ${Ht/1e3}s. Inspect the error below to diagnose. Common causes: weather entity offline, integration disabled, network failure.`,o),this._forecastLastFetch=Date.now()}finally{this._forecastFetching=!1}}}_unsubscribeForecasts(){this._subscribedEntityId=null,this._forecastLastFetch=0}disconnectedCallback(){this._unsubscribeForecasts(),this._cleanupTimers()}_fullRender(){if(!this._hass||!this._config||!this.shadowRoot)return;let t=this._getDiscovery(),a=this._hass.states[t.weatherEntityId];if(!a)return;let r=["<style>",Ca,"</style>",'<div class="pw-card">'],o=this._config.sections||[];this._warnIfAtmosCeMissing(o,t);for(let i=0;i<o.length;i++){let n=o[i],l=hn[n.type];if(l)try{let p=l({hass:this._hass,config:n,discovery:t,weatherEntity:a,forecastData:this._forecastData,sectionIndex:i,proPersisted:!!this._proState[i]});p&&r.push(p)}catch(p){console.warn(`${we} section "${n?.type}" renderer threw \u2014 section will be skipped, other sections continue. Please share the error below when reporting.`,p)}}r.push("</div>"),this.shadowRoot.innerHTML=r.join(""),this._postRender(t),this._schedulePhaseTransition(),this._minuteTimer||(this._minuteTimer=setInterval(()=>{this._lastWeatherState=null,this._hass&&this._fullRender()},6e4)),this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=null),this.shadowRoot.querySelector(".pw-astro-countdown")&&(this._countdownTimer=setInterval(()=>{let i=this.shadowRoot?.querySelector(".pw-astro-countdown");if(!i){clearInterval(this._countdownTimer),this._countdownTimer=null;return}let n=Number(i.dataset.target)-Date.now();if(n<=0){clearInterval(this._countdownTimer),this._countdownTimer=null,this._lastWeatherState=null,this._fullRender();return}let l=Math.floor(n/1e3),p=Math.floor(l/3600),c=Math.floor(l%3600/60),s=l%60;i.textContent=(p>0?p+"h "+c+"m":c+"m "+s+"s")+(i.dataset.suffix||"")},1e3))}_schedulePhaseTransition(){if(this._phaseTimer&&(clearTimeout(this._phaseTimer),this._phaseTimer=null),!this._hass||!this._config)return;let t=this._getDiscovery(),a=t.atmosCe,r=this._hass.states[t.sunEntityId||""];if(!r)return;let o=new Date,i=o.getTime(),n=[],l=r.attributes?.next_rising,p=r.attributes?.next_setting,{todaySunrise:c,todaySunset:s}=Ve(o,l,p),d=r.attributes?.next_rising?new Date(r.attributes.next_rising).getTime():NaN,u=r.attributes?.next_setting?new Date(r.attributes.next_setting).getTime():NaN;Number.isFinite(d)&&d>i&&n.push(d),Number.isFinite(u)&&u>i&&n.push(u);let f={golden_hour_morning_start:c,golden_hour_morning_end:c,blue_hour_morning_start:c,blue_hour_morning_end:c,golden_hour_evening_start:s,golden_hour_evening_end:s,blue_hour_evening_start:s,blue_hour_evening_end:s};for(let[v,w]of Object.entries(f)){if(!a[v])continue;let b=new Date(String(this._hass.states[a[v]]?.state||""));if(isNaN(b.getTime()))continue;let $=Z(b,w);if(!$)continue;let _=$.getTime();_>i&&n.push(_);let S=_+864e5;S>i&&n.push(S)}if(n.length===0)return;let h=Math.min(...n)-i+1e3;this._phaseTimer=setTimeout(()=>{this._phaseTimer=null,this._lastWeatherState=null,this._hass&&this._fullRender()},h)}_postRender(t){if(!this.shadowRoot||!this._hass)return;let a=this.shadowRoot.querySelectorAll(".pw-fx[data-condition]");for(let s of a){let d=s.getAttribute("data-condition")||"",u=s.getAttribute("data-night")==="true",f=null;try{let h=s.getAttribute("data-cloud");h&&h!=='""'&&h!==""&&(f=JSON.parse(h))}catch{}let m=Va(d,u,f);s.replaceChildren(m)}let r=this.shadowRoot.querySelectorAll(".pw-aqi[data-pm25]");for(let s of r){let d=Number(s.getAttribute("data-pm25"))||0,u=Number(s.getAttribute("data-pm10"))||0,f=s.querySelector(".pw-fx");if(f&&(d>0||u>0)){let m=document.createDocumentFragment();Ua(m,d,u),f.replaceChildren(m)}}let o=this.shadowRoot.querySelectorAll(".pw-fx[data-astro-stars]");for(let s of o){let d=s.getAttribute("data-astro-stars")==="true",u=s.getAttribute("data-astro-day")==="true",f=document.createDocumentFragment();d&&Gt(f),u&&(J(f,3,.5),xt(f)),s.replaceChildren(f)}let i=this.shadowRoot.querySelectorAll(".pw-atmos-fx[data-atmos-score]");for(let s of i){let d=Number(s.getAttribute("data-atmos-score"))||0,u=s.getAttribute("data-atmos-color")||"#30d158",f=Za(d,u);s.replaceChildren(f)}let n=[...this.shadowRoot.querySelectorAll(".pw-section")],l=this.shadowRoot.querySelectorAll("button.pw-brand-mark-corner");for(let s of l)s.addEventListener("click",d=>{let u=d.currentTarget,f=u.closest(".pw-section");if(!f||!this._config)return;let m=n.indexOf(f);if(m<0)return;let h=f.dataset.proAction||"view-swap";if(h==="wind-mode"||h==="meteo-horizon"||h==="aqi-scale"){let w=(this._config.sections||[]).map(($,_)=>_===m?{...$}:$),b=w[m];if(!b)return;if(h==="wind-mode"&&b.type==="wind")b.speed_mode=b.speed_mode==="gust"?"speed":"gust";else if(h==="meteo-horizon"&&b.type==="meteogram"){let $=Number(b.hours),_=Number.isFinite($)&&$>0?$>=18:b.horizon==="long";b.horizon=_?"short":"long","hours"in b&&delete b.hours}else h==="aqi-scale"&&b.type==="air_quality"&&(b.scale=b.scale==="us"?"eu":"us");this._config={...this._config,sections:w},this._fullRender();return}let v=f.dataset.pro==="true"?"false":"true";f.dataset.pro=v,u.setAttribute("aria-pressed",v),this._proState[m]=v==="true"});let p=this.shadowRoot.querySelectorAll(".pw-hourly-strip");for(let s of p){let d=!1,u=0,f=0;s.addEventListener("mousedown",m=>{d=!0,u=m.pageX-s.offsetLeft,f=s.scrollLeft,s.style.cursor="grabbing"}),s.addEventListener("mouseleave",()=>{d=!1,s.style.cursor=""}),s.addEventListener("mouseup",()=>{d=!1,s.style.cursor=""}),s.addEventListener("mousemove",m=>{if(!d)return;m.preventDefault();let h=m.pageX-s.offsetLeft;s.scrollLeft=f-(h-u)}),s.addEventListener("touchstart",m=>{m.stopPropagation()},{passive:!0}),s.addEventListener("touchmove",m=>{m.stopPropagation()},{passive:!0}),s.addEventListener("wheel",m=>{let h=m;Math.abs(h.deltaX)<Math.abs(h.deltaY)&&(m.preventDefault(),s.scrollLeft+=h.deltaY)},{passive:!1})}let c=this.shadowRoot.querySelector(".pw-atmos-column-wrap[data-has-detail]");if(c){let s=this.shadowRoot.querySelector(".pw-atmos-detail");s&&(this._atmosExpanded&&(s.style.maxHeight=`${s.scrollHeight}px`,c.setAttribute("aria-expanded","true")),c.addEventListener("click",()=>{this._atmosExpanded=!this._atmosExpanded,this._atmosExpanded?(s.style.maxHeight=`${s.scrollHeight}px`,c.setAttribute("aria-expanded","true")):(s.style.maxHeight="0",c.setAttribute("aria-expanded","false"))}))}}getCardSize(){let t=this._config?.sections?.length||1;return Math.max(3,t*3)}getGridOptions(){return{columns:12,min_columns:6,rows:this.getCardSize(),min_rows:3}}static async getConfigElement(){return await import("./pulse-weather-card-editor.js"),document.createElement(ma)}static getStubConfig(t){let a=Object.keys(t.states).find(r=>r.startsWith("weather."));return{type:`custom:${He}`,weather_entity:a||"weather.home",sections:[{type:"overview"}]}}};customElements.get(He)||(customElements.define(He,Zt),console.info(`%c ${He.toUpperCase()} %c v${ua} `,"background:#5ac8fa;color:#000;font-weight:bold","background:#333;color:#fff"));window.customCards=window.customCards||[];window.customCards.push({type:He,name:"Pulse Weather Card",description:"Weather visualization with atmospheric effects, forecasts, wind rose, and more",preview:!0});export{Zt as PulseWeatherCard};
