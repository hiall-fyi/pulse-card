...
`;var wr=[{type:"overview"}],Ta={overview:{},forecast:{mode:"both"},wind:{speed_mode:"speed"},air_quality:{scale:"eu"},astro:{},alerts:{},atmosphere:{}};function st(e){if(!e)return{type:"overview"};if(typeof e=="string")return st({type:e});if(typeof e!="object")return{type:"overview"};let t=er.includes(e.type)?e.type:"overview";return{...Ta[t]||{},...e,type:t}}function gr(e){if(!e||typeof e!="object")return{type:"custom:pulse-weather-card",sections:wr.map(st)};let t=e,r=Array.isArray(t.sections)&&t.sections.length>0?t.sections.map(st):wr.map(st);return{type:t.type||"custom:pulse-weather-card",weather_entity:t.weather_entity||void 0,atmos_source:t.atmos_source||void 0,sections:r}}function g(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function S(e){return e==null||e===""?"":String(e).replace(/[;{}]/g,"").replace(/url\s*\(/gi,"").replace(/expression\s*\(/gi,"").replace(/-moz-binding\s*:/gi,"")}function br(e){return{columns:12,min_columns:e,rows:"auto"}}function qe(){return typeof window>"u"?!1:window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches??!1}function te(e){let t=e?.config?.time_zone;if(t&&e?.locale?.time_zone!=="local")return t}function ie(e,t,r){return!e||isNaN(e.getTime())?"":new Intl.DateTimeFormat("en-GB",{...r,timeZone:t}).format(e)}function H(e,t){return ie(e,t,{hour:"2-digit",minute:"2-digit",hourCycle:"h23"})}var Rt=0;function vr(e="pulse-id"){return Rt=Rt+1>>>0,`${e}-${Rt.toString(36)}`}function xr(e,t,{signal:r,role:a="button"}={}){e.setAttribute("role",a),e.setAttribute("tabindex","0"),e.addEventListener("keydown",o=>{let n=o;n.key!=="Enter"&&n.key!==" "||(n.preventDefault(),t(n))},r?{signal:r}:void 0)}function Lt(e){let t=e.replace(/^weather\./,"");return t.endsWith(Nt)&&(t=t.slice(0,-Nt.length)),t}function yr(e,t){let r=t.weather_entity||Object.keys(e).find(d=>d.startsWith("weather."))||"",a=t.atmos_source||Lt(r),o={};for(let d of cr){let p=`sensor.${a}_${d}`;p in e&&(o[d]=p)}let n=Object.keys(o).length>=dr,i=n?o:{},l=[];if(t.alert_entities&&t.alert_entities.length>0)for(let d of t.alert_entities)d in e&&l.push(d);else if(n){for(let s of pr){let u=`sensor.${a}_${s}`,f=`sensor.${a}_warnings_${s}`;u in e?l.push(u):f in e&&l.push(f)}let d=`binary_sensor.${a}_alert_active`,p=`binary_sensor.${a}_warnings_alert_active`;d in e?l.push(d):p in e&&l.push(p)}let c="sun.sun"in e?"sun.sun":null;return{weatherEntityId:r,atmosCe:i,sunEntityId:c,atmosSource:n?a:null,alertEntityIds:l}}function Aa(e){if(typeof e!="string")return null;let t=e.trim().replace(/^#/,"");return t.length===3&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),t.length!==6||/[^0-9a-f]/i.test(t)?null:{r:parseInt(t.slice(0,2),16),g:parseInt(t.slice(2,4),16),b:parseInt(t.slice(4,6),16)}}function ye(e,t){if(typeof e!="string")return String(e);let r=Math.max(0,Math.min(1,Number(t))),a=Aa(e);if(a)return`rgba(${a.r},${a.g},${a.b},${r})`;let o=/^rgb\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*\)$/i.exec(e.trim());return o?`rgba(${o[1]},${o[2]},${o[3]},${r})`:e}function $r(e,t){return e.filter(r=>Number.isFinite(t(r)))}function V(e,t=0){let r=Number(e);return Number.isFinite(r)?r:t}function lt(e,t,r,a,o,n=0){if(t?.[a]){let i=Number(e?.states?.[t[a]]?.state);if(Number.isFinite(i))return i}return Number(r?.[o]??n)||n}function kr(e,t,r,a){return t?.[r]&&e?.states?.[t[r]]?.attributes?.unit_of_measurement||a}function Ge(e,t,r=0){let a=t?e?.states?.[t]:null;if(!a)return{value:r,unit:void 0,entity:null};let o=Number(a.state);return{value:Number.isFinite(o)?o:r,unit:a.attributes?.unit_of_measurement,entity:a}}function ct(e,t,r){let a=t?.state||"sunny",o=r?.sunEntityId?e?.states?.[r.sunEntityId]?.state:null;return{condition:a,isNight:a==="clear-night"||o==="below_horizon"}}function Xe(e="pw-id"){return vr(e)}function Sr(e){return`${e}, linear-gradient(180deg, var(--pw-sky-top) 0%, var(--pw-sky-mid) 45%, var(--pw-sky-bot) 100%)`}function pt(e,t,r=36e5){let a=(t?t.getTime():Date.now())-r;return e.filter(o=>{let n=o.datetime;if(!n)return!1;let i=new Date(n).getTime();return Number.isFinite(i)&&i>=a})}function Dt(e){let t=Number(e);for(let r of ot)if(t<=r.max)return r.color;return ot[ot.length-1].color}function Mr(e){let t=Number(e);for(let r of nt)if(t<=r.max)return r.tier;return nt[nt.length-1].tier}function Tr(e){let t=Number(e);for(let r of it)if(t<=r.max)return r;return it[it.length-1]}function dt(e){let t=(Number(e)%360+360)%360,r=Math.round(t/22.5)%16;return ir[r]}function ze(e,t,r){if(!t||!r)return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let a=new Date(t),o=new Date(r);if(isNaN(a.getTime())||isNaN(o.getTime()))return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let n=a.getTime()>e.getTime()?new Date(a.getTime()-864e5):a,i=o.getTime()>e.getTime()?o:new Date(o.getTime()-864e5);i.getTime()>n.getTime()+864e5&&(i=new Date(i.getTime()-864e5)),n.getTime()>i.getTime()&&(n=new Date(n.getTime()-864e5));let l=a.getTime()>e.getTime()?a:new Date(a.getTime()+864e5);return{todaySunrise:n,todaySunset:i,tomorrowSunrise:l}}function Y(e,t){if(!e||isNaN(e.getTime()))return null;if(!t)return e;let r=t.getTime(),a=[e,new Date(e.getTime()-864e5),new Date(e.getTime()+864e5)],o=a[0],n=Math.abs(o.getTime()-r);for(let i=1;i<a.length;i+=1){let l=Math.abs(a[i].getTime()-r);l<n&&(o=a[i],n=l)}return o}function ne(e,t,r){let a=t?Object.entries(t).map(([o,n])=>` ${o}="${n}"`).join(""):"";return r!=null?`<${e}${a}>${r}</${e}>`:`<${e}${a}/>`}function ut(e){return ur[e]||"\u{1F324}\uFE0F"}var _r={"clear-night":"Clear Night",cloudy:"Cloudy",exceptional:"Exceptional",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning Rainy",partlycloudy:"Partly Cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy Rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy Variant"};function Ar(e){return Object.hasOwn(_r,e)?_r[e]:e.replace(/-/g," ").replace(/\b\w/g,t=>t.toUpperCase())}function re(e,t,r){let a=document.createElement(e);if(a.className=t,r)for(let[o,n]of Object.entries(r))a.style.setProperty(o,n);return a}function M(e,t){return Math.random()*(t-e)+e}function Ye(e,t=60,r=1,a=2){let o=Math.min(t,rr);for(let n=0;n<o;n++){let i=re("div","pw-rain-drop"),l=M(15,30),c=M(.4,.8)/r;Object.assign(i.style,{left:`${M(0,100)}%`,top:`${M(-10,20)}%`,width:`${a}px`,height:`${l}px`,borderRadius:`0 0 ${a}px ${a}px`,background:"linear-gradient(to bottom, transparent, rgba(120,180,255,0.6))",animation:`pw-rainFall ${c}s linear ${M(0,2)}s infinite`,animationFillMode:"backwards",position:"absolute"}),e.appendChild(i)}}function It(e,t=40){let r=Math.min(t,ar);for(let a=0;a<r;a++){let o=re("div","pw-snowflake"),n=M(2,5);Object.assign(o.style,{left:`${M(0,100)}%`,top:`${M(-5,10)}%`,width:`${n}px`,height:`${n}px`,borderRadius:"50%",background:"rgba(255,255,255,0.7)",animation:`pw-snowFall ${M(3,6)}s linear ${M(0,4)}s infinite`,animationFillMode:"backwards",position:"absolute"}),e.appendChild(o)}}function Fa(e){for(let t=0;t<4;t++){let r=re("div","pw-fog-layer");Object.assign(r.style,{position:"absolute",width:"200%",height:"40px",top:`${30+t*20}%`,left:"0",background:"linear-gradient(to right, transparent 0%, rgba(200,200,200,0.06) 20%, rgba(200,200,200,0.1) 50%, rgba(200,200,200,0.06) 80%, transparent 100%)",animation:`pw-fogDrift ${M(15,25)}s linear ${t*2}s infinite`,animationFillMode:"backwards"}),e.appendChild(r)}}function mt(e){for(let t=0;t<8;t++){let r=re("div","pw-sun-ray");Object.assign(r.style,{position:"absolute",top:"-20px",left:`${10+t*12}%`,width:"2px",height:"120px",background:"linear-gradient(to bottom, rgba(255,220,100,0.08), transparent)",transformOrigin:"top center",transform:`rotate(${-15+t*4}deg)`,animation:`pw-rayPulse ${M(3,5)}s ease-in-out ${M(0,2)}s infinite`,animationFillMode:"backwards"}),e.appendChild(r)}}function K(e,t=4,r=1){let a=Math.min(t,Et);for(let o=0;o<a;o++){let n=re("div","pw-cloud"),i=M(80,160),l=M(30,60),c=M(20,40)/r;Object.assign(n.style,{position:"absolute",width:`${i}px`,height:`${l}px`,top:`${M(5,50)}%`,left:"0",borderRadius:"50%",background:"radial-gradient(ellipse, rgba(255,255,255,0.05) 0%, transparent 70%)",animation:`pw-cloudDrift ${c}s linear ${M(0,15)}s infinite`,animationFillMode:"backwards"}),e.appendChild(n)}}function Ot(e){for(let t=0;t<or;t++){let r=re("div","pw-star"),a=M(1,3);Object.assign(r.style,{position:"absolute",left:`${M(0,100)}%`,top:`${M(0,70)}%`,width:`${a}px`,height:`${a}px`,borderRadius:"50%",background:"#fff",animation:`pw-twinkle ${M(2,5)}s ease-in-out ${M(0,3)}s infinite`,animationFillMode:"backwards"}),e.appendChild(r)}}function Ea(e,t){let r=[],a=e,o=0,n=Math.floor(M(4,8)),i=t/n;r.push(`${a},${o}`);for(let l=0;l<n;l++)a+=M(-15,15),o+=i,r.push(`${a},${o}`);return r.join(" ")}function Fr(e,t=2,r){let a=r||Array.from({length:t},(n,i)=>i*3),o=re("div","pw-lightning-flash");Object.assign(o.style,{position:"absolute",inset:"0",background:"rgba(255,255,255,0.15)",animation:`pw-flash 6s ease-in-out ${a[0]||0}s infinite`,animationFillMode:"backwards",pointerEvents:"none"}),e.appendChild(o);for(let n=0;n<t;n++){let i="http://www.w3.org/2000/svg",l=document.createElementNS(i,"svg");l.setAttribute("class","pw-lightning-bolt"),l.setAttribute("width","60"),l.setAttribute("height","200"),l.setAttribute("viewBox","0 0 60 200"),l.style.position="absolute",l.style.top="0",l.style.left=`${M(15,75)}%`,l.style.pointerEvents="none",l.style.zIndex="2",l.style.animation=`pw-boltStrike 6s ease-in-out ${a[n]||0}s infinite`,l.style.animationFillMode="backwards";let c=Ea(30,180),d=document.createElementNS(i,"polyline");d.setAttribute("points",c),d.setAttribute("fill","none"),d.setAttribute("stroke","rgba(200,220,255,0.4)"),d.setAttribute("stroke-width","6"),d.setAttribute("stroke-linecap","round"),d.setAttribute("stroke-linejoin","round"),l.appendChild(d);let p=document.createElementNS(i,"polyline");p.setAttribute("points",c),p.setAttribute("fill","none"),p.setAttribute("stroke","#fff"),p.setAttribute("stroke-width","2"),p.setAttribute("stroke-linecap","round"),p.setAttribute("stroke-linejoin","round"),l.appendChild(p),e.appendChild(l)}}function Ca(e){let t=re("div","pw-heat-shimmer");Object.assign(t.style,{position:"absolute",inset:"0",pointerEvents:"none",background:"linear-gradient(0deg, transparent 0%, rgba(255,200,100,0.03) 30%, transparent 50%, rgba(255,180,80,0.02) 70%, transparent 100%)",backgroundSize:"100% 200%",animation:"pw-shimmer 3s ease-in-out infinite"}),e.appendChild(t);let r=re("div","pw-heat-ripple");Object.assign(r.style,{position:"absolute",bottom:"0",left:"0",right:"0",height:"60px",pointerEvents:"none",background:"repeating-linear-gradient(0deg, transparent, rgba(255,200,100,0.02) 2px, transparent 4px)",animation:"pw-rippleWave 2s ease-in-out infinite"}),e.appendChild(r)}function Er(e,t,r){let a=Math.min(1,(t/75+r/150)/2);if(a<.05)return;let o=re("div","pw-smog-overlay");o.style.background=`rgba(120,110,80,${.05+a*.15})`,e.appendChild(o);let n=re("div","pw-haze-vignette");if(n.style.background=`radial-gradient(ellipse at center, transparent 40%, rgba(80,70,50,${a*.3}) 100%)`,e.appendChild(n),qe())return;let i=Math.floor(a*20);for(let c=0;c<i;c++){let d=re("div","pw-dust-particle"),p=M(1,3+a*3);Object.assign(d.style,{left:`${M(0,100)}%`,top:`${M(10,90)}%`,width:`${p}px`,height:`${p}px`,animationDelay:`${M(0,8)}s`,animationFillMode:"backwards"}),e.appendChild(d)}let l=Math.floor(a*5);for(let c=0;c<l;c++){let d=re("div","pw-haze-blob"),p=M(60,120);Object.assign(d.style,{left:`${M(-10,80)}%`,top:`${M(10,70)}%`,width:`${p}px`,height:`${p*.6}px`,animationDelay:`${M(0,12)}s`,animationFillMode:"backwards"}),e.appendChild(d)}}function Cr(e,t,r){let a=document.createDocumentFragment();if(qe())return a;try{t&&Ot(a);let o=r?Math.round(r.total/100*Et):0;switch(e){case"sunny":t||mt(a),r&&o>0&&K(a,o);break;case"clear-night":r&&o>0&&K(a,o);break;case"partlycloudy":t||mt(a),K(a,r?o:3);break;case"cloudy":K(a,r?Math.max(o,4):6);break;case"rainy":Ye(a,40,1,2),K(a,r?Math.max(o,3):4);break;case"pouring":Ye(a,80,1.5,3),K(a,r?Math.max(o,5):6);break;case"snowy":It(a,40),K(a,r?Math.max(o,3):4);break;case"snowy-rainy":It(a,20),Ye(a,20,.8,1),K(a,r?Math.max(o,3):4);break;case"hail":Ye(a,30,1.2,3),It(a,15),K(a,r?Math.max(o,4):5);break;case"lightning":Fr(a,2,[0,3]),K(a,r?Math.max(o,5):6);break;case"lightning-rainy":Fr(a,3,[0,2,4]),Ye(a,60,1.3,2),K(a,r?Math.max(o,5):6);break;case"fog":Fa(a);break;case"windy":case"windy-variant":K(a,r?o:3,1.5);break;case"exceptional":Ca(a);break;default:r&&o>0&&K(a,o);break}}catch(o){console.warn(`${ce} buildConditionFx threw \u2014 atmospheric FX will be partial or absent for this condition. Please share the error below when reporting.`,o)}return a}function Ke(e,t,r){return r===t?0:Math.max(0,Math.min(1,(e-t)/(r-t)))}function zt(e,t,r="ellipse"){let a=Math.max(0,Math.min(1,t)),o=Math.round(3+a*50),n=Math.round(2+a*25),i=Math.round(50+a*30),l=c=>c.toString(16).padStart(2,"0");return`radial-gradient(${r} at 50% 30%, ${e}${l(o)} 0%, ${e}${l(n)} ${i}%, transparent 90%)`}function Nr(e,t=6,r=1.2){let a=Math.max(0,Math.min(1,e));return t-a*(t-r)}function Rr(e,t="0,0,0"){let r=Math.max(0,Math.min(1,e));if(r<.1)return"";let a=Math.round(60-r*30),o=(r*.5).toFixed(2);return`radial-gradient(ellipse at center, transparent ${a}%, rgba(${t},${o}) 100%)`}function Lr(e,t=8,r=2){let a=Math.max(0,Math.min(1,e));return t-a*(t-r)}function Dr(e,t){let r=t?Number(ie(e,t,{hour:"2-digit",hourCycle:"h23"})):e.getHours();return r>=6&&r<12?"this morning":r>=12&&r<17?"this afternoon":r>=17&&r<21?"this evening":"tonight"}function Na(e,t){return e==="sunny"||e==="clear-night"?"Clear skies":e==="rainy"||e==="pouring"?"Rain":e==="snowy"||e==="snowy-rainy"?"Snow":e==="lightning"||e==="lightning-rainy"?"Storms":e==="fog"?"Fog":t>=88?"Overcast":t>=50?"Mostly cloudy":t>=12?"Some sun":"Sunny"}function Ra(e){let t=e.slots.slice(0,6);if(t.length===0)return null;let r=Number(t[t.length-1].cloud_coverage),a=Number.isFinite(r)?r-e.cloudCoverNow:0,o=t.reduce((d,p)=>Math.max(d,Number(p.precipitation_probability)||0),0),n=t.reduce((d,p)=>Math.max(d,Number(p.snowfall)||0),0),l=t.reduce((d,p)=>Math.max(d,Number(p.wind_speed)||0),e.windSpeed)-e.windSpeed;return["moderate","high"].includes(e.stabilityState)?"with thunderstorms developing":o>=60?n>0?"with snow likely":"with rain likely":o>=40?n>0?"with snow possible":"with a brief shower or two":a>=30?"then increasing clouds":a<=-30?"then clearing":l>=8?"with wind firming":null}function Ir(e){let t=Na(e.conditionNow,Number(e.cloudCoverNow)||0),r=Ra(e),a=r?Dr(e.now,e.timeZone):null,o;return r?r.startsWith("then ")?o=`${t}, ${r} ${a}.`:o=`${t}, then ${r} ${a}.`:o=`${t} ${Dr(e.now,e.timeZone)}.`,{initial:t,transition:r,anchor:a,sentence:o}}var La="#a83d2a",Or="#7a2d20",Ae="#fdf6e3",Da='<svg viewBox="0 0 40 40" width="38" height="38" aria-hidden="true">',Ia="</svg>";function zr(e){let t=["day","cloudy","rain","night"].includes(e)?e:"day",a=`<circle class="mc" cx="20" cy="20" r="18" fill="${t==="night"?Or:La}" opacity="0.92"/>`,o=`<line class="mh" x1="6" y1="22" x2="34" y2="22" stroke="${Ae}" stroke-width="0.8" opacity="0.85"/>`,n="";return t==="day"?n=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.95"/>`:t==="cloudy"?n=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.45"/>`:t==="rain"?n=[`<line class="mg" x1="14" y1="11" x2="13" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="20" y1="11" x2="19" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="26" y1="11" x2="25" y2="16" stroke="${Ae}" stroke-width="0.7" opacity="0.55"/>`].join(""):t==="night"&&(n=`<circle class="md" cx="20" cy="14" r="2.4" fill="${Ae}" opacity="0.95"/><circle class="md-cut" cx="21.4" cy="13.4" r="1.8" fill="${Or}"/>`),`${Da}${a}${o}${n}${Ia}`}function J(e,t){return t?"night":["rainy","pouring","snowy","snowy-rainy","hail","lightning-rainy"].includes(e)?"rain":["cloudy","fog"].includes(e)?"cloudy":"day"}var y={kicker(e){return`<div class="pw-t-kicker">${g(e)}</div>`},heroTier(e,{flavor:t="aqi",color:r=""}={}){let a=t==="atmos"?"pw-t-hero-tier-atmos":"pw-t-hero-tier-aqi",o=r?` style="color:${S(r)}"`:"";return`<div class="pw-t-hero-tier ${a}"${o}>${g(e)}</div>`},display(e,{color:t="",suffix:r=""}={}){let a=t?` style="color:${S(t)}"`:"",o=r?`<span class="pw-t-display-suf">${g(r)}</span>`:"";return`<div class="pw-t-display"${a}>${g(String(e))}${o}</div>`},narrative(e){return`<div class="pw-t-narrative">${g(e)}</div>`},gloss(e){return`<div class="pw-t-gloss">${g(e)}</div>`},meta(e){return`<div class="pw-t-meta">${g(e)}</div>`},chartCaption(e){return`<div class="pw-t-chart-caption">${g(e)}</div>`},stat(e,t,{data:r=!1,valueColor:a=""}={}){let o=a?` style="color:${S(a)}"`:"",n=r?"pw-t-stat-l pw-t-data":"pw-t-stat-l";return`<div class="pw-t-stat"><div class="pw-t-stat-v"${o}>${g(String(e))}</div><div class="${n}">${g(t)}</div></div>`},statLabel(e){return`<span class="pw-t-stat-l">${g(e)}</span>`},dataToken(e){return`<span class="pw-t-data">${e}</span>`},heroBlock({tier:e="",tierFlavor:t="aqi",tierColor:r="",value:a="",valueSuffix:o="",valueColor:n="",narrative:i=""}={}){let l=e?this.heroTier(e,{flavor:t,color:r}):"",c=a!==""?this.display(a,{color:n,suffix:o}):"",d=i?this.narrative(i):"";return`<div class="pw-hero-block">${l}${c}${d}</div>`},statsRow(e,{columns:t=4,divided:r=!1}={}){let a=e.filter(Boolean);return a.length?`<div class="pulse-stats-row" data-cols="${t}"${r?' data-divided="true"':""}>${a.join("")}</div>`:""}};function q({sectionClass:e,ariaLabel:t,brandVariant:r,kicker:a="",narrative:o="",preContent:n="",extraSectionClass:i="",sectionStyle:l="",body:c,proView:d="",proInitial:p=!1,proAction:s="view-swap",proAriaLabel:u="Toggle pro view",pro:f=!0}){f===!1&&(d="",s="view-swap",p=!1);let m=l?` style="${l}"`:"",w=`pw-section pw-cartouche ${e}${i?` ${i}`:""}`,h=zr(r),b=[a?y.kicker(a):"",o?y.narrative(o):""].filter(Boolean).join(""),$=b?`<div class="pw-t-marg">${b}</div>`:"",x=!!d,_=x||s!=="view-swap",T=x?`<div class="pw-view pw-view-default">${c}</div><div class="pw-view pw-view-pro">${d}</div>`:c,k=p?"true":"false",A=_?`<button class="pw-brand-mark-corner" aria-label="${g(u)}" aria-pressed="${k}" type="button">${h}</button>`:`<div class="pw-brand-mark-corner" aria-hidden="true">${h}</div>`;return`
    <div class="${w}" data-pro="${k}" data-pro-action="${s}"${m} role="region" aria-label="${g(t)}">
    ...
    </div>`}function Oa(e,t,r){let a=e.map(p=>{let s=Number(p.cape);return Number.isFinite(s)?s:0}),o=Math.max(...a,300),n=Math.max(...a),i=a.indexOf(n),c=a.map((p,s)=>({x:s/Math.max(e.length-1,1)*t,y:r-p/o*r})).map((p,s)=>`${s===0?"M":"L"}${p.x.toFixed(1)},${p.y.toFixed(1)}`).join(" "),d=`${c} L${t},${r} L0,${r} Z`;return{svgPath:c,areaPath:d,peakValue:n,peakIndex:i,maxCape:o}}function za(e,t,r,a,o,n,i,l){let c=[];return i>0&&c.push({name:"Snow",value:i,unit:l}),r>0&&c.push({name:"Rain",value:r,unit:a}),o>0&&c.push({name:"Showers",value:o,unit:n}),c.length>0?`${c.map(p=>`${g(p.name)} ${g(p.value.toFixed(1))} ${g(p.unit)}`).join(" \xB7 ")} now`:e>0?`Precipitation \u2014 next 12h \xB7 ${g(e.toFixed(1))} ${g(t)} now`:"Precipitation \u2014 next 12h"}function Hr({hass:e,config:t,discovery:r,weatherEntity:a,forecastData:o}){let n=a.attributes,i=r.atmosCe,l=r.sunEntityId||"",c=te(e),{condition:d,isNight:p}=ct(e,a,r),s=(P,W)=>lt(e,i,n,P,W),u=(P,W)=>kr(e,i,P,W),f=s("temperature","temperature"),m=s("humidity","humidity"),w=s("wind_speed","wind_speed"),h=s("wind_direction","wind_bearing"),b=s("wind_gusts","wind_gust_speed")||s("wind_gusts","wind_gusts"),$=s("dew_point","dew_point"),x=s("visibility","visibility"),_=s("pressure","pressure"),T=u("temperature","\xB0C"),k=u("visibility","km"),A=u("pressure","hPa"),C=u("dew_point","\xB0C"),L=o?.daily,N=o?.hourly,O=n.forecast,D=f,v=f;if(L&&L.length>0){let P=L[0],W=Number(P.templow),I=Number(P.temperature);Number.isFinite(W)&&Number.isFinite(I)&&(D=Math.min(W,I),v=Math.max(W,I))}else if(N&&N.length>0){let P=Date.now(),W=new Date;W.setHours(23,59,59,999);let I=W.getTime(),X=1/0,j=-1/0;for(let fe of N.slice(0,24)){let U=Date.parse(String(fe.datetime??""));if(Number.isFinite(U)&&(U<P||U>I))continue;let oe=Number(fe.temperature);Number.isFinite(oe)&&(oe<X&&(X=oe),oe>j&&(j=oe))}Number.isFinite(X)&&Number.isFinite(j)&&X!==j&&(D=Math.min(X,f),v=Math.max(j,f))}else if(O&&O.length>0){let P=O[0],W=Number(P.templow),I=Number(P.temperature);Number.isFinite(W)&&Number.isFinite(I)&&(D=Math.min(W,I),v=Math.max(W,I))}let E=r.atmosCe.uv_index,F=E?Number(e.states[E]?.state)||0:Number(n.uv_index??0),{value:R,unit:ee}=Ge(e,i.precipitation),ue=ee||"mm",{value:me,unit:we}=Ge(e,i.rain),{value:ge,unit:$e}=Ge(e,i.showers),{value:ke,unit:B}=Ge(e,i.snowfall),z=we||"mm",G=$e||"mm",ae=B||"cm",le=i.dew_point_comfort?e.states[i.dew_point_comfort]:null,be=i.visibility_category?e.states[i.visibility_category]:null,Ee=i.feels_like_context?e.states[i.feels_like_context]:null,Ce=i.pressure_trend?e.states[i.pressure_trend]:null,Ne=new Date,Re=l?e.states[l]:null,We=Re?.attributes?.next_rising,Be=Re?.attributes?.next_setting,{todaySunrise:Ue,todaySunset:Se,tomorrowSunrise:je}=ze(Ne,We,Be),ve=null;r.atmosCe.cloud_cover&&(ve={total:Number(e.states[r.atmosCe.cloud_cover]?.state)||0,low:Number(e.states[r.atmosCe.cloud_cover_low]?.state)||0,mid:Number(e.states[r.atmosCe.cloud_cover_mid]?.state)||0,high:Number(e.states[r.atmosCe.cloud_cover_high]?.state)||0});let bt=(i.stability_assessment?e.states[i.stability_assessment]:null)?.state||"",vt=dt(h),xt=`data-condition="${g(d)}" data-night="${p}" data-cloud='${g(JSON.stringify(ve||""))}'`,yt=Ke(f,20,42),_t=Ke(f,15,-10),$t=Math.max(yt,_t),Je=Rr($t),xe=Je?`<div class="pw-tension-vignette" style="background: ${S(Je)}"></div>`:"",Le=Ee?.state||"",et=Ee?.attributes?.difference,tt="";if(et!=null){let P=Math.round(Number(et));Le==="wind_chill"?tt=`Wind chill ${P}\xB0`:Le==="heat_index"&&(tt=`Heat index +${P}\xB0`)}let wa=le?.state||"",jt=b>w+5,Vt="",qt=l?e.states[l]:null;if(qt&&Ue&&Se&&je){let P=Ne.getTime(),W=qt.state==="above_horizon",I,X,j,fe,U;if(W){let he=Ue.getTime(),Z=Se.getTime(),De=Math.max(Z-he,1);I=Math.max(0,Math.min(100,(P-he)/De*100)),X=H(Ue,c),j=H(Se,c),fe="background: linear-gradient(to right, #ff9f0a, #ffd60a)",U="#ff9f0a"}else{let he=Se.getTime(),Z=je.getTime(),De=Math.max(Z-he,1);I=Math.max(0,Math.min(100,(P-he)/De*100)),X=H(Se,c),j=H(je,c),fe="background: linear-gradient(to right, #1a3050, #5ac8fa)",U="#5ac8fa"}let oe=`left:${Number(I)}%; background:${S(U)}; box-shadow: 0 0 6px ${S(U)}66`,Me=` style="color:${S(U)}"`,Te=W?"":"\u{1F319}";Vt=`
      <div class="pw-day-arc">
        <span class="pw-day-arc-label"${Me}>${g(X)}</span>
        <div class="pw-day-arc-bar">
          <div class="pw-day-arc-fill" style="width:${Number(I)}%; ${fe}"></div>
          <div class="pw-day-arc-marker" style="${oe}">${Te}</div>
        </div>
        <span class="pw-day-arc-label"${Me}>${g(j)}</span>
      </div>`}let kt="",Gt="",Xt=o?.hourly||[];if(Xt.length>0){let I=pt(Xt,new Date).slice(0,12),X=za(R,ue,me,z,ge,G,ke,ae);if(R>0?kt=X:kt=Ir({now:new Date,cloudCoverNow:ve?ve.total:0,conditionNow:d,slots:I,windSpeed:w,uvIndex:F,stabilityState:bt,timeZone:c}).sentence,I.some(j=>Number(j.cape)>300)){let U=Oa(I,320,24),oe=I[U.peakIndex]?.datetime?new Date(I[U.peakIndex].datetime):null,Me=U.peakValue>=1e3?`${(U.peakValue/1e3).toFixed(1)}k`:String(Math.round(U.peakValue)),Te=oe?`storm risk \xB7 peak ${Me} J/kg at ${H(oe,c)}`:`storm risk \xB7 peak ${Me} J/kg`,he=Xe("pw-cape-grad");Gt=`<div class="pw-overview-spark-block">
        ${y.chartCaption(Te)}
        <div class="pw-overview-storm">
          <svg viewBox="0 0 320 24" preserveAspectRatio="none" role="img" aria-label="${g(Te)}">
            <defs>
              <linearGradient id="${he}" x1="0" y1="0" x2="0" y2="1">
            ...
            <path d="${U.areaPath}" fill="url(#${he})"/>
            <path d="${U.svgPath}" fill="none" stroke="var(--pw-warn-amber)" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        </div>
      </div>`}}let ga=Ar(d),ba=J(d,p),va=t?.location_label||"Now",xa=ve?Math.round(ve.total)+"%":"--",ya=`
        <div class="pw-loc-stamp">${g(va)} \xB7 ${g(H(new Date,c))}</div>
        <div class="pw-hero-block">
          ${y.display(Math.round(f),{suffix:T})}
          ${y.gloss(`${ga}${tt?" \xB7 "+tt:""}`)}
        </div>`,_a=y.statsRow([y.stat(`${Math.round(D)}/${Math.round(v)}\xB0`,"range"),y.stat(`${Math.round(w)}${jt?` / ${Math.round(b)}`:""} ${vt}`,jt?"wind / gust":"wind"),y.stat(Math.round(F),"uv"),y.stat(xa,"cloud")],{columns:4}),rt=(o?.daily||[]).slice(0,7),St="";if(rt.length>=2){let I=rt.map(Z=>Number(Z.temperature)||0),X=rt.map(Z=>Number(Z.templow??Z.temperature)||0),j=Math.min(...X),fe=Math.max(...I),U=Math.max(fe-j,1),oe=Z=>Z/(rt.length-1)*320,Me=Z=>38-(Z-j)/U*34-2,Te=I.map((Z,De)=>`${De===0?"M":"L"}${oe(De).toFixed(1)},${Me(Z).toFixed(1)}`).join(" ");St=`<svg viewBox="0 0 320 38" preserveAspectRatio="none">
      ...
      <path d="${Te}" stroke="var(--pw-ink-cream)" stroke-width="1.4" fill="none" stroke-linecap="round" opacity="0.85"/>
    </svg>`}let $a=St?`<div class="pw-overview-spark-block">
        ${y.chartCaption("7-day temperature trend")}
        <div class="pw-overview-spark">${St}</div>
      </div>`:"",Yt=be?.state||"",Mt=Ce?.state||"",ka=[Number.isFinite(m)&&m>0,Number.isFinite($)&&$!==0,!!Yt,!!Mt].filter(Boolean).length>=2,Kt="";if(ka){let P=Number.isFinite(m)&&m>0?y.stat(`${Math.round(m)}%`,wa||"humidity"):y.stat("\u2014","humidity"),W=Number.isFinite($)?y.stat(`${Math.round($)}${C}`,"dew point"):y.stat("\u2014","dew point"),I=Number.isFinite(_)&&_>0?y.stat(`${Math.round(_)}`,Mt?`${A} ${Mt}`:A):y.stat("\u2014","pressure"),X=Number.isFinite(x)&&x>0?y.stat(`${x.toFixed(x<10?1:0)}${k}`,Yt||"visibility"):y.stat("\u2014","visibility");Kt=y.statsRow([P,W,I,X],{columns:4})}let Sa=`
        ${ya}
        ${y.narrative(kt)}
        ${Vt}
        ${$a}
        ${Gt}
        ${_a}
        ${Kt}`;return q({sectionClass:"pw-overview-v2",ariaLabel:"Current weather overview",brandVariant:ba,preContent:`${xe}<div class="pw-fx" ${xt} role="img" aria-label="${g(d)} weather effects"></div>`,body:Sa,pro:t?.pro!==!1})}function Ha(e,t){if(!e||e.length===0)return"Forecast unavailable";let r=0;for(let l=1;l<e.length;l++)Number(e[l].temperature)>Number(e[r].temperature)&&(r=l);let a=e.findIndex(l=>Number(l.precipitation_probability)>=50),o=l=>l===0?"today":ie(new Date(String(e[l].datetime||"")),t,{weekday:"short"}).toLowerCase(),n=o(r),i=Math.round(Number(e[r].temperature));return a>=0&&a!==r?`Warmest ${n} (${i}\xB0) \xB7 rain ${o(a)}`:a>=0?`Wet stretch \xB7 warmest ${n} (${i}\xB0)`:`Warmest ${n} (${i}\xB0) \xB7 dry through the week`}function Pr({hass:e,config:t,discovery:r,forecastData:a,weatherEntity:o}){let n=a?.daily||[];if(n.length===0)return null;let i=te(e),l=r.atmosCe,d=(l.temperature?e.states[l.temperature]:null)?.attributes?.unit_of_measurement||"\xB0C",p=n.slice(0,7),s=p.flatMap(k=>[V(k.temperature,0),V(k.templow,0)]),u=Math.min(...s),f=Math.max(...s),m=Math.max(f-u,1),w=Number(o?.attributes?.temperature),h=p.map((k,A)=>{let C=V(k.temperature,0),L=V(k.templow,0),N=Math.round(Number(k.precipitation_probability)||0),O=A===0,D=O?"today":ie(new Date(String(k.datetime||"")),i,{weekday:"short"}).toLowerCase(),v=ut(String(k.condition||"")),E=N>=50?`<span class="pw-fc-pop">${g(String(N))}%</span>`:'<span class="pw-fc-pop"></span>',F=(L-u)/m*100,R=(C-L)/m*100,ee=O&&Number.isFinite(w)?`<span class="pw-fc-now" style="left:${S(((w-u)/m*100).toFixed(2)+"%")}"></span>`:"";return`
      <div class="pw-fc-row${O?" is-today":""}">
        ...
        <span class="pw-fc-bar" aria-label="High ${Math.round(C)}${g(d)}, low ${Math.round(L)}${g(d)}">
          <span class="pw-fc-bar-fill" style="left:${S(F.toFixed(2)+"%")};width:${S(R.toFixed(2)+"%")}"></span>
          ${ee}
        </span>
      ...
      </div>`}).join(""),{condition:b,isNight:$}=ct(e,o,r),x=J(b,$),_=Ha(p,i),T=`
        <div class="pw-fc-list" role="list">
          ${h}
        </div>`;return q({sectionClass:"pw-forecast-v2",ariaLabel:"Seven-day forecast",brandVariant:x,kicker:"the week ahead",narrative:_,body:T,pro:t?.pro!==!1})}var He=240,pe=He/2,de=He/2,Ze=90,Wr=.12,ft=6,ht=.5,Br=.25,Pa=.3,Wa=6,Ur=.7,Ba=.2,Ua=4,ja=3.3,Va=15,qa=35,Ga=.08,Xa=.2,Ya=[{l:"N",a:0},{l:"NE",a:45},{l:"E",a:90},{l:"SE",a:135},{l:"S",a:180},{l:"SW",a:225},{l:"W",a:270},{l:"NW",a:315}];function jr(e){return(e-90)*Math.PI/180}function Ka(e){let t=e*Math.PI/180;return{x:Math.sin(t),y:-Math.cos(t)}}function _e(e,t){return{x:pe+t*Math.cos(e),y:de+t*Math.sin(e)}}function Za(e,t,r,a){let o=Math.min(e/Oe,1)*Ze,n=_e(t-Br,o),i=_e(t+Br,o),l=r>Pa?"pw-gust-sweep":"",c=Math.max(.6,2.5-r*2).toFixed(2),d=(.15+r*.3).toFixed(2),p=`transform-origin:${pe}px ${de}px;--gust-dur:${c}s;--gust-peak:${d}`;return ne("path",{class:l,d:`M${pe},${de} L${n.x.toFixed(1)},${n.y.toFixed(1)} L${i.x.toFixed(1)},${i.y.toFixed(1)} Z`,fill:a,opacity:.15,style:p})}function Qa(e,t,r,a){let o=Math.min(e/Oe,1)*Ze,n=_e(t,o),i=_e(t-Wr,o*.7),l=_e(t+Wr,o*.7),c={x:n.x-ft*Math.cos(t-ht),y:n.y-ft*Math.sin(t-ht)},d={x:n.x-ft*Math.cos(t+ht),y:n.y-ft*Math.sin(t+ht)},p=r*Wa,s=Math.max(.4,4-r*3.6),u=p>Ba?`animation:pw-arrowSway ${s.toFixed(2)}s ease-in-out infinite;--sway-fwd:${(p*Ur).toFixed(2)}deg;--sway-back:${(-p*(1-Ur)).toFixed(2)}deg`:"",f=`transform-origin:${pe}px ${de}px;filter:drop-shadow(0 0 6px ${ye(a,.38)});${u}`,m=ne("path",{d:`M${pe},${de} L${i.x.toFixed(1)},${i.y.toFixed(1)} L${n.x.toFixed(1)},${n.y.toFixed(1)} L${l.x.toFixed(1)},${l.y.toFixed(1)} Z`,fill:a,opacity:.5}),w=ne("line",{x1:pe,y1:de,x2:n.x.toFixed(1),y2:n.y.toFixed(1),stroke:a,"stroke-width":2.5,"stroke-linecap":"round"}),h=ne("path",{d:`M${n.x.toFixed(1)},${n.y.toFixed(1)} L${c.x.toFixed(1)},${c.y.toFixed(1)} L${d.x.toFixed(1)},${d.y.toFixed(1)} Z`,fill:a});return ne("g",{style:f},m+w+h)}function Vr({hass:e,config:t,discovery:r,weatherEntity:a}){let o=a.attributes,n=r.atmosCe,i=t.speed_mode||"speed",l=(B,z)=>lt(e,n,o,B,z),c=l("wind_speed","wind_speed"),d=l("wind_gusts","wind_gust_speed")||l("wind_gusts","wind_gusts")||c,p=l("wind_direction","wind_bearing"),u=(n.wind_speed?e.states[n.wind_speed]:null)?.attributes?.unit_of_measurement||o.wind_speed_unit||"km/h",f=i==="gust"?d:c,m=Math.min(c/Oe,1),w=Tr(f),h=Mr(f),b=at[h]||at.calm,$=dt(p),x=jr(p),_=Ka(p),T=Math.round(m*tr),k=Ua-m*ja,A=Ga+m*Xa,C=Va+m*qa,L=-_.y,N=_.x,O=[];for(let B=0;B<T;B++){let z=(Math.random()-.5)*400,G=-120-Math.random()*60,ae=420+Math.random()*60,le=(C*(.6+Math.random()*.8)).toFixed(1),be=(k+Math.random()*k*.5).toFixed(2),Ee=(Math.random()*3).toFixed(2),Ce=(A*(.5+Math.random()*.5)).toFixed(3),Ne=(G*_.x+z*L).toFixed(1),Re=(G*_.y+z*N).toFixed(1),We=(ae*_.x+z*L).toFixed(1),Be=(ae*_.y+z*N).toFixed(1);O.push(`<div class="pw-streak" style="left:50%;top:50%;width:${le}px;height:1px;transform:rotate(${p-90}deg);animation-duration:${be}s;animation-delay:${Ee}s;opacity:${Ce};background:linear-gradient(to right, transparent, ${ye(b,.27)}, transparent);--sx:${Ne}px;--sy:${Re}px;--ex:${We}px;--ey:${Be}px"></div>`)}let D=[];for(let B=1;B<=3;B++)D.push(ne("circle",{cx:pe,cy:de,r:B*30,fill:"none",stroke:b,"stroke-width":.5,opacity:.08+B*.02}));for(let B of Ya){let z=jr(B.a),G=_e(z,20),ae=_e(z,Ze+4),le=_e(z,Ze+16),be=B.l.length===1;D.push(ne("line",{x1:G.x.toFixed(1),y1:G.y.toFixed(1),x2:ae.x.toFixed(1),y2:ae.y.toFixed(1),stroke:b,"stroke-width":.5,opacity:.12})),D.push(ne("text",{x:le.x.toFixed(1),y:le.y.toFixed(1),"text-anchor":"middle","dominant-baseline":"central",fill:be?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.3)","font-size":be?11:9,"font-weight":be?600:400},g(B.l)))}D.push(Za(d,x,m,b)),D.push(Qa(f,x,m,b)),(f>Oe||d>Oe)&&D.push(ne("circle",{cx:pe,cy:de,r:Ze+2,fill:"none",stroke:"#ff453a","stroke-width":1.5,"stroke-dasharray":"4 4",opacity:.7})),D.push(ne("circle",{cx:pe,cy:de,r:18,fill:b,opacity:.06})),D.push(ne("circle",{cx:pe,cy:de,r:3,fill:b}));let E=m>Ft?(m-Ft)*5:0,F=Math.max(.15,.4-m*.25),R="";E>.1&&(R=`--dx:${(E*_.x).toFixed(2)}px;--dy:${(E*_.y).toFixed(2)}px;animation:pw-roseShake ${F.toFixed(2)}s ease-in-out infinite`);let ee=Math.round(12+m*50).toString(16).padStart(2,"0"),ue=Math.round(6+m*25).toString(16).padStart(2,"0"),me=Sr(`radial-gradient(ellipse at 50% 50%, ${b}${ee} 0%, ${b}${ue} 40%, transparent 85%)`),we=J(a?.state||"sunny",!1),ge=i==="gust",$e=ge?"wind \xB7 gust":"wind",ke=`
        <div class="pw-wind-streaks">${O.join("")}</div>
        <div class="pw-rose-wrap" style="${R}">
          <svg class="pw-rose-svg" width="${He}" height="${He}" viewBox="0 0 ${He} ${He}" style="display:block" role="img" aria-label="Wind compass rose showing ${g(Math.round(f))} ${g(u)} from ${g($)}">
        ...
        </div>`;return q({sectionClass:"pw-wind-v2",ariaLabel:"Wind compass and speed",brandVariant:we,kicker:$e,sectionStyle:`background: ${S(me)}`,body:ke,proAction:"wind-mode",proInitial:ge,proAriaLabel:"Toggle speed and gust mode",pro:t.pro!==!1})}function Ja(e,t,r,a){if(r&&a){let i=(t==="us"?At:Tt).find(l=>l.label.toLowerCase()===r.toLowerCase());return{label:r,color:a,desc:i?.desc||""}}let o=t==="us"?At:Tt;for(let n of o)if(e<=n.max)return n;return o[o.length-1]}function eo(e){let t=(e||"").toLowerCase();return t.includes("very unhealthy")||t.includes("hazardous")||t.includes("extremely poor")?"very_unhealthy":t.includes("sensitive")?"unhealthy_sg":t.includes("unhealthy")||t.includes("very poor")?"unhealthy":t.includes("moderate")||t.includes("fair")||t.includes("poor")?"moderate":t.includes("good")?"good":"unknown"}var qr=Object.freeze({good:"var(--pw-good-green)",moderate:"var(--pw-warn-yellow)",unhealthy_sg:"var(--pw-warn-amber)",unhealthy:"var(--pw-warn-red)",very_unhealthy:"#8b0000",unknown:"var(--pw-ink-cream)"});function Gr({hass:e,config:t,discovery:r,weatherEntity:a}){let o=t.scale||"eu",n=o==="us"?"us_aqi":"european_aqi",i=t.aqi_entity||r.atmosCe[n];if(!i||!e.states[i])return null;let l=e.states[i],c=Number(l.state)||0,d=l.attributes?.category||null,p=l.attributes?.color||null,s=Ja(c,o,d,p),u=E=>{let F=r.atmosCe[E];if(!F||!e.states[F])return null;let R=Number(e.states[F].state);return Number.isFinite(R)?R:null},f=u("pm2_5"),m=u("pm10"),w=u("ozone"),h=u("nitrogen_dioxide"),b=u("sulphur_dioxide"),$=u("carbon_monoxide"),x=eo(s.label),_=qr[x]||qr.unknown,T=J("cloudy",!1),k=o==="us",C=Math.min(100,Math.max(0,c/(k?300:100)*100)),L=k?"air quality \xB7 us":"air quality",N=y.heroBlock({value:Math.round(c),valueColor:_,tier:s.label,tierFlavor:"aqi",tierColor:_}),O=`
        ...
        ${N}
        ${O}
        ${D}`;return q({sectionClass:"pw-air-quality-v2",ariaLabel:"Air quality index",brandVariant:T,kicker:L,body:v,proAction:"aqi-scale",proInitial:k,proAriaLabel:"Toggle EU and US AQI scale",pro:t.pro!==!1})}function to(e){let t=(e%Q+Q)%Q;return mr[Math.floor(t/Q*8)%8]}function ro(e){return(e%Q+Q)%Q<Q/2}var Ht=864e5;function ao(e,t,r,a,o){if(a==null)return`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${r}" fill="#c8d0e0"/>`;let n=Math.max(0,Math.min(1,a/100)),i=o!=null?ro(o):!0,l=`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${r}" fill="#2a2a3a"/>`;if(n>=.99)l+=`<circle cx="${e.toFixed(1)}" cy="${t.toFixed(1)}" r="${r}" fill="#e8e0d0"/>`;else if(n>.01){let c=t-r,d=t+r,p=(r*Math.abs(2*n-1)).toFixed(1),s=n>.5?1:0,u;i?u=`M${e.toFixed(1)},${c.toFixed(1)} A${r},${r} 0 0 1 ${e.toFixed(1)},${d.toFixed(1)} A${p},${r} 0 0 ${s} ${e.toFixed(1)},${c.toFixed(1)} Z`:u=`M${e.toFixed(1)},${c.toFixed(1)} A${r},${r} 0 0 0 ${e.toFixed(1)},${d.toFixed(1)} A${p},${r} 0 0 ${1-s} ${e.toFixed(1)},${c.toFixed(1)} Z`,l+=`<path d="${u}" fill="#e8e0d0"/>`}return l}var wt="#050510",Xr="#0a1226",Yr="#172b4f",Kr="#1f3d6e",Zr="#3a6fa8",Qr="#d97a3a",Jr="#ff9f0a",ea="#ffc560",ta="#7eaedb",ra="#2c5a8e",aa="#ffd60a";function oo(e,t,r,a,o,n,i,l,c,d){let p=new Date(e.getTime());p.setHours(0,0,0,0);let s=e.getTime(),u=t.getTime(),f=(r??new Date(s-35*6e4)).getTime(),m=(a??new Date(s-30*6e4)).getTime(),w=(o??new Date(s-6*6e4)).getTime(),h=(n??new Date(s+30*6e4)).getTime(),b=(i??new Date(u-30*6e4)).getTime(),$=(l??new Date(u+6*6e4)).getTime(),x=(c??new Date(u+30*6e4)).getTime(),_=(d??new Date(u+35*6e4)).getTime(),T=(s+u)/2,k=v=>Math.max(0,Math.min(100,v)),A=v=>k((v-p.getTime())/Ht*100),C=(v,E)=>A((v+E)/2),L=Math.min(60,(u-s)/8)*6e4,N=T-L,O=T+L;return`linear-gradient(to right, ${[`${wt} 0%`,`${wt} ${A(f).toFixed(2)}%`,`${Xr} ${C(f,m).toFixed(2)}%`,`${Yr} ${A(m).toFixed(2)}%`,`${Kr} ${C(m,w).toFixed(2)}%`,`${Zr} ${A(w).toFixed(2)}%`,`${Qr} ${C(w,s).toFixed(2)}%`,`${Jr} ${A(s).toFixed(2)}%`,`${ea} ${C(s,h).toFixed(2)}%`,`${ta} ${A(h).toFixed(2)}%`,`${ra} ${C(h,N).toFixed(2)}%`,`${aa} ${A(N).toFixed(2)}%`,`${aa} ${A(O).toFixed(2)}%`,`${ra} ${C(O,b).toFixed(2)}%`,`${ta} ${A(b).toFixed(2)}%`,`${ea} ${C(b,u).toFixed(2)}%`,`${Jr} ${A(u).toFixed(2)}%`,`${Qr} ${C(u,$).toFixed(2)}%`,`${Zr} ${A($).toFixed(2)}%`,`${Kr} ${C($,x).toFixed(2)}%`,`${Yr} ${A(x).toFixed(2)}%`,`${Xr} ${C(x,_).toFixed(2)}%`,`${wt} ${A(_).toFixed(2)}%`,`${wt} 100%`].join(", ")})`}function oa(e){if(!e||isNaN(e)||e<=0)return"--";let t=Math.round(e/6e4),r=Math.floor(t/60),a=t%60;return`${r}h ${String(a).padStart(2,"0")}m`}function na({hass:e,config:t,discovery:r}){let a=new Date,o=te(e),n=r.sunEntityId?e.states[r.sunEntityId]:null;if(!n)return null;let i=n.attributes||{},l=i.next_rising||i.sunrise,c=i.next_setting||i.sunset;if(!l||!c)return null;let d=new Date(a);d.setHours(12,0,0,0);let p=Y(new Date(l),d),s=Y(new Date(c),d);if(!p||!s||isNaN(p.getTime())||isNaN(s.getTime()))return null;let u=r.atmosCe,f=xe=>u[xe]?new Date(String(e.states[u[xe]]?.state)):null,m=Y(f("golden_hour_morning_start"),p),w=Y(f("golden_hour_morning_end"),p),h=Y(f("blue_hour_morning_start"),p),b=Y(f("golden_hour_evening_start"),s),$=Y(f("golden_hour_evening_end"),s),x=Y(f("blue_hour_evening_end"),s),_=i.next_dawn,T=i.next_dusk,k=_?Y(new Date(_),p):null,A=T?Y(new Date(T),s):null,C=u.moon_phase?e.states[u.moon_phase]:null,L=C?.attributes||{},N=L.moon_age!==void 0?Number(L.moon_age):null,O=L.illumination!==void 0?Number(L.illumination):null,D=N!==null?to(N):C?.state||null,v=Y(f("moonrise"),a),E=Y(f("moonset"),a),F=a.getTime()>=p.getTime()&&a.getTime()<=s.getTime(),R=H(p,o),ee=H(s,o),ue=(p.getTime()+s.getTime())/2,me=H(new Date(ue),o),we=s.getTime()-p.getTime(),ge=Ht-we,$e=oa(we),ke=oa(ge),B=F?"Daylight":"Night",z=F?$e:ke,G=new Date(p.getTime());G.setHours(0,0,0,0);let ae=Math.max(0,Math.min(100,(a.getTime()-G.getTime())/Ht*100)),le=oo(p,s,k,h,m,w,b,$,x,A),Ee=`
      ...
      </div>`,Ce=O!=null?Math.round(O):null,Ne=D||"Moon",Re=ao(24,24,22,O,N),We=Ce!==null?`<span class="pw-astro-moon-illum">${g(`${Ce}%`)}</span> illuminated`:"",Be=N!=null?`${N.toFixed(1)}d old`:"",Ue=N!=null?(()=>{let xe=Q/2,Le=(N%Q+Q)%Q;return`${(Le<=xe?xe-Le:Q-Le+xe).toFixed(1)}d to full`})():"",Se=[We,Be,Ue].filter(Boolean).join(" \xB7 "),je=`
      <div class="pw-astro-moon-hero">
        <div class="pw-astro-moon-glyph" aria-hidden="true">
          <svg viewBox="0 0 48 48" width="48" height="48">${Re}</svg>
        </div>
        <div class="pw-astro-moon-text">
          <div class="pw-astro-moon-name">${g(Ne)}</div>
          <div class="pw-astro-moon-meta">${Se}</div>
        </div>
      </div>`,ve=F?`Sun rose ${R}, sets ${ee} \xB7 solar noon ${me}.`:`Sun set ${ee}, rises ${R} \xB7 solar noon ${me}.`,Ut=`
      <div class="pw-astro-hero">
        <div class="pw-astro-hero-tier">${g(B)}</div>
        <div class="pw-astro-hero-num">${g(z)}</div>
      </div>
      ${y.narrative(ve)}`,bt=H(v,o),vt=H(E,o),xt=y.statsRow([y.stat(H(k,o),"civil dawn"),y.stat(H(m,o),"golden start",{valueColor:"var(--pw-warn-amber)"}),y.stat(H(h,o),"blue start",{valueColor:"var(--pw-wind)"}),y.stat(bt,"moonrise")],{columns:4,divided:!0}),yt=y.statsRow([y.stat(H(A,o),"civil dusk"),y.stat(H($,o),"golden end",{valueColor:"var(--pw-warn-amber)"}),y.stat(H(x,o),"blue end",{valueColor:"var(--pw-wind)"}),y.stat(vt,"moonset")],{columns:4,divided:!0}),_t=`
      ${Ut}
      ${je}
      ${Ee}
      ${xt}
      ${yt}`,$t=J(F?"sunny":"clear-night",!F),Je=`<div class="pw-fx" data-astro-stars="${!F}" data-astro-day="${F}" role="img" aria-label="Sky atmospheric effects"></div>`;return q({sectionClass:"pw-astro-v2",extraSectionClass:F?"":"is-night",ariaLabel:"Astronomy: sun and moon",brandVariant:$t,kicker:"today's sky",preContent:Je,body:_t,pro:t?.pro!==!1})}var ia=18,no=62,sa=168;function io(e){return e.active?0:typeof e.hoursUntil=="number"&&e.hoursUntil>0?e.hoursUntil:0}function la(e){let t=Math.min(io(e),sa)/sa;return ia+t*(no-ia)}function Pt(e){let t=`${e.summary||""}|${e.type||""}|${e.endTime||""}`,r=0;for(let a=0;a<t.length;a+=1)r=(r*31+t.charCodeAt(a))%360;return r/360*2*Math.PI}function so(e,t){let r=e.alert_type||e.type||"wind",a=Number(e.level),o=Number.isFinite(a)&&a>0?a:1,n=lr[Ve(o)],i=sr[r]||"mdi:alert",l=Number(e.progress)||0,c=Array.isArray(e.locations)?e.locations:[],d=e.end_time??"",p=null,s=null,u=!1;if(d==="")u=!0;else if(d){let f=new Date(d),m=new Date,w=f.getTime()-m.getTime();if(w/(1e3*60*60*24)>nr)u=!0;else if(t)p=Math.max(0,w/(1e3*60*60));else{let b=e.start_time||e.datetime;if(b){let $=new Date(String(b));s=Math.max(0,($.getTime()-m.getTime())/(1e3*60*60))}}}return{type:r,icon:i,severity:o,color:n,summary:String(e.headline||e.summary||""),desc:String(e.description||""),active:t,hoursLeft:p,hoursUntil:s,progress:l,locations:c,link:e.link?String(e.link):null,endTime:String(d),isUntilFurtherNotice:u}}function lo(e){let t=Ve(e.severity),r="";e.isUntilFurtherNotice?r="UNTIL FURTHER NOTICE":e.active&&e.hoursLeft!==null?r=`${Math.round(e.hoursLeft)}H LEFT`:e.hoursUntil!==null?r=`IN ${Math.round(e.hoursUntil)}H`:e.active&&(r="ACTIVE");let a=String(e.type||"").toUpperCase(),o=String(e.summary||e.desc||"").toUpperCase().trim(),n=e.locations.length>0?e.locations.join(", ").toUpperCase():"",l=[r,a,o,n].filter(Boolean).join(" \xB7 ");return`
    <div class="pw-alert-ticker pw-alert-${t}">
      <span class="pw-alert-tri">\u25B6</span>
      <span class="pw-alert-text">${g(l)}</span>
    </div>`}function ca({hass:e,config:t,discovery:r,proPersisted:a=!1}){let o=[];for(let v of r.alertEntityIds){let F=e.states[v]?.attributes?.all_alerts;if(Array.isArray(F)){for(let R of F)o.push(so(R,R.active===!0));break}}let n=o.length>0,i=n?o.reduce((v,E)=>E.severity>v.severity?E:v,o[0]).severity:0,l=n?o.reduce((v,E)=>E.severity>v.severity?E:v,o[0]).color:"#30d158",c=Ke(i,0,4),d=n?Math.min(1.5,1+(o.length-1)*.15):1,p=Lr(c,3,1.2).toFixed(2),s=Nr(c).toFixed(2),u=n?zt(l,c*d):zt("#30d158",.08),f=140,m=f/2,w=f/2,h=n?{bgInner:i>=4?"#1a0000":i>=3?"#1a0e00":"#1a1500",bgOuter:i>=4?"#0a0000":i>=3?"#0a0500":"#0a0800",ring:S(ye(l,.15)),line:S(ye(l,.08)),sweep:S(ye(l,.4))}:{bgInner:"#001a00",bgOuter:"#000800",ring:"rgba(80,255,0,0.15)",line:"rgba(80,255,0,0.08)",sweep:"rgba(80,255,0,0.35)"},b=o.map(v=>{let E=m+Math.cos(Pt(v))*la(v),F=w+Math.sin(Pt(v))*la(v),R=(Pt(v)/(2*Math.PI)*Number(p)).toFixed(2);return v.active?`<div class="pw-radar-blip" style="left:${E.toFixed(1)}px;top:${F.toFixed(1)}px;--pw-blip-color:${S(v.color)};animation-delay:${R}s"></div>`:`<div style="position:absolute;left:${E.toFixed(1)}px;top:${F.toFixed(1)}px;width:4px;height:4px;border-radius:var(--pulse-radius-circle);background:${S(v.color)};opacity:0.2;transform:translate(-50%,-50%)"></div>`}).join(""),$=`
    <div style="display:flex;justify-content:center;padding:12px var(--pulse-space-card-wide);position:relative;z-index:2">
      <div class="pw-radar" style="--pw-radar-bg-inner:${h.bgInner};--pw-radar-bg-outer:${h.bgOuter};--pw-radar-color:${h.ring};--pw-radar-line:${h.line};--pw-radar-sweep:${h.sweep};--pw-radar-dur:${p}s" role="img" aria-label="${n?`${o.length} weather alerts`:"No weather alerts"}">
    ...
    </div>`,x=(()=>{if(!n)return"";let v=null;for(let E of o){if(E.isUntilFurtherNotice)return"further notice";if(E.endTime){let F=new Date(E.endTime);!isNaN(F.getTime())&&(!v||F>v)&&(v=F)}}return v?ie(v,te(e),{hour:"2-digit",minute:"2-digit",month:"short",day:"numeric",hourCycle:"h23"}):"further notice"})(),_=J(n?"rainy":"sunny",!1),T=o.map(lo).join(""),k=n?"":'<div class="pw-all-clear-v2"><strong>All Clear</strong>no active or upcoming warnings</div>',A=o.length===1?"alert":"alerts",C=n?`<div class="pw-alert-timestamp pw-alert-${Ve(i)}">${o.length} ${A} \xB7 valid through ${g(x)}</div>`:"",L=`<div class="pw-tension-wash${n?" breathing":""}" style="background: ${S(u)}; --breathe-dur: ${s}s"></div>`,N=`
        ${$}
        ${k}
        ${T?`<div class="pw-alert-list">${T}</div>`:""}
        ${C}`,O=o.map(v=>{let E=Ve(v.severity),F=v.summary||v.desc||v.type,R=[];v.isUntilFurtherNotice?R.push("until further notice"):v.active&&v.hoursLeft!==null?R.push(`${Math.round(v.hoursLeft)}h left`):v.hoursUntil!==null&&R.push(`in ${Math.round(v.hoursUntil)}h`),v.severity>0&&R.push(`severity ${v.severity}`),v.type&&R.push(v.type);let ee=R.join(" \xB7 "),ue=v.desc&&v.desc!==v.summary?`<div class="pw-alert-detail-desc">${g(v.desc)}</div>`:"",me=v.locations.length>0?`<div class="pw-alert-detail-loc">${g(v.locations.join(" \xB7 "))}</div>`:"";return`
        <div class="pw-alert-detail pw-alert-${E}">
          <div class="pw-alert-detail-head">${g(F)}</div>
          ${ee?`<div class="pw-alert-detail-meta">${g(ee)}</div>`:""}
          ${ue}
          ${me}
        </div>`}).join(""),D=n?`
        ${$}
        ${k}
        ${O}
        ${C}`:void 0;return q({sectionClass:"pw-alerts-v2",ariaLabel:"Weather alerts",brandVariant:_,kicker:n?`weather alerts (${o.length})`:"no weather alerts",preContent:L,body:N,proView:D,proInitial:a,pro:t?.pro!==!1})}var co=Object.freeze({none:{label:"Stable",color:"#30d158",desc:"No thunderstorm risk"},marginal:{label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"},slight:{label:"Slight",color:"#ff9f0a",desc:"Brief storms possible"},enhanced:{label:"Enhanced",color:"#ff6b35",desc:"Organized storms likely"},moderate:{label:"Moderate",color:"#ff453a",desc:"Severe storms expected"},high:{label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"},unknown:{label:"Unknown",color:"#888888",desc:"Insufficient data"}}),po=Object.freeze({none:5,marginal:20,slight:40,enhanced:60,moderate:80,high:100,unknown:0});function uo(e,t){let r=Math.min(100,e/4e3*100),a=Math.min(100,Math.max(0,(6-t)/12*100));return Math.round(r*.6+a*.4)}function mo(e){return e<=10?{tierKey:"none",label:"Stable",color:"#30d158",desc:"No thunderstorm risk"}:e<=30?{tierKey:"marginal",label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"}:e<=55?{tierKey:"slight",label:"Moderate",color:"#ff9f0a",desc:"Scattered storms likely"}:e<=80?{tierKey:"moderate",label:"High",color:"#ff453a",desc:"Severe storms expected"}:{tierKey:"high",label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"}}function fo(e,t){let r=t.atmosCe,a=r.cape&&e.states[r.cape]&&Number(e.states[r.cape].state)||0,o=r.lifted_index&&e.states[r.lifted_index]&&Number(e.states[r.lifted_index].state)||0,n=!!(r.cape&&e.states[r.cape]),i=!!(r.lifted_index&&e.states[r.lifted_index]),l=n||i?uo(a,o):null;if(r.stability_assessment&&e.states[r.stability_assessment]){let d=e.states[r.stability_assessment].state,p=e.states[r.stability_assessment].attributes||{},s=co[d];if(s){let u=po[d]??0;return{tierKey:d,...s,score:u,source:"composite",attrs:p,capeValue:a,liValue:o,hasCape:n,hasLI:i}}}let c=l!==null?mo(l):null;return{tierKey:c?.tierKey||"unknown",label:c?.label||"Unknown",color:c?.color||"#888888",desc:c?.desc||"",score:l,source:"fallback",attrs:null,capeValue:a,liValue:o,hasCape:n,hasLI:i}}function ho(e){return Math.max(0,Math.min(100,e))}function pa(e,t=5e3){return t<=0?0:Math.max(0,Math.min(100,e/t*100))}function wo(e,t){let n=Math.max(e,t),i=5e3;n>5e3*.8&&(i=Math.max(5e3,Math.ceil(n*1.25/1e3)*1e3));let l=Math.ceil(i/5e3)*1e3;i=Math.ceil(i/l)*l;let c=[];for(let d=i;d>=0;d-=l)c.push(d);return{scaleMax:i,labelInterval:l,labels:c}}var go=Object.freeze({none:0,unknown:0,marginal:1,slight:2,enhanced:3,moderate:4,high:5});function bo(e){if(!e)return null;let t=r=>go[String(e[r]||"none")]??0;return{maxThermal:Math.max(t("cape_tier"),t("lifted_index_tier"),t("lapse_rate_tier")),shearTier:t("wind_shear_tier")}}function vo({tierKey:e,tierDesc:t,hourly:r,now:a,todaySunset:o,attrs:n,timeZone:i}){if(e==="none"||e==="unknown")return"Atmosphere settled \xB7 no convective signals";let l=bo(n);if(l&&l.maxThermal===0&&l.shearTier>=2)return"Wind shear elevated \xB7 atmosphere thermally quiet";let c=o&&!isNaN(o.getTime())?o.getTime():null,d=a.getTime(),p=c!==null&&d>=c,s=Array.isArray(r)?r.slice(0,6):[],u=s.map(x=>Number(x&&x.cape)||0),f=u.some(x=>Number.isFinite(x)&&x>0),m=null,w=null;if(f){let x=Math.max(...u);if(x>0){let _=s[u.indexOf(x)],T=_?_.datetime:null,k=T?new Date(String(T)):null;k&&!isNaN(k.getTime())&&(m=H(k,i),w=k.getTime())}}if(m===null||w===null){let x=t||"Storm risk active";return p?`${x} \xB7 calming overnight`:x}let h=1800*1e3,b=w<d-h,$=w>=d-h&&w<=d+h;return b?p?`Storm risk easing \u2014 peaked ${m}, calming overnight`:`Storm risk easing \u2014 peaked ${m}`:$?p?"Storm risk peaking now, calming overnight":c!==null?"Storm risk peaking now, calming after sunset":"Storm risk peaking now":c!==null&&w<c?`Storm risk peaks ${m}, calming after sunset`:c!==null?`Storm risk peaks ${m} (after sunset)`:`Storm risk peaks ${m}`}var ai=Object.freeze([Object.freeze({max:30,tier:"none"}),Object.freeze({max:40,tier:"marginal"}),Object.freeze({max:50,tier:"slight"}),Object.freeze({max:60,tier:"enhanced"}),Object.freeze({max:75,tier:"moderate"})]);var oi=Object.freeze([Object.freeze({max:6,tier:"none"}),Object.freeze({max:6.5,tier:"marginal"}),Object.freeze({max:7.5,tier:"slight"}),Object.freeze({max:8,tier:"enhanced"}),Object.freeze({max:9,tier:"moderate"})]);function xo(e){let t=Math.max(0,Math.min(100,e)),r=t/100;return{count:t<=10?0:Math.round(2+r*6),minSize:2+Math.round(r),maxSize:3+Math.round(r),minDur:4-r*2.2,maxDur:4-r*1.2}}function da(e,t,r=Math.random){let a=document.createDocumentFragment(),o=xo(e);if(o.count===0)return a;let n=S(t);for(let i=0;i<o.count;i++){let l=document.createElement("div");l.className="pw-thermal-particle";let c=o.minSize+r()*(o.maxSize-o.minSize),d=10+r()*80,p=r()*30,s=o.minDur+r()*(o.maxDur-o.minDur),u=r()*s,f=.4+r()*.3,m=-(50+r()*60);l.setAttribute("style",[`width:${c.toFixed(1)}px`,`height:${c.toFixed(1)}px`,`left:${d.toFixed(1)}%`,`bottom:${p.toFixed(1)}%`,`background:${n}`,`--rise-dur:${s.toFixed(2)}s`,`--rise-dist:${m.toFixed(0)}px`,`--peak-op:${f.toFixed(2)}`,`animation-delay:${u.toFixed(2)}s`].join(";")),a.appendChild(l)}return a}function ua({hass:e,config:t,discovery:r,forecastData:a}){let o=r.atmosCe;if(!o.cape&&!o.lifted_index&&!o.freezing_level_height)return console.debug(`${ce} Atmosphere section requires Atmos CE sensors (cape / lifted_index / freezing_level_height) \u2014 section skipped. Install Atmos CE integration if you want the atmospheric stability column.`),null;let n=fo(e,r),{capeValue:i,liValue:l,hasCape:c,hasLI:d,score:p}=n,s=z=>{let G=o[z];if(!G||!e.states[G])return{value:null,unit:""};let ae=Number(e.states[G].state);if(!Number.isFinite(ae))return{value:null,unit:""};let le=String(e.states[G].attributes?.unit_of_measurement||"");return{value:ae,unit:le}},u=s("wind_shear_0_6_km"),f=s("lapse_rate_700_500_hpa"),m=s("freezing_level_height"),w=s("lcl_height"),h=n.tierKey,b={label:n.label,color:n.color,desc:n.desc},x=["slight","enhanced","moderate","high"].includes(h)?"rain":"cloudy",_=new Date,T=r.sunEntityId?e.states[r.sunEntityId]:null,{todaySunset:k}=ze(_,T?.attributes?.next_rising,T?.attributes?.next_setting),A=vo({tierKey:h,tierDesc:b.desc,hourly:a?.hourly||[],now:_,todaySunset:k,attrs:n.attrs,timeZone:te(e)}),C=m.value??0,L=w.value??0,{scaleMax:N,labels:O}=wo(C,L),D=p!==null?ho(p):0,v=b.color,E=c||d?`
          <div class="pw-atmos-cape-fill" style="height:${Number(D)}%;background:linear-gradient(to top, ${S(v)}66, ${S(v)}11)"></div>`:"",F=m.unit||"m",R=m.value!==null?(()=>{let z=pa(m.value,N);return`
          <div class="pw-atmos-freeze-marker" style="bottom:${Number(z)}%">
            <span class="pw-atmos-freeze-label">\u2744 ${g(String(Math.round(m.value)))}${g(F)}</span>
            <div class="pw-atmos-freeze-line"></div>
          </div>`})():"",ee=w.unit||"m",ue=w.value!==null?(()=>{let z=pa(w.value,N);return`
          <div class="pw-atmos-lcl-marker" style="bottom:${Number(z)}%">
            <span class="pw-atmos-lcl-label">\u2601 LCL ${g(String(Math.round(w.value)))}${g(ee)}</span>
        ...
        </div>`,ge=y.heroBlock({tier:b.label,tierFlavor:"atmos",tierColor:"var(--pw-vermilion)",narrative:A}),$e=[c?y.stat(`${Math.round(i)}`,"cape J/kg"):"",d?y.stat(l.toFixed(1),"lifted idx"):"",u.value!==null?y.stat(`${Math.round(u.value)}`,`shear ${u.unit||"km/h"}`):"",f.value!==null?y.stat(f.value.toFixed(1),`lapse ${f.unit||"\xB0C/km"}`):""],ke=y.statsRow($e,{columns:4,divided:!0}),B=`
        ${ge}
        ${we}
        ${ke}`;return q({sectionClass:"pw-atmosphere-v2",ariaLabel:"Atmospheric stability",brandVariant:x,kicker:"atmospheric stability",body:B,pro:t?.pro!==!1})}var se=600,yo=280,gt=8,Wt=80,Pe=200,Qe=220,_o=254,ma=12,$o=30,ko=.9,So=3;function Fe(e,t){return t<=1?se/2:gt+e/(t-1)*(se-2*gt)}function fa(e,t,r){if(!Number.isFinite(e)||!Number.isFinite(t)||!Number.isFinite(r))return(Wt+Pe)/2;let a=r-t||1;return Wt+(r-e)/a*(Pe-Wt)}function Mo(e,t){let r=new Date(e);return ie(r,t,{hour:"2-digit",hourCycle:"h23"})}var To=500;function Ao(e,t=24,r){if(!Array.isArray(e))return null;let a=e.slice(0,To),n=pt(a,new Date).slice(0,t);if(n.length<2)return null;let i=n[0],l="cloud_cover"in i,c="cloud_cover_low"in i&&"cloud_cover_mid"in i&&"cloud_cover_high"in i,d="wind_speed"in i&&("wind_bearing"in i||"wind_direction"in i),p=n.map(h=>{let b=Number(h.temperature),$=V(h.precipitation_probability,0),x=V(h.snowfall,0),_=V(h.rain,0),T=V(h.showers,0),k=String(h.condition||""),A=x>0||k==="snowy"||k==="snowy-rainy"?"snow":"rain",C=A==="snow"?x:_+T;return{temp:b,precip:$,precipMm:C,precipType:A,condition:k,cloudCover:l?V(h.cloud_cover,0):null,cloudLow:c?V(h.cloud_cover_low,0):null,cloudMid:c?V(h.cloud_cover_mid,0):null,cloudHigh:c?V(h.cloud_cover_high,0):null,windSpeed:d?V(h.wind_speed,0):null,windBearing:d?V(h.wind_bearing??h.wind_direction,0):null,timeLabel:Mo(String(h.datetime||""),r),datetime:String(h.datetime||"")}}),s=$r(p,h=>h.temp);if(s.length<2)return null;let u=s.map(h=>h.temp),f=Math.min(...u),m=Math.max(...u),w=Math.max(...s.map(h=>h.precipMm),0);return{points:s,n:s.length,min:f,max:m,minIdx:u.indexOf(f),maxIdx:u.indexOf(m),maxPrecipMm:w,hasCloud:l,hasLayeredCloud:c,hasWind:d}}function Fo(e){let{points:t,n:r,hasLayeredCloud:a}=e;if(r<=0)return"";let o=r>1?(se-2*gt)/(r-1)/2:se/2,n="";for(let i=0;i<r;i++){let l=Fe(i,r),c=i===0?0:l-o,p=(i===r-1?se:l+o)-c,s=c/se*100,u=p/se*100,f;if(a){let m=(Number(t[i].cloudHigh)||0)/100*.06,w=(Number(t[i].cloudMid)||0)/100*.08,h=(Number(t[i].cloudLow)||0)/100*.1;f=Math.min(m+w+h,.15)}else f=(Number(t[i].cloudCover)||0)/100*.12;f<=0||(n+=`<div class="pw-meteogram-cloud-slot" style="left:${s.toFixed(2)}%;width:${u.toFixed(2)}%;opacity:${f.toFixed(3)}"></div>`)}return n?`<div class="pw-meteogram-cloud-bg" aria-hidden="true">${n}</div>`:""}function Eo(e){let{points:t,n:r,maxPrecipMm:a}=e,o=Qe-Pe,n=(se-2*gt)/(r-1)*ko,i=a>0,l=i?Math.max(a,2):100,c="";for(let d=0;d<r;d++){let{precipMm:p,precip:s,precipType:u}=t[d],f=i?p:s;if(f<=0)continue;let m=f/l*o,w=Fe(d,r)-n/2,h=n;w<0&&(h+=w,w=0),w+h>se&&(h=se-w);let b=Qe-m,$=u==="snow"?"rgba(200,220,240,0.45)":"color-mix(in srgb, var(--pw-wind) 40%, transparent)";c+=`<rect x="${w.toFixed(1)}" y="${b.toFixed(1)}" width="${h.toFixed(1)}" height="${m.toFixed(1)}" fill="${$}" rx="1"/>`}return c}function Co(e){let{points:t,n:r,maxPrecipMm:a}=e,o=Qe-Pe,n=a>0,i=n?Math.max(a,2):100,l="";for(let c=0;c<r;c++){let{precipMm:d,precip:p}=t[c],s=n?d:p;if(s<=0)continue;let u=Fe(c,r),f=s/i*o,m=Qe-f-2,w=n?d>=10?String(Math.round(d)):d.toFixed(1):`${Math.round(p)}%`;l+=`<text x="${u.toFixed(1)}" y="${m.toFixed(1)}" text-anchor="middle" fill="color-mix(in srgb, var(--pw-wind) 90%, transparent)" font-size="13" font-weight="600">${g(w)}</text>`}return l}function No(e){let{points:t,n:r,min:a,max:o}=e,n=t.map(f=>parseFloat(f.temp.toFixed(1))),i=t.map((f,m)=>({x:Fe(m,r),y:fa(n[m],a,o)})),l=i.map((f,m)=>`${m===0?"M":"L"}${f.x.toFixed(1)},${f.y.toFixed(1)}`).join(" "),c=`${l} L${i[i.length-1].x.toFixed(1)},${Pe} L${i[0].x.toFixed(1)},${Pe} Z`,d=Xe("pw-meteogram-grad"),p=Dt(o),s=Dt(a),u=`<defs><linearGradient id="${d}" x1="0" y1="0" x2="0" y2="1">`;return u+=`<stop offset="0%" stop-color="${S(p)}" stop-opacity="0.25"/>`,u+=`<stop offset="100%" stop-color="${S(s)}" stop-opacity="0.03"/>`,u+="</linearGradient></defs>",u+=`<path d="${c}" fill="url(#${d})"/>`,u+=`<path d="${l}" fill="none" stroke="rgba(255,255,255,0.7)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>`,u}function Ro(e){let{points:t,n:r}=e,a="";for(let o=0;o<r;o+=So){let n=Fe(o,r);a+=`<text x="${n.toFixed(1)}" y="${_o}" text-anchor="middle" fill="var(--pw-ink-cream-dim)" font-size="15" font-weight="600">${g(t[o].timeLabel)}</text>`}return a}function Lo(e,t,r,a){let o=r/1.852,n=((a+180)%360-90+360)%360,i=Math.round(o/5)*5,l=Math.floor(i/50);i-=l*50;let c=Math.floor(i/10);i-=c*10;let d=Math.floor(i/5),p=18,s="var(--pw-ink-cream-muted)",u="",f=-p;for(let m=0;m<l;m++)u+=`<polygon points="0,${f.toFixed(1)} 9,${(f+3).toFixed(1)} 0,${(f+6).toFixed(1)}" fill="${s}"/>`,f+=6;for(let m=0;m<c;m++)u+=`<line x1="0" y1="${f.toFixed(1)}" x2="9" y2="${(f+4.5).toFixed(1)}" stroke="${s}" stroke-width="1.4" stroke-linecap="round"/>`,f+=4.5;for(let m=0;m<d;m++)u+=`<line x1="0" y1="${f.toFixed(1)}" x2="4.5" y2="${(f+2.25).toFixed(1)}" stroke="${s}" stroke-width="1.4" stroke-linecap="round"/>`;return`<g transform="translate(${e.toFixed(1)},${t}) rotate(${n})"><line x1="0" y1="0" x2="0" y2="${-p}" stroke="${s}" stroke-width="1.4" stroke-linecap="round"/>${u}</g>`}function Do(e){let{points:t,n:r,min:a,max:o,minIdx:n,maxIdx:i}=e,l=0,c=1,d=2,p="";for(let s=0;s<r;s++){let u=s===n||s===i,f=u?l:s%3,m=Fe(s,r),w=fa(t[s].temp,a,o);if(f===l){let h=t[s].temp,b=u?String(Math.round(h)):h.toFixed(1),$=s===n?"var(--pw-wind)":s===i?"var(--pw-vermilion)":"var(--pw-ink-cream)",x=u?17:15,_=w-ma;p+=`<text x="${m.toFixed(1)}" y="${_.toFixed(1)}" text-anchor="middle" fill="${$}" font-size="${x}" font-weight="600">${b}\xB0</text>`}else if(f===c){let h=ut(t[s].condition),b=w-ma;p+=`<text x="${m.toFixed(1)}" y="${b.toFixed(1)}" text-anchor="middle" font-size="20">${h}</text>`}else if(f===d){let h=Number(t[s].windSpeed),b=Number(t[s].windBearing);if(!Number.isFinite(h)||h<1||!Number.isFinite(b))continue;let $=w-$o;p+=Lo(m,$,h,b)}}return p}function ha({hass:e,config:t,forecastData:r}){let a=r?.hourly||[];if(a.length<2)return null;let o=te(e),n=Number(t.hours),i=t.horizon==="long"?"long":"short",l=Number.isFinite(n)&&n>0?Math.max(4,Math.min(48,n)):i==="long"?24:12,c=Ao(a,l,o);if(!c)return null;let p=(t.show_cloud==="auto"||t.show_cloud===void 0?c.hasCloud:!!t.show_cloud)&&c.hasCloud?Fo(c):"",s=J(c.points[0]?.condition||"sunny",!1),u=[];u.push(Eo(c)),u.push(Co(c)),u.push(No(c)),u.push(Do(c));let f=Fe(0,c.n).toFixed(1);u.push(`<line x1="${f}" y1="0" x2="${f}" y2="${Qe}" stroke="var(--pw-vermilion)" stroke-width="0.8" stroke-dasharray="2 3" opacity="0.7"/>`),u.push(Ro(c));let m=c.n,w=`${m}-hour meteogram showing temperature, condition, wind, and precipitation`,h=m<=12?"next twelve hours":`next ${m===24?"twenty-four":m} hours`,b=Xe("pw-meteogram-title"),$=`
        <div class="pw-meteogram-chart" aria-labelledby="${b}">
          <svg viewBox="0 0 ${se} ${yo}" style="width:100%; height:auto" role="img" aria-label="${g(w)}">
            <title id="${b}">${g(w)}</title>
            ${u.join(`
`)}
          </svg>
        </div>`;return q({sectionClass:"pw-meteogram-v2",ariaLabel:w,brandVariant:s,kicker:h,preContent:p,body:$,proAction:"meteo-horizon",proInitial:l>=18,proAriaLabel:"Toggle 12-hour and 24-hour view",pro:t.pro!==!1})}var Io={overview:Hr,forecast:Pr,wind:Vr,air_quality:Gr,astro:na,alerts:ca,atmosphere:ua,meteogram:ha},Bt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null,this._lastWeatherState=null,this._atmosExpanded=!1,this._forecastData=null,this._forecastLastFetch=0,this._subscribedEntityId=null,this._atmosConfigEntryId=null,this._discovery=null,this._forecastFetching=!1,this._phaseTimer=null,this._countdownTimer=null,this._minuteTimer=null,this._warnedMissingEntity=null,this._warnedMissingAtmosCe=null,this._proState={}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._cleanupTimers(),this._config=gr(t),this._warnedMissingEntity=null,this._warnedMissingAtmosCe=null,this._discovery=null,this._proState={},this._hass&&this._fullRender()}_getDiscovery(){return this._discovery||(this._discovery=yr(this._hass.states,this._config)),this._discovery}_getCeFingerprint(t){let a=this._getDiscovery().atmosCe,o=[];for(let n of Object.keys(a)){let i=a[n],l=t.states[i];l&&o.push(`${n}=${l.state}`)}return o.join("|")}_warnIfAtmosCeMissing(t,r){let a=new Set(["atmosphere","air_quality","meteogram"]);if(!t.some(c=>a.has(c.type))||Object.keys(r.atmosCe).length>0)return;let n=this._config,i=n.atmos_source||Lt(r.weatherEntityId||"");if(this._warnedMissingAtmosCe===i)return;this._warnedMissingAtmosCe=i;let l=n.atmos_source?`Set atmos_source matches no sensor.${i}_* entities \u2014 check the slug.`:`Derived slug "${i}" matches no sensor.${i}_* entities. If you renamed your weather entity after installing Atmos CE, set atmos_source manually in the card config.`;console.warn(`${ce} atmosphere / air_quality / meteogram sections configured but no Atmos CE sensors discovered. ${l}`)}_cleanupTimers(){this._phaseTimer&&(clearTimeout(this._phaseTimer),this._phaseTimer=null),this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=null),this._minuteTimer&&(clearInterval(this._minuteTimer),this._minuteTimer=null)}set hass(t){if(this._hass=t,!this._config)return;let r=this._config.weather_entity,a=r||Object.keys(t.states).find(c=>c.startsWith("weather."))||"",o=t.states[a];if(!o){r&&this._warnedMissingEntity!==r&&(console.warn(`${ce} weather_entity "${r}" not found in hass.states. Check the entity_id in your card config (likely a typo, or the integration was removed).`),this._warnedMissingEntity=r);return}let n=this._getCeFingerprint(t),i=`${o.state}|${JSON.stringify(o.attributes)}|${n}`;i!==this._lastWeatherState&&(this._lastWeatherState=i,this._fullRender()),this._subscribeForecast(t,a)}async _subscribeForecast(t,r){let a=Date.now()-this._forecastLastFetch>=Ct;if(!(this._subscribedEntityId===r&&this._forecastData&&!a)&&!this._forecastFetching){this._forecastFetching=!0,this._subscribedEntityId=r;try{if(!t.callWS)return;let o=null;if(this._discovery?.atmosSource)try{if(!this._atmosConfigEntryId){let s=(await t.callWS({type:"config/entity_registry/list"}).catch(()=>[])).find(u=>u.platform==="atmos_ce");this._atmosConfigEntryId=s?.config_entry_id||null}if(this._atmosConfigEntryId){let u=(await t.callWS({type:"call_service",domain:"atmos_ce",service:"get_extended_forecast",service_data:{config_entry_id:this._atmosConfigEntryId,type:"hourly"},return_response:!0}).catch(()=>null))?.response;u?.forecast&&(o=u.forecast)}}catch(p){console.debug(`${ce} extended forecast fetch failed, falling back to standard hourly`,p)}let n=null;r&&t.states[r]&&(n=await t.callWS({type:"call_service",domain:"weather",service:"get_forecasts",target:{entity_id:r},service_data:{type:"daily"},return_response:!0}).catch(()=>null));let i=null;!o&&r&&t.states[r]&&(i=(await t.callWS({type:"call_service",domain:"weather",service:"get_forecasts",target:{entity_id:r},service_data:{type:"hourly"},return_response:!0}).catch(()=>null))?.response?.[r]?.forecast||[]);let d=n?.response?.[r];this._forecastData={hourly:o||i||[],daily:d?.forecast||[]},this._forecastLastFetch=Date.now(),this._fullRender()}catch(o){console.warn(`${ce} forecast fetch failed; retries throttled to ${Ct/1e3}s. Inspect the error below to diagnose. Common causes: weather entity offline, integration disabled, network failure.`,o),this._forecastLastFetch=Date.now()}finally{this._forecastFetching=!1}}}_unsubscribeForecasts(){this._subscribedEntityId=null,this._forecastLastFetch=0}disconnectedCallback(){this._unsubscribeForecasts(),this._cleanupTimers()}_fullRender(){if(!this._hass||!this._config||!this.shadowRoot)return;let t=this._getDiscovery(),r=this._hass.states[t.weatherEntityId];if(!r)return;let a=["<style>",hr,"</style>",'<div class="pw-card">'],o=this._config.sections||[];this._warnIfAtmosCeMissing(o,t);for(let n=0;n<o.length;n++){let i=o[n],l=Io[i.type];if(l)try{let c=l({hass:this._hass,config:i,discovery:t,weatherEntity:r,forecastData:this._forecastData,sectionIndex:n,proPersisted:!!this._proState[n]});c&&a.push(c)}catch(c){console.warn(`${ce} section "${i?.type}" renderer threw \u2014 section will be skipped, other sections continue. Please share the error below when reporting.`,c)}}a.push("</div>"),this.shadowRoot.innerHTML=a.join(""),this._postRender(t),this._schedulePhaseTransition(),this._minuteTimer||(this._minuteTimer=setInterval(()=>{this._lastWeatherState=null,this._hass&&this._fullRender()},6e4)),this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=null),this.shadowRoot.querySelector(".pw-astro-countdown")&&(this._countdownTimer=setInterval(()=>{let n=this.shadowRoot?.querySelector(".pw-astro-countdown");if(!n){clearInterval(this._countdownTimer),this._countdownTimer=null;return}let i=Number(n.dataset.target)-Date.now();if(i<=0){clearInterval(this._countdownTimer),this._countdownTimer=null,this._lastWeatherState=null,this._fullRender();return}let l=Math.floor(i/1e3),c=Math.floor(l/3600),d=Math.floor(l%3600/60),p=l%60;n.textContent=(c>0?c+"h "+d+"m":d+"m "+p+"s")+(n.dataset.suffix||"")},1e3))}_schedulePhaseTransition(){if(this._phaseTimer&&(clearTimeout(this._phaseTimer),this._phaseTimer=null),!this._hass||!this._config)return;let t=this._getDiscovery(),r=t.atmosCe,a=this._hass.states[t.sunEntityId||""];if(!a)return;let o=new Date,n=o.getTime(),i=[],l=a.attributes?.next_rising,c=a.attributes?.next_setting,{todaySunrise:d,todaySunset:p}=ze(o,l,c),s=a.attributes?.next_rising?new Date(a.attributes.next_rising).getTime():NaN,u=a.attributes?.next_setting?new Date(a.attributes.next_setting).getTime():NaN;Number.isFinite(s)&&s>n&&i.push(s),Number.isFinite(u)&&u>n&&i.push(u);let f={golden_hour_morning_start:d,golden_hour_morning_end:d,blue_hour_morning_start:d,blue_hour_morning_end:d,golden_hour_evening_start:p,golden_hour_evening_end:p,blue_hour_evening_start:p,blue_hour_evening_end:p};for(let[h,b]of Object.entries(f)){if(!r[h])continue;let $=new Date(String(this._hass.states[r[h]]?.state||""));if(isNaN($.getTime()))continue;let x=Y($,b);if(!x)continue;let _=x.getTime();_>n&&i.push(_);let T=_+864e5;T>n&&i.push(T)}if(i.length===0)return;let w=Math.min(...i)-n+1e3;this._phaseTimer=setTimeout(()=>{this._phaseTimer=null,this._lastWeatherState=null,this._hass&&this._fullRender()},w)}_postRender(t){if(!this.shadowRoot||!this._hass)return;let r=qe(),a=r?[]:this.shadowRoot.querySelectorAll(".pw-fx[data-condition]");for(let s of a){let u=s.getAttribute("data-condition")||"",f=s.getAttribute("data-night")==="true",m=null;try{let h=s.getAttribute("data-cloud");h&&h!=='""'&&h!==""&&(m=JSON.parse(h))}catch{}let w=Cr(u,f,m);s.replaceChildren(w)}let o=this.shadowRoot.querySelectorAll(".pw-aqi[data-pm25]");for(let s of o){let u=Number(s.getAttribute("data-pm25"))||0,f=Number(s.getAttribute("data-pm10"))||0,m=s.querySelector(".pw-fx");if(m&&(u>0||f>0)){let w=document.createDocumentFragment();Er(w,u,f),m.replaceChildren(w)}}let n=r?[]:this.shadowRoot.querySelectorAll(".pw-fx[data-astro-stars]");for(let s of n){let u=s.getAttribute("data-astro-stars")==="true",f=s.getAttribute("data-astro-day")==="true",m=document.createDocumentFragment();u&&Ot(m),f&&(K(m,3,.5),mt(m)),s.replaceChildren(m)}let i=r?[]:this.shadowRoot.querySelectorAll(".pw-atmos-fx[data-atmos-score]");for(let s of i){let u=Number(s.getAttribute("data-atmos-score"))||0,f=s.getAttribute("data-atmos-color")||"#30d158",m=da(u,f);s.replaceChildren(m)}let l=[...this.shadowRoot.querySelectorAll(".pw-section")],c=this.shadowRoot.querySelectorAll("button.pw-brand-mark-corner");for(let s of c)s.addEventListener("click",u=>{let f=u.currentTarget,m=f.closest(".pw-section");if(!m||!this._config)return;let w=l.indexOf(m);if(w<0)return;let h=m.dataset.proAction||"view-swap";if(h==="wind-mode"||h==="meteo-horizon"||h==="aqi-scale"){let $=(this._config.sections||[]).map((_,T)=>T===w?{..._}:_),x=$[w];if(!x)return;if(h==="wind-mode"&&x.type==="wind")x.speed_mode=x.speed_mode==="gust"?"speed":"gust";else if(h==="meteo-horizon"&&x.type==="meteogram"){let _=Number(x.hours),T=Number.isFinite(_)&&_>0?_>=18:x.horizon==="long";x.horizon=T?"short":"long","hours"in x&&delete x.hours}else h==="aqi-scale"&&x.type==="air_quality"&&(x.scale=x.scale==="us"?"eu":"us");this._config={...this._config,sections:$},this._fullRender();return}let b=m.dataset.pro==="true"?"false":"true";m.dataset.pro=b,f.setAttribute("aria-pressed",b),this._proState[w]=b==="true"});let d=this.shadowRoot.querySelectorAll(".pw-hourly-strip");for(let s of d){let u=!1,f=0,m=0,w=s;w.setAttribute("tabindex","0"),w.setAttribute("role","group"),w.hasAttribute("aria-label")||w.setAttribute("aria-label","Hourly forecast, scrollable"),s.addEventListener("mousedown",h=>{u=!0,f=h.pageX-s.offsetLeft,m=s.scrollLeft,s.style.cursor="grabbing"}),s.addEventListener("mouseleave",()=>{u=!1,s.style.cursor=""}),s.addEventListener("mouseup",()=>{u=!1,s.style.cursor=""}),s.addEventListener("mousemove",h=>{if(!u)return;h.preventDefault();let b=h.pageX-s.offsetLeft;s.scrollLeft=m-(b-f)}),s.addEventListener("touchstart",h=>{h.stopPropagation()},{passive:!0}),s.addEventListener("touchmove",h=>{h.stopPropagation()},{passive:!0}),s.addEventListener("wheel",h=>{let b=h;Math.abs(b.deltaX)<Math.abs(b.deltaY)&&(h.preventDefault(),s.scrollLeft+=b.deltaY)},{passive:!1})}let p=this.shadowRoot.querySelector(".pw-atmos-column-wrap[data-has-detail]");if(p){let s=this.shadowRoot.querySelector(".pw-atmos-detail");if(s){this._atmosExpanded&&(s.style.maxHeight=`${s.scrollHeight}px`,p.setAttribute("aria-expanded","true"));let u=()=>{this._atmosExpanded=!this._atmosExpanded,this._atmosExpanded?(s.style.maxHeight=`${s.scrollHeight}px`,p.setAttribute("aria-expanded","true")):(s.style.maxHeight="0",p.setAttribute("aria-expanded","false"))};xr(p,u),p.hasAttribute("aria-expanded")||p.setAttribute("aria-expanded","false"),p.addEventListener("click",u)}}}getCardSize(){let t=this._config?.sections?.length||1;return Math.max(3,t*3)}getGridOptions(){return br(6)}static async getConfigElement(){return await import("./pulse-weather-card-editor.js"),document.createElement(Jt)}static getStubConfig(t){let r=Object.keys(t.states).find(a=>a.startsWith("weather."));return{type:`custom:${Ie}`,weather_entity:r||"weather.home",sections:[{type:"overview"}]}}};customElements.get(Ie)||(customElements.define(Ie,Bt),console.info(`%c ${Ie.toUpperCase()} %c v${Qt} `,"background:#5ac8fa;color:#000;font-weight:bold","background:#333;color:#fff"));window.customCards=window.customCards||[];window.customCards.push({type:Ie,name:"Pulse Weather Card",description:"Weather visualization with atmospheric effects, forecasts, wind rose, and more",preview:!0});export{Bt as PulseWeatherCard};
