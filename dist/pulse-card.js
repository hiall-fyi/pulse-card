...
`;var ea=[{type:"overview"}],sc={overview:{},forecast:{mode:"both"},wind:{speed_mode:"speed"},air_quality:{scale:"eu"},astro:{},alerts:{},atmosphere:{}};function Ho(t){if(!t)return{type:"overview"};if(typeof t=="string")return Ho({type:t});if(typeof t!="object")return{type:"overview"};let e=Pr.includes(t.type)?t.type:"overview";return{...sc[e]||{},...t,type:e}}function oa(t){if(!t||typeof t!="object")return{type:"custom:pulse-weather-card",sections:ea.map(Ho)};let e=t,o=Array.isArray(e.sections)&&e.sections.length>0?e.sections.map(Ho):ea.map(Ho);return{type:e.type||"custom:pulse-weather-card",weather_entity:e.weather_entity||void 0,atmos_source:e.atmos_source||void 0,sections:o}}function ni(t){let e=t.replace(/^weather\./,"");return e.endsWith(oi)&&(e=e.slice(0,-oi.length)),e}function na(t,e){let o=e.weather_entity||Object.keys(t).find(p=>p.startsWith("weather."))||"",n=e.atmos_source||ni(o),i={};for(let p of Yr){let c=`sensor.${n}_${p}`;c in t&&(i[p]=c)}let r=Object.keys(i).length>=Kr,s=r?i:{},a=[];if(e.alert_entities&&e.alert_entities.length>0)for(let p of e.alert_entities)p in t&&a.push(p);else if(r){for(let u of Zr){let m=`sensor.${n}_${u}`,d=`sensor.${n}_warnings_${u}`;m in t?a.push(m):d in t&&a.push(d)}let p=`binary_sensor.${n}_alert_active`,c=`binary_sensor.${n}_warnings_alert_active`;p in t?a.push(p):c in t&&a.push(c)}let l="sun.sun"in t?"sun.sun":null;return{weatherEntityId:o,atmosCe:s,sunEntityId:l,atmosSource:r?n:null,alertEntityIds:a}}function ra(t,e){return t.filter(o=>Number.isFinite(e(o)))}function ut(t,e=0){let o=Number(t);return Number.isFinite(o)?o:e}function Do(t,e,o,n,i,r=0){if(e?.[n]){let s=Number(t?.states?.[e[n]]?.state);if(Number.isFinite(s))return s}return Number(o?.[i]??r)||r}function aa(t,e,o,n){return e?.[o]&&t?.states?.[e[o]]?.attributes?.unit_of_measurement||n}function Fe(t,e,o=0){let n=e?t?.states?.[e]:null;if(!n)return{value:o,unit:void 0,entity:null};let i=Number(n.state);return{value:Number.isFinite(i)?i:o,unit:n.attributes?.unit_of_measurement,entity:n}}function Oo(t,e,o){let n=e?.state||"sunny",i=o?.sunEntityId?t?.states?.[o.sunEntityId]?.state:null;return{condition:n,isNight:n==="clear-night"||i==="below_horizon"}}function Xe(t="pw-id"){return he(t)}function sa(t){return`${t}, linear-gradient(180deg, var(--pw-sky-top) 0%, var(--pw-sky-mid) 45%, var(--pw-sky-bot) 100%)`}function Po(t,e,o=36e5){let n=(e?e.getTime():Date.now())-o;return t.filter(i=>{let r=i.datetime;if(!r)return!1;let s=new Date(r).getTime();return Number.isFinite(s)&&s>=n})}function Qt(t){let e=Number(t);for(let o of Lo)if(e<=o.max)return o.color;return Lo[Lo.length-1].color}function ii(t){let e=Number(t);for(let o of zo)if(e<=o.max)return o.tier;return zo[zo.length-1].tier}function la(t){return Me[ii(t)]||Me.calm}function Bo(t){let e=Number(t);for(let o of Ro)if(e<=o.max)return o;return Ro[Ro.length-1]}function qo(t){let e=(Number(t)%360+360)%360,o=Math.round(e/22.5)%16;return jr[o]}function ca(t){return t<=12?"#30d158":t<=50?"#5ac8fa":t<=87?"#ff9f0a":"#ff453a"}function pa(t){return t<10?"#5ac8fa":t<16?"#30d158":t<19?"#ffd60a":t<22?"#ff9f0a":"#ff453a"}function Ie(t,e,o){if(!e||!o)return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let n=new Date(e),i=new Date(o);if(isNaN(n.getTime())||isNaN(i.getTime()))return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let r=n.getTime()>t.getTime()?new Date(n.getTime()-864e5):n,s=i.getTime()>t.getTime()?i:new Date(i.getTime()-864e5);s.getTime()>r.getTime()+864e5&&(s=new Date(s.getTime()-864e5)),r.getTime()>s.getTime()&&(r=new Date(r.getTime()-864e5));let a=n.getTime()>t.getTime()?n:new Date(n.getTime()+864e5);return{todaySunrise:r,todaySunset:s,tomorrowSunrise:a}}function ft(t,e){if(!t||isNaN(t.getTime()))return null;if(!e)return t;let o=e.getTime(),n=[t,new Date(t.getTime()-864e5),new Date(t.getTime()+864e5)],i=n[0],r=Math.abs(i.getTime()-o);for(let s=1;s<n.length;s+=1){let a=Math.abs(n[s].getTime()-o);a<r&&(i=n[s],r=a)}return i}function Ct(t,e,o){let n=e?Object.entries(e).map(([i,r])=>` ${i}="${r}"`).join(""):"";return o!=null?`<${t}${n}>${o}</${t}>`:`<${t}${n}/>`}function Vo(t){return Jr[t]||"\u{1F324}\uFE0F"}var ia={"clear-night":"Clear Night",cloudy:"Cloudy",exceptional:"Exceptional",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning Rainy",partlycloudy:"Partly Cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy Rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy Variant"};function da(t){return Object.hasOwn(ia,t)?ia[t]:t.replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function $t(t,e,o){let n=document.createElement(t);if(n.className=e,o)for(let[i,r]of Object.entries(o))n.style.setProperty(i,r);return n}function X(t,e){return Math.random()*(e-t)+t}function Ye(t,e=60,o=1,n=2){let i=Math.min(e,qr);for(let r=0;r<i;r++){let s=$t("div","pw-rain-drop"),a=X(15,30),l=X(.4,.8)/o;Object.assign(s.style,{left:`${X(0,100)}%`,top:`${X(-10,20)}%`,width:`${n}px`,height:`${a}px`,borderRadius:`0 0 ${n}px ${n}px`,background:"linear-gradient(to bottom, transparent, rgba(120,180,255,0.6))",animation:`pw-rainFall ${l}s linear ${X(0,2)}s infinite`,animationFillMode:"backwards",position:"absolute"}),t.appendChild(s)}}function ri(t,e=40){let o=Math.min(e,Vr);for(let n=0;n<o;n++){let i=$t("div","pw-snowflake"),r=X(2,5);Object.assign(i.style,{left:`${X(0,100)}%`,top:`${X(-5,10)}%`,width:`${r}px`,height:`${r}px`,borderRadius:"50%",background:"rgba(255,255,255,0.7)",animation:`pw-snowFall ${X(3,6)}s linear ${X(0,4)}s infinite`,animationFillMode:"backwards",position:"absolute"}),t.appendChild(i)}}function lc(t){for(let e=0;e<4;e++){let o=$t("div","pw-fog-layer");Object.assign(o.style,{position:"absolute",width:"200%",height:"40px",top:`${30+e*20}%`,left:"0",background:"linear-gradient(to right, transparent 0%, rgba(200,200,200,0.06) 20%, rgba(200,200,200,0.1) 50%, rgba(200,200,200,0.06) 80%, transparent 100%)",animation:`pw-fogDrift ${X(15,25)}s linear ${e*2}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function Wo(t){for(let e=0;e<8;e++){let o=$t("div","pw-sun-ray");Object.assign(o.style,{position:"absolute",top:"-20px",left:`${10+e*12}%`,width:"2px",height:"120px",background:"linear-gradient(to bottom, rgba(255,220,100,0.08), transparent)",transformOrigin:"top center",transform:`rotate(${-15+e*4}deg)`,animation:`pw-rayPulse ${X(3,5)}s ease-in-out ${X(0,2)}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function gt(t,e=4,o=1){let n=Math.min(e,Qn);for(let i=0;i<n;i++){let r=$t("div","pw-cloud"),s=X(80,160),a=X(30,60),l=X(20,40)/o;Object.assign(r.style,{position:"absolute",width:`${s}px`,height:`${a}px`,top:`${X(5,50)}%`,left:"0",borderRadius:"50%",background:"radial-gradient(ellipse, rgba(255,255,255,0.05) 0%, transparent 70%)",animation:`pw-cloudDrift ${l}s linear ${X(0,15)}s infinite`,animationFillMode:"backwards"}),t.appendChild(r)}}function ai(t){for(let e=0;e<Wr;e++){let o=$t("div","pw-star"),n=X(1,3);Object.assign(o.style,{position:"absolute",left:`${X(0,100)}%`,top:`${X(0,70)}%`,width:`${n}px`,height:`${n}px`,borderRadius:"50%",background:"#fff",animation:`pw-twinkle ${X(2,5)}s ease-in-out ${X(0,3)}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function cc(t,e){let o=[],n=t,i=0,r=Math.floor(X(4,8)),s=e/r;o.push(`${n},${i}`);for(let a=0;a<r;a++)n+=X(-15,15),i+=s,o.push(`${n},${i}`);return o.join(" ")}function ua(t,e=2,o){let n=o||Array.from({length:e},(r,s)=>s*3),i=$t("div","pw-lightning-flash");Object.assign(i.style,{position:"absolute",inset:"0",background:"rgba(255,255,255,0.15)",animation:`pw-flash 6s ease-in-out ${n[0]||0}s infinite`,animationFillMode:"backwards",pointerEvents:"none"}),t.appendChild(i);for(let r=0;r<e;r++){let s="http://www.w3.org/2000/svg",a=document.createElementNS(s,"svg");a.setAttribute("class","pw-lightning-bolt"),a.setAttribute("width","60"),a.setAttribute("height","200"),a.setAttribute("viewBox","0 0 60 200"),a.style.position="absolute",a.style.top="0",a.style.left=`${X(15,75)}%`,a.style.pointerEvents="none",a.style.zIndex="2",a.style.animation=`pw-boltStrike 6s ease-in-out ${n[r]||0}s infinite`,a.style.animationFillMode="backwards";let l=cc(30,180),p=document.createElementNS(s,"polyline");p.setAttribute("points",l),p.setAttribute("fill","none"),p.setAttribute("stroke","rgba(200,220,255,0.4)"),p.setAttribute("stroke-width","6"),p.setAttribute("stroke-linecap","round"),p.setAttribute("stroke-linejoin","round"),a.appendChild(p);let c=document.createElementNS(s,"polyline");c.setAttribute("points",l),c.setAttribute("fill","none"),c.setAttribute("stroke","#fff"),c.setAttribute("stroke-width","2"),c.setAttribute("stroke-linecap","round"),c.setAttribute("stroke-linejoin","round"),a.appendChild(c),t.appendChild(a)}}function pc(t){let e=$t("div","pw-heat-shimmer");Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",background:"linear-gradient(0deg, transparent 0%, rgba(255,200,100,0.03) 30%, transparent 50%, rgba(255,180,80,0.02) 70%, transparent 100%)",backgroundSize:"100% 200%",animation:"pw-shimmer 3s ease-in-out infinite"}),t.appendChild(e);let o=$t("div","pw-heat-ripple");Object.assign(o.style,{position:"absolute",bottom:"0",left:"0",right:"0",height:"60px",pointerEvents:"none",background:"repeating-linear-gradient(0deg, transparent, rgba(255,200,100,0.02) 2px, transparent 4px)",animation:"pw-rippleWave 2s ease-in-out infinite"}),t.appendChild(o)}function ma(t,e,o){let n=Math.min(1,(e/75+o/150)/2);if(n<.05)return;let i=$t("div","pw-smog-overlay");i.style.background=`rgba(120,110,80,${.05+n*.15})`,t.appendChild(i);let r=$t("div","pw-haze-vignette");r.style.background=`radial-gradient(ellipse at center, transparent 40%, rgba(80,70,50,${n*.3}) 100%)`,t.appendChild(r);let s=Math.floor(n*20);for(let l=0;l<s;l++){let p=$t("div","pw-dust-particle"),c=X(1,3+n*3);Object.assign(p.style,{left:`${X(0,100)}%`,top:`${X(10,90)}%`,width:`${c}px`,height:`${c}px`,animationDelay:`${X(0,8)}s`,animationFillMode:"backwards"}),t.appendChild(p)}let a=Math.floor(n*5);for(let l=0;l<a;l++){let p=$t("div","pw-haze-blob"),c=X(60,120);Object.assign(p.style,{left:`${X(-10,80)}%`,top:`${X(10,70)}%`,width:`${c}px`,height:`${c*.6}px`,animationDelay:`${X(0,12)}s`,animationFillMode:"backwards"}),t.appendChild(p)}}function ha(t,e,o){let n=document.createDocumentFragment();try{e&&ai(n);let i=o?Math.round(o.total/100*Qn):0;switch(t){case"sunny":e||Wo(n),o&&i>0&&gt(n,i);break;case"clear-night":o&&i>0&&gt(n,i);break;case"partlycloudy":e||Wo(n),gt(n,o?i:3);break;case"cloudy":gt(n,o?Math.max(i,4):6);break;case"rainy":Ye(n,40,1,2),gt(n,o?Math.max(i,3):4);break;case"pouring":Ye(n,80,1.5,3),gt(n,o?Math.max(i,5):6);break;case"snowy":ri(n,40),gt(n,o?Math.max(i,3):4);break;case"snowy-rainy":ri(n,20),Ye(n,20,.8,1),gt(n,o?Math.max(i,3):4);break;case"hail":Ye(n,30,1.2,3),ri(n,15),gt(n,o?Math.max(i,4):5);break;case"lightning":ua(n,2,[0,3]),gt(n,o?Math.max(i,5):6);break;case"lightning-rainy":ua(n,3,[0,2,4]),Ye(n,60,1.3,2),gt(n,o?Math.max(i,5):6);break;case"fog":lc(n);break;case"windy":case"windy-variant":gt(n,o?i:3,1.5);break;case"exceptional":pc(n);break;default:o&&i>0&&gt(n,i);break}}catch(i){console.warn(`${Bt} buildConditionFx threw \u2014 atmospheric FX will be partial or absent for this condition. Please share the error below when reporting.`,i)}return n}function Ze(t,e,o){return o===e?0:Math.max(0,Math.min(1,(t-e)/(o-e)))}function si(t,e,o="ellipse"){let n=Math.max(0,Math.min(1,e)),i=Math.round(3+n*50),r=Math.round(2+n*25),s=Math.round(50+n*30),a=l=>l.toString(16).padStart(2,"0");return`radial-gradient(${o} at 50% 30%, ${t}${a(i)} 0%, ${t}${a(r)} ${s}%, transparent 90%)`}function fa(t,e=6,o=1.2){let n=Math.max(0,Math.min(1,t));return e-n*(e-o)}function ga(t,e){let o=Math.max(0,Math.min(1,e)),n=Math.round(4+o*20),i=Math.round(o*8),s=Math.round((.15+o*.55)*255).toString(16).padStart(2,"0");return`0 0 ${n}px ${i}px ${t}${s}`}function va(t,e="0,0,0"){let o=Math.max(0,Math.min(1,t));if(o<.1)return"";let n=Math.round(60-o*30),i=(o*.5).toFixed(2);return`radial-gradient(ellipse at center, transparent ${n}%, rgba(${e},${i}) 100%)`}function ba(t,e=8,o=2){let n=Math.max(0,Math.min(1,t));return e-n*(e-o)}var dc="#a83d2a",wa="#7a2d20",ae="#fdf6e3",uc='<svg viewBox="0 0 40 40" width="38" height="38" aria-hidden="true">',mc="</svg>";function ya(t){let e=["day","cloudy","rain","night"].includes(t)?t:"day",n=`<circle class="mc" cx="20" cy="20" r="18" fill="${e==="night"?wa:dc}" opacity="0.92"/>`,i=`<line class="mh" x1="6" y1="22" x2="34" y2="22" stroke="${ae}" stroke-width="0.8" opacity="0.85"/>`,r="";return e==="day"?r=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.95"/>`:e==="cloudy"?r=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.45"/>`:e==="rain"?r=[`<line class="mg" x1="14" y1="11" x2="13" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="20" y1="11" x2="19" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="26" y1="11" x2="25" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`].join(""):e==="night"&&(r=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.95"/><circle class="md-cut" cx="21.4" cy="13.4" r="1.8" fill="${wa}"/>`),`${uc}${n}${i}${r}${mc}`}function _t(t,e){return e?"night":["rainy","pouring","snowy","snowy-rainy","hail","lightning-rainy"].includes(t)?"rain":["cloudy","fog"].includes(t)?"cloudy":"day"}var P={kicker(t){return`<div class="pw-t-kicker">${h(t)}</div>`},heroTier(t,{flavor:e="aqi",color:o=""}={}){let n=e==="atmos"?"pw-t-hero-tier-atmos":"pw-t-hero-tier-aqi",i=o?` style="color:${S(o)}"`:"";return`<div class="pw-t-hero-tier ${n}"${i}>${h(t)}</div>`},display(t,{color:e="",suffix:o=""}={}){let n=e?` style="color:${S(e)}"`:"",i=o?`<span class="pw-t-display-suf">${h(o)}</span>`:"";return`<div class="pw-t-display"${n}>${h(String(t))}${i}</div>`},narrative(t){return`<div class="pw-t-narrative">${h(t)}</div>`},gloss(t){return`<div class="pw-t-gloss">${h(t)}</div>`},meta(t){return`<div class="pw-t-meta">${h(t)}</div>`},chartCaption(t){return`<div class="pw-t-chart-caption">${h(t)}</div>`},stat(t,e,{data:o=!1,valueColor:n=""}={}){let i=n?` style="color:${S(n)}"`:"",r=o?"pw-t-stat-l pw-t-data":"pw-t-stat-l";return`<div class="pw-t-stat"><div class="pw-t-stat-v"${i}>${h(String(t))}</div><div class="${r}">${h(e)}</div></div>`},statLabel(t){return`<span class="pw-t-stat-l">${h(t)}</span>`},dataToken(t){return`<span class="pw-t-data">${t}</span>`},heroBlock({tier:t="",tierFlavor:e="aqi",tierColor:o="",value:n="",valueSuffix:i="",valueColor:r="",narrative:s=""}={}){let a=t?this.heroTier(t,{flavor:e,color:o}):"",l=n!==""?this.display(n,{color:r,suffix:i}):"",p=s?this.narrative(s):"";return`<div class="pw-hero-block">${a}${l}${p}</div>`},statsRow(t,{columns:e=4,divided:o=!1}={}){let n=t.filter(Boolean);return n.length?`<div class="pulse-stats-row" data-cols="${e}"${o?' data-divided="true"':""}>${n.join("")}</div>`:""}};function mt({sectionClass:t,ariaLabel:e,brandVariant:o,kicker:n="",narrative:i="",preContent:r="",extraSectionClass:s="",sectionStyle:a="",body:l,proView:p="",proInitial:c=!1,proAction:u="view-swap",proAriaLabel:m="Toggle pro view",pro:d=!0}){d===!1&&(p="",u="view-swap",c=!1);let f=a?` style="${a}"`:"",g=`pw-section pw-cartouche ${t}${s?` ${s}`:""}`,w=ya(o),v=[n?P.kicker(n):"",i?P.narrative(i):""].filter(Boolean).join(""),b=v?`<div class="pw-t-marg">${v}</div>`:"",y=!!p,_=y||u!=="view-swap",$=y?`<div class="pw-view pw-view-default">${l}</div><div class="pw-view pw-view-pro">${p}</div>`:l,C=c?"true":"false",E=_?`<button class="pw-brand-mark-corner" aria-label="${h(m)}" aria-pressed="${C}" type="button">${w}</button>`:`<div class="pw-brand-mark-corner" aria-hidden="true">${w}</div>`;return`
    <div class="${g}" data-pro="${C}" data-pro-action="${u}"${f} role="region" aria-label="${h(e)}">
      ...
      <div class="pw-content">
        ...
        </div>`,q=P.heroBlock({tier:v.label,tierFlavor:"atmos",tierColor:"var(--pw-vermilion)",narrative:E}),H=[l?P.stat(`${Math.round(s)}`,"cape J/kg"):"",p?P.stat(a.toFixed(1),"lifted idx"):"",m.value!==null?P.stat(`${Math.round(m.value)}`,`shear ${m.unit||"km/h"}`):"",d.value!==null?P.stat(d.value.toFixed(1),`lapse ${d.unit||"\xB0C/km"}`):""],V=P.statsRow(H,{columns:4,divided:!0}),L=`
        ${q}
        ${B}
        ${V}`;return mt({sectionClass:"pw-atmosphere-v2",ariaLabel:"Atmospheric stability",brandVariant:y,kicker:"atmospheric stability",body:L,pro:e?.pro!==!1})}function Sa(t){let e=t.getHours();return e>=6&&e<12?"this morning":e>=12&&e<17?"this afternoon":e>=17&&e<21?"this evening":"tonight"}function Sc(t,e){return t==="sunny"||t==="clear-night"?"Clear skies":t==="rainy"||t==="pouring"?"Rain":t==="snowy"||t==="snowy-rainy"?"Snow":t==="lightning"||t==="lightning-rainy"?"Storms":t==="fog"?"Fog":e>=88?"Overcast":e>=50?"Mostly cloudy":e>=12?"Some sun":"Sunny"}function kc(t){let e=t.slots.slice(0,6);if(e.length===0)return null;let o=Number(e[e.length-1].cloud_coverage),n=Number.isFinite(o)?o-t.cloudCoverNow:0,i=e.reduce((p,c)=>Math.max(p,Number(c.precipitation_probability)||0),0),r=e.reduce((p,c)=>Math.max(p,Number(c.snowfall)||0),0),a=e.reduce((p,c)=>Math.max(p,Number(c.wind_speed)||0),t.windSpeed)-t.windSpeed;return["moderate","high"].includes(t.stabilityState)?"with thunderstorms developing":i>=60?r>0?"with snow likely":"with rain likely":i>=40?r>0?"with snow possible":"with a brief shower or two":n>=30?"then increasing clouds":n<=-30?"then clearing":a>=8?"with wind firming":null}function ka(t){let e=Sc(t.conditionNow,Number(t.cloudCoverNow)||0),o=kc(t),n=o?Sa(t.now):null,i;return o?o.startsWith("then ")?i=`${e}, ${o} ${n}.`:i=`${e}, then ${o} ${n}.`:i=`${e} ${Sa(t.now)}.`,{initial:e,transition:o,anchor:n,sentence:i}}var Tc={sunny:"linear-gradient(180deg, #1a4a7a 0%, #2a6aaa 40%, transparent 100%)","clear-night":"linear-gradient(180deg, #050510 0%, #0a0a1a 50%, transparent 100%)",partlycloudy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",cloudy:"linear-gradient(180deg, #2a2a3a 0%, #3a3a4a 50%, transparent 100%)",rainy:"linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",pouring:"linear-gradient(180deg, #0a1a2a 0%, #1a2a3a 50%, transparent 100%)",snowy:"linear-gradient(180deg, #2a3040 0%, #3a4050 50%, transparent 100%)","snowy-rainy":"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",hail:"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",lightning:"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)","lightning-rainy":"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)",fog:"linear-gradient(180deg, #2a2a2e 0%, #3a3a3e 50%, transparent 100%)",windy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)","windy-variant":"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",exceptional:"linear-gradient(180deg, #4a2a1a 0%, #6a3a1a 40%, transparent 100%)"},Ac="linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",Ta={dry:"#30d158",comfortable:"#30d158",slightly_humid:"#ffd60a",humid:"#ff9f0a",oppressive:"#ff453a",clear:"#30d158",good:"#30d158",moderate:"#ffd60a",poor:"#ff9f0a",fog:"#ff453a"};function Cc(t){return t<=30?"#5ac8fa":t<=60?"#30d158":t<=80?"#ff9f0a":"#ff453a"}function Mc(t,e){if(t==null)return"Press";let o=Math.abs(Number(t));if(o<=1)return"Press";let n=e==="rising"?"Rising":e==="falling"?"Falling":"Press";return o>3?`${n} rapidly`:n}function Ec(t,e,o){let n=t.map(c=>{let u=Number(c.cape);return Number.isFinite(u)?u:0}),i=Math.max(...n,300),r=Math.max(...n),s=n.indexOf(r),l=n.map((c,u)=>({x:u/Math.max(t.length-1,1)*e,y:o-c/i*o})).map((c,u)=>`${u===0?"M":"L"}${c.x.toFixed(1)},${c.y.toFixed(1)}`).join(" "),p=`${l} L${e},${o} L0,${o} Z`;return{svgPath:l,areaPath:p,peakValue:r,peakIndex:s,maxCape:i}}function Fc(t,e,o,n,i,r,s,a){let l=[];return s>0&&l.push({name:"Snow",value:s,unit:a}),o>0&&l.push({name:"Rain",value:o,unit:n}),i>0&&l.push({name:"Showers",value:i,unit:r}),l.length>0?`${l.map(c=>`${h(c.name)} ${h(c.value.toFixed(1))} ${h(c.unit)}`).join(" \xB7 ")} now`:t>0?`Precipitation \u2014 next 12h \xB7 ${h(t.toFixed(1))} ${h(e)} now`:"Precipitation \u2014 next 12h"}function Uo(t){return!t||isNaN(t.getTime())?"":dt(t)}function Aa({hass:t,config:e,discovery:o,weatherEntity:n,forecastData:i}){let r=n.attributes,s=o.atmosCe,a=o.sunEntityId||"",{condition:l,isNight:p}=Oo(t,n,o),c=(K,J)=>Do(t,s,r,K,J),u=(K,J)=>aa(t,s,K,J),m=c("temperature","temperature"),d=c("apparent_temperature","apparent_temperature")||m,f=c("humidity","humidity"),g=c("wind_speed","wind_speed"),w=c("wind_direction","wind_bearing"),v=c("wind_gusts","wind_gust_speed")||c("wind_gusts","wind_gusts"),b=c("dew_point","dew_point"),y=c("visibility","visibility"),_=c("pressure","pressure"),$=u("temperature","\xB0C"),C=u("visibility","km"),E=u("pressure","hPa"),M=u("dew_point","\xB0C"),F=i?.daily,I=i?.hourly,k=r.forecast,x=m,A=m;if(F&&F.length>0){let K=F[0],J=Number(K.templow),j=Number(K.temperature);Number.isFinite(J)&&Number.isFinite(j)&&(x=Math.min(J,j),A=Math.max(J,j))}else if(I&&I.length>0){let K=Date.now(),J=new Date;J.setHours(23,59,59,999);let j=J.getTime(),ct=1/0,pt=-1/0;for(let Wt of I.slice(0,24)){let kt=Date.parse(String(Wt.datetime??""));if(Number.isFinite(kt)&&(kt<K||kt>j))continue;let ot=Number(Wt.temperature);Number.isFinite(ot)&&(ot<ct&&(ct=ot),ot>pt&&(pt=ot))}Number.isFinite(ct)&&Number.isFinite(pt)&&ct!==pt&&(x=Math.min(ct,m),A=Math.max(pt,m))}else if(k&&k.length>0){let K=k[0],J=Number(K.templow),j=Number(K.temperature);Number.isFinite(J)&&Number.isFinite(j)&&(x=Math.min(J,j),A=Math.max(J,j))}let T=o.atmosCe.uv_index,z=T?Number(t.states[T]?.state)||0:Number(r.uv_index??0),{value:O,unit:W}=Fe(t,s.precipitation),R=W||"mm",{value:N,unit:B}=Fe(t,s.rain),{value:q,unit:H}=Fe(t,s.showers),{value:V,unit:L}=Fe(t,s.snowfall),D=B||"mm",U=H||"mm",G=L||"cm",{value:tt,entity:et}=Fe(t,s.uv_index_clear_sky),lt=s.dew_point_comfort?t.states[s.dew_point_comfort]:null,vt=s.visibility_category?t.states[s.visibility_category]:null,St=s.feels_like_context?t.states[s.feels_like_context]:null,it=s.pressure_trend?t.states[s.pressure_trend]:null,Mt=new Date,bt=a?t.states[a]:null,Zo=bt?.attributes?.next_rising,Ko=bt?.attributes?.next_setting,{todaySunrise:ze,todaySunset:ee,tomorrowSunrise:Re}=Ie(Mt,Zo,Ko),Lt=null;o.atmosCe.cloud_cover&&(Lt={total:Number(t.states[o.atmosCe.cloud_cover]?.state)||0,low:Number(t.states[o.atmosCe.cloud_cover_low]?.state)||0,mid:Number(t.states[o.atmosCe.cloud_cover_mid]?.state)||0,high:Number(t.states[o.atmosCe.cloud_cover_high]?.state)||0});let le=s.freezing_level_height?t.states[s.freezing_level_height]:null,to=le&&Number(le.state)||0,ce=(s.stability_assessment?t.states[s.stability_assessment]:null)?.state||"",He=s.lifted_index?t.states[s.lifted_index]:null,zt=He&&Number(He.state)||0,eo=S(Tc[l]||Ac),Jo=Math.max(A-x,1),bp=Math.max(0,Math.min(100,(m-x)/Jo*100)),hi=qo(w),es=`data-condition="${h(l)}" data-night="${p}" data-cloud='${h(JSON.stringify(Lt||""))}'`,os=Ze(m,20,42),ns=Ze(m,15,-10),Qo=Math.max(os,ns),is=Qt(m),wp=Qo>.05?`text-shadow: 0 2px 20px rgba(0,0,0,0.3), ${ga(is,Qo)}`:"text-shadow: 0 2px 20px rgba(0,0,0,0.3)",fi=va(Qo),rs=fi?`<div class="pw-tension-vignette" style="background: ${S(fi)}"></div>`:"",yp=V>0?`<div class="pw-snow-badge" style="color:var(--pw-color-freeze, #5ac8fa)">\u2744 ${h(V.toFixed(1))} ${h(G)}</div>`:"",gi=St?.state||"",pe=St?.attributes?.difference,oo="";gi==="wind_chill"&&pe!==null&&pe!==void 0?oo=`<div class="pw-feels-context">Wind chill ${h(String(Math.round(Number(pe))))}\xB0</div>`:gi==="heat_index"&&pe!==null&&pe!==void 0&&(oo=`<div class="pw-feels-context">Heat index +${h(String(Math.round(Number(pe))))}\xB0</div>`);let as=["marginal","slight","enhanced","moderate","high"],ss="";if(ce&&as.includes(ce)){let K=li[ce];if(K){let J=S(K.color),j=`\u26A1 ${h(K.label)}`;if(He&&zt<0){let ct=Ge.find(pt=>zt>=pt.min)||Ge[Ge.length-1];j+=` \xB7 <span style="color:${S(ct.color)}">LI ${h(String(zt))}</span>`}ss=` <span class="pw-stability-badge" style="background:${J}33; color:${J}">${j}</span>`}}let tn=vt?.state||"",_p=tn&&!["unavailable","unknown"].includes(tn)&&Ta[tn]||"",no=lt?.state||"",xp=no&&!["unavailable","unknown"].includes(no)&&Ta[no]||"",vi=it?.attributes?.trend_symbol||"",bi=it?.state==="rising"?"#30d158":it?.state==="falling"?"#ff9f0a":it?.state==="steady"?"#5ac8fa":"",ls=et&&Math.abs(tt-z)>=.5,en=it?.attributes?.change_3h,on=Mc(en!=null?Number(en):null,it?.state||"");if(on==="Press"&&it?.state){let K=it.state;K==="rising"?on="Rising":K==="falling"&&(on="Falling")}let $p=bi||(it?"#5ac8fa":""),cs=la(g),Sp=Bo(g),nn=v>g+5,ps=g>0&&v/g>1.5,ds=nn?ps?` / <b>${h(Math.round(v))}</b>`:` / ${h(Math.round(v))}`:"",us=`<svg width="10" height="10" viewBox="0 0 10 10" style="vertical-align:middle;transform:rotate(${Number(w)||0}deg)"><polygon points="5,0 3,8 5,6 7,8" fill="${S(cs)}" opacity="0.8"/></svg>`,kp=`${h(Math.round(g))}${ds} ${us}${h(hi)}`,Tp=`linear-gradient(to right, ${S(Qt(x))}, ${S(Qt(A))})`,ms="";if(le&&to<5e3&&x<=0){let K=Math.max(0,Math.min(100,(0-x)/Jo*100)),J=le?.attributes?.unit_of_measurement||"m";ms=`<div class="pw-arc-freeze" style="left:${Number(K)}%">
            <div class="pw-arc-freeze-label">\u2744 ${h(String(Math.round(to)))}${h(J)}</div>
            <div class="pw-arc-freeze-line"></div>
          </div>`}let wi="",yi=a?t.states[a]:null;if(yi&&ze&&ee&&Re){let K=Mt.getTime(),J=yi.state==="above_horizon",j,ct,pt,Wt,kt;if(J){let nt=ze.getTime(),xt=ee.getTime(),Gt=Math.max(xt-nt,1);j=Math.max(0,Math.min(100,(K-nt)/Gt*100)),ct=Uo(ze),pt=Uo(ee),Wt="background: linear-gradient(to right, #ff9f0a, #ffd60a)",kt="#ff9f0a"}else{let nt=ee.getTime(),xt=Re.getTime(),Gt=Math.max(xt-nt,1);j=Math.max(0,Math.min(100,(K-nt)/Gt*100)),ct=Uo(ee),pt=Uo(Re),Wt="background: linear-gradient(to right, #1a3050, #5ac8fa)",kt="#5ac8fa"}let ot=`left:${Number(j)}%; background:${S(kt)}; box-shadow: 0 0 6px ${S(kt)}66`,jt=` style="color:${S(kt)}"`,st=J?"1":"0.85",Ut=J?"":"\u{1F319}";wi=`
      ...
      </div>`}let hs="",fs="",gs="",io="",_i=i?.hourly||[];if(_i.length>0){let j=Po(_i,new Date).slice(0,12),ct=j.some(ot=>Number(ot.precipitation_probability)>0),pt=Fc(O,R,N,D,q,U,V,G);if(O>0)io=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        <span style="font-size:14px">\u{1F327}</span> ${pt}
      </div>`;else{let ot=ka({now:new Date,cloudCoverNow:Lt?Lt.total:0,conditionNow:l,slots:j,windSpeed:g,uvIndex:z,stabilityState:ce});io=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        ${h(ot.sentence)}
      </div>`}if(ct){let ot=j.map(Ut=>{let nt=Math.min(100,Math.max(0,Number(Ut.precipitation_probability)||0)),xt=Number(Ut.snowfall)||0,Gt=(Number(Ut.rain)||0)+(Number(Ut.showers)||0),De=xt>0;if(De&&Gt>0){let Cs=xt+Gt,ki=Math.round(nt*xt/Cs),Ms=nt-ki;return`<div class="pulse-precip-slot"><div class="pulse-precip-fill" style="height:${Number(Ms)}%"></div><div class="pulse-precip-fill pw-precip-snow" style="height:${Number(ki)}%"></div></div>`}return`<div class="pulse-precip-slot"><div class="${De?"pulse-precip-fill pw-precip-snow":"pulse-precip-fill"}" style="height: ${nt}%"></div></div>`}).join(""),st=j[Math.floor(j.length/2)]?`+${Math.floor(j.length/2)}h`:"";hs=`
      ...
      </div>`}if(j.some(ot=>Number(ot.cape)>300)){let st=Ec(j,200,24),Ut=st.peakIndex/Math.max(j.length-1,1)*200,nt=st.peakValue>=1e3?`${(st.peakValue/1e3).toFixed(1)}k`:String(Math.round(st.peakValue)),xt=j[st.peakIndex]?.datetime?new Date(j[st.peakIndex].datetime):null,Gt=xt?dt(xt):"",De=Xe("pw-cape-grad");fs=`
      ...
      </div>`}j.some(ot=>ot.dew_point!==void 0&&ot.dew_point!==null)&&(gs=`
      <div style="position: relative; z-index: 2; margin: 2px var(--pulse-space-card-wide) 0;">
        ...
        <div class="pw-comfort-bar">${j.map(jt=>{let st=Number(jt.dew_point)||0;return`<div class="pw-comfort-slot" style="background:${S(pa(st))}"></div>`}).join("")}</div>
      </div>`)}let Ap=Qt(d),Cp=Lt!==null?ca(Lt.total):"",Mp=Cc(f),Ep=`${h(Math.round(_))} ${h(E)}${vi?` <span style="color:${S(bi)}">${h(vi)}</span>`:""}`,Fp=`${h(Math.round(z))}${ls?` <span style="opacity:0.5">/ ${h(String(Math.round(tt)))}</span>`:""}`;function vs(){return dt(new Date)}let bs=da(l),ws=_t(l,p),ys=e?.location_label||"Now",xi=oo?oo.replace(/<[^>]*>/g,"").trim():"",_s=io?io.replace(/<[^>]*>/g,"").trim():"",xs=Lt?Math.round(Lt.total)+"%":"--",$s=`
        <div class="pw-loc-stamp">${h(ys)} \xB7 ${h(vs())}</div>
        <div class="pw-hero-block">
          ${P.display(Math.round(m),{suffix:$})}
          ${P.gloss(`${bs}${xi?" \xB7 "+xi:""}`)}
        </div>`,Ss=P.statsRow([P.stat(`${Math.round(x)}/${Math.round(A)}\xB0`,"range"),P.stat(`${Math.round(g)}${nn?` / ${Math.round(v)}`:""} ${hi}`,nn?"wind / gust":"wind"),P.stat(Math.round(z),"uv"),P.stat(xs,"cloud")],{columns:4}),ro=(i?.daily||[]).slice(0,7),rn="";if(ro.length>=2){let j=ro.map(nt=>Number(nt.temperature)||0),ct=ro.map(nt=>Number(nt.templow??nt.temperature)||0),pt=Math.min(...ct),Wt=Math.max(...j),kt=Math.max(Wt-pt,1),ot=nt=>nt/(ro.length-1)*320,jt=nt=>38-(nt-pt)/kt*34-2,st=j.map((nt,xt)=>`${xt===0?"M":"L"}${ot(xt).toFixed(1)},${jt(nt).toFixed(1)}`).join(" ");rn=`<svg viewBox="0 0 320 38" preserveAspectRatio="none">
      ...
      <div class="pw-fc-row${I?" is-today":""}">
        ...
        <span class="pw-fc-bar" aria-label="High ${Math.round(E)}${h(l)}, low ${Math.round(M)}${h(l)}">
          <span class="pw-fc-bar-fill" style="left:${S(T.toFixed(2)+"%")};width:${S(z.toFixed(2)+"%")}"></span>
          ${O}
        </span>
      ...
      </div>`}).join(""),{condition:w,isNight:v}=Oo(t,i,o),b=_t(w,v),y=Ic(p),_=`
        <div class="pw-fc-list" role="list">
          ${g}
        </div>`;return mt({sectionClass:"pw-forecast-v2",ariaLabel:"Seven-day forecast",brandVariant:b,kicker:"the week ahead",narrative:y,body:_,pro:e?.pro!==!1})}var Ne=240,qt=Ne/2,Vt=Ne/2,Ke=90,Ma=.12,jo=6,Go=.5,Ea=.25,Nc=.3,Lc=6,Fa=.7,zc=.2,Rc=4,Hc=3.3,Dc=15,Oc=35,Pc=.08,Bc=.2,qc=[{l:"N",a:0},{l:"NE",a:45},{l:"E",a:90},{l:"SE",a:135},{l:"S",a:180},{l:"SW",a:225},{l:"W",a:270},{l:"NW",a:315}];function Ia(t){return(t-90)*Math.PI/180}function Vc(t){let e=t*Math.PI/180;return{x:Math.sin(e),y:-Math.cos(e)}}function te(t,e){return{x:qt+e*Math.cos(t),y:Vt+e*Math.sin(t)}}function Wc(t,e,o,n){let i=Math.min(t/Ee,1)*Ke,r=te(e-Ea,i),s=te(e+Ea,i),a=o>Nc?"pw-gust-sweep":"",l=Math.max(.6,2.5-o*2).toFixed(2),p=(.15+o*.3).toFixed(2),c=`transform-origin:${qt}px ${Vt}px;--gust-dur:${l}s;--gust-peak:${p}`;return Ct("path",{class:a,d:`M${qt},${Vt} L${r.x.toFixed(1)},${r.y.toFixed(1)} L${s.x.toFixed(1)},${s.y.toFixed(1)} Z`,fill:n,opacity:.15,style:c})}function Uc(t,e,o,n){let i=Math.min(t/Ee,1)*Ke,r=te(e,i),s=te(e-Ma,i*.7),a=te(e+Ma,i*.7),l={x:r.x-jo*Math.cos(e-Go),y:r.y-jo*Math.sin(e-Go)},p={x:r.x-jo*Math.cos(e+Go),y:r.y-jo*Math.sin(e+Go)},c=o*Lc,u=Math.max(.4,4-o*3.6),m=c>zc?`animation:pw-arrowSway ${u.toFixed(2)}s ease-in-out infinite;--sway-fwd:${(c*Fa).toFixed(2)}deg;--sway-back:${(-c*(1-Fa)).toFixed(2)}deg`:"",d=`transform-origin:${qt}px ${Vt}px;filter:drop-shadow(0 0 6px ${Xt(n,.38)});${m}`,f=Ct("path",{d:`M${qt},${Vt} L${s.x.toFixed(1)},${s.y.toFixed(1)} L${r.x.toFixed(1)},${r.y.toFixed(1)} L${a.x.toFixed(1)},${a.y.toFixed(1)} Z`,fill:n,opacity:.5}),g=Ct("line",{x1:qt,y1:Vt,x2:r.x.toFixed(1),y2:r.y.toFixed(1),stroke:n,"stroke-width":2.5,"stroke-linecap":"round"}),w=Ct("path",{d:`M${r.x.toFixed(1)},${r.y.toFixed(1)} L${l.x.toFixed(1)},${l.y.toFixed(1)} L${p.x.toFixed(1)},${p.y.toFixed(1)} Z`,fill:n});return Ct("g",{style:d},f+g+w)}function Na({hass:t,config:e,discovery:o,weatherEntity:n}){let i=n.attributes,r=o.atmosCe,s=e.speed_mode||"speed",a=(L,D)=>Do(t,r,i,L,D),l=a("wind_speed","wind_speed"),p=a("wind_gusts","wind_gust_speed")||a("wind_gusts","wind_gusts")||l,c=a("wind_direction","wind_bearing"),m=(r.wind_speed?t.states[r.wind_speed]:null)?.attributes?.unit_of_measurement||i.wind_speed_unit||"km/h",d=s==="gust"?p:l,f=Math.min(l/Ee,1),g=Bo(d),w=ii(d),v=Me[w]||Me.calm,b=qo(c),y=Ia(c),_=Vc(c),$=Math.round(f*Br),C=Rc-f*Hc,E=Pc+f*Bc,M=Dc+f*Oc,F=-_.y,I=_.x,k=[];for(let L=0;L<$;L++){let D=(Math.random()-.5)*400,U=-120-Math.random()*60,G=420+Math.random()*60,tt=(M*(.6+Math.random()*.8)).toFixed(1),et=(C+Math.random()*C*.5).toFixed(2),lt=(Math.random()*3).toFixed(2),vt=(E*(.5+Math.random()*.5)).toFixed(3),St=(U*_.x+D*F).toFixed(1),it=(U*_.y+D*I).toFixed(1),Mt=(G*_.x+D*F).toFixed(1),bt=(G*_.y+D*I).toFixed(1);k.push(`<div class="pw-streak" style="left:50%;top:50%;width:${tt}px;height:1px;transform:rotate(${c-90}deg);animation-duration:${et}s;animation-delay:${lt}s;opacity:${vt};background:linear-gradient(to right, transparent, ${Xt(v,.27)}, transparent);--sx:${St}px;--sy:${it}px;--ex:${Mt}px;--ey:${bt}px"></div>`)}let x=[];for(let L=1;L<=3;L++)x.push(Ct("circle",{cx:qt,cy:Vt,r:L*30,fill:"none",stroke:v,"stroke-width":.5,opacity:.08+L*.02}));for(let L of qc){let D=Ia(L.a),U=te(D,20),G=te(D,Ke+4),tt=te(D,Ke+16),et=L.l.length===1;x.push(Ct("line",{x1:U.x.toFixed(1),y1:U.y.toFixed(1),x2:G.x.toFixed(1),y2:G.y.toFixed(1),stroke:v,"stroke-width":.5,opacity:.12})),x.push(Ct("text",{x:tt.x.toFixed(1),y:tt.y.toFixed(1),"text-anchor":"middle","dominant-baseline":"central",fill:et?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.3)","font-size":et?11:9,"font-weight":et?600:400},h(L.l)))}x.push(Wc(p,y,f,v)),x.push(Uc(d,y,f,v)),(d>Ee||p>Ee)&&x.push(Ct("circle",{cx:qt,cy:Vt,r:Ke+2,fill:"none",stroke:"#ff453a","stroke-width":1.5,"stroke-dasharray":"4 4",opacity:.7})),x.push(Ct("circle",{cx:qt,cy:Vt,r:18,fill:v,opacity:.06})),x.push(Ct("circle",{cx:qt,cy:Vt,r:3,fill:v}));let T=f>Jn?(f-Jn)*5:0,z=Math.max(.15,.4-f*.25),O="";T>.1&&(O=`--dx:${(T*_.x).toFixed(2)}px;--dy:${(T*_.y).toFixed(2)}px;animation:pw-roseShake ${z.toFixed(2)}s ease-in-out infinite`);let W=Math.round(12+f*50).toString(16).padStart(2,"0"),R=Math.round(6+f*25).toString(16).padStart(2,"0"),N=sa(`radial-gradient(ellipse at 50% 50%, ${v}${W} 0%, ${v}${R} 40%, transparent 85%)`),B=_t(n?.state||"sunny",!1),q=s==="gust",H=q?"wind \xB7 gust":"wind",V=`
        ...
        ${I}
        ${k}
        ${x}`;return mt({sectionClass:"pw-air-quality-v2",ariaLabel:"Air quality index",brandVariant:$,kicker:F,body:A,proAction:"aqi-scale",proInitial:C,proAriaLabel:"Toggle EU and US AQI scale",pro:e.pro!==!1})}function Xc(t){let e=(t%yt+yt)%yt;return Qr[Math.floor(e/yt*8)%8]}function Yc(t){return(t%yt+yt)%yt<yt/2}var ci=864e5;function It(t){return!t||isNaN(t.getTime())?"--:--":t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})}function Zc(t,e,o,n,i){if(n==null)return`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#c8d0e0"/>`;let r=Math.max(0,Math.min(1,n/100)),s=i!=null?Yc(i):!0,a=`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#2a2a3a"/>`;if(r>=.99)a+=`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#e8e0d0"/>`;else if(r>.01){let l=e-o,p=e+o,c=(o*Math.abs(2*r-1)).toFixed(1),u=r>.5?1:0,m;s?m=`M${t.toFixed(1)},${l.toFixed(1)} A${o},${o} 0 0 1 ${t.toFixed(1)},${p.toFixed(1)} A${c},${o} 0 0 ${u} ${t.toFixed(1)},${l.toFixed(1)} Z`:m=`M${t.toFixed(1)},${l.toFixed(1)} A${o},${o} 0 0 0 ${t.toFixed(1)},${p.toFixed(1)} A${c},${o} 0 0 ${1-u} ${t.toFixed(1)},${l.toFixed(1)} Z`,a+=`<path d="${m}" fill="#e8e0d0"/>`}return a}var Xo="#050510",Ra="#0a1226",Ha="#172b4f",Da="#1f3d6e",Oa="#3a6fa8",Pa="#d97a3a",Ba="#ff9f0a",qa="#ffc560",Va="#7eaedb",Wa="#2c5a8e",Ua="#ffd60a";function Kc(t,e,o,n,i,r,s,a,l,p){let c=new Date(t.getTime());c.setHours(0,0,0,0);let u=t.getTime(),m=e.getTime(),d=(o??new Date(u-35*6e4)).getTime(),f=(n??new Date(u-30*6e4)).getTime(),g=(i??new Date(u-6*6e4)).getTime(),w=(r??new Date(u+30*6e4)).getTime(),v=(s??new Date(m-30*6e4)).getTime(),b=(a??new Date(m+6*6e4)).getTime(),y=(l??new Date(m+30*6e4)).getTime(),_=(p??new Date(m+35*6e4)).getTime(),$=(u+m)/2,C=A=>Math.max(0,Math.min(100,A)),E=A=>C((A-c.getTime())/ci*100),M=(A,T)=>E((A+T)/2),F=Math.min(60,(m-u)/8)*6e4,I=$-F,k=$+F;return`linear-gradient(to right, ${[`${Xo} 0%`,`${Xo} ${E(d).toFixed(2)}%`,`${Ra} ${M(d,f).toFixed(2)}%`,`${Ha} ${E(f).toFixed(2)}%`,`${Da} ${M(f,g).toFixed(2)}%`,`${Oa} ${E(g).toFixed(2)}%`,`${Pa} ${M(g,u).toFixed(2)}%`,`${Ba} ${E(u).toFixed(2)}%`,`${qa} ${M(u,w).toFixed(2)}%`,`${Va} ${E(w).toFixed(2)}%`,`${Wa} ${M(w,I).toFixed(2)}%`,`${Ua} ${E(I).toFixed(2)}%`,`${Ua} ${E(k).toFixed(2)}%`,`${Wa} ${M(k,v).toFixed(2)}%`,`${Va} ${E(v).toFixed(2)}%`,`${qa} ${M(v,m).toFixed(2)}%`,`${Ba} ${E(m).toFixed(2)}%`,`${Pa} ${M(m,b).toFixed(2)}%`,`${Oa} ${E(b).toFixed(2)}%`,`${Da} ${M(b,y).toFixed(2)}%`,`${Ha} ${E(y).toFixed(2)}%`,`${Ra} ${M(y,_).toFixed(2)}%`,`${Xo} ${E(_).toFixed(2)}%`,`${Xo} 100%`].join(", ")})`}function ja(t){if(!t||isNaN(t)||t<=0)return"--";let e=Math.round(t/6e4),o=Math.floor(e/60),n=e%60;return`${o}h ${String(n).padStart(2,"0")}m`}function Ga({hass:t,config:e,discovery:o}){let n=new Date,i=o.sunEntityId?t.states[o.sunEntityId]:null;if(!i)return null;let r=i.attributes||{},s=r.next_rising||r.sunrise,a=r.next_setting||r.sunset;if(!s||!a)return null;let l=new Date(n);l.setHours(12,0,0,0);let p=ft(new Date(s),l),c=ft(new Date(a),l);if(!p||!c||isNaN(p.getTime())||isNaN(c.getTime()))return null;let u=o.atmosCe,m=zt=>u[zt]?new Date(String(t.states[u[zt]]?.state)):null,d=ft(m("golden_hour_morning_start"),p),f=ft(m("golden_hour_morning_end"),p),g=ft(m("blue_hour_morning_start"),p),w=ft(m("golden_hour_evening_start"),c),v=ft(m("golden_hour_evening_end"),c),b=ft(m("blue_hour_evening_end"),c),y=r.next_dawn,_=r.next_dusk,$=y?ft(new Date(y),p):null,C=_?ft(new Date(_),c):null,E=u.moon_phase?t.states[u.moon_phase]:null,M=E?.attributes||{},F=M.moon_age!==void 0?Number(M.moon_age):null,I=M.illumination!==void 0?Number(M.illumination):null,k=F!==null?Xc(F):E?.state||null,x=ft(m("moonrise"),n),A=ft(m("moonset"),n),T=n.getTime()>=p.getTime()&&n.getTime()<=c.getTime(),z=It(p),O=It(c),W=(p.getTime()+c.getTime())/2,R=It(new Date(W)),N=c.getTime()-p.getTime(),B=ci-N,q=ja(N),H=ja(B),V=T?"Daylight":"Night",L=T?q:H,D=new Date(p.getTime());D.setHours(0,0,0,0);let U=Math.max(0,Math.min(100,(n.getTime()-D.getTime())/ci*100)),G=Kc(p,c,$,g,d,f,w,v,b,C),et=`
      ...
      </div>`,lt=I!=null?Math.round(I):null,vt=k||"Moon",St=Zc(24,24,22,I,F),it=lt!==null?`<span class="pw-astro-moon-illum">${h(`${lt}%`)}</span> illuminated`:"",Mt=F!=null?`${F.toFixed(1)}d old`:"",bt=F!=null?(()=>{let zt=yt/2,eo=(F%yt+yt)%yt;return`${(eo<=zt?zt-eo:yt-eo+zt).toFixed(1)}d to full`})():"",Zo=[it,Mt,bt].filter(Boolean).join(" \xB7 "),Ko=`
      ...
      </div>`,ze=T?`Sun rose ${z}, sets ${O} \xB7 solar noon ${R}.`:`Sun set ${O}, rises ${z} \xB7 solar noon ${R}.`,ee=`
      <div class="pw-astro-hero">
        <div class="pw-astro-hero-tier">${h(V)}</div>
        <div class="pw-astro-hero-num">${h(L)}</div>
      </div>
      ${P.narrative(ze)}`,Re=It(x),Lt=It(A),le=P.statsRow([P.stat(It($),"civil dawn"),P.stat(It(d),"golden start",{valueColor:"var(--pw-warn-amber)"}),P.stat(It(g),"blue start",{valueColor:"var(--pw-wind)"}),P.stat(Re,"moonrise")],{columns:4,divided:!0}),to=P.statsRow([P.stat(It(C),"civil dusk"),P.stat(It(v),"golden end",{valueColor:"var(--pw-warn-amber)"}),P.stat(It(b),"blue end",{valueColor:"var(--pw-wind)"}),P.stat(Lt,"moonset")],{columns:4,divided:!0}),mi=`
      ${ee}
      ${Ko}
      ${et}
      ${le}
      ${to}`,ce=_t(T?"sunny":"clear-night",!T),He=`<div class="pw-fx" data-astro-stars="${!T}" data-astro-day="${T}" role="img" aria-label="Sky atmospheric effects"></div>`;return mt({sectionClass:"pw-astro-v2",extraSectionClass:T?"":"is-night",ariaLabel:"Astronomy: sun and moon",brandVariant:ce,kicker:"today's sky",preContent:He,body:mi,pro:e?.pro!==!1})}var Xa=18,Jc=62,Ya=168;function Qc(t){return t.active?0:typeof t.hoursUntil=="number"&&t.hoursUntil>0?t.hoursUntil:0}function Za(t){let e=Math.min(Qc(t),Ya)/Ya;return Xa+e*(Jc-Xa)}function pi(t){let e=`${t.summary||""}|${t.type||""}|${t.endTime||""}`,o=0;for(let n=0;n<e.length;n+=1)o=(o*31+e.charCodeAt(n))%360;return o/360*2*Math.PI}function tp(t,e){let o=t.alert_type||t.type||"wind",n=Number(t.level),i=Number.isFinite(n)&&n>0?n:1,r=typeof t.severity=="string"?t.severity.toLowerCase():"",s=Xr[r]||ei[i]||ei[1],a=Gr[o]||"mdi:alert",l=Number(t.progress)||0,p=Array.isArray(t.locations)?t.locations:[],c=t.end_time??"",u=null,m=null,d=!1;if(c==="")d=!0;else if(c){let f=new Date(c),g=new Date,w=f.getTime()-g.getTime();if(w/(1e3*60*60*24)>Ur)d=!0;else if(e)u=Math.max(0,w/(1e3*60*60));else{let b=t.start_time||t.datetime;if(b){let y=new Date(String(b));m=Math.max(0,(y.getTime()-g.getTime())/(1e3*60*60))}}}return{type:o,icon:a,severity:i,color:s,summary:String(t.headline||t.summary||""),desc:String(t.description||""),active:e,hoursLeft:u,hoursUntil:m,progress:l,locations:p,link:t.link?String(t.link):null,endTime:String(c),isUntilFurtherNotice:d}}function ep(t){let e=t.severity>=4?"red":"amber",o="";t.isUntilFurtherNotice?o="UNTIL FURTHER NOTICE":t.active&&t.hoursLeft!==null?o=`${Math.round(t.hoursLeft)}H LEFT`:t.hoursUntil!==null?o=`IN ${Math.round(t.hoursUntil)}H`:t.active&&(o="ACTIVE");let n=String(t.type||"").toUpperCase(),i=String(t.summary||t.desc||"").toUpperCase().trim(),r=t.locations.length>0?t.locations.join(", ").toUpperCase():"",a=[o,n,i,r].filter(Boolean).join(" \xB7 ");return`
    <div class="pw-alert-ticker pw-alert-${e}">
      <span class="pw-alert-tri">\u25B6</span>
      <span class="pw-alert-text">${h(a)}</span>
    </div>`}function Ka({hass:t,config:e,discovery:o,proPersisted:n=!1}){let i=[];for(let T of o.alertEntityIds){let O=t.states[T]?.attributes?.all_alerts;if(Array.isArray(O)){for(let W of O)i.push(tp(W,W.active===!0));break}}let r=i.length>0,s=r?i.reduce((T,z)=>z.severity>T.severity?z:T,i[0]).severity:0,a=r?i.reduce((T,z)=>z.severity>T.severity?z:T,i[0]).color:"#30d158",l=Ze(s,0,4),p=r?Math.min(1.5,1+(i.length-1)*.15):1,c=ba(l,3,1.2).toFixed(2),u=fa(l).toFixed(2),m=r?si(a,l*p):si("#30d158",.08),d=140,f=d/2,g=d/2,w=r?{bgInner:s>=4?"#1a0000":s>=3?"#1a0e00":"#1a1500",bgOuter:s>=4?"#0a0000":s>=3?"#0a0500":"#0a0800",ring:S(Xt(a,.15)),line:S(Xt(a,.08)),sweep:S(Xt(a,.4))}:{bgInner:"#001a00",bgOuter:"#000800",ring:"rgba(80,255,0,0.15)",line:"rgba(80,255,0,0.08)",sweep:"rgba(80,255,0,0.35)"},v=i.map(T=>{let z=f+Math.cos(pi(T))*Za(T),O=g+Math.sin(pi(T))*Za(T),W=(pi(T)/(2*Math.PI)*Number(c)).toFixed(2);return T.active?`<div class="pw-radar-blip" style="left:${z.toFixed(1)}px;top:${O.toFixed(1)}px;--pw-blip-color:${S(T.color)};animation-delay:${W}s"></div>`:`<div style="position:absolute;left:${z.toFixed(1)}px;top:${O.toFixed(1)}px;width:4px;height:4px;border-radius:var(--pulse-radius-circle);background:${S(T.color)};opacity:0.2;transform:translate(-50%,-50%)"></div>`}).join(""),b=`
    <div style="display:flex;justify-content:center;padding:12px var(--pulse-space-card-wide);position:relative;z-index:2">
      <div class="pw-radar" style="--pw-radar-bg-inner:${w.bgInner};--pw-radar-bg-outer:${w.bgOuter};--pw-radar-color:${w.ring};--pw-radar-line:${w.line};--pw-radar-sweep:${w.sweep};--pw-radar-dur:${c}s" role="img" aria-label="${r?`${i.length} weather alerts`:"No weather alerts"}">
        ...
        ${C}
        ${x}
        ${M}`:void 0;return mt({sectionClass:"pw-alerts-v2",extraSectionClass:F,ariaLabel:"Weather alerts",brandVariant:_,kicker:r?`weather alerts (${i.length})`:"no weather alerts",preContent:I,body:k,proView:A,proInitial:n,pro:e?.pro!==!1})}var Nt=600,op=280,Yo=8,di=80,Le=200,Je=220,np=254,Ja=12,ip=30,rp=.9,ap=3;function se(t,e){return e<=1?Nt/2:Yo+t/(e-1)*(Nt-2*Yo)}function Qa(t,e,o){if(!Number.isFinite(t)||!Number.isFinite(e)||!Number.isFinite(o))return(di+Le)/2;let n=o-e||1;return di+(o-t)/n*(Le-di)}function sp(t){try{let e=new Date(t);return isNaN(e.getTime())?"":String(e.getHours()).padStart(2,"0")}catch{return""}}var lp=500;function cp(t,e=24){if(!Array.isArray(t))return null;let o=t.slice(0,lp),i=Po(o,new Date).slice(0,e);if(i.length<2)return null;let r=i[0],s="cloud_cover"in r,a="cloud_cover_low"in r&&"cloud_cover_mid"in r&&"cloud_cover_high"in r,l="wind_speed"in r&&("wind_bearing"in r||"wind_direction"in r),p=i.map(g=>{let w=Number(g.temperature),v=ut(g.precipitation_probability,0),b=ut(g.snowfall,0),y=ut(g.rain,0),_=ut(g.showers,0),$=String(g.condition||""),C=b>0||$==="snowy"||$==="snowy-rainy"?"snow":"rain",E=C==="snow"?b:y+_;return{temp:w,precip:v,precipMm:E,precipType:C,condition:$,cloudCover:s?ut(g.cloud_cover,0):null,cloudLow:a?ut(g.cloud_cover_low,0):null,cloudMid:a?ut(g.cloud_cover_mid,0):null,cloudHigh:a?ut(g.cloud_cover_high,0):null,windSpeed:l?ut(g.wind_speed,0):null,windBearing:l?ut(g.wind_bearing??g.wind_direction,0):null,timeLabel:sp(String(g.datetime||"")),datetime:String(g.datetime||"")}}),c=ra(p,g=>g.temp);if(c.length<2)return null;let u=c.map(g=>g.temp),m=Math.min(...u),d=Math.max(...u),f=Math.max(...c.map(g=>g.precipMm),0);return{points:c,n:c.length,min:m,max:d,minIdx:u.indexOf(m),maxIdx:u.indexOf(d),maxPrecipMm:f,hasCloud:s,hasLayeredCloud:a,hasWind:l}}function pp(t){let{points:e,n:o,hasLayeredCloud:n}=t;if(o<=0)return"";let i=o>1?(Nt-2*Yo)/(o-1)/2:Nt/2,r="";for(let s=0;s<o;s++){let a=se(s,o),l=s===0?0:a-i,c=(s===o-1?Nt:a+i)-l,u=l/Nt*100,m=c/Nt*100,d;if(n){let f=(Number(e[s].cloudHigh)||0)/100*.06,g=(Number(e[s].cloudMid)||0)/100*.08,w=(Number(e[s].cloudLow)||0)/100*.1;d=Math.min(f+g+w,.15)}else d=(Number(e[s].cloudCover)||0)/100*.12;d<=0||(r+=`<div class="pw-meteogram-cloud-slot" style="left:${u.toFixed(2)}%;width:${m.toFixed(2)}%;opacity:${d.toFixed(3)}"></div>`)}return r?`<div class="pw-meteogram-cloud-bg" aria-hidden="true">${r}</div>`:""}function dp(t){let{points:e,n:o,maxPrecipMm:n}=t,i=Je-Le,r=(Nt-2*Yo)/(o-1)*rp,s=n>0,a=s?Math.max(n,2):100,l="";for(let p=0;p<o;p++){let{precipMm:c,precip:u,precipType:m}=e[p],d=s?c:u;if(d<=0)continue;let f=d/a*i,g=se(p,o)-r/2,w=r;g<0&&(w+=g,g=0),g+w>Nt&&(w=Nt-g);let v=Je-f,b=m==="snow"?"rgba(200,220,240,0.45)":"rgba(90,200,250,0.4)";l+=`<rect x="${g.toFixed(1)}" y="${v.toFixed(1)}" width="${w.toFixed(1)}" height="${f.toFixed(1)}" fill="${b}" rx="1"/>`}return l}function up(t){let{points:e,n:o,maxPrecipMm:n}=t,i=Je-Le,r=n>0,s=r?Math.max(n,2):100,a="";for(let l=0;l<o;l++){let{precipMm:p,precip:c}=e[l],u=r?p:c;if(u<=0)continue;let m=se(l,o),d=u/s*i,f=Je-d-2,g=r?p>=10?String(Math.round(p)):p.toFixed(1):`${Math.round(c)}%`;a+=`<text x="${m.toFixed(1)}" y="${f.toFixed(1)}" text-anchor="middle" fill="rgba(90,200,250,0.9)" font-size="13" font-weight="600">${h(g)}</text>`}return a}function mp(t){let{points:e,n:o,min:n,max:i}=t,r=e.map(d=>parseFloat(d.temp.toFixed(1))),s=e.map((d,f)=>({x:se(f,o),y:Qa(r[f],n,i)})),a=s.map((d,f)=>`${f===0?"M":"L"}${d.x.toFixed(1)},${d.y.toFixed(1)}`).join(" "),l=`${a} L${s[s.length-1].x.toFixed(1)},${Le} L${s[0].x.toFixed(1)},${Le} Z`,p=Xe("pw-meteogram-grad"),c=Qt(i),u=Qt(n),m=`<defs><linearGradient id="${p}" x1="0" y1="0" x2="0" y2="1">`;return m+=`<stop offset="0%" stop-color="${S(c)}" stop-opacity="0.25"/>`,m+=`<stop offset="100%" stop-color="${S(u)}" stop-opacity="0.03"/>`,m+="</linearGradient></defs>",m+=`<path d="${l}" fill="url(#${p})"/>`,m+=`<path d="${a}" fill="none" stroke="rgba(255,255,255,0.7)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>`,m}function hp(t){let{points:e,n:o}=t,n="";for(let i=0;i<o;i+=ap){let r=se(i,o);n+=`<text x="${r.toFixed(1)}" y="${np}" text-anchor="middle" fill="var(--pw-ink-cream-dim)" font-size="15" font-weight="600">${h(e[i].timeLabel)}</text>`}return n}function fp(t,e,o,n){let i=o/1.852,r=((n+180)%360-90+360)%360,s=Math.round(i/5)*5,a=Math.floor(s/50);s-=a*50;let l=Math.floor(s/10);s-=l*10;let p=Math.floor(s/5),c=18,u="var(--pw-ink-cream-muted)",m="",d=-c;for(let f=0;f<a;f++)m+=`<polygon points="0,${d.toFixed(1)} 9,${(d+3).toFixed(1)} 0,${(d+6).toFixed(1)}" fill="${u}"/>`,d+=6;for(let f=0;f<l;f++)m+=`<line x1="0" y1="${d.toFixed(1)}" x2="9" y2="${(d+4.5).toFixed(1)}" stroke="${u}" stroke-width="1.4" stroke-linecap="round"/>`,d+=4.5;for(let f=0;f<p;f++)m+=`<line x1="0" y1="${d.toFixed(1)}" x2="4.5" y2="${(d+2.25).toFixed(1)}" stroke="${u}" stroke-width="1.4" stroke-linecap="round"/>`;return`<g transform="translate(${t.toFixed(1)},${e}) rotate(${r})"><line x1="0" y1="0" x2="0" y2="${-c}" stroke="${u}" stroke-width="1.4" stroke-linecap="round"/>${m}</g>`}function gp(t){let{points:e,n:o,min:n,max:i,minIdx:r,maxIdx:s}=t,a=0,l=1,p=2,c="";for(let u=0;u<o;u++){let m=u===r||u===s,d=m?a:u%3,f=se(u,o),g=Qa(e[u].temp,n,i);if(d===a){let w=e[u].temp,v=m?String(Math.round(w)):w.toFixed(1),b=u===r?"var(--pw-wind)":u===s?"var(--pw-vermilion)":"var(--pw-ink-cream)",y=m?17:15,_=g-Ja;c+=`<text x="${f.toFixed(1)}" y="${_.toFixed(1)}" text-anchor="middle" fill="${b}" font-size="${y}" font-weight="600">${v}\xB0</text>`}else if(d===l){let w=Vo(e[u].condition),v=g-Ja;c+=`<text x="${f.toFixed(1)}" y="${v.toFixed(1)}" text-anchor="middle" font-size="20">${w}</text>`}else if(d===p){let w=Number(e[u].windSpeed),v=Number(e[u].windBearing);if(!Number.isFinite(w)||w<1||!Number.isFinite(v))continue;let b=g-ip;c+=fp(f,b,w,v)}}return c}function ts({config:t,forecastData:e}){let o=e?.hourly||[];if(o.length<2)return null;let n=Number(t.hours),i=t.horizon==="long"?"long":"short",r=Number.isFinite(n)&&n>0?Math.max(4,Math.min(48,n)):i==="long"?24:12,s=cp(o,r);if(!s)return null;let l=(t.show_cloud==="auto"||t.show_cloud===void 0?s.hasCloud:!!t.show_cloud)&&s.hasCloud?pp(s):"",p=_t(s.points[0]?.condition||"sunny",!1),c=[];c.push(dp(s)),c.push(up(s)),c.push(mp(s)),c.push(gp(s));let u=se(0,s.n).toFixed(1);c.push(`<line x1="${u}" y1="0" x2="${u}" y2="${Je}" stroke="var(--pw-vermilion)" stroke-width="0.8" stroke-dasharray="2 3" opacity="0.7"/>`),c.push(hp(s));let m=s.n,d=`${m}-hour meteogram showing temperature, condition, wind, and precipitation`,f=m<=12?"next twelve hours":`next ${m===24?"twenty-four":m} hours`,g=Xe("pw-meteogram-title"),w=`
