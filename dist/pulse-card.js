...
`;var Si="1.8.0",ki="Pulse Card:",Tt={min:0,max:100,height:"8px",border_radius:"4px",decimal:null,entity_row:!1,complementary:!1,limit_value:!1,columns:1,animation:{state:"on",speed:.8,effect:"none"},positions:{icon:"off",name:"outside",value:"outside",indicator:"off"},tap_action:{action:"more-info"},hold_action:{action:"none"},double_tap_action:{action:"none"}};function h(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function S(t){return t==null||t===""?"":String(t).replace(/[;{}]/g,"").replace(/url\s*\(/gi,"").replace(/expression\s*\(/gi,"").replace(/-moz-binding\s*:/gi,"")}function At(t,e,o){return Math.min(Math.max(t,e),o)}var $s=32;function de(t){if(t==null||t==="")return"";let e=String(t);if(e.length>$s)return e;let o=e.split(".");if(o.length>2)return e;for(let i of o){if(i.length===0)return e;for(let n=0;n<i.length;n++){let a=i.charCodeAt(n);if(a<48||a>57)return e}}return`${e}px`}function Rt(){return typeof window>"u"?!1:window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches??!1}function Z(t,e=1){return t==null?"--":typeof t!="number"?String(t):isFinite(t)?String(parseFloat(t.toFixed(e))):"--"}function dt(t){return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}function io(t){return(e,...o)=>console.warn(`${t} ${e}`,...o)}var Ss=new Set(["unavailable","unknown","error"]);function Q(t){return t?Ss.has(t.state??""):!0}var on=0;function ue(t="pulse-id"){return on=on+1>>>0,`${t}-${on.toString(36)}`}var no="Pulse sparkline:";async function Re(t,e,o=24){let i={};if(!t?.callWS||e.length===0)return i;let n=new Date,a=new Date(n.getTime()-o*60*60*1e3);try{let s=await t.callWS({type:"history/history_during_period",start_time:a.toISOString(),end_time:n.toISOString(),entity_ids:e,minimal_response:!0,significant_changes_only:!0});for(let r of e)try{let l=s?.[r];if(!l||l.length<2){i[r]=[];continue}let p=[];for(let c of l){let u=parseFloat(c.s);if(!isNaN(u)){let m=c.lu??c.last_updated,d=typeof m=="number"?m*1e3:new Date(m).getTime();isFinite(d)&&p.push({t:d,v:u})}}i[r]=p}catch(l){console.warn(`${no} parse failed for %s: %O`,r,l),i[r]=[]}}catch(s){console.warn(`${no} fetch failed: %O`,s);for(let r of e)i[r]=[]}return i}async function Ai(t,e,o=24){let i={};if(!t?.callWS||e.length===0)return i;let n=new Date,a=new Date(n.getTime()-o*60*60*1e3);try{let s=await t.callWS({type:"history/history_during_period",start_time:a.toISOString(),end_time:n.toISOString(),entity_ids:e,minimal_response:!0,significant_changes_only:!1});for(let r of e)try{let l=s?.[r];if(!Array.isArray(l)||l.length===0){i[r]=[];continue}let p=[];for(let c of l){let u=c.lu??c.last_updated,m=typeof u=="number"?u*1e3:new Date(u).getTime();if(!isFinite(m))continue;let d=String(c.s??c.state??"").toLowerCase(),f="idle";d==="heat"||d==="heating"?f="heating":d==="cool"||d==="cooling"?f="cooling":d==="off"&&(f="off");let g=f==="heating"||f==="cooling"?50:0;p.push({t:m,state:f,power:g})}i[r]=p}catch(l){console.warn(`${no} state-history parse failed for %s: %O`,r,l),i[r]=[]}}catch(s){console.warn(`${no} state-history fetch failed: %O`,s);for(let r of e)i[r]=[]}return i}var Ti={avg:t=>t.reduce((e,o)=>e+o,0)/t.length,min:t=>Math.min(...t),max:t=>Math.max(...t),median:t=>{let e=[...t].sort((i,n)=>i-n),o=Math.floor(e.length/2);return e.length%2?e[o]:(e[o-1]+e[o])/2},first:t=>t[0],last:t=>t[t.length-1],sum:t=>t.reduce((e,o)=>e+o,0),delta:t=>Math.max(...t)-Math.min(...t),diff:t=>t[t.length-1]-t[0]};function ks(t,e,o="avg"){if(t.length===0||e<1)return[];if(t.length<=e){let u=t[0].t,m=t[t.length-1].t-u||1;return t.map(d=>({x:(d.t-u)/m,v:d.v}))}let i=Ti[o]||Ti.avg,n=t[0].t,r=(t[t.length-1].t-n||1)/e,l=[],p=0,c=t[0].v;for(let u=0;u<e;u++){let m=n+(u+1)*r,d=[];for(;p<t.length&&t[p].t<m;)d.push(t[p].v),p++;d.length>0&&(c=i(d)),l.push({x:u/(e-1||1),v:c})}return l}function me(t,e,o,i=24,n="avg",a=!0){if(t.length<2)return"";let s=ks(t,i,n);if(s.length<2)return"";let r=s[0].v,l=s[0].v;for(let d=1;d<s.length;d++)s[d].v<r&&(r=s[d].v),s[d].v>l&&(l=s[d].v);let p=l-r||1,c=2,u=o-c*2,m=s.map(d=>({x:d.x*e,y:c+u-(d.v-r)/p*u}));return nn(m,a)}function nn(t,e=!0){if(!t||t.length<2)return"";if(t.length===2||!e){let n=`M${t[0].x.toFixed(1)},${t[0].y.toFixed(1)}`;for(let a=1;a<t.length;a++)n+=`L${t[a].x.toFixed(1)},${t[a].y.toFixed(1)}`;return n}let o=t[0],i=`M${o.x.toFixed(1)},${o.y.toFixed(1)}`;for(let n=1;n<t.length;n++){let a=t[n],s=(o.x+a.x)/2,r=(o.y+a.y)/2;i+=` ${s.toFixed(1)},${r.toFixed(1)}`,i+=` Q${a.x.toFixed(1)},${a.y.toFixed(1)}`,o=a}return i+=` ${o.x.toFixed(1)},${o.y.toFixed(1)}`,i}function he(t){if(typeof t!="string")return null;let e=t.trim().replace(/^#/,"");return e.length===3&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),e.length!==6||/[^0-9a-f]/i.test(e)?null:{r:parseInt(e.slice(0,2),16),g:parseInt(e.slice(2,4),16),b:parseInt(e.slice(4,6),16)}}function Ci(t,e,o){return{r:Math.round(t.r+(e.r-t.r)*o),g:Math.round(t.g+(e.g-t.g)*o),b:Math.round(t.b+(e.b-t.b)*o)}}function Mi(t,e,o){let i=he(t),n=he(e);if(!i||!n)return"";let{r:a,g:s,b:r}=Ci(i,n,o);return`rgb(${a}, ${s}, ${r})`}function Ei(t,e,o){let i=he(t),n=he(e);if(!i||!n)return t;let{r:a,g:s,b:r}=Ci(i,n,o);return`#${a.toString(16).padStart(2,"0")}${s.toString(16).padStart(2,"0")}${r.toString(16).padStart(2,"0")}`}function Xt(t,e){if(typeof t!="string")return String(t);let o=Math.max(0,Math.min(1,Number(e))),i=he(t);if(i)return`rgba(${i.r},${i.g},${i.b},${o})`;let n=/^rgb\(\s*(\d+)\s*[,\s]\s*(\d+)\s*[,\s]\s*(\d+)\s*\)$/i.exec(t.trim());return n?`rgba(${n[1]},${n[2]},${n[3]},${o})`:t}var Ts=new Set(["on","open","home","locked","playing","active"]),As=new Set(["off","closed","not_home","unlocked","idle","paused","standby"]);function Ii(t,e,o){if(typeof t!="string")return null;let i=t.toLowerCase();return Ts.has(i)?o:As.has(i)?e:null}function Cs(t,e){let o=String(t),i=o.charAt(0).toUpperCase()+o.slice(1);return e?`${i}${e}`:i}function Ms(t,e,o,i=!1){let n=Ii(t,e,o),a=n!==null?n:parseFloat(t);if(isNaN(a))return 0;let s=o-e;if(s<=0)return 0;let r=i?o-a:a;return At((r-e)/s,0,1)*100}function Es(t,e){if(!e||e.length===0)return null;let o=parseFloat(t);if(isNaN(o))return null;for(let i of e)if(o>=i.from&&o<=i.to)return i;return null}function Fs(t,e,o){return Mi(t,e,o)}function Is(t,e){if(!e||e.length<2)return null;let o=parseFloat(t);if(isNaN(o))return null;let i=e[0].from<=e[e.length-1].from?e:[...e].sort((n,a)=>n.from-a.from);for(let n=0;n<i.length-1;n++){let a=i[n],s=i[n+1];if(o>=a.from&&o<=s.to){let r=s.from-a.from,l=r>0?(o-a.from)/r:0;return Fs(a.color,s.color,At(l,0,1))}}return o<=i[0].from?i[0].color:i[i.length-1].color}function Ns(t,e,o){let i=t.min??o?.min,n=t.max??o?.max;return i==null&&(i=e?.attributes?.min??e?.attributes?.min_temp??Tt.min),n==null&&(n=e?.attributes?.max??e?.attributes?.max_temp??Tt.max),{min:parseFloat(String(i)),max:parseFloat(String(n))}}function ao(t,e,o){return t.decimal??e.decimal??o?.entities?.[t.entity]?.display_precision??null}function fe(t,e){return t.unit_of_measurement??e?.attributes?.unit_of_measurement??""}function zs(t){return!isFinite(t)||t<0?"0":t>=1e9?`${(t/1e9).toFixed(1)}G`:t>=1e6?`${(t/1e6).toFixed(1)}M`:t>=1e3?`${(t/1e3).toFixed(1)}K`:t.toString()}function Ls(t,e,o){let i=parseFloat(t);if(isNaN(i))return String(t);let n=e!=null?i.toFixed(e):i.toString();return o?`${n}${o}`:n}function Ni(t,e){if(e==null)return{direction:"neutral",delta:0};let o=parseFloat(t),i=parseFloat(e);if(isNaN(o)||isNaN(i))return{direction:"neutral",delta:0};if(!isFinite(o)||!isFinite(i))return{direction:"neutral",delta:0};let n=Math.abs(o-i),a=Math.max(Math.abs(o),1);if(n>a*1e3)return{direction:"neutral",delta:0};let s=Math.round((o-i)*100)/100;return{direction:s>0?"up":s<0?"down":"neutral",delta:s}}function an(t,e,o,i,n){let a=t==="up"?"\u25B2":t==="down"?"\u25BC":"\u25B6";if(!o)return{arrow:a,text:a};let s=i!=null?e.toFixed(i):String(Math.round(e*100)/100),r=e>0?"+":"";return{arrow:a,text:`${a} ${r}${s}${n||""}`}}var Ht=io(ki);async function zi(t,e,o=60){let i={};if(!t?.callWS||e.length===0)return i;let n=new Date,a=new Date(n.getTime()-o*60*1e3);try{let s=await t.callWS({type:"history/history_during_period",start_time:a.toISOString(),end_time:n.toISOString(),entity_ids:e,minimal_response:!0,significant_changes_only:!0});for(let r of e){let l=s?.[r];if(!l||l.length===0){i[r]=null;continue}let p=parseFloat(l[0].s);i[r]=isNaN(p)?null:p}}catch(s){Ht("Failed to fetch history for %s: %O",e.join(", "),s);for(let r of e)i[r]=null}return i}function Fi(t){return!Array.isArray(t)||t.length<2?t:[...t].sort((e,o)=>e.from-o.from)}function Li(t){if(!t)throw new Error("Please define an entity or entities");if(!t.entity&&!t.entities)throw new Error("Please define an entity or entities");let e={...Tt,...t,animation:{...Tt.animation,...t.animation},positions:{...Tt.positions,...t.positions}};e.columns!==null&&e.columns!==void 0&&(e.columns=Number(e.columns)||1),e.animation.speed!==null&&e.animation.speed!==void 0&&(e.animation.speed=Number(e.animation.speed)||Tt.animation.speed),e.severity&&(e.severity=Fi(e.severity)),e.indicator?.show===!0&&e.positions.indicator==="off"&&(e.positions={...e.positions,indicator:"outside"}),e.entities=t.entities?t.entities.map(i=>{let n=typeof i=="string"?{entity:i}:{...i};return n.severity&&(n.severity=Fi(n.severity)),!n.secondary_info&&e.secondary_info&&(n._cardSecondaryInfo=e.secondary_info),n.indicator?.show===!0&&n.positions&&n.positions.indicator==="off"?n.positions={...n.positions,indicator:"outside"}:n.indicator?.show===!0&&!n.positions?.indicator&&(n.positions={...n.positions||{},indicator:"outside"}),n}):[{entity:t.entity}];let o=new Set;for(let i of e.entities)o.has(i.entity)&&Ht('Duplicate entity "%s" in config \u2014 only the last bar will update dynamically',i.entity),o.add(i.entity);return e}function ro(t,e){if(t==null)return{value:null,showLabel:!1};if(typeof t=="number")return{value:isNaN(t)?null:t,showLabel:!1};if(typeof t=="string"){let o=e?.states[t];if(!o)return{value:null,showLabel:!1};let i=parseFloat(o.state);return{value:isNaN(i)?null:i,showLabel:!1}}return typeof t=="object"&&t.value!==void 0?{value:ro(t.value,e).value,showLabel:t.show_label===!0}:{value:null,showLabel:!1}}function rn(t,e,o){let i=o?.states[t.entity],n=Q(i),{min:a,max:s}=Ns(t,i,e),r=t.attribute?i?.attributes?.[t.attribute]:i?.state,l=t.attribute?null:Ii(r,a,s),p=l!==null,c=p?l:parseFloat(r),u=t.complementary??e.complementary,m=n?0:Ms(r,a,s,u),d=fe(t,i),f=ao(t,e,o),w=(t.limit_value??e.limit_value)&&!isNaN(c)?At(c,a,s):r,v=n?"Unavailable":t.state_map?.[r]?t.state_map[r]:p?Cs(r,d):Ls(w,f,d),b=t.name??i?.attributes?.friendly_name??t.entity,y="",_="";if(!n){let C=t.state_color,E=i?.state;if(C&&E&&C[E])y=C[E];else{let z=t.attribute_color??e.attribute_color;if(z?.attribute&&z?.map){let k=i?.attributes?.[z.attribute];if(k!=null){let x=z.map[String(k)];x&&(y=x)}}if(!y){let k=t.severity??e.severity;if(k&&k.length>0)if(k.some(T=>T.mode==="gradient")){let T=Is(c,k);T&&(y=T)}else{let T=Es(c,k);T&&(y=T.color,T.icon&&(_=T.icon))}}}}let $=y||t.color||e.color||"",A=t.icon||i?.attributes?.icon||"";return{isUnavailable:n,min:a,max:s,numValue:c,fill:m,displayValue:v,name:b,color:$,resolvedIcon:_||A}}function ge(t,e){let o=t.bar_width??e.bar_width;return o!=null?Math.max(1,Math.min(100,o))/100:1}function sn(t,e){if(!t.visibility)return!0;let o=e?.states[t.entity];if(!o)return!1;let i=t.visibility,n=t.attribute?o.attributes?.[t.attribute]:o.state;if(!t.attribute&&Q(o))return i.state_equal!==void 0&&String(i.state_equal)===o.state;let a=parseFloat(n);return!(i.state_above!==void 0&&(isNaN(a)||a<=i.state_above)||i.state_below!==void 0&&(isNaN(a)||a>=i.state_below)||i.state_equal!==void 0&&String(n)!==String(i.state_equal)||i.state_not_equal!==void 0&&String(n)===String(i.state_not_equal))}var Ri={input_number:{service:"set_value",dataKey:"value"},number:{service:"set_value",dataKey:"value"},light:{service:"turn_on",dataKey:"brightness_pct",fixedRange:{min:0,max:100,step:1}},cover:{service:"set_cover_position",dataKey:"position",fixedRange:{min:0,max:100,step:1}},fan:{service:"set_percentage",dataKey:"percentage",fixedRange:{min:0,max:100,step:1}},media_player:{service:"volume_set",dataKey:"volume_level",transform:t=>t/100,fixedRange:{min:0,max:100,step:1}},climate:{service:"set_temperature",dataKey:"temperature"}};function so(t,e,o,i){if(i<=0)return At(t,e,o);let n=Math.round((t-e)/i)*i+e,a=(String(i).split(".")[1]||"").length,s=Number(n.toFixed(a));return At(s,e,o)}function Hi(t,e,o){if(o?.service){let s=o.service.split(".");if(s.length<2||!s[0]||!s[1])return null;let r={entity_id:t};if(o.data)for(let[l,p]of Object.entries(o.data))r[l]=p==="$value"?e:p;return{domain:s[0],service:s[1],data:r}}let i=t.split(".")[0],n=Ri[i];if(!n)return null;let a=n.transform?n.transform(e):e;return{domain:i,service:n.service,data:{entity_id:t,[n.dataKey]:a}}}function He(t,e,o,i){let n=t.split(".")[0],s=Ri[n]?.fixedRange,r=e?.attributes,l=i?.min??r?.min??r?.min_temp??s?.min??0,p=i?.max??r?.max??r?.max_temp??s?.max??100,c=o?.step??r?.step??r?.target_temp_step??r?.percentage_step??s?.step??1;return{min:Number(l),max:Number(p),step:Number(c)||1}}function Rs(t){if(!t)return"";let e=new Date(t).getTime();if(isNaN(e))return"";let o=Date.now()-e;if(o<0)return"just now";let i=Math.floor(o/1e3);if(i<60)return"just now";let n=Math.floor(i/60);if(n<60)return`${n} min ago`;let a=Math.floor(n/60);return a<24?`${a}h ago`:`${Math.floor(a/24)}d ago`}function ln(t,e){let o=t.secondary_info??t._cardSecondaryInfo;if(!o)return"";if(o.text!==void 0&&o.text!==null&&o.text!=="")return String(o.text);let i=e?.states[t.entity];if(!i)return"";if(o.template)return o.template.replace(/\{(\w+)\}/g,(n,a)=>{let s=i.attributes?.[a];return s==null?"":(a==="bytes"||a==="packets")&&typeof s=="number"?zs(s):String(s)});if(o.attribute){let n=i.attributes?.[o.attribute];return n!=null?String(n):""}return o.type==="last_changed"?Rs(i.last_changed):""}function lo(t,e,o){t.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:o}))}function Hs(t){if(typeof t!="string"||t.length===0)return!1;let e=t.trim();if(e.startsWith("/")&&!e.startsWith("//")||e.startsWith("./")||e.startsWith("../")||e.startsWith("#"))return!0;try{let o=new URL(e,window.location.href);return["http:","https:","mailto:","tel:"].includes(o.protocol)}catch{return!1}}function Ds(t){if(typeof t!="string"||t.length===0)return!1;let e=t.trim();return!(e.startsWith("//")||/^[a-zA-Z][a-zA-Z0-9+.-]*:/.test(e))}function ve(t,e,o,i,n){if(!(!o||o.action==="none"))switch(o.action){case"more-info":lo(t,"hass-more-info",{entityId:o.entity||i});break;case"navigate":o.navigation_path&&Ds(o.navigation_path)?(history.pushState(null,"",o.navigation_path),lo(t,"location-changed",{replace:!1})):o.navigation_path&&n("navigation_path rejected \u2014 must be a same-origin relative path: %s",o.navigation_path);break;case"call-service":case"perform-action":{let a=o.service||o.perform_action;if(!a||typeof a!="string")break;let s=a.indexOf(".");if(s<=0||s===a.length-1){n('Service rejected \u2014 expected "domain.service" format, got: %s',a);break}let r=a.slice(0,s),l=a.slice(s+1);e.callService(r,l,o.service_data||o.data).catch(p=>n("Service call %s failed: %O",a,p));break}case"url":o.url_path&&Hs(o.url_path)?window.open(o.url_path,"_blank","noopener,noreferrer"):o.url_path&&n("url_path rejected \u2014 only http/https/mailto/tel schemes or relative paths are allowed: %s",o.url_path);break;case"toggle":e.callService("homeassistant","toggle",{entity_id:o.entity||i}).catch(a=>n("Toggle %s failed: %O",o.entity||i,a));break}}function Os(t,e,o){let i=e?.[t],n=o?.[t];return i||n||{action:t==="tap_action"?"more-info":"none"}}function co(t,e,o,i,n){let a=Os(n,i,o);ve(t,e,a,i.entity,Ht)}function pn(t){let e=t.__pulseCleanup;typeof e=="function"&&e()}function Di(t,e,o,i,n){pn(t);let a=new AbortController,{signal:s}=a,r=0,l=null,p=null,c=!1;t.__pulseCleanup=()=>{a.abort(),l&&clearTimeout(l),p&&clearTimeout(p),delete t.__pulseCleanup},t.setAttribute("tabindex","0"),t.addEventListener("keydown",m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),e._hass&&co(e,e._hass,i,n,"tap_action"))},{signal:s}),t.addEventListener("click",m=>{if(m.preventDefault(),c){c=!1;return}t.__pulseSliding||(r++,r===1?l=setTimeout(()=>{r=0,e._hass&&co(e,e._hass,i,n,"tap_action")},250):r===2&&(l&&clearTimeout(l),r=0,e._hass&&co(e,e._hass,i,n,"double_tap_action")))},{signal:s}),t.addEventListener("pointerdown",()=>{c=!1,p=setTimeout(()=>{c=!0,e._hass&&co(e,e._hass,i,n,"hold_action")},500)},{signal:s});let u=()=>{p&&clearTimeout(p)};t.addEventListener("pointerup",u,{signal:s}),t.addEventListener("pointercancel",u,{signal:s}),t.addEventListener("contextmenu",m=>m.preventDefault(),{signal:s})}var Ps=50;function dn(t){let e=t.__pulseSliderCleanup;typeof e=="function"&&e()}function Oi(t,e,o,i){dn(t);let n=t.querySelector(".pb-container");if(!n)return;let a=n,s=new AbortController,{signal:r}=s,l=null;t.__pulseSliderCleanup=()=>{s.abort(),l&&clearTimeout(l),g&&clearInterval(g),delete t.__pulseSliderCleanup};let p=typeof i.interactive=="object"?i.interactive:typeof o.interactive=="object"?o.interactive:void 0,c=null;function u(b){let y=a.getBoundingClientRect(),_=Math.max(0,Math.min(b-y.left,y.width)),$=y.width>0?_/y.width:0,M=e._hass?.states[i.entity],{min:C,max:E,step:z}=He(i.entity,M,p,i),k=C+$*(E-C);return so(k,C,E,z)}function m(b){let _=e._hass?.states[i.entity],{min:$,max:A,step:M}=He(i.entity,_,p,i),C=A-$,E=C>0?(b-$)/C*100:0,z=a.querySelector(".pb-fill");z&&(z.style.width=`${E}%`);let k=fe(i,_),x=(String(M).split(".")[1]||"").length,T=x>0?b.toFixed(x):String(Math.round(b)),F=k?`${T}${k}`:T,B=t.querySelectorAll(".pb-value");for(let I of B)I.textContent=F}function d(){if(!c)return;let b=a.querySelector(".pb-fill");b&&(b.style.transition="",b.style.width=c.fillWidth);let y=t.querySelectorAll(".pb-value");for(let _ of y)_.textContent=c.displayValue}function f(b){let y=Hi(i.entity,b,p);if(!y){Ht("No slider service mapping for %s",i.entity),d();return}let _=e._hass;if(!_){d();return}_.callService(y.domain,y.service,y.data).catch($=>{Ht("Slider service call failed for %s: %O",i.entity,$),d()})}a.addEventListener("pointerdown",b=>{if(!e._hass)return;b.preventDefault();let y=a.querySelector(".pb-fill"),_=t.querySelector(".pb-value");c={fillWidth:y?.style.width||"0%",displayValue:_?.textContent||"",pointerId:b.pointerId,startX:b.clientX},t.__pulseSliding=!0,a.setPointerCapture(b.pointerId),t.classList.add("sliding"),y&&(y.style.transition="none");let $=u(b.clientX);m($)},{signal:r}),a.addEventListener("pointermove",b=>{if(!c||b.pointerId!==c.pointerId)return;b.preventDefault();let y=u(b.clientX);m(y)},{signal:r}),a.addEventListener("pointerup",b=>{if(!c||b.pointerId!==c.pointerId)return;b.preventDefault();let y=a.querySelector(".pb-fill");y&&(y.style.transition=""),t.classList.remove("sliding"),a.releasePointerCapture(b.pointerId);let _=u(b.clientX);m(_),f(_),c=null,l=setTimeout(()=>{t.__pulseSliding=!1},Ps)},{signal:r}),a.addEventListener("pointercancel",b=>{if(!c||b.pointerId!==c.pointerId)return;let y=a.querySelector(".pb-fill");y&&(y.style.transition=""),t.classList.remove("sliding"),a.releasePointerCapture(b.pointerId),d(),c=null,t.__pulseSliding=!1},{signal:r});let g=null;function w(b){let y=e._hass;if(!y)return;let _=y.states[i.entity],{min:$,max:A,step:M}=He(i.entity,_,p,i),C=i.attribute?parseFloat(_?.attributes?.[i.attribute]):parseFloat(_?.state);if(isNaN(C))return;let E=so(C+b*M,$,A,M);E!==C&&(m(E),f(E))}let v=t.querySelectorAll(".pb-step-btn");for(let b of v){let y=Number(b.dataset.step);b.addEventListener("click",$=>{$.stopPropagation(),w(y)},{signal:r}),b.addEventListener("pointerdown",$=>{$.stopPropagation(),g&&clearInterval(g),g=setInterval(()=>w(y),200)},{signal:r});let _=()=>{g&&(clearInterval(g),g=null)};b.addEventListener("pointerup",_,{signal:r}),b.addEventListener("pointercancel",_,{signal:r}),b.addEventListener("pointerleave",_,{signal:r})}t.addEventListener("keydown",b=>{let y=e._hass;if(!y||b.key!=="ArrowRight"&&b.key!=="ArrowUp"&&b.key!=="ArrowLeft"&&b.key!=="ArrowDown")return;b.preventDefault();let _=y.states[i.entity],{min:$,max:A,step:M}=He(i.entity,_,p,i),C=i.attribute?parseFloat(_?.attributes?.[i.attribute]):parseFloat(_?.state);if(isNaN(C))return;let E=b.key==="ArrowRight"||b.key==="ArrowUp"?1:-1,z=so(C+E*M,$,A,M);z!==C&&(m(z),f(z))},{signal:r})}function Et(t){if(!customElements.get("ha-ripple")||t.querySelector("ha-ripple"))return;let e=document.createElement("ha-ripple");t.appendChild(e),t.classList.add("has-ripple")}var Pi="1.8.0",uo="pulse-climate-card",Bi="pulse-climate-card-editor",oe="Pulse Climate Card:",ne={heating:{icon:"mdi:fire",token:"var(--pulse-tier-strong)",fallback:"#ff9f0a",label:"Heating"},cooling:{icon:"mdi:snowflake",token:"var(--pulse-tier-calm)",fallback:"#5ac8fa",label:"Cooling"},drying:{icon:"mdi:water-off",token:null,fallback:"#9C27B0",label:"Drying"},fan:{icon:"mdi:fan",token:null,fallback:"#607D8B",label:"Fan"},idle:{icon:"mdi:clock-outline",token:"var(--pulse-text-secondary)",fallback:"#9E9E9E",label:"Idle"},off:{icon:"mdi:power",token:"var(--pulse-disabled)",fallback:"#616161",label:"Off"}},un={None:{token:"var(--pulse-tier-moderate)",fallback:"#30d158"},Low:{token:"var(--pulse-tier-moderate)",fallback:"#30d158"},Medium:{token:"var(--pulse-tier-strong)",fallback:"#ff9f0a"},High:{token:"var(--pulse-tier-gale)",fallback:"#ff453a"},Critical:{token:"var(--pulse-tier-gale)",fallback:"#ff453a"}},qi=["zones"];var Dt=["var(--pulse-tier-calm)","var(--pulse-tier-gale)","var(--pulse-tier-moderate)","var(--pulse-tier-strong)","var(--pulse-accent)","var(--pulse-info-color)","var(--pulse-tier-strong)","var(--success-color, #8BC34A)"],Zt={columns:1,layout:"default",show_temp_bar:!0,show_power_bar:!0,tap_action:{action:"more-info"},hold_action:{action:"none"},double_tap_action:{action:"none"}},Wi={graph:{attribute:"current_temperature",stacked:!1,hours_to_show:24,height:80},donut:{size:120},thermal_strip:{hours_to_show:24,mode:"timeline",slots_per_hour:2,attribute:"temperature"},comfort_strip:{slots_per_hour:1,hours_to_show:24,mode:"heatmap"},radial:{size:280,attribute:"temperature"},energy_flow:{}};var mn=`${pe}
...
`;function Vi(t){!t||t.__pcPhaseAttached||(t.__pcPhaseAttached=!0)}var Gi={api_usage:"api_usage",api_limit:"api_limit",api_status:"api_status",api_reset:"api_reset",token_status:"token_status",polling_interval:"polling_interval",call_history:"call_history",api_breakdown:"api_breakdown",last_sync:"last_sync",next_sync:"next_sync",outside_temp:"outside_temp",solar_intensity:"solar_intensity",weather:"weather",home_state:"home",bridge_connected:"bridge_connected",boiler_flow_temp:"boiler_flow_temp",wc_target_flow:"wc_target_flow_temp",wc_status:"wc_status",boiler_max_output:"boiler_max_output_temp",homekit_connected:"homekit_connected",homekit_reads_saved:"homekit_reads_saved",homekit_writes_saved:"homekit_writes_saved",bridge_capabilities:"bridge_capabilities",bridge_schema_version:"bridge_schema_version",zone_count:"zone_count",home_id:"home_id",home_insights:"home_insights"},Bs={temperature:"temperature",humidity:"humidity",heating_power:"heating_power",ac_power:"ac_power",target_temp:"target",overlay:"overlay",mold_risk:"mold_risk",mold_risk_pct:"mold_risk_pct",condensation:"condensation_risk",surface_temp:"surface_temp",dew_point:"dew_point",comfort_level:"comfort_level",thermal_inertia:"thermal_inertia",heating_rate:"heating_rate",preheat_time:"preheat_time",confidence:"confidence",heat_accel:"heat_accel",approach_factor:"approach_factor",schedule_deviation:"schedule_deviation",next_schedule:"next_schedule",next_sched_temp:"next_sched_temp",preheat_advisor:"preheat_advisor",comfort_target:"comfort_target",open_window:"window",preheat_now:"preheat_now",window_predicted:"window_predicted",battery:"battery",connection:"connection",insights:"insights"},qs={battery:"battery",connection:"connection"},Ws={temperature:{platform:"sensor",suffixes:["_temp","_temperature"]},humidity:{platform:"sensor",suffixes:["_humidity"]},heating_power:{platform:"sensor",suffixes:["_heating","_heating_power"]},ac_power:{platform:"sensor",suffixes:["_ac","_ac_power"]},target_temp:{platform:"sensor",suffixes:["_ce_target","_target"]},overlay:{platform:"sensor",suffixes:["_ce_overlay","_mode"]},mold_risk:{platform:"sensor",suffixes:["_ce_mold_risk","_mold_risk"]},mold_risk_pct:{platform:"sensor",suffixes:["_ce_mold_risk_pct","_mold_risk_percentage"]},condensation:{platform:"sensor",suffixes:["_ce_condensation","_condensation_risk"]},surface_temp:{platform:"sensor",suffixes:["_ce_surface_temp","_surface_temperature"]},dew_point:{platform:"sensor",suffixes:["_ce_dew_point","_dew_point"]},comfort_level:{platform:"sensor",suffixes:["_ce_comfort_level","_comfort_level"]},thermal_inertia:{platform:"sensor",suffixes:["_ce_thermal_inertia","_thermal_inertia"]},heating_rate:{platform:"sensor",suffixes:["_ce_heating_rate","_avg_heating_rate"]},preheat_time:{platform:"sensor",suffixes:["_ce_preheat_time","_preheat_time"]},confidence:{platform:"sensor",suffixes:["_ce_confidence","_analysis_confidence"]},schedule_deviation:{platform:"sensor",suffixes:["_ce_schedule_deviation","_historical_deviation"]},next_schedule:{platform:"sensor",suffixes:["_ce_next_schedule","_next_schedule_time"]},next_sched_temp:{platform:"sensor",suffixes:["_ce_next_sched_temp","_next_schedule_temp"]},preheat_advisor:{platform:"sensor",suffixes:["_ce_preheat_advisor","_preheat_advisor"]},comfort_target:{platform:"sensor",suffixes:["_ce_comfort_target","_smart_comfort_target"]},heat_accel:{platform:"sensor",suffixes:["_ce_heat_accel","_heat_acceleration"]},approach_factor:{platform:"sensor",suffixes:["_ce_approach_factor","_approach_factor"]},open_window:{platform:"binary_sensor",suffixes:["_window","_open_window"]},preheat_now:{platform:"binary_sensor",suffixes:["_ce_preheat_now","_preheat_now"]},window_predicted:{platform:"binary_sensor",suffixes:["_ce_window_predicted","_window_predicted"]},battery:{platform:"sensor",suffixes:["_ce_battery","_battery"]},connection:{platform:"binary_sensor",suffixes:["_ce_connection","_connection"]},insights:{platform:"sensor",suffixes:["_ce_insights","_insights"]}},Vs={api_usage:{platform:"sensor",suffixes:["_api_usage"]},api_limit:{platform:"sensor",suffixes:["_api_limit"]},api_status:{platform:"sensor",suffixes:["_api_status"]},api_reset:{platform:"sensor",suffixes:["_api_reset"]},token_status:{platform:"sensor",suffixes:["_token_status"]},polling_interval:{platform:"sensor",suffixes:["_polling_interval"]},call_history:{platform:"sensor",suffixes:["_call_history"]},api_breakdown:{platform:"sensor",suffixes:["_api_breakdown","_api_call_breakdown"]},last_sync:{platform:"sensor",suffixes:["_last_sync"]},next_sync:{platform:"sensor",suffixes:["_next_sync"]},outside_temp:{platform:"sensor",suffixes:["_outside_temp"]},solar_intensity:{platform:"sensor",suffixes:["_solar_intensity"]},weather:{platform:"sensor",suffixes:["_weather","_weather_state"]},home_state:{platform:"binary_sensor",suffixes:["_home"]},bridge_connected:{platform:"binary_sensor",suffixes:["_bridge_connected","_bridge"]},boiler_flow_temp:{platform:"sensor",suffixes:["_boiler_flow_temp"]},wc_target_flow:{platform:"sensor",suffixes:["_wc_target_flow_temp"]},wc_status:{platform:"sensor",suffixes:["_wc_status"]},boiler_max_output:{platform:"number",suffixes:["_boiler_max_output_temp"]},homekit_connected:{platform:"binary_sensor",suffixes:["_homekit_connected"]},homekit_reads_saved:{platform:"sensor",suffixes:["_homekit_reads_saved"]},homekit_writes_saved:{platform:"sensor",suffixes:["_homekit_writes_saved"]},bridge_capabilities:{platform:"sensor",suffixes:["_bridge_capabilities"]},bridge_schema_version:{platform:"sensor",suffixes:["_bridge_schema_version"]},zone_count:{platform:"sensor",suffixes:["_zone_count","_zones_count"]},home_id:{platform:"sensor",suffixes:["_home_id"]},home_insights:{platform:"sensor",suffixes:["_home_insights"]}};function Us(t){let e=new Map;for(let[o,i]of Object.entries(t))i.platform==="tado_ce"&&i.translation_key&&(e.has(i.translation_key)||e.set(i.translation_key,o));return{byTranslationKey:e}}function js(t,e){let o={};for(let[i,n]of Object.entries(Gi)){let a=e.byTranslationKey.get(n);a&&(o[i]=a)}return o}function Gs(t,e,o){let i={},n={...Bs,...qs};for(let a of e){i[a]={};let s=`climate.${a}`,r=t[s];if(!r?.device_id||r.platform!=="tado_ce")continue;let l=r.device_id;for(let[p,c]of Object.entries(t)){if(c.platform!=="tado_ce"||c.device_id!==l||!c.translation_key||!o[p])continue;let u=c.translation_key;if(u.endsWith("_suffixed")){let m=u.replace("_suffixed",""),d=Object.keys(n).find(f=>n[f]===m);if(!d)continue;if(!i[a][d])i[a][d]=p;else{let f=2;for(;i[a][`${d}_${f}`];)f++;i[a][`${d}_${f}`]=p}}else{let m=Object.keys(n).find(d=>n[d]===u);if(!m)continue;i[a][m]||(i[a][m]=p)}}}return i}function Ui(t){let e={},o=Object.keys(t);for(let[i,{platform:n,suffixes:a}]of Object.entries(Vs))for(let s of a){let r=o.find(l=>l.startsWith(`${n}.tado_ce`)&&l.endsWith(s));if(r){e[i]=r;break}}return e}function ji(t,e){let o={};for(let i of e){o[i]={};for(let[n,{platform:a,suffixes:s}]of Object.entries(Ws))for(let r of s){let l=`${a}.${i}${r}`;if(t[l]){o[i][n]=l;break}}}return o}var ie={states:null,zoneNames:null,result:null};function Xi(t,e,o){if(ie.result&&ie.states===t&&ie.zoneNames!==null&&ie.zoneNames.length===e.length&&ie.zoneNames.every((p,c)=>p===e[c]))return ie.result;let i=!1,n=!1;o&&(i=Object.values(o).some(p=>p.platform==="tado_ce"),n=i),i||(i=Object.keys(t).some(p=>p.startsWith("sensor.tado_ce_")));let a={};if(i)if(n){let p=Us(o);a=js(o,p);let c=Ui(t);for(let[u,m]of Object.entries(c))a[u]||(a[u]=m)}else a=Ui(t);let s;if(n){s=Gs(o,e,t);let p=ji(t,e);for(let c of e){s[c]||(s[c]={});let u=p[c]||{};for(let[m,d]of Object.entries(u))s[c][m]||(s[c][m]=d)}}else s=ji(t,e);let r=Object.keys(Gi).filter(p=>!a[p]),l={isTadoCE:i,hubEntities:a,zoneEntities:s,missingHubKeys:r};if(i)for(let[p,c]of Object.entries(s))Object.keys(c).length===0&&console.debug(`${oe} zone "${p}" \u2014 no Tado CE entities discovered. Check entity_id matches sensor.<zone>_temperature pattern, or use temperature_entity / set_point_entity overrides.`);return ie={states:t,zoneNames:[...e],result:l},l}function K(t){return t.replace(/^(climate|sensor|binary_sensor)\./,"")}var Ot=io(oe);function wt(t){return t?.isUnavailable?" pc-row-unavail pc-row-quiet":t?.hvacMode==="sensor"?" pc-row-sensor pc-row-quiet":t?.hvacAction==="heating"?" pc-row-heat pc-row-active":t?.hvacAction==="cooling"?" pc-row-cool pc-row-active":t?.hvacAction==="off"||t?.targetTemp===null||t?.targetTemp===void 0?" pc-row-off pc-row-quiet":t?.currentTemp!==null&&t?.currentTemp!==void 0&&Math.abs(t.currentTemp-t.targetTemp)<=.3?" pc-row-at-target pc-row-mid":" pc-row-idle pc-row-mid"}function at(t,e,o,i){let n=t.entity,a=K(n),s=e?.zoneEntities?.[a]||{},r=we(n,s,o,t,i||{});return{entityId:n,zoneName:a,zoneEntities:s,zoneState:r}}var Zi=new Set;function mo(t,e,o,i){if(!o||i[o])return;let n=`${t}|${e}|${o}`;Zi.has(n)||(Zi.add(n),Ot(`zone "%s": ${e} override points at missing entity "%s" \u2014 chip will not render`,t,o))}function be(t){let e=ne[t]||ne.idle;return{...e,glow:t==="heating"||t==="cooling"?e.fallback:null}}function ho(t){let e=t.filter(a=>!a.isUnavailable);if(e.length===0)return"off";let o=0,i=0,n=0;for(let a of e)a.hvacAction==="heating"?o+=1:a.hvacAction==="cooling"?i+=1:a.hvacAction==="off"&&(n+=1);return o>0&&i>0?"mixed":o>0?"heating":i>0?"cooling":n===e.length?"off":"idle"}function De(t,e,o){let i=we(t,{},e,o||{entity:t},{});return{name:i.name,temp:i.currentTemp??void 0,target:i.targetTemp??void 0,humidity:i.humidity??void 0,hvacAction:i.hvacAction,unit:i.unit}}function fo(t){let e=t.charAt(0).toUpperCase()+t.slice(1).toLowerCase();return un[e]||un.Low}function Oe(t,e,o){return o<=e?50:At((t-e)/(o-e),0,1)*100}function Xs(t,e,o,i){let n=[],a=!i,s=l=>a||i.includes(l);if(i&&s("humidity")&&t.humidity!==null&&n.push({type:"humidity",icon:"mdi:water-percent",label:`${Math.round(t.humidity)}%`}),s("hvac_action")){let l=be(t.hvacAction);n.push({type:"hvac_action",icon:l.icon,label:l.label,color:l.fallback})}if(s("overlay")&&t.overlayType){let l=t.overlayType==="Manual"?"mdi:hand-back-right":"mdi:calendar-clock";n.push({type:"overlay",icon:l,label:t.overlayType,entityId:e.overlay})}if(s("preset")&&t.presetMode){let l=t.presetMode==="away"?"mdi:home-export-outline":"mdi:home";n.push({type:"preset",icon:l,label:t.presetMode==="away"?"Away":"Home"})}let r=(l,p,c)=>{if(!s(l)||!e[c])return;let u=o[e[c]];if(!Q(u)&&u.state.toLowerCase()!=="none"){let m=fo(u.state);n.push({type:l,icon:p,label:u.state,color:m.token,severity:u.state,entityId:e[c]})}};if(s("open_window")&&e.open_window){let l=o[e.open_window];if(l){let p=l.state==="on";n.push({type:"open_window",icon:p?"mdi:window-open":"mdi:window-closed",label:p?"Open":"Closed",color:p?"var(--pulse-tier-gale)":void 0,entityId:e.open_window})}}if(s("window_predicted")&&e.window_predicted){let l=o[e.window_predicted];l&&l.state==="on"&&n.push({type:"window_predicted",icon:"mdi:window-open-variant",label:"Window predicted",color:"var(--pulse-tier-strong)",entityId:e.window_predicted})}if(r("mold_risk","mdi:mushroom","mold_risk"),r("condensation","mdi:water-alert","condensation"),s("comfort_level")&&e.comfort_level){let l=o[e.comfort_level];Q(l)||n.push({type:"comfort_level",icon:"mdi:emoticon-outline",label:l.state,entityId:e.comfort_level})}if(s("preheat_now")&&e.preheat_now){let l=o[e.preheat_now];l&&l.state==="on"&&n.push({type:"preheat_now",icon:"mdi:radiator",label:"Preheating",color:"var(--pulse-tier-strong)",entityId:e.preheat_now})}if(s("battery")||s("battery_all")){let l=i&&i.includes("battery_all"),p=[],c=["battery"],u=2;for(;e[`battery_${u}`];)c.push(`battery_${u}`),u++;for(let m of c){let d=e[m];if(!d)continue;let f=o[d];Q(f)||p.push({eid:d,state:f.state,lower:f.state.toLowerCase()})}if(p.length>0)if(l)for(let m=0;m<p.length;m++){let d=p[m],f=d.lower==="low"||d.lower==="critical"?"mdi:battery-alert":"mdi:battery",g=d.lower==="critical"?"var(--pulse-tier-gale)":d.lower==="low"?"var(--pulse-tier-strong)":void 0;n.push({type:`battery${m>0?`_${m+1}`:""}`,icon:f,label:d.state,color:g,entityId:d.eid})}else{let m={critical:3,low:2,normal:1},d=p[0];for(let w of p)(m[w.lower]||0)>(m[d.lower]||0)&&(d=w);let f=d.lower==="low"||d.lower==="critical"?"mdi:battery-alert":"mdi:battery",g=d.lower==="critical"?"var(--pulse-tier-gale)":d.lower==="low"?"var(--pulse-tier-strong)":void 0;n.push({type:"battery",icon:f,label:d.state,color:g,entityId:d.eid})}}if(s("valve_control")){let p=o[t.entityId]?.attributes||{},c=p.valve_control_active,u=p.valve_target,m=p.valve_control_backed_off,d=p.valve_control_enabled;m===!0?n.push({type:"valve_control",icon:"mdi:valve",label:"Valve: Backed off",color:"var(--pulse-disabled)"}):c===!0&&u!==void 0?n.push({type:"valve_control",icon:"mdi:valve",label:`Valve: ${Z(u)}${t.unit}`,color:"var(--pulse-tier-strong)"}):d===!0&&n.push({type:"valve_control",icon:"mdi:valve",label:"Valve: Idle",color:"var(--pulse-disabled)"})}if(i&&s("temp_source")){let p=o[t.entityId]?.attributes?.temperature_source;if(p&&p!=="cloud"){let c=p==="external"?"mdi:thermometer-probe":p==="homekit"?"mdi:apple":"mdi:cloud-outline";n.push({type:"temp_source",icon:c,label:p.charAt(0).toUpperCase()+p.slice(1)})}}return n}function we(t,e,o,i,n){let a=o[t],s=Q(a),r=a?.attributes||{},l=t.startsWith("sensor."),p=l?s?null:parseFloat(a?.state)||null:r.current_temperature??null,c=s||a?.state==="off"?null:r.temperature??null,u=l?null:r.current_humidity??null,m=l?"idle":r.hvac_action||(a?.state==="off"?"off":"idle"),d=l?"sensor":a?.state||"off",f=r.preset_mode||"",g=Number(r.min_temp??5),w=Number(r.max_temp??35),v=Number(r.target_temp_step??.5),b=r.unit_of_measurement||"\xB0C",y=0,_=i.heating_power_entity||e.heating_power;if(i.heating_power_entity&&mo(i.name||t,"heating_power_entity",i.heating_power_entity,o),_){let T=o[_];Q(T)||(y=parseFloat(T.state)||0)}else r.heating_power!==void 0&&(y=parseFloat(r.heating_power)||0);let $=0;if(e.ac_power){let T=o[e.ac_power];Q(T)||($=parseFloat(T.state)||0)}let A="";if(e.overlay){let T=o[e.overlay];Q(T)||(A=T.state)}else r.overlay_type&&(A=r.overlay_type);let M=i.name||r.friendly_name||t.replace(/^(climate|sensor)\./,""),C=i.icon||r.icon||"mdi:thermometer",E=i.chips||n.chips||null,z={...e},k=i.name||t;i.open_window_entity&&(z.open_window=i.open_window_entity,mo(k,"open_window_entity",i.open_window_entity,o)),i.battery_entity&&(z.battery=i.battery_entity,mo(k,"battery_entity",i.battery_entity,o)),i.mold_risk_entity&&(z.mold_risk=i.mold_risk_entity,mo(k,"mold_risk_entity",i.mold_risk_entity,o));let x={entityId:t,name:M,icon:C,isUnavailable:s,currentTemp:p,targetTemp:c,humidity:u,heatingPower:y,coolingPower:$,hvacAction:m,hvacMode:d,presetMode:f,overlayType:A,minTemp:g,maxTemp:w,tempStep:v,unit:b,chips:[]};return x.chips=Xs(x,z,o,E),x}var Ki=280;function hn(t,e=Ki){return t<=50?0:(2+(t-50)/50*3)*(e/Ki)}function Yi(t,e=20,o=1){if(o<=0)return 0;let i=Math.min(4,Math.max(2,Math.round(t/30))),n=Math.floor(e/o);return Math.min(i,n)}function Ji(t){return 4-t/100*2.5}function Qi(t,e){return 1.5+t/e*1.5}function ye(t,e){return 3*(t/e)}function ta(t){if(!t)throw new Error("Please define an entity or zones");if(!t.entity&&!t.zones)throw new Error("Please define an entity or zones");if(t.entity&&typeof t.entity=="string"&&!t.entity.startsWith("climate.")&&!t.entity.startsWith("water_heater."))throw new Error("Entity must be a climate.* or water_heater.* entity");let e;t.zones?e=t.zones.map(a=>typeof a=="string"?{entity:a}:{...a}):e=[{entity:t.entity}];for(let a of e)if(!a.entity||typeof a.entity!="string")throw new Error("Each zone must have an entity ID");let o=t.atmosphere_intensity,i=o==="subtle"||o==="bold"?o:"medium",n={...t,columns:Number(t.columns)||Zt.columns,layout:t.layout||Zt.layout,show_temp_bar:t.show_temp_bar??Zt.show_temp_bar,show_power_bar:t.show_power_bar??Zt.show_power_bar,show_atmosphere:t.show_atmosphere!==!1,atmosphere_intensity:i,show_hero:t.show_hero===!0,hero_show_thermal_strip:t.hero_show_thermal_strip!==!1,hero_show_outside:t.hero_show_outside!==!1,tap_action:t.tap_action||{...Zt.tap_action},hold_action:t.hold_action||{...Zt.hold_action},double_tap_action:t.double_tap_action||{...Zt.double_tap_action},sections:t.sections||[...qi],_zones:e};return Array.isArray(n.sections)&&(n.sections=n.sections.map(a=>{let s=typeof a=="string"?{type:a}:{...a},r=Wi[s.type];if(r){for(let[l,p]of Object.entries(r))if(s[l]===void 0||s[l]===null)s[l]=p;else if(typeof p=="number"){let c=Number(s[l]);Number.isFinite(c)?s[l]=c||p:(Ot('section "%s": %s=%o is not numeric \u2014 using default %o',s.type,l,s[l],p),s[l]=p)}}return s})),n}function fn(t,e,o){let i=new Map;if(!Array.isArray(t))return i;for(let n of t){if(!n?.entity)continue;let a=o?o(n.entity):n.entity;i.set(n.entity,e?.data?.[a]||[])}return i}function _e(t){return typeof t=="string"&&t.length>0}function ht(t,e,o,i){if(_e(i?.temperature_entity))return{entityId:i.temperature_entity,source:"yaml_override"};let a=e[t]?.attributes?.external_temp_sensor;return _e(a)&&e[a]?{entityId:a,source:"external"}:_e(o?.temperature)?{entityId:o.temperature,source:"discovery"}:{entityId:t,source:"climate_fallback"}}function Kt(t,e,o,i){if(_e(i?.humidity_entity))return{entityId:i.humidity_entity,source:"yaml_override"};let a=e[t]?.attributes?.external_humidity_sensor;return _e(a)&&e[a]?{entityId:a,source:"external"}:_e(o?.humidity)?{entityId:o.humidity,source:"discovery"}:null}var Pe={timestamp:0,data:{},stateData:{}};function ea(){return Pe}function oa(t,e){let o={...Pe.data};for(let[n,a]of Object.entries(t))a.length>0&&(o[n]=a);let i={...Pe.stateData};if(e)for(let[n,a]of Object.entries(e))Array.isArray(a)&&a.length>0&&(i[n]=a);return Pe={timestamp:Date.now(),data:o,stateData:i},Pe}function na(){return{timestamp:0,data:{},stateData:{}}}function gn(t){return t.timestamp>0&&Date.now()-t.timestamp<3e5}function ia(t,e){let o={...t.data};for(let[i,n]of Object.entries(e))n.length>0&&(o[i]=n);return{timestamp:Date.now(),data:o}}function vn(t,e){if(t.length===0||e<1)return[];let o=t[0].t,a=(t[t.length-1].t-o||1)/e,s=[],r=0,l=t[0].v;for(let p=0;p<e;p++){let c=o+(p+1)*a,u=0,m=0;for(;r<t.length&&t[r].t<c;)u+=t[r].v,m++,r++;m>0&&(l=u/m),s.push({x:p/(e-1||1),v:l})}return s}function ra(t,e,o,i,n){let s=o-4,r=n-i||1,l=t.map(p=>({x:p.x*e,y:2+s-(p.v-i)/r*s}));return nn(l)}function sa(t,e,o,i=48){if(!t||t.length===0)return[];let n=1/0,a=-1/0;for(let s of t)for(let r of s.data)isFinite(r.v)&&(r.v<n&&(n=r.v),r.v>a&&(a=r.v));return isFinite(n)||(n=0),isFinite(a)||(a=100),t.map(s=>{let r=s.data.filter(c=>isFinite(c.v));if(r.length<2)return{entityId:s.entityId,color:s.color,d:""};let l=vn(r,i),p=ra(l,e,o,n,a);return{entityId:s.entityId,color:s.color,d:p}})}function Zs(t,e,o,i){if(!t||t.length===0)return[];let n=o??e/2-2,a=i??n*.6,s=e/2,r=e/2,l=t.map(m=>Math.max(0,m.value)),p=l.reduce((m,d)=>m+d,0);if(p===0)return[];let c=[],u=-90;for(let m=0;m<t.length;m++){if(l[m]===0)continue;let d=l[m]/p*360;d>=360&&(d=359.9);let f=u+d,g=vo(s,r,a,n,u,f);c.push({label:t[m].label,color:t[m].color,d:g,angle:d}),u=f}return c}function bn(t="pc-bloom"){return ue(t)}function Ft(t,e=1.5,o){let i=o||"-30%",n=o==="-5%"?"110%":"160%",a=o===void 0?"":` x="${i}" y="${i}" width="${n}" height="${n}"`;return`<filter id="${t}"${a}><feGaussianBlur stdDeviation="${e}" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>`}function go(t,e={}){let o=e.size||120,i=e.ariaLabel||t.map(v=>`${v.label} ${v.value}`).join(", "),n=e.centerNumStyle||"",a=e.centerLabel,s=Zs(t,o),r=t.reduce((v,b)=>v+b.value,0);if(t.length===0)return{html:"",total:0};let l=bn("donut-bloom"),p=0,c=-1;for(let v=0;v<s.length;v++){let b=t[v]?.value||0;b>p&&(p=b,c=v)}let u=o<=80?1.5:3,m=`<svg viewBox="0 0 ${o} ${o}" role="img" aria-label="${h(i)}">`;m+=`<defs>${Ft(l,u,"-30%")}</defs>`;let d=o/2-2,f=d*.6;m+=`<circle cx="${o/2}" cy="${o/2}" r="${((d+f)/2).toFixed(1)}" fill="none" stroke="var(--pulse-border-divider)" stroke-width="${(d-f).toFixed(1)}" />`;for(let v=0;v<s.length;v++){let b=s[v],y=v===c,_=y?"pc-donut-arc pc-donut-arc-active":"pc-donut-arc",$=y?` filter="url(#${l})"`:"";m+=`<path d="${b.d}" fill="${S(b.color)}" class="${_}"${$} data-segment="${h(b.label)}"><title>${h(b.label)}: ${Math.round(b.angle/360*r)}</title></path>`}m+="</svg>";let g='<div class="pc-donut-center">',w=n?` style="${n}"`:"";return g+=`<div class="pc-donut-center-num"${w}>${h(Math.round(r))}</div>`,a!=null&&(g+=`<div class="pc-donut-center-label">${h(a)}</div>`),g+="</div>",{html:m+g,total:r}}function xe(t){if(!t||t.length===0)return"";let e='<div class="pc-chart-legend">';for(let o of t){let i=S(o.color),n=h(o.label),a=o.value!==void 0&&o.value!==null?` ${h(o.value)}`:"";e+=`<span class="pc-legend-chip"><span class="pc-legend-dot" style="background:${i}"></span>${n}${a}</span>`}return e+="</div>",e}var wn=[{upper:14,color:"#1565C0"},{upper:16,color:"#4FC3F7"},{upper:17,color:"#4DB6AC"},{upper:18,color:"#81C784"},{upper:19,color:"#AED581"},{upper:20,color:"#C5E1A5"},{upper:21,color:"#FFF176"},{upper:22,color:"#FFB74D"},{upper:23,color:"#FF8A65"},{upper:24,color:"#EF5350"},{upper:null,color:"#C62828"}];function rt(t){for(let e of wn)if(e.upper===null||t<=e.upper)return e.color;return"#C62828"}function Be(t){return t<=20?"#C62828":t<=30?"#EF5350":t<=35?"#FF8A65":t<=40?"#FFB74D":t<=45?"#AED581":t<=55?"#4CAF50":t<=60?"#AED581":t<=65?"#4DB6AC":t<=70?"#4FC3F7":t<=80?"#1E88E5":"#1565C0"}function vo(t,e,o,i,n,a){let s=n*Math.PI/180,r=a*Math.PI/180,l=a-n,p=Math.abs(l)>180?1:0,c=t+i*Math.cos(s),u=e+i*Math.sin(s),m=t+i*Math.cos(r),d=e+i*Math.sin(r),f=t+o*Math.cos(r),g=e+o*Math.sin(r),w=t+o*Math.cos(s),v=e+o*Math.sin(s);return[`M${c.toFixed(2)},${u.toFixed(2)}`,`A${i.toFixed(2)},${i.toFixed(2)} 0 ${p} 1 ${m.toFixed(2)},${d.toFixed(2)}`,`L${f.toFixed(2)},${g.toFixed(2)}`,`A${o.toFixed(2)},${o.toFixed(2)} 0 ${p} 0 ${w.toFixed(2)},${v.toFixed(2)}`,"Z"].join(" ")}function Pt(t,e,o,i=48){if(!t||t.length<2)return null;let n=t.filter(m=>isFinite(m.v));if(n.length<2)return null;let a=Date.now(),s=n[n.length-1];a-s.t>6e5&&n.push({t:a,v:s.v});let r=vn(n,i);if(r.length<2)return null;let l=1/0,p=-1/0;for(let m of r)m.v<l&&(l=m.v),m.v>p&&(p=m.v);isFinite(l)||(l=0),isFinite(p)||(p=100);let c=ra(r,e,o,l,p);if(!c)return null;let u=`${c} L${e.toFixed(1)},${o.toFixed(1)} L0,${o.toFixed(1)} Z`;return{linePath:c,areaPath:u}}function yn(t,e=24,o=""){if(!t||t.length<2)return"";let i=t.filter(p=>isFinite(p.v));if(i.length<2)return"";let n=vn(i,e),a=i[0].t,s=i[i.length-1].t,r=i.every(p=>Number.isInteger(p.v)),l={u:o,d:[]};return l.d=n.map(p=>{let c=a+p.x*(s-a),u=new Date(c),m=`${String(u.getHours()).padStart(2,"0")}:${String(u.getMinutes()).padStart(2,"0")}`,d=r?Math.round(p.v):Math.round(p.v*10)/10;return{l:m,v:d}}),JSON.stringify(l)}function Yt(t,e,o,i,n,a=""){if(!t||t.length<2)return"";let s=Pt(t,e,o,24);if(!s)return"";let r=S(i),l=`<div class="pc-sparkline-filled" style="height:${o}px">`;return l+=`<svg viewBox="0 0 ${e} ${o}" role="img" aria-label="${h(a)}" preserveAspectRatio="none" style="width:100%;height:${o}px;display:block">`,l+=`<defs><linearGradient id="${h(n)}" x1="0" y1="0" x2="0" y2="1">`,l+=`<stop offset="0%" stop-color="${r}" stop-opacity="0.3"/>`,l+=`<stop offset="100%" stop-color="${r}" stop-opacity="0"/>`,l+="</linearGradient></defs>",l+=`<path d="${s.areaPath}" fill="url(#${h(n)})" />`,l+=`<path d="${s.linePath}" fill="none" stroke="${r}" stroke-width="1.5" />`,l+="</svg></div>",l}var Ks=new Set(["friendly_name","icon","unit_of_measurement","device_class"]);function bo(t,e){let o=[],i=0;if(Array.isArray(t.chart_data)&&t.chart_data.length>0){for(let n of t.chart_data)n.type&&typeof n.count=="number"&&(o.push({label:n.type,value:Math.max(0,n.count),color:e[i%e.length]}),i++);return o}if(t.breakdown_24h&&typeof t.breakdown_24h=="object"){for(let[n,a]of Object.entries(t.breakdown_24h)){let s=Number(a);!isNaN(s)&&s>0&&(o.push({label:n,value:s,color:e[i%e.length]}),i++)}return o}for(let[n,a]of Object.entries(t)){if(Ks.has(n))continue;let s=Number(a);isNaN(s)||(o.push({label:n,value:Math.max(0,s),color:e[i%e.length]}),i++)}return o}var aa={heating:{cold:"#171717",hot:"#ff9f0a"},cooling:{cold:"#171717",hot:"#5ac8fa"},idle:{cold:"#171717",hot:"#525252"},off:{cold:"#171717",hot:"#262626"}};function la(t,e,o){let i=o&&aa[o]||aa.off,n=(e?.maxTemp??30)-(e?.minTemp??0);if(n<=0)return i.cold;let a=Math.max(0,Math.min(1,(t-(e?.minTemp??0))/n));return Ei(i.cold,i.hot,a)}function Ys(t,e,o,i){let n=e.show_temp_bar??o.show_temp_bar??!0,a=e.show_power_bar??o.show_power_bar??!0,s=t.isUnavailable?" pc-unavailable":"",r=!t.isUnavailable&&t.currentTemp!==null&&t.currentTemp!==void 0&&t.targetTemp!==null&&t.targetTemp!==void 0&&Math.abs(t.currentTemp-t.targetTemp)<=.3,l,p;t.isUnavailable?(l=" pc-row-unavail",p='<span class="pc-state-tag pc-tag-unavail">Unavail</span>'):t.hvacAction==="heating"?(l=" pc-row-heat",p='<span class="pc-state-tag pc-tag-heat">Heat</span>'):t.hvacAction==="cooling"?(l=" pc-row-cool",p='<span class="pc-state-tag pc-tag-cool">Cool</span>'):t.hvacAction==="off"?(l=" pc-row-off",p='<span class="pc-state-tag pc-tag-off">Off</span>'):r?(l=" pc-row-at-target",p='<span class="pc-state-tag pc-tag-at-target">At target</span>'):(l=" pc-row-idle",p='<span class="pc-state-tag pc-tag-idle">Idle</span>');let c=t.isUnavailable?"":t.currentTemp!==null?`${Z(t.currentTemp)}${h(t.unit)}`:"--",u=!t.isUnavailable&&t.targetTemp!==null?`<span class="pc-zone-target">\u2192 ${Z(t.targetTemp)}${h(t.unit)}</span>`:"",m=!t.isUnavailable&&t.humidity!==null?` <span class="pc-zone-humidity"><ha-icon icon="mdi:water-percent"></ha-icon>${Math.round(t.humidity)}%</span>`:"",d=t.isUnavailable?`${h(t.name)}: Unavailable`:`${h(t.name)}: ${c}${t.targetTemp!==null?`, target ${Z(t.targetTemp)}${t.unit}`:""}${t.humidity!==null?`, ${Math.round(t.humidity)}% humidity`:""}, ${t.hvacAction}`,f=`<div class="pc-zone-row${s}${l}" tabindex="0" role="button"
    aria-label="${h(d)}" data-entity="${h(t.entityId)}">`;if(f+='<div class="pc-row-ribbon"></div>',f+='<div class="pc-zone-header">',f+=`<span class="pc-zone-name">${t.icon&&t.icon!=="mdi:thermometer"?`<ha-icon icon="${h(t.icon)}"></ha-icon> `:""}${h(t.name)}${m}</span>`,f+=`<span class="pc-zone-temp">${c}${u}${p}</span>`,f+="</div>",n&&!t.isUnavailable){let w=t.currentTemp!==null?Oe(t.currentTemp,t.minTemp,t.maxTemp):50,v=t.targetTemp!==null?Oe(t.targetTemp,t.minTemp,t.maxTemp):null,b=rt(t.minTemp),y=rt((t.minTemp+t.maxTemp)/2),_=rt(t.maxTemp),$=`linear-gradient(to right, ${S(b)}, ${S(y)}, ${S(_)})`;f+='<div class="pc-temp-gauge">',f+=`<div class="pc-temp-gauge-bg" style="background:${$}"></div>`,f+=`<div class="pc-temp-gauge-current" style="left:${S(w.toFixed(1))}%"></div>`,v!==null&&(f+=`<div class="pc-temp-gauge-target" style="left:${S(v.toFixed(1))}%"></div>`),f+="</div>"}if(a&&!t.isUnavailable){let w=t.heatingPower||t.coolingPower||0,v=be(t.hvacAction),b=v.token||v.fallback;if(w>0||t.hvacAction==="heating"||t.hvacAction==="cooling"){let y=Math.min(100,Math.max(0,w)),_=w>0?" pc-bar-active":"";f+='<div class="pc-power-bar-container">',f+='<div class="pc-power-bar-track"></div>',f+=`<div class="pc-power-bar-fill${_}" style="width:${S(y.toFixed(1))}%;background:${S(b)};--pc-bar-glow:${S(v.fallback)}40"></div>`,f+="</div>"}}if(t.chips.length>0){f+='<div class="pc-zone-chips">';for(let w of t.chips){let v=w.severity?` pc-severity-${w.severity.toLowerCase()}`:"",b=w.color?` style="color:${S(w.color)}"`:"",y=w.entityId?` data-entity="${h(w.entityId)}"`:"";f+=`<span class="pc-chip${v}"${b}${y} data-chip-type="${h(w.type)}">`,f+=`<ha-icon icon="${h(w.icon)}"></ha-icon>`,f+=`${h(w.label)}`,f+="</span>"}f+="</div>"}let g=e.sparkline?.mode||"overlay";if(g==="pulse"&&!t.isUnavailable)return Js(t,e,i);if(!t.isUnavailable&&i&&i.length>=2){let w=be(t.hvacAction),v=e.color||w.fallback;g==="prominent"&&(f+=Qs(v,i,t.unit,t.entityId))}return f+="</div>",f}function Js(t,e,o){let i=be(t.hvacAction),n=t.heatingPower>0||t.hvacAction==="heating",a=t.hvacAction==="cooling",s=n||a,r=s?e.color||i.fallback:"var(--pulse-text-secondary)",l=S(r),p=h(t.entityId).replace(/\./g,"-"),c=t.heatingPower||t.coolingPower||0,u=t.hvacAction==="heating"?`Heating ${Math.round(c)}%`:t.hvacAction==="cooling"?`Cooling ${Math.round(c)}%`:"Idle",m=t.currentTemp!==null?`${Z(t.currentTemp)}${h(t.unit)}`:"--",d=t.targetTemp!==null?`\u2192 ${Z(t.targetTemp)}${h(t.unit)}`:"",f=`${h(t.name)}: ${m}, ${u}`,g=`pc-zone-row pc-zone-row-pulse${n?" pc-heating":""}`,w=yn(o||[],24,t.unit),v=`<div class="${g}" tabindex="0" role="button"
    aria-label="${h(f)}" data-entity="${h(t.entityId)}"${w?` data-sparkline='${h(w)}'`:""}>`;if(o&&o.length>=2){let b=Pt(o,360,56,60);if(b){let y=`pulse-grad-${p}`,_=`pulse-glow-${p}`,$=s?" pc-heating-glow":"",A=s?"0.55":"0.2",M=s?"0.05":"0.02",C=s?"2":"1.5",E=s?"1":"0.5";v+='<svg class="pc-pulse-bg" viewBox="0 0 360 56" preserveAspectRatio="none">',v+="<defs>",v+=`<linearGradient id="${y}" x1="0" y1="0" x2="0" y2="1">`,v+=`<stop offset="0%" stop-color="${l}" stop-opacity="${A}"/>`,v+=`<stop offset="100%" stop-color="${l}" stop-opacity="${M}"/>`,v+="</linearGradient>",s&&(v+=Ft(_,ye(360,360).toFixed(1))),v+="</defs>",v+=`<path d="${b.areaPath}" fill="url(#${y})" />`,v+=`<path d="${b.linePath}" fill="none" stroke="${l}" stroke-width="${C}" opacity="${E}"`,s&&(v+=` filter="url(#${_})" class="${$}"`),v+=" />",v+="</svg>"}}return v+='<div class="pc-pulse-info">',v+='<div class="pc-pulse-info-left">',v+=`<div class="pc-zone-name">${t.icon&&t.icon!=="mdi:thermometer"?`<ha-icon icon="${h(t.icon)}"></ha-icon> `:""}${h(t.name)}</div>`,v+='<div class="pc-pulse-status">',v+=`<span class="pc-status-dot" style="background:${l}"></span>`,v+=`${h(u)}`,v+="</div>",v+="</div>",v+='<div class="pc-pulse-info-right">',v+=`<span class="pc-pulse-current">${h(m)}</span>`,d&&(v+=`<span class="pc-zone-target">${d}</span>`),v+="</div>",v+="</div>",v+="</div>",v}function Qs(t,e,o,i){let n=Pt(e,300,40,48);if(!n){let c=me(e,300,40,48,"avg",!0);return c?`<div class="pc-sparkline-prominent"><svg viewBox="0 0 300 40" preserveAspectRatio="none"><path d="${c}" fill="none" stroke="${S(t)}" stroke-width="1.5" opacity="0.7" /></svg></div>`:""}let s=`prom-grad-${i?i.replace(/[^a-z0-9]/gi,"-"):String(Math.random()).slice(2,8)}`,r=S(t),l=yn(e,24,o),p=`<div class="pc-sparkline-filled pc-sparkline-prominent"${l?` data-sparkline='${h(l)}'`:""}>`;return p+='<svg viewBox="0 0 300 40" preserveAspectRatio="none">',p+=`<defs><linearGradient id="${h(s)}" x1="0" y1="0" x2="0" y2="1">`,p+=`<stop offset="0%" stop-color="${r}" stop-opacity="0.3"/>`,p+=`<stop offset="100%" stop-color="${r}" stop-opacity="0"/>`,p+="</linearGradient></defs>",p+=`<path d="${n.areaPath}" fill="url(#${h(s)})" />`,p+=`<path d="${n.linePath}" fill="none" stroke="${r}" stroke-width="1.5" opacity="0.7" />`,p+="</svg></div>",p}function _n(t,e,o,i,n){if(!t||t.length===0)return"";let a=Number(e.columns)||1,s=a>1?" pc-columns":"",r=a>1?` style="grid-template-columns:repeat(${Number(a)}, 1fr)"`:"",l=`<div class="pc-section pc-section-zones${s}"${r}>`,p=i?.hubEntities?.home_state,c=p?o[p]:null;if(Q(c))l+='<div class="pulse-section-label">Zones</div>';else{let u=c.state==="on",m=u?"mdi:home":"mdi:home-export-outline",d=u?"Home":"Away",f=u?"var(--pulse-tier-moderate)":"var(--pulse-text-secondary)";l+='<div class="pc-section-header pc-section-header-center">',l+='<div class="pulse-section-label">Zones</div>',l+=`<span class="pc-chip" data-entity="${h(p)}" style="color:${S(f)}">`,l+=`<ha-icon icon="${h(m)}"></ha-icon>${h(d)}</span>`,l+="</div>"}for(let u of t){let{entityId:m,zoneEntities:d,zoneState:f}=at(u,i,o,e),g=ht(m,o,d,u),w=n?.data?.[g.entityId]||n?.data?.[m]||[];l+=Ys(f,u,e,w)}return l+="</div>",l}function ca(t,e,o,i,n,a){if(!t||!e)return;let s=t.querySelectorAll(".pc-zone-row");for(let r=0;r<e.length;r++){let l=e[r],p=l.entity,c=i[p],u=a[p];if(c===u&&s[r])continue;let{zoneState:m}=at(l,n,i,o),d=s[r];if(!d)continue;let f=d.querySelector(".pc-zone-temp");if(f){let y=m.isUnavailable?"":m.currentTemp!==null?`${Z(m.currentTemp)}${m.unit}`:"--",_=!m.isUnavailable&&m.targetTemp!==null?`<span class="pc-zone-target">\u2192 ${Z(m.targetTemp)}${h(m.unit)}</span>`:"";f.innerHTML=`${h(y)}${_}`}let g=d.querySelector(".pc-power-bar-fill");if(g){let y=m.heatingPower||m.coolingPower||0,_=be(m.hvacAction),$=_.token||_.fallback;g.style.width=`${Math.min(100,Math.max(0,y)).toFixed(1)}%`,g.style.background=$,g.style.setProperty("--pc-bar-glow",`${_.fallback}40`),g.classList.toggle("pc-bar-active",y>0)}let w=d.querySelector(".pc-temp-gauge-current");if(w&&m.currentTemp!==null){let y=Oe(m.currentTemp,m.minTemp,m.maxTemp);w.style.left=`${y.toFixed(1)}%`}let v=d.querySelector(".pc-temp-gauge-target");if(v&&m.targetTemp!==null){let y=Oe(m.targetTemp,m.minTemp,m.maxTemp);v.style.left=`${y.toFixed(1)}%`}let b=d.querySelector(".pc-temp-gauge-bg");if(b&&!m.isUnavailable){let y=rt(m.minTemp),_=rt((m.minTemp+m.maxTemp)/2),$=rt(m.maxTemp);b.style.background=`linear-gradient(to right, ${y}, ${_}, ${$})`}m.isUnavailable?d.classList.add("pc-unavailable"):d.classList.remove("pc-unavailable")}}function qe(t){return!!(t?.api_usage&&t?.api_limit)}function pa(t){return t>95?"var(--pulse-tier-gale)":t>80?"var(--pulse-tier-strong)":"var(--pulse-tier-moderate)"}function tl(t){let e=(t||"").toLowerCase();return e==="ok"||e==="healthy"?"var(--pulse-tier-moderate)":e==="warning"?"var(--pulse-tier-strong)":"var(--pulse-tier-gale)"}function el(t,e){let o=e>0?Math.min(100,t/e*100):0,i=pa(o),n=80,a=n/2,s=n/2,r=n/2-4,l=r*.7,p=vo(a,s,l,r,-90,269.9),c=-90+o/100*360,u=o>0?vo(a,s,l,r,-90,Math.min(c,269.9)):"",m=o>95,d=o>80,f=m||d,g='<div class="pc-usage-gauge">';if(g+=`<svg viewBox="0 0 ${n} ${n}" role="img" aria-label="API usage: ${Math.round(t)} of ${Math.round(e)}" style="width:${n}px;height:${n}px">`,f&&(g+=`<defs>${Ft("gauge-glow",2)}</defs>`),g+=`<path d="${p}" fill="var(--pulse-border-divider)" />`,u){if(g+=`<path d="${u}" fill="${S(i)}"${f?' filter="url(#gauge-glow)"':""}>`,g+=`<title>API usage: ${Math.round(o)}%</title>`,f){let b=m?"1":"2.5";Rt()||(g+=`<animate attributeName="opacity" values="1;0.5;1" dur="${b}s" repeatCount="indefinite"/>`)}g+="</path>"}g+="</svg>";let w=h(Math.round(t)),v=h(Math.round(e));return g+=`<div class="pc-gauge-center">${w}<br><span class="pc-gauge-center-limit">/ ${v}</span></div>`,g+="</div>",g}function ol(t,e,o){let i=e?.data?.[t]||[];return Yt(i,200,40,o,"api-hist-grad","API usage history")}function nl(t){let e=bo(t,Dt);if(e.length===0)return"";let o=60,i='<div class="pc-api-breakdown-row">';i+=`<div class="pc-donut-container pc-api-breakdown-donut" style="width:${o}px;height:${o}px">`;let{html:n}=go(e,{size:o,ariaLabel:"API call breakdown",centerNumStyle:"font-size:var(--pulse-font-body)"});return i+=n,i+="</div>",i+=xe(e.map(a=>({label:a.label,color:a.color,value:String(Math.round(a.value))}))),i+="</div>",i}function wo(t,e,o,i){if(!qe(t))return"";let n=parseFloat(e[t.api_usage]?.state)||0,a=parseFloat(e[t.api_limit]?.state)||100,s=a>0?Math.min(100,n/a*100):0,r=pa(s),l=e[t.api_status]?.state||"unknown",p=tl(l),c='<div class="pc-api-dashboard">';c+='<div class="pc-api-row">',c+=el(n,a);let u=t.api_usage;if(u&&i&&(c+=ol(u,i,r)),c+="</div>",t.api_breakdown&&e[t.api_breakdown]&&(c+='<div class="pc-api-row">',c+=nl(e[t.api_breakdown].attributes||{}),c+="</div>"),c+='<div class="pc-zone-chips">',t.call_history&&e[t.call_history]){let m=e[t.call_history].attributes?.calls_per_hour;m!=null&&Number(m)>0&&(c+=`<span class="pc-chip" data-entity="${h(t.call_history)}">`,c+=`<ha-icon icon="mdi:speedometer"></ha-icon>${h(Math.round(Number(m)))}/hr</span>`)}if(t.polling_interval&&e[t.polling_interval]){let m=e[t.polling_interval],d=m.attributes?.unit_of_measurement||"";c+=`<span class="pc-chip" data-entity="${h(t.polling_interval)}">Poll: ${h(m.state)}${d?h(d):""}</span>`}if(t.next_sync&&e[t.next_sync]){let m=e[t.next_sync].state,d=m,f=0;if(m&&m.includes("T"))try{let g=new Date(m);f=g.getTime();let w=f-Date.now();if(w>0&&w<36e5){let v=Math.floor(w/6e4),b=Math.floor(w%6e4/1e3);d=v>0?`${v}m ${b}s`:`${b}s`}else d=dt(g)}catch{}c+=`<span class="pc-chip chip-next-sync" data-entity="${h(t.next_sync)}" data-target="${f}">Next: ${h(d)}</span>`}if(t.api_reset&&e[t.api_reset]){let m=e[t.api_reset].state,d=m;if(m&&m.includes("T"))try{let f=new Date(m);d=dt(f)}catch{}c+=`<span class="pc-chip" data-entity="${h(t.api_reset)}">Reset: ${h(d)}</span>`}return t.token_status&&e[t.token_status]&&(c+=`<span class="pc-chip" data-entity="${h(t.token_status)}">Token: ${h(e[t.token_status].state)}</span>`),c+=`<span class="pc-chip" data-entity="${t.api_status?h(t.api_status):""}" style="color:${S(p)}">${h(l)}</span>`,c+="</div>",c+="</div>",c}function xn(t,e,o,i){if(!qe(t))return"";let n='<div class="pc-section pc-section-api">';return n+='<div class="pulse-section-label">API Usage</div>',n+=wo(t,e,o,i),n+="</div>",n}function We(t){return!!t?.bridge_connected}function yo(t,e,o){if(!We(t))return"";let i=e[t.bridge_connected];if(!i)return"";let n=i.state==="on",a=n?"var(--pulse-tier-moderate)":"var(--pulse-tier-gale)",s=n?"Connected":"Disconnected",r=n?"pc-pulse-dot pc-connected":"pc-pulse-dot pc-disconnected",l=i.attributes||{},p=l.response_time_ms,c=l.consecutive_failures,u=l.last_error,m=t.boiler_flow_temp&&e[t.boiler_flow_temp]?.attributes?.unit_of_measurement||"\xB0C",d="";if(d+='<div class="pc-zone-chips">',d+=`<span class="pc-chip" data-entity="${h(t.bridge_connected)}" style="color:${S(a)}">`,d+=`<span class="${r}"></span>`,d+=`${h(s)}</span>`,p!==void 0&&(d+=`<span class="pc-chip" data-entity="${h(t.bridge_connected)}">${h(Math.round(p))}ms</span>`),c!==void 0&&c>0&&(d+=`<span class="pc-chip" data-entity="${h(t.bridge_connected)}" style="color:var(--pulse-tier-gale)">Failures: ${h(c)}</span>`),d+="</div>",t.boiler_flow_temp&&e[t.boiler_flow_temp]){let w=parseFloat(e[t.boiler_flow_temp].state),v=e[t.boiler_flow_temp].state,b=isNaN(w)?"var(--pulse-text-primary)":rt(w);if(d+='<div class="pc-flow-temp-row">',d+=`<span class="pc-flow-temp-value" style="color:${S(b)}">${h(v)}${h(m)}</span>`,o){let y=o.data?.[t.boiler_flow_temp]||[],_=Yt(y,120,30,b,"bridge-flow-grad","Boiler flow temperature history");_&&(d+=`<div class="pc-flow-sparkline">${_}</div>`)}d+="</div>"}let f=t.wc_status&&e[t.wc_status],g=t.wc_target_flow&&e[t.wc_target_flow];if((f||g)&&(d+='<div class="pc-zone-chips">',f&&(d+=`<span class="pc-chip" data-entity="${h(t.wc_status)}">${h(e[t.wc_status].state)}</span>`),g&&(d+=`<span class="pc-chip" data-entity="${h(t.wc_target_flow)}">Target: ${h(e[t.wc_target_flow].state)}${h(m)}</span>`),d+="</div>"),t.boiler_max_output&&e[t.boiler_max_output]){let w=e[t.boiler_max_output].state;w!=="unavailable"&&w!=="unknown"&&(d+='<div class="pc-zone-chips">',d+=`<span class="pc-chip" data-entity="${h(t.boiler_max_output)}">`,d+=`<ha-icon icon="mdi:thermometer-high"></ha-icon>Max: ${h(w)}${h(m)}</span>`,d+="</div>")}return u&&u!=="None"&&u!=="null"&&(d+='<div class="pc-zone-chips">',d+=`<span class="pc-chip" style="color:var(--pulse-tier-gale)">Error: ${h(u)}</span>`,d+="</div>"),d}function $n(t,e,o){if(!We(t))return"";let i='<div class="pc-section pc-section-bridge">';return i+='<div class="pulse-section-label">Bridge</div>',i+=yo(t,e,o),i+="</div>",i}var _o="var(--pulse-tier-moderate)",da="var(--pulse-accent)";function $e(t){return!!t?.homekit_connected}function xo(t,e){if(!$e(t))return"";let o=e[t.homekit_connected];if(!o)return"";let i=o.attributes||{},n=t.homekit_reads_saved?e[t.homekit_reads_saved]:null,a=t.homekit_writes_saved?e[t.homekit_writes_saved]:null,s=n?Number(n.state)||0:Number(i.reads_saved_today)||0,r=a?Number(a.state)||0:Number(i.writes_saved_today)||0,l=s+r;return l>0?` \xB7 ${l} saved`:""}function $o(t,e,o){if(!$e(t))return"";let i=e[t.homekit_connected];if(!i)return"";let n=i.state==="on",a=n?_o:"var(--pulse-tier-gale)",s=n?"Connected":"Disconnected",r=n?"pc-pulse-dot pc-connected":"pc-pulse-dot pc-disconnected",l=i.attributes||{},p=l.uptime||"",c=l.mapped_zones,u=l.reconnect_count,m=t.homekit_reads_saved?e[t.homekit_reads_saved]:null,d=t.homekit_writes_saved?e[t.homekit_writes_saved]:null,f=m?Number(m.state)||0:Number(l.reads_saved_today)||0,g=d?Number(d.state)||0:Number(l.writes_saved_today)||0,w=f+g,v="";if(v+='<div class="pc-zone-chips">',v+=`<span class="pc-chip" data-entity="${h(t.homekit_connected)}" style="color:${S(a)}">`,v+=`<span class="${r}"></span>`,v+=`${h(s)}`,p&&(v+=` <span class="pc-chip-aside">${h(p)}</span>`),v+="</span>",c!==void 0&&(v+=`<span class="pc-chip">${h(c)} zones</span>`),u!==void 0&&u>0&&(v+=`<span class="pc-chip" style="color:var(--pulse-tier-strong)">Reconnects: ${h(u)}</span>`),v+="</div>",f>0||g>0){let A=w>0?f/w*100:100;v+='<div class="pc-homekit-bar-stack">',v+='<div class="pc-power-bar-container">',v+='<div class="pc-power-bar-track"></div>',v+=`<div class="pc-power-bar-fill" style="width:100%;background:${S(da)}"></div>`,v+=`<div class="pc-power-bar-fill" style="width:${S(A.toFixed(1))}%;background:${S(_o)}"></div>`,v+="</div>",v+="</div>";let M=t.homekit_reads_saved;if(M&&o){let z=o.data?.[M]||[];v+=Yt(z,200,30,_o,"hk-spark-grad","HomeKit saved calls history")}v+='<div class="pc-zone-chips">';let C=t.homekit_reads_saved||"",E=t.homekit_writes_saved||"";v+=`<span class="pc-chip"${C?` data-entity="${h(C)}"`:""} style="color:${S(_o)}">Reads: ${h(f)}</span>`,g>0&&(v+=`<span class="pc-chip"${E?` data-entity="${h(E)}"`:""} style="color:${S(da)}">Writes: ${h(g)}</span>`),v+="</div>"}let b=Number(l.write_attempts)||0,y=Number(l.write_successes)||0,_=Number(l.write_fallbacks)||0,$=Number(l.write_avg_latency_ms)||0;return(b>0||y>0||_>0)&&(v+='<div class="pc-zone-chips">',b>0&&(v+=`<span class="pc-chip">Attempts: ${h(b)}</span>`),y>0&&(v+=`<span class="pc-chip">Successes: ${h(y)}</span>`),_>0&&(v+=`<span class="pc-chip" style="color:var(--pulse-tier-strong)">Fallbacks: ${h(_)}</span>`),$>0&&(v+=`<span class="pc-chip">Latency: ${h($)}ms</span>`),v+="</div>"),v}function Sn(t,e,o){if(!$e(t))return"";let i=xo(t,e),n='<div class="pc-section pc-section-homekit">';return n+=`<div class="pulse-section-label">HomeKit${h(i)}</div>`,n+=$o(t,e,o),n+="</div>",n}function il(t){return{sunny:"mdi:weather-sunny",clear:"mdi:weather-night",cloudy:"mdi:weather-cloudy",partlycloudy:"mdi:weather-partly-cloudy",rainy:"mdi:weather-rainy",snowy:"mdi:weather-snowy",fog:"mdi:weather-fog",windy:"mdi:weather-windy",lightning:"mdi:weather-lightning"}[(t||"").toLowerCase()]||"mdi:weather-cloudy"}function kn(t,e,o){if(!t.outside_temp)return"";let i=e[t.outside_temp]?.state,n=e[t.weather]?.state||"",a=t.solar_intensity?e[t.solar_intensity]?.state:null,s='<div class="pc-section pc-section-weather">';s+='<div class="pulse-section-label">Weather</div>',s+='<div class="pc-zone-chips">',n&&(s+=`<span class="pc-chip"${t.weather?` data-entity="${h(t.weather)}"`:""}><ha-icon icon="${h(il(n))}"></ha-icon>${h(n)}</span>`),i!=null&&(s+=`<span class="pc-chip" data-entity="${h(t.outside_temp)}"><ha-icon icon="mdi:thermometer"></ha-icon>${h(i)}${h(e[t.outside_temp]?.attributes?.unit_of_measurement||"\xB0C")}</span>`),a!=null&&(s+=`<span class="pc-chip"${t.solar_intensity?` data-entity="${h(t.solar_intensity)}"`:""}><ha-icon icon="mdi:white-balance-sunny"></ha-icon>${h(a)}%</span>`),s+="</div>";let r=t.outside_temp;if(r&&o){let l=o.data?.[r]||[],p=parseFloat(i||"0"),c=isNaN(p)?"var(--pulse-text-primary)":rt(p);s+=Yt(l,200,30,c,"weather-spark-grad","Outdoor temperature history")}return s+="</div>",s}function Tn(t,e,o){let i=!1,n='<div class="pc-section pc-section-environment">';n+='<div class="pulse-section-label">Environment</div>';for(let a of t){let s=K(a.entity),r=o?.zoneEntities?.[s]||{},l=r.mold_risk&&e[r.mold_risk],p=r.condensation&&e[r.condensation],c=r.comfort_level&&e[r.comfort_level],u=r.surface_temp&&e[r.surface_temp],m=r.dew_point&&e[r.dew_point];if(!l&&!p&&!c&&!u&&!m)continue;i=!0;let d=a.name||e[a.entity]?.attributes?.friendly_name||s;if(n+=`<div class="pc-system-row"><span class="pc-system-label">${h(d)}</span>`,n+='<div class="pc-zone-chips">',l){let f=e[r.mold_risk].state,g=fo(f);n+=`<span class="pc-chip" data-entity="${h(r.mold_risk)}" style="color:${S(g.fallback)}">`,n+=`<ha-icon icon="mdi:mushroom"></ha-icon>${h(f)}</span>`}if(p){let f=e[r.condensation].state,g=fo(f);n+=`<span class="pc-chip" data-entity="${h(r.condensation)}" style="color:${S(g.fallback)}">`,n+=`<ha-icon icon="mdi:water-alert"></ha-icon>${h(f)}</span>`}c&&(n+=`<span class="pc-chip" data-entity="${h(r.comfort_level)}"><ha-icon icon="mdi:emoticon-outline"></ha-icon>${h(e[r.comfort_level].state)}</span>`),u&&(n+=`<span class="pc-chip" data-entity="${h(r.surface_temp)}"><ha-icon icon="mdi:texture-box"></ha-icon>${h(e[r.surface_temp].state)}${h(e[r.surface_temp]?.attributes?.unit_of_measurement||"\xB0C")}</span>`),m&&(n+=`<span class="pc-chip" data-entity="${h(r.dew_point)}"><ha-icon icon="mdi:water-thermometer"></ha-icon>${h(e[r.dew_point].state)}${h(e[r.dew_point]?.attributes?.unit_of_measurement||"\xB0C")}</span>`),n+="</div></div>"}return n+="</div>",i?n:""}function An(t,e,o){let i=!1,n='<div class="pc-section pc-section-thermal">';n+='<div class="pulse-section-label">Thermal Analytics</div>';for(let a of t){let s=K(a.entity),r=o?.zoneEntities?.[s]||{},l=r.heating_rate&&e[r.heating_rate],p=r.thermal_inertia&&e[r.thermal_inertia],c=r.preheat_time&&e[r.preheat_time],u=r.confidence&&e[r.confidence],m=r.heat_accel&&e[r.heat_accel],d=r.approach_factor&&e[r.approach_factor];if(!l&&!p&&!c&&!u&&!m&&!d)continue;i=!0;let f=a.name||e[a.entity]?.attributes?.friendly_name||s;n+=`<div class="pc-system-row"><span class="pc-system-label">${h(f)}</span>`,n+='<div class="pc-zone-chips">',l&&(n+=`<span class="pc-chip" data-entity="${h(r.heating_rate)}"><ha-icon icon="mdi:trending-up"></ha-icon>${h(e[r.heating_rate].state)}${h(e[r.heating_rate]?.attributes?.unit_of_measurement||"\xB0C/hr")}</span>`),p&&(n+=`<span class="pc-chip" data-entity="${h(r.thermal_inertia)}"><ha-icon icon="mdi:speedometer"></ha-icon>${h(e[r.thermal_inertia].state)}</span>`),c&&(n+=`<span class="pc-chip" data-entity="${h(r.preheat_time)}"><ha-icon icon="mdi:timer-outline"></ha-icon>${h(e[r.preheat_time].state)} min</span>`),u&&(n+=`<span class="pc-chip" data-entity="${h(r.confidence)}"><ha-icon icon="mdi:check-circle-outline"></ha-icon>${h(e[r.confidence].state)}%</span>`),m&&(n+=`<span class="pc-chip" data-entity="${h(r.heat_accel)}"><ha-icon icon="mdi:rocket-launch"></ha-icon>${h(e[r.heat_accel].state)}${h(e[r.heat_accel]?.attributes?.unit_of_measurement||"")}</span>`),d&&(n+=`<span class="pc-chip" data-entity="${h(r.approach_factor)}"><ha-icon icon="mdi:target"></ha-icon>${h(e[r.approach_factor].state)}${h(e[r.approach_factor]?.attributes?.unit_of_measurement||"")}</span>`),n+="</div></div>"}return n+="</div>",i?n:""}function Cn(t,e,o){let i=!1,n='<div class="pc-section pc-section-schedule">';n+='<div class="pulse-section-label">Schedule</div>';for(let a of t){let s=K(a.entity),r=o?.zoneEntities?.[s]||{},l=r.next_schedule&&e[r.next_schedule],p=r.schedule_deviation&&e[r.schedule_deviation],c=r.preheat_advisor&&e[r.preheat_advisor],u=r.comfort_target&&e[r.comfort_target];if(!l&&!p&&!c&&!u)continue;i=!0;let m=a.name||e[a.entity]?.attributes?.friendly_name||s;if(n+=`<div class="pc-system-row"><span class="pc-system-label">${h(m)}</span>`,n+='<div class="pc-zone-chips">',l){let d=r.next_sched_temp&&e[r.next_sched_temp]?` \u2192 ${h(e[r.next_sched_temp].state)}${h(e[r.next_sched_temp]?.attributes?.unit_of_measurement||"\xB0C")}`:"";n+=`<span class="pc-chip" data-entity="${h(r.next_schedule)}"><ha-icon icon="mdi:calendar-clock"></ha-icon>${h(e[r.next_schedule].state)}${d}</span>`}p&&(n+=`<span class="pc-chip" data-entity="${h(r.schedule_deviation)}"><ha-icon icon="mdi:swap-vertical"></ha-icon>${h(e[r.schedule_deviation].state)}${h(e[r.schedule_deviation]?.attributes?.unit_of_measurement||"\xB0C")}</span>`),c&&(n+=`<span class="pc-chip" data-entity="${h(r.preheat_advisor)}"><ha-icon icon="mdi:radiator"></ha-icon>${h(e[r.preheat_advisor].state)}</span>`),u&&(n+=`<span class="pc-chip" data-entity="${h(r.comfort_target)}"><ha-icon icon="mdi:target"></ha-icon>${h(e[r.comfort_target].state)}${h(e[r.comfort_target]?.attributes?.unit_of_measurement||"\xB0C")}</span>`),n+="</div></div>"}return n+="</div>",i?n:""}function al(){return ue("graph-grad")}function rl(t,e){let o=e&&e.length>0?e:Dt;return o[t%o.length]}function sl(t,e,o){let n=[];for(let l of t){let p=Pt(l.data,300,e,48);p&&n.push({...p,color:l.color,entityId:l.entityId})}if(n.length===0){let l=sa(t,300,e);if(!l.some(u=>u.d!==""))return'<div class="pc-chart-empty">No data available</div>';let c=`<svg viewBox="0 0 300 ${e}" role="img" aria-label="${h(o)}" class="pc-chart-svg" preserveAspectRatio="none">`;for(let u of l)u.d!==""&&(c+=`<path d="${u.d}" fill="none" stroke="${S(u.color)}" stroke-width="var(--pc-chart-line-width, 1.5)" data-entity="${h(u.entityId)}" />`);return c+="</svg>",c}let a=n.map(()=>al()),s=bn("graph-glow"),r=`<svg viewBox="0 0 300 ${e}" role="img" aria-label="${h(o)}" class="pc-chart-svg" preserveAspectRatio="none">`;r+="<defs>";for(let l=0;l<n.length;l++)r+=`<linearGradient id="${a[l]}" x1="0" y1="0" x2="0" y2="1">`,r+=`<stop offset="0%" stop-color="${S(n[l].color)}" stop-opacity="0.25"/>`,r+=`<stop offset="100%" stop-color="${S(n[l].color)}" stop-opacity="0"/>`,r+="</linearGradient>";r+=Ft(s,.6),r+="</defs>";for(let l=0;l<n.length;l++){let p=n[l];r+=`<path d="${p.areaPath}" fill="url(#${a[l]})" />`,r+=`<path d="${p.linePath}" fill="none" stroke="${S(p.color)}" stroke-width="var(--pc-chart-line-width, 1.5)" filter="url(#${s})" data-entity="${h(p.entityId)}" />`}return r+="</svg>",r}function En(t,e,o,i,n){let a=t.attribute||"current_temperature",s=t.stacked===!0,r=Number(t.height)||80,l=t.palette||void 0,p=t.entities||e.map(u=>u.entity);if(p.length===0)return"";let c='<div class="pc-section pc-section-graph">';return s?(c+=Mn(p,"current_temperature","Temperature",r,l,o,i,n,e),c+=Mn(p,"current_humidity","Humidity",r,l,o,i,n,e)):c+=Mn(p,a,a==="current_humidity"?"Humidity":"Temperature",r,l,o,i,n,e),c+="</div>",c}function Mn(t,e,o,i,n,a,s,r,l){let p=[],c=[],u=e==="current_humidity"||e==="humidity";for(let g=0;g<t.length;g++){let w=t[g],v=rl(g,n),b=K(w),y=r?.zoneEntities?.[b]||{},_=l?.find(k=>k.entity===w),A=(u?Kt(w,s,y,_):ht(w,s,y,_))?.entityId||w,M=a.data[A]||[],C=_?.name||s[w]?.attributes?.friendly_name||b,E=s[w]?.attributes?.[e],z=u?"%":s[w]?.attributes?.unit_of_measurement||"\xB0C";p.push({entityId:A,data:M,color:v}),c.push({label:C,color:v,value:E!=null?`${E}${z}`:"--"})}let m=c.map(g=>g.label).join(", "),d=`${o} history for ${m}`,f=`<div class="pulse-section-label">${h(o)}</div>`;return f+=`<div class="pc-chart-container" style="height:${S(i)}px">`,f+=sl(p,i,d),f+="</div>",f+=xe(c),f}function Fn(t,e,o){let i=Number(t.size)||120,n=t.source,a=[];if(n==="api_breakdown"?a=ll(e,o):n==="homekit_saved"?a=cl(e,o):t.segments&&(a=pl(t.segments,o)),a.length===0)return"";let s='<div class="pc-section pc-section-donut">',r={api_breakdown:"API Breakdown",homekit_saved:"HomeKit Saved"},l={api_breakdown:"Calls",homekit_saved:"Saved"},p=n&&r[n]||"Breakdown",c=n&&l[n]||"Total";s+=`<div class="pulse-section-label">${h(p)}</div>`,s+=`<div class="pc-donut-container" style="width:${S(i)}px;height:${S(i)}px">`;let{html:u}=go(a,{size:i,centerLabel:c});s+=u,s+="</div>";let m=a.map(d=>({label:d.label,color:d.color,value:String(Math.round(d.value))}));return s+=xe(m),s+="</div>",s}function ll(t,e){let o=t.api_breakdown;if(!o||!e[o])return[];let i=e[o].attributes;return!i||typeof i!="object"?(Ot("api_call_breakdown entity has no attributes"),[]):bo(i,Dt)}function cl(t,e){if(!t.homekit_connected)return[];let o=e[t.homekit_connected];if(!o)return[];let i=o.attributes||{},n=t.homekit_reads_saved?e[t.homekit_reads_saved]:null,a=t.homekit_writes_saved?e[t.homekit_writes_saved]:null,s=n?Number(n.state)||0:Number(i.reads_saved_today)||0,r=a?Number(a.state)||0:Number(i.writes_saved_today)||0,l=[];return(s>0||r>0)&&(l.push({label:"Reads Saved",value:s,color:Dt[0]}),l.push({label:"Writes Saved",value:r,color:Dt[1]})),l}function pl(t,e){return t.map((o,i)=>({label:o.label||o.entity,value:Math.max(0,Number(e[o.entity]?.state)||0),color:o.color||Dt[i%Dt.length]}))}function So(t,e,o){let n=Date.now()-o,a=o/e,s=[],r=0,l=null;for(;r<t.length&&t[r].t<n;)isFinite(t[r].v)&&(l=Math.round(t[r].v*10)/10),r++;for(let p=0;p<e;p++){let c=n+p*a,u=c+a,m=c+a/2,d=0,f=0;for(;r<t.length&&t[r].t<u;)t[r].t>=c&&isFinite(t[r].v)&&(d+=t[r].v,f++),r++;f>0&&(l=Math.round(d/f*10)/10),s.push({value:l,time:m,label:dt(new Date(m))})}return s}function ko(t,e,o={}){let i=t.length;if(i===0)return'<div class="pc-strip-container"><div class="pc-chart-empty">No data</div></div>';let n=o.emptyColor||"var(--pulse-disabled)",a=o.emptyOpacity??.3,s=o.ariaLabel||"",r=JSON.stringify(t.map(p=>({v:p.value,l:p.label}))),l=`<div class="pc-strip-container" data-slots='${h(r)}'>`;l+=`<svg viewBox="0 0 ${i} 1" preserveAspectRatio="none" role="img" aria-label="${h(s)}" style="width:100%;height:100%;display:block">`;for(let p=0;p<i;p++){let c=t[p].value,u=c!==null?e(c):n,m=c!==null?1:a;l+=`<rect x="${p}" y="0" width="1.05" height="1" fill="${S(u)}" opacity="${m}"/>`}if(l+="</svg>",o.nowPct!==void 0){let p=Math.min(100,Math.max(0,o.nowPct));l+=`<div class="pc-now-marker" style="left:${p.toFixed(1)}%"></div>`}return l+="</div>",l}function Se(t,e,o={}){let i=t.length;if(i===0)return'<div class="pc-cells"><div class="pc-chart-empty">No data</div></div>';let n=JSON.stringify(t.map(s=>({v:s.value,l:s.label}))),a=`<div class="pc-cells" data-slots='${h(n)}'>`;for(let s=0;s<i;s++){let r=t[s].value,l=t[s].label;if(r!==null){let p=e(r),c=S(p);a+=`<div class="pc-cell" style="background:${c};color:${c}" data-hour="${h(l)}" data-score="${r}"></div>`}else a+=`<div class="pc-cell pc-cell-empty" data-hour="${h(l)}"></div>`}return a+="</div>",a}function To(){let t=document.createElement("div");t.className="pc-strip-tooltip",t.style.display="none";let e=null;return{element:t,show(o,i,n){e&&(clearTimeout(e),e=null),t.textContent=n,t.style.display="",t.style.left=`${i}px`},hide(){e=setTimeout(()=>{t.style.display="none"},50)}}}function ua(){let t=document.createElement("div");t.className="pc-strip-tooltip pc-strip-tooltip-fixed",t.style.display="none";let e=null;return{element:t,show(o,i,n){e&&(clearTimeout(e),e=null),t.textContent=n,t.style.display="",t.style.left=`${i}px`,t.style.top=`${o.top-28}px`},hide(){e=setTimeout(()=>{t.style.display="none"},50)}}}function Ao(t,e=5){let o=new Date,i=Date.now()-t,n="";for(let a=0;a<e-1;a++){let s=new Date(i+a/(e-1)*t);n+=`<span class="pc-time-label">${dt(s)}</span>`}return n+=`<span class="pc-time-label">${dt(o)}</span>`,n}function Jt(t,e,o){let i=Math.max(0,Math.min(1,(t-e.left)/e.width));return Math.min(o-1,Math.floor(i*o))}var dl=2e3;function In(t,e,o,i){let n=null,a=r=>{let l=o.getBoundingClientRect(),p=r-l.left;p>=0&&p<=l.width&&(e.style.left=`${i+p}px`,e.style.display="")},s=()=>{e.style.display="none",n&&(clearTimeout(n),n=null)};t.addEventListener("pointermove",r=>{r.pointerType!=="touch"&&a(r.clientX)}),t.addEventListener("pointerleave",s),t.addEventListener("pointerdown",r=>{r.pointerType==="touch"&&(a(r.clientX),n&&clearTimeout(n),n=setTimeout(s,dl))}),t.addEventListener("pointerup",r=>{r.pointerType})}function Nn(t,e,o,i=""){if(!e||e.length===0)return;let n=e.length,a=null,s=null;t.addEventListener("pointerdown",r=>{if(r.pointerType==="touch"&&r.isPrimary===!1)return;let l=t.getBoundingClientRect();a=Jt(r.clientX,l,n),t.setPointerCapture(r.pointerId),s||(s=document.createElement("div"),s.className="pc-strip-drag-highlight",t.style.position="relative",t.appendChild(s)),s.style.display="",s.style.left=`${(a/n*100).toFixed(1)}%`,s.style.width="0%"}),t.addEventListener("pointermove",r=>{if(a===null||!s)return;let l=t.getBoundingClientRect(),p=Jt(r.clientX,l,n),c=Math.min(a,p),u=Math.max(a,p);s.style.left=`${(c/n*100).toFixed(1)}%`,s.style.width=`${((u-c+1)/n*100).toFixed(1)}%`}),t.addEventListener("pointerup",r=>{if(a===null){a=null;return}let l=t.getBoundingClientRect(),p=Jt(r.clientX,l,n),c=Math.min(a,p),u=Math.max(a,p),m=e.slice(c,u+1).filter(d=>d.v!==null);if(m.length>0){let d=m.map($=>$.v),f=(d.reduce(($,A)=>$+A,0)/d.length).toFixed(1),g=Math.min(...d),w=Math.max(...d),v=e[c]?.l||"",b=e[u]?.l||"",y=`${v} \u2013 ${b}: avg ${f}${i}, ${g}${i} \u2013 ${w}${i}`,_=t.getBoundingClientRect();o.show(_,(c+u)/2/n*_.width,y),setTimeout(()=>o.hide(),3e3)}a=null})}var zn=24,ul=zn;function ml(t){if(!Array.isArray(t)||t.length===0)return null;let e=Date.now()-zn*3600*1e3,o=t.filter(n=>n&&n.t>=e&&Number.isFinite(n.v));return o.length===0?null:o.reduce((n,a)=>n+a.v,0)/o.length}function Co(t,e,o,i){let n='<div class="pc-strip-rows">';n+='<div class="pc-strip-crosshair"></div>';let a=0,s=0,r="\xB0C";for(let l of t){let{entityId:p,zoneName:c,zoneEntities:u,zoneState:m}=at(l,o,e),f=ht(p,e,u,l)?.entityId||p,g=i?.data?.[f]||[];m.unit&&(r=m.unit);let w=So(g,ul,zn*3600*1e3),v=Se(w,rt),b=ml(g);b!==null&&(a+=b,s+=1);let y=b===null?"--":`${Z(b)}${h(m.unit||"\xB0C")}`,_=wt(m);n+=`<div class="pc-timeline-group-row pc-timeline-row${_}" data-entity="${h(p)}" data-zone="${h(c)}">`,n+=`<span class="pc-timeline-group-name pc-zone-label">${h(m.name)}</span>`,n+=v,n+=`<span class="pc-timeline-group-stat">${h(y)}</span>`,n+="</div>"}return n+="</div>",n+=hl(),n+=fl(a,s,r,t.length),n}function hl(){return'<div class="pc-timeline-group-axis"><span></span><div class="ticks"><span>\u221224h</span><span>\u221218h</span><span>\u221212h</span><span>\u22126h</span><span>now</span></div><span></span></div>'}function fl(t,e,o,i){let n=e>0?t/e:null,a=n===null?"\u2014":`${Z(n)}${h(o)}`;return'<div class="pc-timeline-group-footer">'+gl(o)+`<span><strong>Home avg ${h(a)}</strong> \xB7 ${i} zones</span></div>`}function gl(t){let e=t?.includes("F"),o=s=>e?Math.round(s*9/5+32):s,i=e?61:16,n='<span class="pc-temp-legend">',a=null;for(let s of wn){let r=s.upper;if(r!==null&&o(r)<i){a=r;continue}let l;r===null?l=`\u2265${a!==null?o(a):i}${t}`:a===null?l=`\u2264${o(r)}${t}`:l=`${o(a)}\u2013${o(r)}${t}`,n+=`<span class="pc-temp-legend-pill"><span class="pc-temp-legend-pip" style="background:${S(s.color)}"></span>${h(l)}</span>`,a=r}return n+="</span>",n}function ma(t,e,o,i,n){if(!t||t.length===0)return"";let a=Number(e?.hours_to_show)||24,s=e?.mode||"timeline",r=Number(e?.slots_per_hour)||2,p=(e?.attribute||"temperature")==="humidity",c=p?Be:rt,u=s==="heatmap"?a:a*r,m=a*36e5,d=Date.now()-m,f=(Date.now()-d)/m*100,g=p?"Humidity":"Thermal",w=s==="heatmap"?"Heatmap":"Timeline",v='<div class="pc-section pc-section-thermal-strip">';if(v+='<div class="pc-section-header">',v+=`<div class="pulse-section-label">${h(String(Number(a)))}h ${h(g)} ${h(w)}</div>`,v+='<span class="pc-section-subtitle">Tap a zone for details</span>',v+="</div>",s==="heatmap"&&!p)return v+='<div class="pc-zone-detail" id="timeline-detail"></div>',v+=Co(t,o,i,n),v+="</div>",v;v+='<div class="pc-zone-detail" id="timeline-detail"></div>',v+='<div class="pc-strip-rows">',v+='<div class="pc-strip-crosshair"></div>';for(let b of t){let{entityId:y,zoneName:_,zoneEntities:$,zoneState:A}=at(b,i,o),C=(p?Kt(y,o,$,b):ht(y,o,$,b))?.entityId||y,E=b.name||o[y]?.attributes?.friendly_name||_,z=n?.data?.[C]||[],k=wt(A);if(v+=`<div class="pc-timeline-row${k}" data-zone="${h(_)}" data-entity="${h(y)}">`,v+=`<span class="pc-zone-label">${h(E)}</span>`,z.length<2){let x=!!o[C],T=C in(n?.data||{});v+=`<div class="pc-strip-container"><div class="pc-chart-empty">${h(x&&!T?"Waiting for data":"No data")}</div></div>`}else{let x=So(z,u,m),F=`${E} ${p?"humidity":"temperature"} over ${a}h`;s==="heatmap"?v+=Se(x,c,{ariaLabel:F}):v+=ko(x,c,{ariaLabel:F,nowPct:f})}v+="</div>"}return v+="</div>",v+='<div class="pc-time-axis">',v+=Ao(m),v+="</div>",v+="</div>",v}var vl={Comfortable:100,Warm:70,Cool:70,"Too Warm":40,"Too Cool":40};function ha(t,e,o,i){if(t==null||e===null||e===void 0||isNaN(t)||isNaN(e))return null;let n=100;if(n-=Math.min(50,Math.abs(t-e)*10),o!=null&&(n-=Math.min(25,Math.abs(o-45)*.5)),i!=null){let a=vl[i]??50;n=n*.7+a*.3}return Math.max(0,Math.min(100,Math.round(n)))}function fa(t){if(t>=80)return`rgba(52, 199, 89, ${(.35+t/100*.55).toFixed(2)})`;if(t>=50){let e=(t-50)/30;return`rgba(${Math.round(255-e*50)}, ${Math.round(159+e*40)}, 10, 0.65)`}return`rgba(255, 69, 58, ${(.35+(50-t)/50*.5).toFixed(2)})`}function Mo(t,e,o=72e5){if(t.length===0)return null;let i=0,n=t.length-1;for(;i<n;){let r=i+n>>1;t[r].t<e?i=r+1:n=r}let a=null,s=1/0;for(let r=Math.max(0,i-1);r<=Math.min(t.length-1,i);r++){let l=Math.abs(t[r].t-e);l<s&&isFinite(t[r].v)&&(s=l,a=t[r].v)}return s<=o?a:null}function ga(t,e,o,i,n){if(!t||t.length===0)return"";let a=Number(e?.slots_per_hour)||1,s=Number(e?.hours_to_show)||24,r=e?.mode||"heatmap",l=a*s,p=s*36e5,c=Date.now()-p,u=(Date.now()-c)/p*100,m=r==="timeline"?"Comfort Timeline":"Comfort Heatmap",d='<div class="pc-section pc-section-comfort-strip">';d+='<div class="pc-section-header">',d+=`<div class="pulse-section-label">${h(String(Number(s)))}h ${h(m)}</div>`,d+='<span class="pc-section-subtitle">Tap a zone for details</span>',d+="</div>",d+='<div class="pc-zone-detail" id="heatmap-detail"></div>',d+='<div class="pc-heatmap-body">',d+='<div class="pc-strip-crosshair"></div>';for(let f=0;f<t.length;f++){let g=t[f],{entityId:w,zoneName:v,zoneEntities:b,zoneState:y}=at(g,i,o),_=g.name||o[w]?.attributes?.friendly_name||v,A=ht(w,o,b,g).entityId,C=Kt(w,o,b,g)?.entityId||null,E=n?.data?.[A]||[],z=C?n?.data?.[C]||[]:[],k=o[w]?.attributes?.temperature??null,x=b.comfort_level,T=x&&o[x]?.state||null,F=[],B=p/l,I=null;if(E.length>0){let N=Mo(E,c,1/0),O=z.length>0?Mo(z,c,1/0):null;N!==null&&(I=ha(N,k,O,T))}for(let N=0;N<l;N++){let P=c+N*B+B/2,H=Mo(E,P),V=Mo(z,P),R=ha(H,k,V,T);R!==null&&(I=R);let D=new Date(P),U=dt(D);F.push({value:I,time:P,label:U})}let q=wt(y);d+=`<div class="pc-heatmap-row${q}" data-zone="${h(v)}" data-idx="${f}">`,d+=`<span class="pc-zone-label">${h(_)}</span>`;let L=`${_} comfort over ${s}h`;r==="timeline"?d+=ko(F,fa,{ariaLabel:L,nowPct:u}):d+=Se(F,fa,{ariaLabel:L}),d+="</div>"}return d+="</div>",d+='<div class="pc-heatmap-time-axis">',d+=Ao(p),d+="</div>",d+='<div class="pc-heatmap-legend">',d+='<div class="pc-legend-item"><div class="pc-legend-swatch pc-legend-swatch-good"></div>\u226580</div>',d+='<div class="pc-legend-item"><div class="pc-legend-swatch pc-legend-swatch-fair"></div>50\u201379</div>',d+='<div class="pc-legend-item"><div class="pc-legend-swatch pc-legend-swatch-poor"></div>&lt;50</div>',d+="</div>",d+="</div>",d}function va(t,e,o,i,n,a,s){let r=a+(s-a)*.35,l=a+(s-a)*.65,p=t-o,c=e-i,u=t+o,m=e+i,d=`M${a},${p.toFixed(1)}`;return d+=` C${r.toFixed(1)},${p.toFixed(1)} ${l.toFixed(1)},${c.toFixed(1)} ${s},${c.toFixed(1)}`,d+=` L${s},${m.toFixed(1)}`,d+=` C${l.toFixed(1)},${m.toFixed(1)} ${r.toFixed(1)},${u.toFixed(1)} ${a},${u.toFixed(1)}`,d+=" Z",d}function bl(t,e,o,i){let n=o+(i-o)*.35,a=o+(i-o)*.65;return`M${o},${t.toFixed(1)} C${n.toFixed(1)},${t.toFixed(1)} ${a.toFixed(1)},${e.toFixed(1)} ${i},${e.toFixed(1)}`}function Ln(t,e,o){if(!t||t.length===0)return"";let i=Rt(),n=[],a=!1;for(let k of t){let{entityId:x,zoneEntities:T,zoneState:F}=at(k,o,e);(F.heatingPower>0||T.heating_power||e[x]?.attributes?.heating_power!==void 0)&&(a=!0),n.push({name:F.name,power:F.heatingPower,temp:F.currentTemp,target:F.targetTemp,unit:F.unit,hvacAction:F.hvacAction})}let s=n.length>0?Math.round(n.reduce((k,x)=>k+x.power,0)/n.length):0,r='<div class="pc-section pc-section-energy-flow">';if(r+='<div class="pc-section-header">',r+='<div class="pulse-section-label">Energy Flow</div>',a&&(r+=`<span class="pc-energy-flow-header-value" style="color:${S(ne.heating.fallback)}">${h(s)}% avg</span>`),r+="</div>",!a)return r+='<div class="pc-chart-empty">No heating data</div></div>',r;let l=360,p=n.length<=3?44:n.length<=6?38:34,c=15,u=Math.max(80,n.length*p+30),m=n.length*p,d=Math.max(40,Math.min(m*.7,m-16)),f=Math.max(36,d*.6),g=Math.max(50,f/2+14),w=l-60,v=u/2,b=22,y=2,_=d/Math.max(n.length,1)*.7,$=ne.heating.fallback,A="var(--pulse-disabled)",M=n.some(k=>k.power>0||k.hvacAction==="heating"||k.hvacAction==="cooling"),C=n.filter(k=>k.power>0).length;r+=`<svg viewBox="0 0 ${l} ${u}" role="img" aria-label="Energy flow from boiler to zones" style="width:100%;height:${S(u)}px;display:block">`,r+="<defs>",r+=Ft("flow-glow",ye(l,360).toFixed(1));for(let k=0;k<n.length;k++){let x=n[k].power>0||n[k].hvacAction==="heating"||n[k].hvacAction==="cooling",T=x?$:A,F=n[k].power;if(x){let B=F>0?(4.5-F/100*3.3).toFixed(1):"5.0";r+=`<linearGradient id="flow-g${k}" x1="-0.5" y1="0" x2="0.5" y2="0" gradientUnits="objectBoundingBox">`,r+=`<stop offset="0%" stop-color="${S(T)}" stop-opacity="0.3"/>`,r+=`<stop offset="50%" stop-color="${S(T)}" stop-opacity="1.0"/>`,r+=`<stop offset="100%" stop-color="${S(T)}" stop-opacity="0.3"/>`,i||(r+=`<animate attributeName="x1" from="-0.5" to="0.5" dur="${B}s" repeatCount="indefinite"/>`,r+=`<animate attributeName="x2" from="0.5" to="1.5" dur="${B}s" repeatCount="indefinite"/>`),r+="</linearGradient>"}else r+=`<linearGradient id="flow-g${k}" x1="0" y1="0" x2="1" y2="0">`,r+=`<stop offset="0%" stop-color="${S(T)}" stop-opacity="0.15"/>`,r+=`<stop offset="50%" stop-color="${S(T)}" stop-opacity="0.25"/>`,r+=`<stop offset="100%" stop-color="${S(T)}" stop-opacity="0.1"/>`,r+="</linearGradient>"}r+="</defs>";let E=M?"rgba(255, 152, 0, 0.15)":"color-mix(in srgb, var(--pulse-text-primary) 8%, transparent)",z=M?"rgba(255, 152, 0, 0.25)":"color-mix(in srgb, var(--pulse-text-primary) 15%, transparent)";r+=`<rect x="${g-f/2}" y="${v-d/2}" width="${f}" height="${d}" rx="8" fill="${S(E)}" stroke="${S(z)}" stroke-width="1"/>`,r+=`<text x="${g}" y="${v-d/2-6}" text-anchor="middle" font-size="10" fill="var(--pulse-text-secondary)">Boiler</text>`;for(let k=0;k<n.length;k++){let x=n[k],T=c+k*p+20,F=x.power>0?y+x.power/100*(b-y):y,B=x.power>0||x.hvacAction==="heating"||x.hvacAction==="cooling",I=B?' class="pc-ribbon-active"':"",q=v+(k-(n.length-1)/2)*_,L=va(q,T,F/2,F/2,l,g+f/2,w-12);if(r+=`<path d="${L}" fill="url(#flow-g${k})"${I}${B?' filter="url(#flow-glow)"':""} data-zone="${h(x.name)}" data-zone-idx="${k}">`,r+=`<title>${h(x.name)}: ${Math.round(x.power)}% heating power</title></path>`,x.power>0&&!i){let V=Yi(x.power,20,C),R=Ji(x.power),D=Qi(F,b),U=(D*.8).toFixed(1),G=bl(q,T,g+f/2,w-12);r+=`<g class="pc-flow-particles" data-zone="${h(x.name)}" data-zone-idx="${k}" style="will-change:transform">`;for(let tt=0;tt<V;tt++){let et=(tt*(R/V)).toFixed(2);r+=`<circle r="${D.toFixed(1)}" fill="${S($)}" opacity="0.8"`,r+=` filter="drop-shadow(0 0 ${U}px ${S($)})">`,r+=`<animateMotion dur="${R.toFixed(1)}s" begin="${et}s" repeatCount="indefinite"`,r+=` path="${G}"/>`,r+="</circle>"}r+="</g>"}let N=B?"var(--pulse-text-primary)":"var(--pulse-text-secondary)",O=B?' font-weight="500"':"";r+=`<text x="${w}" y="${(T-1).toFixed(1)}" font-size="14" fill="${S(N)}"${O}>${h(x.name)}</text>`;let P=B?S($):"var(--pulse-text-secondary)",H=B?`${x.hvacAction==="cooling"?"Cooling":"Heating"} ${Math.round(x.power)}%${x.temp!==null?` \xB7 ${Z(x.temp)}${x.unit}`:""}`:`Idle${x.temp!==null?` \xB7 ${Z(x.temp)}${x.unit}`:""}`;r+=`<text x="${w}" y="${(T+14).toFixed(1)}" font-size="10" fill="${P}">${h(H)}</text>`}return r+="</svg>",r+="</div>",r}function ba(t,e,o,i){if(!t||!e||e.length===0)return!1;let n=t.querySelector("svg");if(!n)return!1;let a=[];for(let k of e){let{zoneState:x}=at(k,i,o);a.push({name:x.name,power:x.heatingPower,temp:x.currentTemp,unit:x.unit,hvacAction:x.hvacAction})}let s=n.querySelectorAll("path[data-zone]");if(s.length!==a.length)return!1;let r=ne.heating.fallback,l="var(--pulse-disabled)",p=a.some(k=>k.power>0||k.hvacAction==="heating"||k.hvacAction==="cooling"),c=360,u=a.length<=3?44:a.length<=6?38:34,m=15,d=Math.max(80,a.length*u+30),f=a.length*u,g=Math.max(40,Math.min(f*.7,f-16)),w=Math.max(36,g*.6),v=Math.max(50,w/2+14),b=c-60,y=d/2,_=22,$=2,A=g/Math.max(a.length,1)*.7,M=Math.round(a.reduce((k,x)=>k+x.power,0)/a.length),C=t.querySelector(".pc-energy-flow-header-value");C&&(C.textContent=`${M}% avg`);let E=n.querySelector("rect");E&&(E.setAttribute("fill",p?"rgba(255, 152, 0, 0.15)":"color-mix(in srgb, var(--pulse-text-primary) 8%, transparent)"),E.setAttribute("stroke",p?"rgba(255, 152, 0, 0.25)":"color-mix(in srgb, var(--pulse-text-primary) 15%, transparent)"),E.setAttribute("stroke-width",p?"0.5":"1"));let z=n.querySelectorAll("text");for(let k=0;k<a.length;k++){let x=a[k],T=s[k],F=x.power>0||x.hvacAction==="heating"||x.hvacAction==="cooling",B=m+k*u+20,I=x.power>0?$+x.power/100*(_-$):$,q=y+(k-(a.length-1)/2)*A,L=va(q,B,I/2,I/2,c,v+w/2,b-12);T.setAttribute("d",L),F?(T.classList.add("pc-ribbon-active"),T.setAttribute("filter","url(#flow-glow)")):(T.classList.remove("pc-ribbon-active"),T.removeAttribute("filter"));let N=T.querySelector("title");N&&(N.textContent=`${x.name}: ${Math.round(x.power)}% heating power`);let O=n.querySelector(`g.flow-particles[data-zone-idx="${k}"]`);O&&(O.style.display=x.power>0?"":"none");let P=n.querySelector(`#flow-g${k}`);if(P){let U=F?r:l,G=P.querySelectorAll("stop"),tt=P.querySelectorAll("animate");if(F){let et=x.power>0?(4.5-x.power/100*3.3).toFixed(1):"5.0";G.length>=3&&(G[0].setAttribute("stop-color",U),G[0].setAttribute("stop-opacity","0.3"),G[1].setAttribute("stop-color",U),G[1].setAttribute("stop-opacity","1.0"),G[2].setAttribute("stop-color",U),G[2].setAttribute("stop-opacity","0.3"));for(let lt of tt)lt.setAttribute("dur",`${et}s`);P.setAttribute("gradientUnits","objectBoundingBox")}else{G.length>=3&&(G[0].setAttribute("stop-color",U),G[0].setAttribute("stop-opacity","0.15"),G[1].setAttribute("stop-color",U),G[1].setAttribute("stop-opacity","0.25"),G[2].setAttribute("stop-color",U),G[2].setAttribute("stop-opacity","0.1"));for(let et of tt)et.remove()}}let H=1+k*2,V=2+k*2,R=z[H],D=z[V];if(R&&(R.textContent=x.name,R.setAttribute("fill",F?"var(--pulse-text-primary)":"var(--pulse-text-secondary)"),F?R.setAttribute("font-weight","500"):R.removeAttribute("font-weight")),D){let U=F?`${x.hvacAction==="cooling"?"Cooling":"Heating"} ${Math.round(x.power)}%${x.temp!==null?` \xB7 ${Z(x.temp)}${x.unit}`:""}`:`Idle${x.temp!==null?` \xB7 ${Z(x.temp)}${x.unit}`:""}`;D.textContent=U,D.setAttribute("fill",F?r:"var(--pulse-text-secondary)")}}return!0}var wa=6,Rn=2;function Hn(t,e,o,i,n,a){let s=n*Math.PI/180,r=a*Math.PI/180,l=a-n>180?1:0;return`M${(t+o*Math.cos(s)).toFixed(2)},${(e+o*Math.sin(s)).toFixed(2)} A${o.toFixed(2)},${o.toFixed(2)} 0 ${l} 1 ${(t+o*Math.cos(r)).toFixed(2)},${(e+o*Math.sin(r)).toFixed(2)} L${(t+i*Math.cos(r)).toFixed(2)},${(e+i*Math.sin(r)).toFixed(2)} A${i.toFixed(2)},${i.toFixed(2)} 0 ${l} 0 ${(t+i*Math.cos(s)).toFixed(2)},${(e+i*Math.sin(s)).toFixed(2)} Z`}function Dn(t,e,o,i,n){if(!t||t.length===0)return"";let a=Rt(),s=Number(e?.size)||280,r=e?.attribute||"temperature",l=r==="temperature"||r==="both",p=r==="humidity"||r==="both",c=s/2,u=s/2,m=s*120/280,d=1.5,w=(360-d*t.length)/t.length,v=[];for(let L of t){let{entityId:N,zoneState:O}=at(L,i,o);v.push({name:O.name,temp:O.currentTemp,target:O.targetTemp,power:O.heatingPower,humidity:O.humidity,hvacAction:O.hvacAction,entityId:N,unit:O.unit,rowClass:wt(O)})}let b=e?.outdoor_temp_entity,y=b||i?.hubEntities?.outside_temp,_=null;if(y&&o[y]){let L=o[y];Q(L)||(_=L.attributes?.temperature!==void 0?String(L.attributes.temperature):L.state)}let $=y&&o[y]?.attributes?.unit_of_measurement||"\xB0C",A=e?.outdoor_humidity_entity,M=null;if(A&&o[A]){let L=o[A];Q(L)||(M=L.attributes?.humidity!==void 0?String(L.attributes.humidity):L.state)}let C="",E=r==="humidity"?M!==null?`${h(M)}%`:"--":_!==null?`${h(_)}${h($)}`:"--";r!=="humidity"&&p&&M!==null&&(C=`${h(M)}%`);let k={temperature:"Home Thermal View",humidity:"Home Humidity View",both:"Home Climate View"}[r]||"Home Thermal View",x=`<div class="pc-section pc-section-radial" data-attribute="${h(r)}"${b?` data-outdoor-temp-entity="${h(b)}"`:""}${A?` data-outdoor-humidity-entity="${h(A)}"`:""}>`;x+=`<div class="pulse-section-label">${h(k)}</div>`,x+='<div class="pc-radial-container">';let T=`r${Math.random().toString(36).slice(2,9)}`,F=`radial-glow-${T}`,B=L=>`heat-shimmer-${T}-${L}`;if(x+=`<svg class="pc-radial-svg" viewBox="0 0 ${s} ${s}" width="${s}" height="${s}" role="img" aria-label="${h(k)}">`,x+="<defs>",x+=Ft(F,ye(s,280).toFixed(1)),!a)for(let L=0;L<v.length;L++){let N=v[L],O=hn(N.power,s);if(O<=0)continue;let P=45/Math.max(w,10),H=(.02*P).toFixed(4),V=(.04*P).toFixed(4);x+=`<filter id="${B(L)}" x="-5%" y="-5%" width="110%" height="110%">`,x+=`<feTurbulence type="turbulence" baseFrequency="${H} ${V}" numOctaves="2" result="turb">`,x+=`<animate attributeName="baseFrequency" values="${H} ${V};${(parseFloat(H)*1.5).toFixed(4)} ${V};${H} ${V}" dur="4s" repeatCount="indefinite"/>`,x+="</feTurbulence>",x+=`<feDisplacementMap in="SourceGraphic" in2="turb" scale="${O.toFixed(1)}" xChannelSelector="R" yChannelSelector="G"/>`,x+="</filter>"}x+="</defs>";for(let L=0;L<v.length;L++){let N=v[L],O=L*(w+d)-90,P=O+w,H=N.power>0||N.hvacAction==="heating"||N.hvacAction==="cooling",V=H?" pc-arc-active":"",R=[h(N.name)];l&&R.push(N.temp!==null?`${Z(N.temp)}${N.unit}`:"--"),p&&N.humidity!==null&&R.push(`${Math.round(N.humidity)}%`),R.push(H?`${N.hvacAction==="cooling"?"Cooling":"Heating"} ${N.power}%`:"Idle");let D=R.join(", ");x+=`<g class="pc-arc-group${V}" data-idx="${L}">`;let U=p&&r==="both"?m+Rn+wa+4:m+4,G=m-28-4,tt=Hn(c,u,U,G,O-d/2,P+d/2);if(x+=`<path d="${tt}" fill="transparent" class="pc-arc-hit"/>`,l){let et=N.temp!==null?rt(N.temp):"var(--pulse-disabled)",lt=8+N.power/100*20,vt=m-lt,St=Hn(c,u,m,vt,O,P);if(x+=`<path d="${St}" fill="${S(et)}" class="pc-arc-path"`,hn(N.power,s)>0&&!a?x+=` filter="url(#${B(L)})"`:H&&(x+=` filter="url(#${F})"`),x+=`><title>${D}</title>`,H&&!a){let Mt=N.power>0?(4.5-N.power/100*3).toFixed(1):"5.0";x+=`<animate attributeName="opacity" values="1;0.82;1" dur="${Mt}s" repeatCount="indefinite"/>`}x+="</path>"}if(p&&N.humidity!==null){let et=Be(N.humidity),lt,vt;if(r==="both")lt=m+Rn+wa,vt=m+Rn;else{let it=8+N.power/100*20;lt=m,vt=m-it}let St=Hn(c,u,lt,vt,O,P);x+=`<path d="${St}" fill="${S(et)}" class="pc-arc-path" opacity="0.8">`,x+=`<title>${D}</title>`,x+="</path>"}x+="</g>"}x+="</svg>";let I=8;if(l)for(let L of v){let N=8+L.power/100*20;N>I&&(I=N)}let q=Math.round((m-I)*2);x+=`<div class="pc-center-info" id="radial-center" style="width:${q}px;height:${q}px">`,x+='<div class="pc-center-sheen" id="radial-sheen"></div>',x+=`<div class="pc-center-value">${E}</div>`,x+='<div class="pc-center-label">Outdoor</div>',x+=`<div class="pc-center-sub">${C}</div>`,x+="</div>",x+="</div>",x+='<div class="pc-zone-detail" id="radial-detail"></div>',x+='<div class="pc-radial-legend">';for(let L=0;L<v.length;L++){let N=v[L],O=r==="humidity"?N.humidity!==null?Be(N.humidity):"var(--pulse-disabled)":N.temp!==null?rt(N.temp):"var(--pulse-disabled)",P="";l&&(P+=N.temp!==null?`${Z(N.temp)}${N.unit}`:"--"),l&&p&&(P+=" \xB7 "),p&&(P+=N.humidity!==null?`${Math.round(N.humidity)}%`:"--"),x+=`<div class="pc-legend-item${N.rowClass}" data-idx="${L}">`,x+=`<span class="pc-legend-dot" style="background:${S(O)}"></span>`,x+=`<span class="pc-legend-name">${h(N.name)}</span> <span class="pc-legend-temp">${h(P)}</span>`,x+="</div>"}return x+="</div>",x+="</div>",x}var wl=5,ya={green:"var(--pulse-tier-moderate)",amber:"var(--pulse-tier-strong)",red:"var(--pulse-tier-gale)"},yl={green:"mdi:check-circle",amber:"mdi:progress-clock",red:"mdi:alert-circle"};function _l(t){if(t.length===0)return{label:"All Good",color:"green",detail:"All zones off"};let e=t.filter(a=>a.currentTemp!==null&&a.currentTemp!==void 0&&a.targetTemp!==null&&a.targetTemp!==void 0&&Math.abs(a.currentTemp-a.targetTemp)<=1).length,o=t.length,i=e/o,n=o-e;return i>=.8?{label:"All Good",color:"green",detail:`${e} of ${o} zones at target`}:i>=.4?{label:"Warming Up",color:"amber",detail:`${n} zone${n!==1?"s":""} still catching up`}:{label:"Cold Start",color:"red",detail:`${n} of ${o} zones below target`}}function xl(t){let e=[],o=[],i=[];for(let n of t)n.isUnavailable?i.push(n):n.hvacAction==="off"||!n.targetTemp?o.push(n):e.push(n);return e.sort((n,a)=>{let s=n.currentTemp!==null&&n.currentTemp!==void 0&&n.targetTemp!==null?Math.abs(n.currentTemp-n.targetTemp):0;return(a.currentTemp!==null&&a.currentTemp!==void 0&&a.targetTemp!==null?Math.abs(a.currentTemp-a.targetTemp):0)-s}),o.sort((n,a)=>n.name.localeCompare(a.name)),i.sort((n,a)=>n.name.localeCompare(a.name)),[...e,...o,...i]}function $l(t){if(t.length===0)return{onTarget:"--",avgActual:"--",avgTarget:"--",avgPower:"--"};let e=t.filter(r=>r.currentTemp!==null&&r.currentTemp!==void 0&&r.targetTemp!==null&&r.targetTemp!==void 0&&Math.abs(r.currentTemp-r.targetTemp)<=1).length,o=t.length,i=(t.reduce((r,l)=>r+(l.currentTemp??0),0)/o).toFixed(1),n=(t.reduce((r,l)=>r+(l.targetTemp??0),0)/o).toFixed(1),a=Math.round(t.reduce((r,l)=>r+l.heatingPower,0)/o),s=t[0].unit||"\xB0C";return{onTarget:`${e}/${o}`,avgActual:`${i}${s}`,avgTarget:`${n}${s}`,avgPower:`${a}%`}}function Sl(t){let e=h(t.entityId),o=h(t.name),i=h(t.unit||"\xB0C"),n=!t.isUnavailable&&t.hvacAction!=="off"&&t.targetTemp,a,s;if(t.isUnavailable)a='<span class="pc-home-status-actual pc-off">--</span><span class="pc-home-status-arrow">\u2192</span><span class="pc-home-status-target">Unavailable</span>',s='<div class="pc-home-status-delta"><div class="pc-home-status-bar-track"><div class="pc-home-status-bar-center"></div></div><span class="pc-home-status-delta-text">--</span></div>';else if(!n)a=`<span class="pc-home-status-actual pc-off">${t.currentTemp!==null&&t.currentTemp!==void 0?`${h(t.currentTemp)}${i}`:"--"}</span><span class="pc-home-status-arrow"></span><span class="pc-home-status-target">Off</span>`,s='<div class="pc-home-status-delta"><div class="pc-home-status-bar-track"><div class="pc-home-status-bar-center"></div></div><span class="pc-home-status-delta-text">Off</span></div>';else if(a=`<span class="pc-home-status-actual">${t.currentTemp!==null&&t.currentTemp!==void 0?`${h(t.currentTemp)}${i}`:"--"}</span><span class="pc-home-status-arrow">\u2192</span><span class="pc-home-status-target">${h(t.targetTemp)}${i}</span>`,t.currentTemp!==null&&t.currentTemp!==void 0){let p=t.currentTemp-t.targetTemp,c=Math.abs(p),u=Math.min(c/wl,1)*50,m=p<0?`${S(50-u)}%`:"50%",d=`${S(u)}%`,f=c<1?"green":c<=2.5?"amber":"red",g=ya[f],v=`${p>=0?"+":"\u2212"}${h(c.toFixed(1))}\xB0`;s=`<div class="pc-home-status-delta"><div class="pc-home-status-bar-track"><div class="pc-home-status-bar-center"></div><div class="pc-home-status-bar-fill" style="left:${m};width:${d};background:${S(g)}"></div></div><span class="pc-home-status-delta-text" style="color:${S(g)}">${v}</span></div>`}else s='<div class="pc-home-status-delta"><div class="pc-home-status-bar-track"><div class="pc-home-status-bar-center"></div></div><span class="pc-home-status-delta-text">--</span></div>';return`<div class="pc-home-status-row${wt(t)}" role="button" tabindex="0" data-entity="${e}"><span class="pc-home-status-zone-name">${o}</span><div class="pc-home-status-temps">${a}</div>`+s+"</div>"}function On(t,e,o,i){if(!t||t.length===0)return"";let n=t.map(m=>at(m,o,e).zoneState),a=n.filter(m=>!m.isUnavailable&&m.hvacAction!=="off"&&m.targetTemp),s=_l(a),r=ya[s.color],l=yl[s.color],p=xl(n),c=$l(a),u='<div class="pc-section pc-section-home-status">';u+='<div class="pulse-section-label">Home Status</div>',i?.show_hero===!1&&(u+='<div class="pc-home-status-hero">',u+=`<ha-icon class="pc-home-status-icon" icon="${h(l)}" style="color:${S(r)}"></ha-icon>`,u+=`<div class="pc-home-status-label" style="color:${S(r)}">${h(s.label)}</div>`,u+=`<div class="pc-home-status-detail">${h(s.detail)}</div>`,u+="</div>"),u+='<div class="pc-home-status-zones">';for(let m of p)u+=Sl(m);return u+="</div>",u+='<div class="pc-home-status-summary">',u+=`<div class="pc-stat"><div class="pc-stat-value">${h(c.onTarget)}</div><div class="pc-stat-label">On Target</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(c.avgActual)}</div><div class="pc-stat-label">Avg Actual</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(c.avgTarget)}</div><div class="pc-stat-label">Avg Target</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(c.avgPower)}</div><div class="pc-stat-label">Avg Power</div></div>`,u+="</div>",u+="</div>",u}var Pn={comfort:"comfort_level"};function kl(t,e,o,i){if(!(t in Pn))return!0;let n=Pn[t];if(!e||e.length===0)return!1;for(let a of e){let s=K(a.entity),l=(o?.zoneEntities?.[s]||{})[n];if(l&&!Q(i[l]))return!0}return!1}function _a(t,e,o,i){let n=Pn[t];if(!n)return null;let s=(o?.zoneEntities?.[e]||{})[n];if(!s)return null;let r=i[s];if(Q(r))return null;if(t==="comfort"){let p=r.attributes||{},c=parseFloat(p.temperature),u=parseFloat(p.comfort_target);if(!Number.isFinite(c)||!Number.isFinite(u))return null;let m=Math.abs(c-u);return Math.max(0,Math.min(100,Math.round(100-m*10)))}let l=parseFloat(r.state);return Number.isFinite(l)?l:null}function xa(t,e,o){let i=["power","temp","humidity"];return kl("comfort",t,e,o)&&i.push("comfort"),i}var $a="var(--pulse-tier-calm)";function Tl(t){return t<=40?"var(--pulse-tier-moderate)":t<=70?"var(--pulse-tier-strong)":"var(--pulse-tier-gale)"}function Al(t){return t>=80?"var(--pulse-tier-moderate)":t>=50?"var(--pulse-tier-strong)":"var(--pulse-tier-gale)"}var Sa={power:{label:"Power",unit:"%",max:100,colorFn:Tl},temp:{label:"Temp",unit:null,max:null,colorFn:()=>$a},humidity:{label:"Humidity",unit:"%",max:100,colorFn:()=>$a},comfort:{label:"Comfort",unit:"",max:100,colorFn:Al}};function Cl(t,e,o,i,n){if(e.isUnavailable)return null;switch(t){case"power":return e.heatingPower;case"temp":return e.currentTemp;case"humidity":return e.humidity;case"comfort":return _a("comfort",o,i,n);default:return null}}function Ml(t,e){let o=t.filter(l=>l!=null);if(o.length===0)return{avg:"--",high:"--",low:"--",spread:"--"};let i=o.reduce((l,p)=>l+p,0)/o.length,n=Math.max(...o),a=Math.min(...o),s=n-a,r=e||"";return{avg:`${Z(i)}${r}`,high:`${Z(n)}${r}`,low:`${Z(a)}${r}`,spread:`${Z(s)}${r}`}}function Eo(t,e,o,i="power"){if(!t||t.length===0)return"";let n=xa(t,o,e),a=n.includes(i)?i:"power",s=Sa[a];if(!s)return"";let r=[];for(let f of t){let{entityId:g,zoneName:w,zoneState:v}=at(f,o,e),b=Cl(a,v,w,o,e);r.push({entityId:g,name:v.name,value:b,unit:v.unit||"\xB0C",rowClass:wt(v)})}r.sort((f,g)=>f.value===null&&g.value===null?0:f.value===null?1:g.value===null?-1:g.value-f.value);let l=r.map(f=>f.value).filter(f=>f!==null),p=s.max;p===null&&(p=l.length>0?Math.max(...l,30):30);let c=s.unit!==null?s.unit:r[0]?.unit||"\xB0C",u=`<div class="pc-section pc-section-zone-ranking" data-metric="${h(a)}">`;u+='<div class="pc-ranking-header">',u+='<div class="pulse-section-label">Zone Ranking</div>',u+='<div class="pc-ranking-tabs">';for(let f of n){let g=Sa[f];if(!g)continue;u+=`<div class="pc-ranking-tab${f===a?" pc-active":""}" data-metric="${h(f)}">${h(g.label)}</div>`}u+="</div></div>",u+='<div class="pc-ranking-list">';for(let f=0;f<r.length;f++){let g=r[f],w=f+1,v=w===1&&g.value!==null?" pc-top":"",b=g.value!==null&&p>0?Math.round(g.value/p*100):0,y=g.value!==null?s.colorFn(g.value):"",_=g.value!==null?`${b}%`:"0%",$;g.value===null?$="--":a==="temp"?$=`${g.value}${g.unit}`:$=`${g.value}${c}`,u+=`<div class="pc-rank-row${g.rowClass}" role="button" tabindex="0" data-entity="${h(g.entityId)}">`,u+=`<div class="pc-rank-num${v}">${w}</div>`,u+=`<div class="pc-rank-name">${h(g.name)}</div>`,u+=`<div class="pc-rank-bar-track"><div class="pc-rank-bar-fill" style="width:${S(_)};background:${S(y)}"></div></div>`,u+=`<div class="pc-rank-value">${h($)}</div>`,u+="</div>"}u+="</div>";let m=r.map(f=>f.value),d=Ml(m,c);return u+='<div class="pc-ranking-summary">',u+=`<div class="pc-stat"><div class="pc-stat-value">${h(d.avg)}</div><div class="pc-stat-label">Average</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(d.high)}</div><div class="pc-stat-label">Highest</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(d.low)}</div><div class="pc-stat-label">Lowest</div></div>`,u+=`<div class="pc-stat"><div class="pc-stat-value">${h(d.spread)}</div><div class="pc-stat-label">Spread</div></div>`,u+="</div>",u+="</div>",u}var El=48,ka=30,Ta=70;function Bn(t,e){let o=Date.now(),i=24*3600*1e3,n=i/e,a=o-i,s=Array.from({length:e},()=>({state:"idle",power:0}));if(!Array.isArray(t)||t.length===0)return s;for(let r=0;r<e;r++){let l=a+r*n,p=l+n,c=t.filter(w=>w&&w.t>=l&&w.t<p);if(c.length===0)continue;let u={heating:0,cooling:0,idle:0,off:0},m=0,d=0;for(let w of c)u[w.state]!==void 0&&(u[w.state]+=1),(w.state==="heating"||w.state==="cooling")&&Number.isFinite(w.power)&&(m+=w.power,d+=1);let f=["heating","cooling","idle","off"].reduce((w,v)=>u[v]>u[w]?v:w,"idle"),g=d>0?m/d:0;s[r]={state:f,power:g}}return s}function Fl(t){let e="idle";return t.state==="heating"?t.power>=Ta?e="heat":t.power>=ka?e="heat-mid":e="heat-low":t.state==="cooling"?t.power>=Ta?e="cool":t.power>=ka?e="cool-mid":e="cool-low":t.state==="off"&&(e="off"),`pc-state-cell-${e}`}function Il(t){let e=0,o=0;for(let i of t)i.state==="heating"?e+=30:i.state==="cooling"&&(o+=30);return{heatMin:e,coolMin:o}}function Ca(t){let e=0,o=0,i=0,n=0,a=0,s=0;for(let l of t)l.state==="heating"||l.state==="cooling"?(n+=1,l.state==="heating"?a+=1:s+=1,n>e&&(e=n,o=a,i=s)):(n=0,a=0,s=0);if(e===0)return{minutes:0,mode:"none"};let r="mixed";return o>0&&i===0?r="heat":i>0&&o===0&&(r="cool"),{minutes:e*30,mode:r}}function Ma(t){if(t.length===0)return null;let e=t.length/24,o=Array.from({length:24},()=>0);for(let r=0;r<t.length;r++){let l=t[r];if(l.state==="heating"||l.state==="cooling"){let p=Math.floor(r/e);o[p]+=1}}let i=-1,n=0;for(let r=0;r<24;r++)o[r]>n&&(n=o[r],i=r);return i<0?null:{hour:(new Date(Date.now()-24*3600*1e3).getHours()+i)%24,minutes:Math.round(n*30)}}function Nl(t,e){if(t===0&&e===0)return"\u2014";let o=t+e,i=Math.floor(o/60),n=o%60;return n===0?`${i}h`:`${i}h ${n}m`}function zl(t,e){return t>e&&t>0?"pc-state-active-heat":e>0?"pc-state-active-cool":""}function Ll(t){let o=Date.now()-864e5;return dt(new Date(o+t*18e5))}function Rl(t){if(t.state==="heating"||t.state==="cooling"){let e=t.state==="heating"?"heat":"cool";return t.power>0?`${e} ${Math.round(t.power)}%`:e}return t.state==="off"?"off":"idle"}function Ea(t,e,o,i){let n='<div class="pc-strip-rows">';n+='<div class="pc-strip-crosshair"></div>';let a=0,s=0;for(let r of t){let{entityId:l,zoneName:p,zoneState:c}=at(r,o,e),u=i?.stateData?.[l]||[],m=Bn(u,El),{heatMin:d,coolMin:f}=Il(m);a+=d,s+=f;let g=Nl(d,f),w=zl(d,f),v=wt(c);n+=`<div class="pc-timeline-group-row pc-state-row${v}" data-entity="${h(l)}" data-zone="${h(p)}">`,n+=`<span class="pc-timeline-group-name">${h(c.name)}</span>`,n+='<div class="pc-state-timeline-cells pc-cells">';for(let b=0;b<m.length;b++){let y=m[b],_=Ll(b),$=Rl(y);n+=`<span class="pc-state-cell pc-cell ${Fl(y)}" data-hour="${h(_)}" data-score="${h($)}"></span>`}n+="</div>",n+=`<span class="pc-timeline-group-stat ${w}">${h(g)}</span>`,n+="</div>"}return n+="</div>",n+=Hl(),n+=Dl(a,s,t.length),n}function Hl(){return'<div class="pc-timeline-group-axis"><span></span><div class="ticks"><span>\u221224h</span><span>\u221218h</span><span>\u221212h</span><span>\u22126h</span><span>now</span></div><span></span></div>'}function Aa(t){let e=Math.floor(t/60),o=t%60;return o===0?`${e}h`:`${e}h ${o}m`}function Dl(t,e,o){let i=t>0?`${Aa(t)} heat`:"",n=e>0?`${Aa(e)} cool`:"",s=[i,n].filter(Boolean).join(" \xB7 ")||"\u2014";return'<div class="pc-timeline-group-footer">'+Ol()+`<span><strong>${h(s)}</strong> \xB7 ${o} zones</span></div>`}function Ol(){return'<span class="pc-state-legend"><span class="pc-state-legend-pill"><span class="pc-state-legend-pip pc-state-legend-pip-heat"></span>Heat</span><span class="pc-state-legend-pill"><span class="pc-state-legend-pip pc-state-legend-pip-cool"></span>Cool</span><span class="pc-state-legend-pill"><span class="pc-state-legend-pip pc-state-legend-pip-idle"></span>Idle</span><span class="pc-state-legend-pill"><span class="pc-state-legend-pip pc-state-legend-pip-off"></span>Off</span></span>'}var Pl=new Set(["thermal","state"]),Fa={thermal:{label:"Thermal",subtitle:"Tap a zone for details"},state:{label:"State",subtitle:"Heat / cool demand by zone"}};function qn(t,e,o,i,n){if(!e||e.length===0)return"";let a=t?.active_tab,s=typeof a=="string"&&Pl.has(a)?a:"thermal",r=`<div class="pc-section pc-section-timeline-group" data-active-tab="${h(s)}">`;r+='<div class="pc-section-header">',r+='<div class="pulse-section-label">24h Timeline</div>';let l=h(Fa[s].subtitle);r+=`<span class="pc-section-subtitle">${l}</span>`,r+="</div>",r+='<div class="pc-timeline-group-tabs" role="tablist">';for(let p of["thermal","state"])r+=`<div class="pc-timeline-group-tab${p===s?" pc-active":""}" role="tab" tabindex="0" aria-selected="${p===s}" data-tab="${h(p)}">${h(Fa[p].label)}</div>`;return r+="</div>",r+='<div class="pc-zone-detail" id="timeline-detail"></div>',r+='<div class="pc-timeline-group-body">',r+=s==="thermal"?Co(e,o,i,n):Ea(e,o,i,n),r+="</div>",r+="</div>",r}var Bl=[{key:"bridge",label:"Bridge",soloHeader:(t,e)=>"Bridge",predicate:We,render:(t,e,o,i)=>yo(t,e,i)},{key:"homekit",label:"HomeKit",soloHeader:(t,e)=>`HomeKit${xo(t,e)}`,predicate:$e,render:(t,e,o,i)=>$o(t,e,i)},{key:"api",label:"API",soloHeader:(t,e)=>"API Usage",predicate:qe,render:(t,e,o,i)=>wo(t,e,o,i)}];function Wn(t,e,o,i){let n=Bl.filter(c=>c.predicate(e));if(n.length===0)return"";if(n.length===1){let c=n[0],u='<div class="pc-section pc-section-system-health-group">';return u+=`<div class="pulse-section-label">${h(c.soloHeader(e,o))}</div>`,u+='<div class="pc-system-health-group-body">',u+=c.render(e,o,t,i),u+="</div>",u+="</div>",u}let a=t?.active_tab,r=n.some(c=>c.key===a)?a:n[0].key,l=n.find(c=>c.key===r)||n[0],p=`<div class="pc-section pc-section-system-health-group" data-active-tab="${h(r)}">`;p+='<div class="pc-section-header">',p+='<div class="pulse-section-label">System Health</div>',p+="</div>",p+='<div class="pc-system-health-group-tabs" role="tablist">';for(let c of n){let u=c.key===r?" pc-active":"";p+=`<div class="pc-system-health-group-tab${u}" role="tab" tabindex="0" aria-selected="${c.key===r}" data-tab="${h(c.key)}">${h(c.label)}</div>`}return p+="</div>",p+='<div class="pc-system-health-group-body">',p+=l.render(e,o,t,i),p+="</div>",p+="</div>",p}var ql=new Set(["heating","cooling","mixed"]),Wl=new Set(["subtle","medium","bold"]);function Ia(t,e){if(!t||!ql.has(t))return"";let o=e&&Wl.has(e)?e:"medium";return`<div class="pc-atmosphere-wash pc-state-${t} pc-intensity-${o}" aria-hidden="true"></div>`}var Vl={heating:"Heating",cooling:"Cooling",mixed:"Mixed",idle:"Idle",off:"Off"},Ul=6;function jl(t){let e="idle";return t.isUnavailable?e="unavail":t.hvacAction==="heating"?e="heating":t.hvacAction==="cooling"?e="cooling":t.hvacAction==="off"&&(e="off"),`pc-hero-dot-${e}`}function Gl(t){let e="idle";return t.isUnavailable?e="unavail":t.hvacAction==="heating"?e="heat":t.hvacAction==="cooling"?e="cool":t.hvacAction==="off"&&(e="off"),`pc-row-${e}`}function Vn(t,e,o,i){if(!Array.isArray(t)||t.length===0)return"";let n=t.filter(b=>!b.isUnavailable),a=ho(t),s=t.filter(b=>!b.isUnavailable&&typeof b.currentTemp=="number"&&Number.isFinite(b.currentTemp)),r=s.length>0?s.reduce((b,y)=>b+y.currentTemp,0)/s.length:null,l=t[0]&&t[0].unit||"\xB0C",p=n.filter(b=>b.hvacAction==="heating").length,c=n.filter(b=>b.hvacAction==="cooling").length,u=Vl[a]||"Idle",m=r===null?"\u2014":`${Z(r)}${h(l)}`,d=`<div class="pc-hero pc-state-${a}">`;d+='<div class="pc-hero-top-row">',d+='<div class="pc-hero-temp-block">',d+='<div class="pc-hero-label">Home avg</div>',d+=`<div class="pc-hero-temp">${m}</div>`,d+="</div>",d+='<div class="pc-hero-dots">';for(let b of t){let y=jl(b),_=[h(b.name)];!b.isUnavailable&&b.hvacAction&&_.push(h(b.hvacAction)),d+=`<span class="pc-hero-zone-dot ${y}" data-entity="${h(b.entityId)}" title="${_.join(" \u2014 ")}"></span>`}d+="</div>",d+='<div class="pc-hero-right">';let f=p+c,g=f>0?`${h(u)} \xB7 ${f} active`:`${h(u)} \xB7 ${n.length} ${n.length===1?"zone":"zones"}`;if(d+=`<div class="pc-hero-status">${g}</div>`,e?.hero_show_outside!==!1&&i&&typeof i.value=="number"&&Number.isFinite(i.value)){let b=i;d+='<div class="pc-hero-outside">',d+=`Outside ${Z(b.value)}${h(b.unit)}`,d+="</div>"}if(d+="</div>",d+="</div>",e?.hero_show_thermal_strip!==!1){let b=Xl(t,o);b&&(d+=b)}return d+="</div>",d}function Xl(t,e){let i=t.slice(0,Ul),n=t.length-i.length,a=!1;for(let r of i){let l=e?.get?.(r.entityId);if(Array.isArray(l)&&l.length>=2){a=!0;break}}if(!a)return"";let s='<div class="pc-hero-strips">';for(let r of i)s+=Zl(r,e?.get?.(r.entityId)||[],24);return n>0&&(s+='<div class="pc-hero-zone-strip pc-hero-zone-strip-overflow">',s+=`<div class="pc-hero-zone-strip-label">+${n} more</div>`,s+="</div>"),s+="</div>",s}function Zl(t,e,o){let i=Gl(t),n="";if(Array.isArray(e)&&e.length>=2){let a={minTemp:t.minTemp??18,maxTemp:t.maxTemp??26},s=t.isUnavailable?"off":t.hvacAction,r=Math.max(1,Math.floor(e.length/o));for(let l=0;l<o;l++){let p=e[Math.min(e.length-1,l*r)],c=la(p.v,a,s);n+=`<span style="background:${S(c)}"></span>`}}else for(let a=0;a<o;a++)n+='<span class="pc-hero-zone-strip-cell-ghost"></span>';return`<div class="pc-hero-zone-strip ${i}" data-entity="${h(t.entityId)}"><div class="pc-hero-zone-strip-label">${h(t.name)}</div><div class="pc-hero-zone-strip-cells">${n}</div></div>`}function Un(t,e,o){let i={value:null,unit:"\xB0C",entityId:null};if(!o)return i;let n=t?.outdoor_temp_entity||e?.hubEntities?.outside_temp||null;if(!n){for(let p of Object.keys(o))if(p.startsWith("weather.")&&o[p]?.attributes?.temperature!==void 0){n=p;break}}if(!n||!o[n])return i;let a=o[n];if(Q(a))return{value:null,unit:"\xB0C",entityId:n};let s=a.attributes?.temperature!==void 0?a.attributes.temperature:a.state,r=Number.parseFloat(s),l=a.attributes?.unit_of_measurement||"\xB0C";return{value:Number.isFinite(r)?r:null,unit:l,entityId:n}}var Na=!1,Kl=typeof CSSStyleSheet<"u"&&typeof CSSStyleSheet.prototype.replaceSync=="function"&&typeof document<"u"&&"adoptedStyleSheets"in document.createElement("div").attachShadow({mode:"open"}),za=Kl?(()=>{let t=new CSSStyleSheet;return t.replaceSync(mn),t})():null,Yl=new Set(["zones","api","graph","bridge","thermal_strip","comfort_strip","homekit","weather","radial","donut","timeline_group","system_health_group"]),Jl={zones:".pc-section-zones",api:".pc-section-api",graph:".pc-section-graph",bridge:".pc-section-bridge",thermal_strip:".pc-section-thermal-strip",comfort_strip:".pc-section-comfort-strip",homekit:".pc-section-homekit",weather:".pc-section-weather",radial:".pc-section-radial",donut:".pc-section-donut",environment:".pc-section-environment",thermal:".pc-section-thermal",schedule:".pc-section-schedule",energy_flow:".pc-section-energy-flow",home_status:".pc-section-home-status",zone_ranking:".pc-section-zone-ranking",timeline_group:".pc-section-timeline-group",system_health_group:".pc-section-system-health-group"},jn=class extends HTMLElement{_config=null;_hass=null;_prevStates={};_elements={};_discovery=null;_historyCache;_shadow;_countdownTimer=null;_historyFetchInProgress=!1;_rafId=null;_lastUpdateTime=0;_rerenderTargets=null;_chipAbort=null;_sectionChipAbort=null;_radialAbort=null;_timelineAbort=null;_stateTimelineAbort=null;_heatmapAbort=null;_energyFlowAbort=null;_sparklineAbort=null;_zoneRankingTabsAbort=null;_timelineGroupTabsAbort=null;_timelineGroupCellTooltipAbort=null;_systemHealthGroupTabsAbort=null;_sparklinePathCache=new Map;_radialAnimState={shimmer:!1,sheen:!1};_historyGen=0;constructor(){super(),this._shadow=this.attachShadow({mode:"open"}),this._historyCache=na()}setConfig(e){this._stopRadialAnimations(),this._historyGen++,this._config=ta(e),this._discovery=null,this._prevStates={},this._elements={},this._hass&&(this._runDiscovery(),this._fullRender()),this._buildRerenderTargets()}set hass(e){if(this._hass=e,!!this._config){if(!this._discovery){this._runDiscovery(),this._fullRender(),this._refreshHistoryIfNeeded();return}this._rafId||(this._rafId=requestAnimationFrame(()=>{if(this._rafId=null,!this._hass||!this._config||!this._discovery)return;let o=Date.now();if(o-this._lastUpdateTime<200)return;this._lastUpdateTime=o;let i=this._hass.states,n=(this._config._zones||[]).some(a=>i[a.entity]!==this._prevStates[a.entity]);n&&this._updateZones(),this._updateSections(),n&&this._updateHero(),this._refreshHistoryIfNeeded(),this._cacheWatchedStates()}))}}_runDiscovery(){if(!this._hass||!this._config)return;this._historyGen++;let o=(this._config._zones||[]).map(i=>K(i.entity));if(this._discovery=Xi(this._hass.states,o,this._hass.entities),!Na&&this._discovery.isTadoCE){Na=!0;let i=Object.entries(this._discovery.hubEntities).map(([n,a])=>`${n}=${a}`);console.info(`${oe} Tado CE hub discovery \u2014 found: ${i.join(", ")}`),this._discovery.missingHubKeys.length>0&&console.warn(`${oe} Tado CE hub discovery \u2014 missing: ${this._discovery.missingHubKeys.join(", ")}. Affected sections may render with degraded data.`)}this._buildRerenderTargets()}_rebuildSparklinePathCache(){this._sparklinePathCache.clear();let e=this._historyCache?.data;if(e)for(let[o,i]of Object.entries(e)){if(!i||i.length<2)continue;let n=Pt(i,340,36,48);n&&this._sparklinePathCache.set(o,n)}}_buildRerenderTargets(){if(!this._config||!this._discovery)return;let e=this._discovery,o=e.hubEntities,i=this._config._zones||[];this._rerenderTargets=[{selector:".pc-section-zones",watchIds:[o.home_state].filter(Boolean),render:()=>{let n=this._config,a=this._hass?.states||{};return _n(i,n,a,e,this._historyCache)}},{selector:".pc-section-api",watchIds:[o.api_usage,o.api_limit,o.api_status,o.next_sync,o.token_status].filter(Boolean),render:()=>{let n=this._hass?.states||{},s=(this._config?.sections||[{type:"zones"}]).find(r=>(typeof r=="string"?r:r.type)==="api")||{};return xn(o,n,s,this._historyCache)}},{selector:".pc-section-homekit",watchIds:[o.homekit_connected,o.homekit_reads_saved,o.homekit_writes_saved].filter(Boolean),render:()=>{let n=this._hass?.states||{};return Sn(o,n,this._historyCache)}},{selector:".pc-section-bridge",watchIds:[o.bridge_connected,o.boiler_flow_temp,o.wc_status,o.wc_target_flow].filter(Boolean),render:()=>{let n=this._hass?.states||{};return $n(o,n,this._historyCache)}},{selector:".pc-section-weather",watchIds:[o.outside_temp,o.weather,o.solar_intensity].filter(Boolean),render:()=>{let n=this._hass?.states||{};return kn(o,n,this._historyCache)}},{selector:".pc-section-environment",watchIds:i.flatMap(n=>{let a=K(n.entity),s=e.zoneEntities?.[a]||{};return[s.mold_risk,s.condensation,s.comfort_level,s.surface_temp,s.dew_point].filter(Boolean)}),render:()=>{let n=this._hass?.states||{};return Tn(i,n,e)}},{selector:".pc-section-thermal",watchIds:i.flatMap(n=>{let a=K(n.entity),s=e.zoneEntities?.[a]||{};return[s.heating_rate,s.thermal_inertia,s.preheat_time,s.confidence].filter(Boolean)}),render:()=>{let n=this._hass?.states||{};return An(i,n,e)}},{selector:".pc-section-schedule",watchIds:i.flatMap(n=>{let a=K(n.entity),s=e.zoneEntities?.[a]||{};return[s.next_schedule,s.next_sched_temp,s.schedule_deviation,s.preheat_advisor,s.comfort_target].filter(Boolean)}),render:()=>{let n=this._hass?.states||{};return Cn(i,n,e)}},{selector:".pc-section-radial",watchIds:i.map(n=>n.entity),render:()=>{let n=this._hass?.states||{},s=(this._config?.sections||[{type:"zones"}]).find(r=>(typeof r=="string"?r:r.type)==="radial")||{};return Dn(i,s,n,e,this._historyCache)}},{selector:".pc-section-donut",watchIds:(()=>{let s=(this._config?.sections||[]).find(r=>(typeof r=="string"?r:r.type)==="donut")?.source;return s==="api_breakdown"&&o.api_breakdown?[o.api_breakdown]:s==="homekit_saved"?[o.homekit_reads_saved,o.homekit_writes_saved].filter(Boolean):[]})(),render:()=>{let n=this._hass?.states||{},s=(this._config?.sections||[]).find(r=>(typeof r=="string"?r:r.type)==="donut")||{};return Fn(s,o,n)}},{selector:".pc-section-graph",watchIds:[],render:()=>{let n=this._hass?.states||{},s=(this._config?.sections||[{type:"zones"}]).find(r=>(typeof r=="string"?r:r.type)==="graph")||{};return En(s,i,this._historyCache,n,e)}},{selector:".pc-section-home-status",watchIds:i.map(n=>n.entity),render:()=>{let n=this._hass?.states||{};return On(i,n,e,this._config||{})}},{selector:".pc-section-zone-ranking",watchIds:i.map(n=>n.entity),render:()=>{let n=this._hass?.states||{},s=this._shadow.querySelector(".pc-section-zone-ranking")?.getAttribute("data-metric")||"power";return Eo(i,n,e,s)}}]}_fullRender(){if(!this._config||!this._hass||!this._discovery)return;let e=this._config,o=this._hass.states,i=this._discovery,n=e._zones||[],a=e.layout==="compact",s=e.entity_row===!0,r="";za?this._shadow.adoptedStyleSheets=[za]:r+=`<style>${mn}</style>`;let l=n.map(u=>{let m=K(u.entity),d=i.zoneEntities?.[m]||{};return we(u.entity,d,o,u,e)}),p=ho(l);if(s||(r+=`<ha-card${a?' class="pc-compact"':""}>`),e.show_atmosphere!==!1&&(r+=Ia(p,e.atmosphere_intensity)),r+='<div class="pc-card-content">',e.title&&(r+=`<div class="pulse-title">${h(e.title)}</div>`),e.show_hero!==!1){let u=Un(e,i,o),m=f=>{let g=n.findIndex(_=>_.entity===f);if(g<0)return f;let w=n[g],v=K(f),b=i?.zoneEntities?.[v]||{};return ht(f,o,b,w)?.entityId||f},d=fn(n,this._historyCache,m);r+=Vn(l,e,d,u)}let c=e.sections||[{type:"zones"}];for(let u=0;u<c.length;u++){let m=c[u],d=this._renderSection(m,n,o,i);r+=d.replace(/^<div class="pc-section([^"]*)"/,`<div class="pc-section$1" data-section-index="${u}"`)}r+="</div>",s||(r+="</ha-card>"),this._shadow.innerHTML=r,this._elements.zonesSection=this._shadow.querySelector(".pc-section-zones"),this._elements.apiSection=this._shadow.querySelector(".pc-section-api"),this._cacheWatchedStates(),this._bindZoneActions(),this._bindChipActions(),this._bindSectionInteractions(),this._bindSectionChipActions(),this._startCountdownTimer()}_bindZoneActions(){if(!this._config||!this._hass)return;let e=this._shadow.querySelectorAll(".pc-zone-row"),o=this._config._zones||[];for(let i=0;i<e.length&&i<o.length;i++){let n=e[i],a=o[i],s=a.entity,r=n.__pulseCleanup;typeof r=="function"&&r();let l=new AbortController,{signal:p}=l,c=0,u=null,m=null,d=!1;n.__pulseCleanup=()=>{l.abort(),u&&clearTimeout(u),m&&clearTimeout(m),delete n.__pulseCleanup},n.addEventListener("keydown",g=>{let w=g;(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),this._fireAction(s,a,"tap_action"))},{signal:p}),n.addEventListener("click",g=>{if(g.preventDefault(),d){d=!1;return}c++,c===1?u=setTimeout(()=>{c=0,this._fireAction(s,a,"tap_action")},250):c===2&&(u&&clearTimeout(u),c=0,this._fireAction(s,a,"double_tap_action"))},{signal:p}),n.addEventListener("pointerdown",()=>{d=!1,m=setTimeout(()=>{d=!0,this._fireAction(s,a,"hold_action")},500)},{signal:p});let f=()=>{m&&clearTimeout(m)};n.addEventListener("pointerup",f,{signal:p}),n.addEventListener("pointercancel",f,{signal:p}),n.addEventListener("contextmenu",g=>g.preventDefault(),{signal:p}),Et(n)}}_bindSectionInteractions(){this._bindRadialInteractions(),this._bindTimelineInteractions(),this._bindHeatmapInteractions(),this._bindEnergyFlowInteractions(),this._bindSparklineCrosshairs(),this._bindZoneRankingTabs(),this._bindTimelineGroupTabs(),this._bindTimelineGroupCellTooltip(),this._bindStateTimelineInteractions(),this._bindSystemHealthGroupTabs()}_bindChipActions(){if(!this._config||!this._hass)return;let e=this._resetAbort("_chipAbort"),o=this._config._zones||[],i=this._shadow.querySelectorAll(".pc-zone-row");for(let n=0;n<i.length&&n<o.length;n++){let a=o[n],s=a.entity,r=i[n].querySelectorAll(".pc-chip");for(let l of r){let p=l,c=p.dataset.chipType||"",u=p.dataset.entity||s,m=a.chip_actions,d=this._config.chip_actions,f=m?.[c]||d?.[c]||{},g=f.tap_action||{action:"more-info",entity:u},w=f.hold_action||{action:"none"};p.style.cursor="pointer",Et(p),p.addEventListener("click",b=>{b.stopPropagation(),this._hass&&ve(this,this._hass,g,u,Ot)},{signal:e});let v=null;p.addEventListener("pointerdown",b=>{b.stopPropagation(),v=setTimeout(()=>{!this._hass||w.action==="none"||ve(this,this._hass,w,u,Ot)},500)},{signal:e}),p.addEventListener("pointerup",b=>{b.stopPropagation(),v&&clearTimeout(v)},{signal:e}),p.addEventListener("pointercancel",()=>{v&&clearTimeout(v)},{signal:e}),p.addEventListener("contextmenu",b=>b.preventDefault(),{signal:e})}}}_bindSectionChipActions(){let e=this._resetAbort("_sectionChipAbort"),o=this._shadow.querySelectorAll(".pc-section [data-entity]");for(let i of o){let n=i;n.closest(".pc-zone-row")&&n.classList.contains("pc-chip")||n.classList.contains("pc-zone-row")||(n.style.cursor="pointer",Et(n),n.addEventListener("click",a=>{a.stopPropagation();let s=n.dataset.entity;s&&lo(this,"hass-more-info",{entityId:s})},{signal:e}))}}_startCountdownTimer(){this._countdownTimer&&clearInterval(this._countdownTimer);let e=this._shadow.querySelector(".chip-next-sync");if(!e)return;let o=Number(e.getAttribute("data-target"));if(!o||!isFinite(o))return;let i=()=>{let n=o-Date.now();if(n<=0){e.textContent="Next: now",this._countdownTimer&&(clearInterval(this._countdownTimer),this._countdownTimer=null);return}let a=Math.floor(n/6e4),s=Math.floor(n%6e4/1e3);e.textContent=a>0?`Next: ${a}m ${s}s`:`Next: ${s}s`};i(),this._countdownTimer=setInterval(i,1e3)}_bindRadialInteractions(){let e=this._resetAbort("_radialAbort"),o=this._shadow.querySelectorAll(".pc-arc-group"),i=this._shadow.querySelectorAll(".pc-radial-legend .pc-legend-item"),n=this._shadow.querySelector("#radial-center"),a=this._shadow.querySelector("#radial-detail"),s=this._shadow.querySelector(".pc-section-radial svg");if(o.length===0||!n)return;let l=(s&&Number(s.getAttribute("width"))||280)/2,p=this._config?._zones||[],c=null,u=this._shadow.querySelector(".pc-section-radial")?.getAttribute("data-outdoor-temp-entity"),m=this._shadow.querySelector(".pc-section-radial")?.getAttribute("data-attribute")||"temperature",d=this._shadow.querySelector(".pc-section-radial")?.getAttribute("data-outdoor-humidity-entity"),f=()=>{let v=this._hass?.states||{},b=this._discovery,y=u||b?.hubEntities?.outside_temp,_="--",$="";if(m!=="humidity"&&y&&v[y]){let A=v[y];Q(A)||(_=`${A.attributes?.temperature!==void 0?A.attributes.temperature:A.state}${A.attributes?.unit_of_measurement||"\xB0C"}`)}if(d&&v[d]){let A=v[d];if(!Q(A)){let M=A.attributes?.humidity!==void 0?A.attributes.humidity:A.state;m==="humidity"?_=`${M}%`:$=`${M}%`}}return{center:_,centerSub:$}},g=v=>{let b=this._hass?.states||{},y=this._discovery;if(c===v){w();return}c=v;let _=p[v];if(!_)return;let $=_.entity,A=K($),M=y?.zoneEntities?.[A]||{},C=De($,b,_),{name:E,temp:z,target:k,humidity:x}=C,T=C.hvacAction,F=0;if(M.heating_power){let P=b[M.heating_power];Q(P)||(F=parseFloat(P.state)||0)}else b[$]?.attributes?.heating_power!==void 0&&(F=parseFloat(b[$].attributes.heating_power)||0);let I=F>0||T==="heating"||T==="cooling"?`${T==="cooling"?"Cooling":"Heating"} ${Math.round(F)}%`:"Idle",q=n.querySelector(".pc-center-value"),L=n.querySelector(".pc-center-label"),N=n.querySelector(".pc-center-sub");q&&(q.textContent=z!==void 0?`${Z(z)}${C.unit}`:"--"),L&&(L.textContent=E);let O=x!==void 0?` \xB7 ${x}%`:"";N&&(N.textContent=`${I}${O}`),o.forEach((P,H)=>{P.classList.toggle("pc-dimmed",H!==v),P.classList.toggle("pc-selected",H===v),H===v?P.setAttribute("transform",`translate(${l}, ${l}) scale(1.06) translate(${-l}, ${-l})`):P.removeAttribute("transform")}),i.forEach((P,H)=>{P.classList.toggle("pc-selected",H===v)}),a&&(a.innerHTML=`<div class="pc-detail-stats">
          <div class="pc-stat"><div class="pc-stat-value">${k!==void 0?h(k)+h(C.unit):"--"}</div><div class="pc-stat-label">Target</div></div>
...
`;var Ya=[{type:"overview"}],tc={overview:{},forecast:{mode:"both"},wind:{speed_mode:"speed"},air_quality:{scale:"eu"},astro:{},alerts:{},atmosphere:{}};function ti(t){if(!t||typeof t!="object")return{type:"overview"};let e=Ha.includes(t.type)?t.type:"overview";return{...tc[e]||{},...t,type:e}}function Ja(t){if(!t||typeof t!="object")return{type:"custom:pulse-weather-card",sections:Ya.map(ti)};let e=t,o=Array.isArray(e.sections)&&e.sections.length>0?e.sections.map(ti):Ya.map(ti);return{type:e.type||"custom:pulse-weather-card",weather_entity:e.weather_entity||void 0,atmos_source:e.atmos_source||void 0,sections:o}}function ei(t){let e=t.replace(/^weather\./,"");return e.endsWith(Qn)&&(e=e.slice(0,-Qn.length)),e}function Qa(t,e){let o=e.weather_entity||Object.keys(t).find(p=>p.startsWith("weather."))||"",i=e.atmos_source||ei(o),n={};for(let p of Ua){let c=`sensor.${i}_${p}`;c in t&&(n[p]=c)}let a=Object.keys(n).length>=Ga,s=a?n:{},r=[];if(e.alert_entities&&e.alert_entities.length>0)for(let p of e.alert_entities)p in t&&r.push(p);else if(a){for(let u of ja){let m=`sensor.${i}_${u}`,d=`sensor.${i}_warnings_${u}`;m in t?r.push(m):d in t&&r.push(d)}let p=`binary_sensor.${i}_alert_active`,c=`binary_sensor.${i}_warnings_alert_active`;p in t?r.push(p):c in t&&r.push(c)}let l="sun.sun"in t?"sun.sun":null;return{weatherEntityId:o,atmosCe:s,sunEntityId:l,atmosSource:a?i:null,alertEntityIds:r}}function er(t,e){return t.filter(o=>Number.isFinite(e(o)))}function ut(t,e=0){let o=Number(t);return Number.isFinite(o)?o:e}function zo(t,e,o,i,n,a=0){if(e?.[i]){let s=Number(t?.states?.[e[i]]?.state);if(Number.isFinite(s))return s}return Number(o?.[n]??a)||a}function or(t,e,o,i){return e?.[o]&&t?.states?.[e[o]]?.attributes?.unit_of_measurement||i}function Ce(t,e,o=0){let i=e?t?.states?.[e]:null;if(!i)return{value:o,unit:void 0,entity:null};let n=Number(i.state);return{value:Number.isFinite(n)?n:o,unit:i.attributes?.unit_of_measurement,entity:i}}function Lo(t,e,o){let i=e?.state||"sunny",n=o?.sunEntityId?t?.states?.[o.sunEntityId]?.state:null;return{condition:i,isNight:i==="clear-night"||n==="below_horizon"}}function Ue(t="pw-id"){return ue(t)}function nr(t){return`${t}, linear-gradient(180deg, var(--pw-sky-top) 0%, var(--pw-sky-mid) 45%, var(--pw-sky-bot) 100%)`}function Ro(t,e,o=36e5){let i=(e?e.getTime():Date.now())-o;return t.filter(n=>{let a=n.datetime;if(!a)return!1;let s=new Date(a).getTime();return Number.isFinite(s)&&s>=i})}function Qt(t){let e=Number(t);for(let o of Fo)if(e<=o.max)return o.color;return Fo[Fo.length-1].color}function oi(t){let e=Number(t);for(let o of Io)if(e<=o.max)return o.tier;return Io[Io.length-1].tier}function ir(t){return Te[oi(t)]||Te.calm}function Ho(t){let e=Number(t);for(let o of No)if(e<=o.max)return o;return No[No.length-1]}function Do(t){let e=(Number(t)%360+360)%360,o=Math.round(e/22.5)%16;return Wa[o]}function ar(t){return t<=12?"#30d158":t<=50?"#5ac8fa":t<=87?"#ff9f0a":"#ff453a"}function rr(t){return t<10?"#5ac8fa":t<16?"#30d158":t<19?"#ffd60a":t<22?"#ff9f0a":"#ff453a"}function Me(t,e,o){if(!e||!o)return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let i=new Date(e),n=new Date(o);if(isNaN(i.getTime())||isNaN(n.getTime()))return{todaySunrise:null,todaySunset:null,tomorrowSunrise:null};let a=i.getTime()>t.getTime()?new Date(i.getTime()-864e5):i,s=n.getTime()>t.getTime()?n:new Date(n.getTime()-864e5);s.getTime()>a.getTime()+864e5&&(s=new Date(s.getTime()-864e5)),a.getTime()>s.getTime()&&(a=new Date(a.getTime()-864e5));let r=i.getTime()>t.getTime()?i:new Date(i.getTime()+864e5);return{todaySunrise:a,todaySunset:s,tomorrowSunrise:r}}function ft(t,e){if(!t||isNaN(t.getTime()))return null;if(!e)return t;let o=e.getTime(),i=[t,new Date(t.getTime()-864e5),new Date(t.getTime()+864e5)],n=i[0],a=Math.abs(n.getTime()-o);for(let s=1;s<i.length;s+=1){let r=Math.abs(i[s].getTime()-o);r<a&&(n=i[s],a=r)}return n}function Ct(t,e,o){let i=e?Object.entries(e).map(([n,a])=>` ${n}="${a}"`).join(""):"";return o!=null?`<${t}${i}>${o}</${t}>`:`<${t}${i}/>`}function Oo(t){return Xa[t]||"\u{1F324}\uFE0F"}var tr={"clear-night":"Clear Night",cloudy:"Cloudy",exceptional:"Exceptional",fog:"Fog",hail:"Hail",lightning:"Lightning","lightning-rainy":"Lightning Rainy",partlycloudy:"Partly Cloudy",pouring:"Pouring",rainy:"Rainy",snowy:"Snowy","snowy-rainy":"Snowy Rainy",sunny:"Sunny",windy:"Windy","windy-variant":"Windy Variant"};function sr(t){return Object.hasOwn(tr,t)?tr[t]:t.replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function $t(t,e,o){let i=document.createElement(t);if(i.className=e,o)for(let[n,a]of Object.entries(o))i.style.setProperty(n,a);return i}function X(t,e){return Math.random()*(e-t)+t}function je(t,e=60,o=1,i=2){let n=Math.min(e,Oa);for(let a=0;a<n;a++){let s=$t("div","pw-rain-drop"),r=X(15,30),l=X(.4,.8)/o;Object.assign(s.style,{left:`${X(0,100)}%`,top:`${X(-10,20)}%`,width:`${i}px`,height:`${r}px`,borderRadius:`0 0 ${i}px ${i}px`,background:"linear-gradient(to bottom, transparent, rgba(120,180,255,0.6))",animation:`pw-rainFall ${l}s linear ${X(0,2)}s infinite`,animationFillMode:"backwards",position:"absolute"}),t.appendChild(s)}}function ni(t,e=40){let o=Math.min(e,Pa);for(let i=0;i<o;i++){let n=$t("div","pw-snowflake"),a=X(2,5);Object.assign(n.style,{left:`${X(0,100)}%`,top:`${X(-5,10)}%`,width:`${a}px`,height:`${a}px`,borderRadius:"50%",background:"rgba(255,255,255,0.7)",animation:`pw-snowFall ${X(3,6)}s linear ${X(0,4)}s infinite`,animationFillMode:"backwards",position:"absolute"}),t.appendChild(n)}}function ec(t){for(let e=0;e<4;e++){let o=$t("div","pw-fog-layer");Object.assign(o.style,{position:"absolute",width:"200%",height:"40px",top:`${30+e*20}%`,left:"0",background:"linear-gradient(to right, transparent 0%, rgba(200,200,200,0.06) 20%, rgba(200,200,200,0.1) 50%, rgba(200,200,200,0.06) 80%, transparent 100%)",animation:`pw-fogDrift ${X(15,25)}s linear ${e*2}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function Po(t){for(let e=0;e<8;e++){let o=$t("div","pw-sun-ray");Object.assign(o.style,{position:"absolute",top:"-20px",left:`${10+e*12}%`,width:"2px",height:"120px",background:"linear-gradient(to bottom, rgba(255,220,100,0.08), transparent)",transformOrigin:"top center",transform:`rotate(${-15+e*4}deg)`,animation:`pw-rayPulse ${X(3,5)}s ease-in-out ${X(0,2)}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function gt(t,e=4,o=1){let i=Math.min(e,Kn);for(let n=0;n<i;n++){let a=$t("div","pw-cloud"),s=X(80,160),r=X(30,60),l=X(20,40)/o;Object.assign(a.style,{position:"absolute",width:`${s}px`,height:`${r}px`,top:`${X(5,50)}%`,left:"0",borderRadius:"50%",background:"radial-gradient(ellipse, rgba(255,255,255,0.05) 0%, transparent 70%)",animation:`pw-cloudDrift ${l}s linear ${X(0,15)}s infinite`,animationFillMode:"backwards"}),t.appendChild(a)}}function ii(t){for(let e=0;e<Ba;e++){let o=$t("div","pw-star"),i=X(1,3);Object.assign(o.style,{position:"absolute",left:`${X(0,100)}%`,top:`${X(0,70)}%`,width:`${i}px`,height:`${i}px`,borderRadius:"50%",background:"#fff",animation:`pw-twinkle ${X(2,5)}s ease-in-out ${X(0,3)}s infinite`,animationFillMode:"backwards"}),t.appendChild(o)}}function oc(t,e){let o=[],i=t,n=0,a=Math.floor(X(4,8)),s=e/a;o.push(`${i},${n}`);for(let r=0;r<a;r++)i+=X(-15,15),n+=s,o.push(`${i},${n}`);return o.join(" ")}function lr(t,e=2,o){let i=o||Array.from({length:e},(a,s)=>s*3),n=$t("div","pw-lightning-flash");Object.assign(n.style,{position:"absolute",inset:"0",background:"rgba(255,255,255,0.15)",animation:`pw-flash 6s ease-in-out ${i[0]||0}s infinite`,animationFillMode:"backwards",pointerEvents:"none"}),t.appendChild(n);for(let a=0;a<e;a++){let s="http://www.w3.org/2000/svg",r=document.createElementNS(s,"svg");r.setAttribute("class","pw-lightning-bolt"),r.setAttribute("width","60"),r.setAttribute("height","200"),r.setAttribute("viewBox","0 0 60 200"),r.style.position="absolute",r.style.top="0",r.style.left=`${X(15,75)}%`,r.style.pointerEvents="none",r.style.zIndex="2",r.style.animation=`pw-boltStrike 6s ease-in-out ${i[a]||0}s infinite`,r.style.animationFillMode="backwards";let l=oc(30,180),p=document.createElementNS(s,"polyline");p.setAttribute("points",l),p.setAttribute("fill","none"),p.setAttribute("stroke","rgba(200,220,255,0.4)"),p.setAttribute("stroke-width","6"),p.setAttribute("stroke-linecap","round"),p.setAttribute("stroke-linejoin","round"),r.appendChild(p);let c=document.createElementNS(s,"polyline");c.setAttribute("points",l),c.setAttribute("fill","none"),c.setAttribute("stroke","#fff"),c.setAttribute("stroke-width","2"),c.setAttribute("stroke-linecap","round"),c.setAttribute("stroke-linejoin","round"),r.appendChild(c),t.appendChild(r)}}function nc(t){let e=$t("div","pw-heat-shimmer");Object.assign(e.style,{position:"absolute",inset:"0",pointerEvents:"none",background:"linear-gradient(0deg, transparent 0%, rgba(255,200,100,0.03) 30%, transparent 50%, rgba(255,180,80,0.02) 70%, transparent 100%)",backgroundSize:"100% 200%",animation:"pw-shimmer 3s ease-in-out infinite"}),t.appendChild(e);let o=$t("div","pw-heat-ripple");Object.assign(o.style,{position:"absolute",bottom:"0",left:"0",right:"0",height:"60px",pointerEvents:"none",background:"repeating-linear-gradient(0deg, transparent, rgba(255,200,100,0.02) 2px, transparent 4px)",animation:"pw-rippleWave 2s ease-in-out infinite"}),t.appendChild(o)}function cr(t,e,o){let i=Math.min(1,(e/75+o/150)/2);if(i<.05)return;let n=$t("div","pw-smog-overlay");n.style.background=`rgba(120,110,80,${.05+i*.15})`,t.appendChild(n);let a=$t("div","pw-haze-vignette");a.style.background=`radial-gradient(ellipse at center, transparent 40%, rgba(80,70,50,${i*.3}) 100%)`,t.appendChild(a);let s=Math.floor(i*20);for(let l=0;l<s;l++){let p=$t("div","pw-dust-particle"),c=X(1,3+i*3);Object.assign(p.style,{left:`${X(0,100)}%`,top:`${X(10,90)}%`,width:`${c}px`,height:`${c}px`,animationDelay:`${X(0,8)}s`,animationFillMode:"backwards"}),t.appendChild(p)}let r=Math.floor(i*5);for(let l=0;l<r;l++){let p=$t("div","pw-haze-blob"),c=X(60,120);Object.assign(p.style,{left:`${X(-10,80)}%`,top:`${X(10,70)}%`,width:`${c}px`,height:`${c*.6}px`,animationDelay:`${X(0,12)}s`,animationFillMode:"backwards"}),t.appendChild(p)}}function pr(t,e,o){let i=document.createDocumentFragment();try{e&&ii(i);let n=o?Math.round(o.total/100*Kn):0;switch(t){case"sunny":e||Po(i),o&&n>0&&gt(i,n);break;case"clear-night":o&&n>0&&gt(i,n);break;case"partlycloudy":e||Po(i),gt(i,o?n:3);break;case"cloudy":gt(i,o?Math.max(n,4):6);break;case"rainy":je(i,40,1,2),gt(i,o?Math.max(n,3):4);break;case"pouring":je(i,80,1.5,3),gt(i,o?Math.max(n,5):6);break;case"snowy":ni(i,40),gt(i,o?Math.max(n,3):4);break;case"snowy-rainy":ni(i,20),je(i,20,.8,1),gt(i,o?Math.max(n,3):4);break;case"hail":je(i,30,1.2,3),ni(i,15),gt(i,o?Math.max(n,4):5);break;case"lightning":lr(i,2,[0,3]),gt(i,o?Math.max(n,5):6);break;case"lightning-rainy":lr(i,3,[0,2,4]),je(i,60,1.3,2),gt(i,o?Math.max(n,5):6);break;case"fog":ec(i);break;case"windy":case"windy-variant":gt(i,o?n:3,1.5);break;case"exceptional":nc(i);break;default:o&&n>0&&gt(i,n);break}}catch(n){console.warn(`${Bt} buildConditionFx threw \u2014 atmospheric FX will be partial or absent for this condition. Please share the error below when reporting.`,n)}return i}function Ge(t,e,o){return o===e?0:Math.max(0,Math.min(1,(t-e)/(o-e)))}function ai(t,e,o="ellipse"){let i=Math.max(0,Math.min(1,e)),n=Math.round(3+i*50),a=Math.round(2+i*25),s=Math.round(50+i*30),r=l=>l.toString(16).padStart(2,"0");return`radial-gradient(${o} at 50% 30%, ${t}${r(n)} 0%, ${t}${r(a)} ${s}%, transparent 90%)`}function dr(t,e=6,o=1.2){let i=Math.max(0,Math.min(1,t));return e-i*(e-o)}function ur(t,e){let o=Math.max(0,Math.min(1,e)),i=Math.round(4+o*20),n=Math.round(o*8),s=Math.round((.15+o*.55)*255).toString(16).padStart(2,"0");return`0 0 ${i}px ${n}px ${t}${s}`}function mr(t,e="0,0,0"){let o=Math.max(0,Math.min(1,t));if(o<.1)return"";let i=Math.round(60-o*30),n=(o*.5).toFixed(2);return`radial-gradient(ellipse at center, transparent ${i}%, rgba(${e},${n}) 100%)`}function hr(t,e=8,o=2){let i=Math.max(0,Math.min(1,t));return e-i*(e-o)}var ic="#a83d2a",fr="#7a2d20",ae="#fdf6e3",ac='<svg viewBox="0 0 40 40" width="38" height="38" aria-hidden="true">',rc="</svg>";function gr(t){let e=["day","cloudy","rain","night"].includes(t)?t:"day",i=`<circle class="mc" cx="20" cy="20" r="18" fill="${e==="night"?fr:ic}" opacity="0.92"/>`,n=`<line class="mh" x1="6" y1="22" x2="34" y2="22" stroke="${ae}" stroke-width="0.8" opacity="0.85"/>`,a="";return e==="day"?a=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.95"/>`:e==="cloudy"?a=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.45"/>`:e==="rain"?a=[`<line class="mg" x1="14" y1="11" x2="13" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="20" y1="11" x2="19" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`,`<line class="mg" x1="26" y1="11" x2="25" y2="16" stroke="${ae}" stroke-width="0.7" opacity="0.55"/>`].join(""):e==="night"&&(a=`<circle class="md" cx="20" cy="14" r="2.4" fill="${ae}" opacity="0.95"/><circle class="md-cut" cx="21.4" cy="13.4" r="1.8" fill="${fr}"/>`),`${ac}${i}${n}${a}${rc}`}function _t(t,e){return e?"night":["rainy","pouring","snowy","snowy-rainy","hail","lightning-rainy"].includes(t)?"rain":["cloudy","fog"].includes(t)?"cloudy":"day"}var W={kicker(t){return`<div class="pw-t-kicker">${h(t)}</div>`},heroTier(t,{flavor:e="aqi",color:o=""}={}){let i=e==="atmos"?"pw-t-hero-tier-atmos":"pw-t-hero-tier-aqi",n=o?` style="color:${S(o)}"`:"";return`<div class="pw-t-hero-tier ${i}"${n}>${h(t)}</div>`},display(t,{color:e="",suffix:o=""}={}){let i=e?` style="color:${S(e)}"`:"",n=o?`<span class="pw-t-display-suf">${h(o)}</span>`:"";return`<div class="pw-t-display"${i}>${h(String(t))}${n}</div>`},narrative(t){return`<div class="pw-t-narrative">${h(t)}</div>`},gloss(t){return`<div class="pw-t-gloss">${h(t)}</div>`},meta(t){return`<div class="pw-t-meta">${h(t)}</div>`},chartCaption(t){return`<div class="pw-t-chart-caption">${h(t)}</div>`},stat(t,e,{data:o=!1,valueColor:i=""}={}){let n=i?` style="color:${S(i)}"`:"",a=o?"pw-t-stat-l pw-t-data":"pw-t-stat-l";return`<div class="pw-t-stat"><div class="pw-t-stat-v"${n}>${h(String(t))}</div><div class="${a}">${h(e)}</div></div>`},statLabel(t){return`<span class="pw-t-stat-l">${h(t)}</span>`},dataToken(t){return`<span class="pw-t-data">${t}</span>`},heroBlock({tier:t="",tierFlavor:e="aqi",tierColor:o="",value:i="",valueSuffix:n="",valueColor:a="",narrative:s=""}={}){let r=t?this.heroTier(t,{flavor:e,color:o}):"",l=i!==""?this.display(i,{color:a,suffix:n}):"",p=s?this.narrative(s):"";return`<div class="pw-hero-block">${r}${l}${p}</div>`},statsRow(t,{columns:e=4,divided:o=!1}={}){let i=t.filter(Boolean);return i.length?`<div class="pulse-stats-row" data-cols="${e}"${o?' data-divided="true"':""}>${i.join("")}</div>`:""}};function mt({sectionClass:t,ariaLabel:e,brandVariant:o,kicker:i="",narrative:n="",preContent:a="",extraSectionClass:s="",sectionStyle:r="",body:l,proView:p="",proInitial:c=!1,proAction:u="view-swap",proAriaLabel:m="Toggle pro view",pro:d=!0}){d===!1&&(p="",u="view-swap",c=!1);let f=r?` style="${r}"`:"",g=`pw-section pw-cartouche ${t}${s?` ${s}`:""}`,w=gr(o),v=[i?W.kicker(i):"",n?W.narrative(n):""].filter(Boolean).join(""),b=v?`<div class="pw-t-marg">${v}</div>`:"",y=!!p,_=y||u!=="view-swap",$=y?`<div class="pw-view pw-view-default">${l}</div><div class="pw-view pw-view-pro">${p}</div>`:l,A=c?"true":"false",M=_?`<button class="pw-brand-mark-corner" aria-label="${h(m)}" aria-pressed="${A}" type="button">${w}</button>`:`<div class="pw-brand-mark-corner" aria-hidden="true">${w}</div>`;return`
    <div class="${g}" data-pro="${A}" data-pro-action="${u}"${f} role="region" aria-label="${h(e)}">
      ...
      <div class="pw-content">
        ...
        ${$}
    ...
    </div>`}var ri=Object.freeze({none:{label:"Stable",color:"#30d158",desc:"No thunderstorm risk"},marginal:{label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"},slight:{label:"Slight",color:"#ff9f0a",desc:"Brief storms possible"},enhanced:{label:"Enhanced",color:"#ff6b35",desc:"Organized storms likely"},moderate:{label:"Moderate",color:"#ff453a",desc:"Severe storms expected"},high:{label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"},unknown:{label:"Unknown",color:"#888888",desc:"Insufficient data"}}),sc=Object.freeze({none:5,marginal:20,slight:40,enhanced:60,moderate:80,high:100,unknown:0});function lc(t,e){let o=Math.min(100,t/4e3*100),i=Math.min(100,Math.max(0,(6-e)/12*100));return Math.round(o*.6+i*.4)}function cc(t){return t<=10?{tierKey:"none",label:"Stable",color:"#30d158",desc:"No thunderstorm risk"}:t<=30?{tierKey:"marginal",label:"Marginal",color:"#ffd60a",desc:"Isolated storms possible"}:t<=55?{tierKey:"slight",label:"Moderate",color:"#ff9f0a",desc:"Scattered storms likely"}:t<=80?{tierKey:"moderate",label:"High",color:"#ff453a",desc:"Severe storms expected"}:{tierKey:"high",label:"Extreme",color:"#8b0000",desc:"Dangerous storm potential"}}function pc(t,e){let o=e.atmosCe,i=o.cape&&t.states[o.cape]&&Number(t.states[o.cape].state)||0,n=o.lifted_index&&t.states[o.lifted_index]&&Number(t.states[o.lifted_index].state)||0,a=!!(o.cape&&t.states[o.cape]),s=!!(o.lifted_index&&t.states[o.lifted_index]),r=a||s?lc(i,n):null;if(o.stability_assessment&&t.states[o.stability_assessment]){let p=t.states[o.stability_assessment].state,c=t.states[o.stability_assessment].attributes||{},u=ri[p];if(u){let m=sc[p]??0;return{tierKey:p,...u,score:m,source:"composite",attrs:c,capeValue:i,liValue:n,hasCape:a,hasLI:s}}}let l=r!==null?cc(r):null;return{tierKey:l?.tierKey||"unknown",label:l?.label||"Unknown",color:l?.color||"#888888",desc:l?.desc||"",score:r,source:"fallback",attrs:null,capeValue:i,liValue:n,hasCape:a,hasLI:s}}function dc(t){return Math.max(0,Math.min(100,t))}function vr(t,e=5e3){return e<=0?0:Math.max(0,Math.min(100,t/e*100))}function uc(t,e){let a=Math.max(t,e),s=5e3;a>5e3*.8&&(s=Math.max(5e3,Math.ceil(a*1.25/1e3)*1e3));let r=Math.ceil(s/5e3)*1e3;s=Math.ceil(s/r)*r;let l=[];for(let p=s;p>=0;p-=r)l.push(p);return{scaleMax:s,labelInterval:r,labels:l}}var mc=Object.freeze({none:0,unknown:0,marginal:1,slight:2,enhanced:3,moderate:4,high:5});function hc(t){if(!t)return null;let e=o=>mc[String(t[o]||"none")]??0;return{maxThermal:Math.max(e("cape_tier"),e("lifted_index_tier"),e("lapse_rate_tier")),shearTier:e("wind_shear_tier")}}function fc({tierKey:t,tierDesc:e,hourly:o,now:i,todaySunset:n,attrs:a}){if(t==="none"||t==="unknown")return"Atmosphere settled \xB7 no convective signals";let s=hc(a);if(s&&s.maxThermal===0&&s.shearTier>=2)return"Wind shear elevated \xB7 atmosphere thermally quiet";let r=n&&!isNaN(n.getTime())?n.getTime():null,l=i.getTime(),p=r!==null&&l>=r,c=Array.isArray(o)?o.slice(0,6):[],u=c.map(b=>Number(b&&b.cape)||0),m=u.some(b=>Number.isFinite(b)&&b>0),d=null,f=null;if(m){let b=Math.max(...u);if(b>0){let y=c[u.indexOf(b)],_=y?y.datetime:null,$=_?new Date(String(_)):null;$&&!isNaN($.getTime())&&(d=$.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1}),f=$.getTime())}}if(d===null||f===null){let b=e||"Storm risk active";return p?`${b} \xB7 calming overnight`:b}let g=1800*1e3,w=f<l-g,v=f>=l-g&&f<=l+g;return w?p?`Storm risk easing \u2014 peaked ${d}, calming overnight`:`Storm risk easing \u2014 peaked ${d}`:v?p?"Storm risk peaking now, calming overnight":r!==null?"Storm risk peaking now, calming after sunset":"Storm risk peaking now":r!==null&&f<r?`Storm risk peaks ${d}, calming after sunset`:r!==null?`Storm risk peaks ${d} (after sunset)`:`Storm risk peaks ${d}`}var uh=Object.freeze([Object.freeze({max:30,tier:"none"}),Object.freeze({max:40,tier:"marginal"}),Object.freeze({max:50,tier:"slight"}),Object.freeze({max:60,tier:"enhanced"}),Object.freeze({max:75,tier:"moderate"})]);var mh=Object.freeze([Object.freeze({max:6,tier:"none"}),Object.freeze({max:6.5,tier:"marginal"}),Object.freeze({max:7.5,tier:"slight"}),Object.freeze({max:8,tier:"enhanced"}),Object.freeze({max:9,tier:"moderate"})]);function gc(t){let e=Math.max(0,Math.min(100,t)),o=e/100;return{count:e<=10?0:Math.round(2+o*6),minSize:2+Math.round(o),maxSize:3+Math.round(o),minDur:4-o*2.2,maxDur:4-o*1.2}}function br(t,e,o=Math.random){let i=document.createDocumentFragment(),n=gc(t);if(n.count===0)return i;let a=S(e);for(let s=0;s<n.count;s++){let r=document.createElement("div");r.className="pw-thermal-particle";let l=n.minSize+o()*(n.maxSize-n.minSize),p=10+o()*80,c=o()*30,u=n.minDur+o()*(n.maxDur-n.minDur),m=o()*u,d=.4+o()*.3,f=-(50+o()*60);r.setAttribute("style",[`width:${l.toFixed(1)}px`,`height:${l.toFixed(1)}px`,`left:${p.toFixed(1)}%`,`bottom:${c.toFixed(1)}%`,`background:${a}`,`--rise-dur:${u.toFixed(2)}s`,`--rise-dist:${f.toFixed(0)}px`,`--peak-op:${d.toFixed(2)}`,`animation-delay:${m.toFixed(2)}s`].join(";")),i.appendChild(r)}return i}function wr({hass:t,config:e,discovery:o,forecastData:i}){let n=o.atmosCe;if(!n.cape&&!n.lifted_index&&!n.freezing_level_height)return console.debug(`${Bt} Atmosphere section requires Atmos CE sensors (cape / lifted_index / freezing_level_height) \u2014 section skipped. Install Atmos CE integration if you want the atmospheric stability column.`),null;let a=pc(t,o),{capeValue:s,liValue:r,hasCape:l,hasLI:p,score:c}=a,u=D=>{let U=n[D];if(!U||!t.states[U])return{value:null,unit:""};let G=Number(t.states[U].state);if(!Number.isFinite(G))return{value:null,unit:""};let tt=String(t.states[U].attributes?.unit_of_measurement||"");return{value:G,unit:tt}},m=u("wind_shear_0_6_km"),d=u("lapse_rate_700_500_hpa"),f=u("freezing_level_height"),g=u("lcl_height"),w=a.tierKey,v={label:a.label,color:a.color,desc:a.desc},y=["slight","enhanced","moderate","high"].includes(w)?"rain":"cloudy",_=new Date,$=o.sunEntityId?t.states[o.sunEntityId]:null,{todaySunset:A}=Me(_,$?.attributes?.next_rising,$?.attributes?.next_setting),M=fc({tierKey:w,tierDesc:v.desc,hourly:i?.hourly||[],now:_,todaySunset:A,attrs:a.attrs}),C=f.value??0,E=g.value??0,{scaleMax:z,labels:k}=uc(C,E),x=c!==null?dc(c):0,T=v.color,F=l||p?`
          <div class="pw-atmos-cape-fill" style="height:${Number(x)}%;background:linear-gradient(to top, ${S(T)}66, ${S(T)}11)"></div>`:"",B=f.unit||"m",I=f.value!==null?(()=>{let D=vr(f.value,z);return`
          ...
          </div>`})():"",q=g.unit||"m",L=g.value!==null?(()=>{let D=vr(g.value,z);return`
        ...
        </div>`,P=W.heroBlock({tier:v.label,tierFlavor:"atmos",tierColor:"var(--pw-vermilion)",narrative:M}),H=[l?W.stat(`${Math.round(s)}`,"cape J/kg"):"",p?W.stat(r.toFixed(1),"lifted idx"):"",m.value!==null?W.stat(`${Math.round(m.value)}`,`shear ${m.unit||"km/h"}`):"",d.value!==null?W.stat(d.value.toFixed(1),`lapse ${d.unit||"\xB0C/km"}`):""],V=W.statsRow(H,{columns:4,divided:!0}),R=`
        ${P}
        ${O}
        ${V}`;return mt({sectionClass:"pw-atmosphere-v2",ariaLabel:"Atmospheric stability",brandVariant:y,kicker:"atmospheric stability",body:R,pro:e?.pro!==!1})}function yr(t){let e=t.getHours();return e>=6&&e<12?"this morning":e>=12&&e<17?"this afternoon":e>=17&&e<21?"this evening":"tonight"}function vc(t,e){return t==="sunny"||t==="clear-night"?"Clear skies":t==="rainy"||t==="pouring"?"Rain":t==="snowy"||t==="snowy-rainy"?"Snow":t==="lightning"||t==="lightning-rainy"?"Storms":t==="fog"?"Fog":e>=88?"Overcast":e>=50?"Mostly cloudy":e>=12?"Some sun":"Sunny"}function bc(t){let e=t.slots.slice(0,6);if(e.length===0)return null;let o=Number(e[e.length-1].cloud_coverage),i=Number.isFinite(o)?o-t.cloudCoverNow:0,n=e.reduce((p,c)=>Math.max(p,Number(c.precipitation_probability)||0),0),a=e.reduce((p,c)=>Math.max(p,Number(c.snowfall)||0),0),r=e.reduce((p,c)=>Math.max(p,Number(c.wind_speed)||0),t.windSpeed)-t.windSpeed;return["moderate","high"].includes(t.stabilityState)?"with thunderstorms developing":n>=60?a>0?"with snow likely":"with rain likely":n>=40?a>0?"with snow possible":"with a brief shower or two":i>=30?"then increasing clouds":i<=-30?"then clearing":r>=8?"with wind firming":null}function _r(t){let e=vc(t.conditionNow,Number(t.cloudCoverNow)||0),o=bc(t),i=o?yr(t.now):null,n;return o?o.startsWith("then ")?n=`${e}, ${o} ${i}.`:n=`${e}, then ${o} ${i}.`:n=`${e} ${yr(t.now)}.`,{initial:e,transition:o,anchor:i,sentence:n}}var wc={sunny:"linear-gradient(180deg, #1a4a7a 0%, #2a6aaa 40%, transparent 100%)","clear-night":"linear-gradient(180deg, #050510 0%, #0a0a1a 50%, transparent 100%)",partlycloudy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",cloudy:"linear-gradient(180deg, #2a2a3a 0%, #3a3a4a 50%, transparent 100%)",rainy:"linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",pouring:"linear-gradient(180deg, #0a1a2a 0%, #1a2a3a 50%, transparent 100%)",snowy:"linear-gradient(180deg, #2a3040 0%, #3a4050 50%, transparent 100%)","snowy-rainy":"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",hail:"linear-gradient(180deg, #1a2a3a 0%, #2a3a48 50%, transparent 100%)",lightning:"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)","lightning-rainy":"linear-gradient(180deg, #0a0a1a 0%, #1a1a2a 50%, transparent 100%)",fog:"linear-gradient(180deg, #2a2a2e 0%, #3a3a3e 50%, transparent 100%)",windy:"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)","windy-variant":"linear-gradient(180deg, #1a2a4a 0%, #2c4a6e 50%, transparent 100%)",exceptional:"linear-gradient(180deg, #4a2a1a 0%, #6a3a1a 40%, transparent 100%)"},yc="linear-gradient(180deg, #1a2a3a 0%, #2a3a4a 50%, transparent 100%)",xr={dry:"#30d158",comfortable:"#30d158",slightly_humid:"#ffd60a",humid:"#ff9f0a",oppressive:"#ff453a",clear:"#30d158",good:"#30d158",moderate:"#ffd60a",poor:"#ff9f0a",fog:"#ff453a"};function _c(t){return t<=30?"#5ac8fa":t<=60?"#30d158":t<=80?"#ff9f0a":"#ff453a"}function xc(t,e){if(t==null)return"Press";let o=Math.abs(Number(t));if(o<=1)return"Press";let i=e==="rising"?"Rising":e==="falling"?"Falling":"Press";return o>3?`${i} rapidly`:i}function $c(t,e,o){let i=t.map(c=>{let u=Number(c.cape);return Number.isFinite(u)?u:0}),n=Math.max(...i,300),a=Math.max(...i),s=i.indexOf(a),l=i.map((c,u)=>({x:u/Math.max(t.length-1,1)*e,y:o-c/n*o})).map((c,u)=>`${u===0?"M":"L"}${c.x.toFixed(1)},${c.y.toFixed(1)}`).join(" "),p=`${l} L${e},${o} L0,${o} Z`;return{svgPath:l,areaPath:p,peakValue:a,peakIndex:s,maxCape:n}}function Sc(t,e,o,i,n,a,s,r){let l=[];return s>0&&l.push({name:"Snow",value:s,unit:r}),o>0&&l.push({name:"Rain",value:o,unit:i}),n>0&&l.push({name:"Showers",value:n,unit:a}),l.length>0?`${l.map(c=>`${h(c.name)} ${h(c.value.toFixed(1))} ${h(c.unit)}`).join(" \xB7 ")} now`:t>0?`Precipitation \u2014 next 12h \xB7 ${h(t.toFixed(1))} ${h(e)} now`:"Precipitation \u2014 next 12h"}function Bo(t){return!t||isNaN(t.getTime())?"":dt(t)}function $r({hass:t,config:e,discovery:o,weatherEntity:i,forecastData:n}){let a=i.attributes,s=o.atmosCe,r=o.sunEntityId||"",{condition:l,isNight:p}=Lo(t,i,o),c=(Y,J)=>zo(t,s,a,Y,J),u=(Y,J)=>or(t,s,Y,J),m=c("temperature","temperature"),d=c("apparent_temperature","apparent_temperature")||m,f=c("humidity","humidity"),g=c("wind_speed","wind_speed"),w=c("wind_direction","wind_bearing"),v=c("wind_gusts","wind_gust_speed")||c("wind_gusts","wind_gusts"),b=c("dew_point","dew_point"),y=c("visibility","visibility"),_=c("pressure","pressure"),$=u("temperature","\xB0C"),A=u("visibility","km"),M=u("pressure","hPa"),C=u("dew_point","\xB0C"),E=n?.daily,z=n?.hourly,k=a.forecast,x=m,T=m;if(E&&E.length>0){let Y=E[0],J=Number(Y.templow),j=Number(Y.temperature);Number.isFinite(J)&&Number.isFinite(j)&&(x=Math.min(J,j),T=Math.max(J,j))}else if(z&&z.length>0){let Y=Date.now(),J=new Date;J.setHours(23,59,59,999);let j=J.getTime(),ct=1/0,pt=-1/0;for(let Vt of z.slice(0,24)){let kt=Date.parse(String(Vt.datetime??""));if(Number.isFinite(kt)&&(kt<Y||kt>j))continue;let ot=Number(Vt.temperature);Number.isFinite(ot)&&(ot<ct&&(ct=ot),ot>pt&&(pt=ot))}Number.isFinite(ct)&&Number.isFinite(pt)&&ct!==pt&&(x=Math.min(ct,m),T=Math.max(pt,m))}else if(k&&k.length>0){let Y=k[0],J=Number(Y.templow),j=Number(Y.temperature);Number.isFinite(J)&&Number.isFinite(j)&&(x=Math.min(J,j),T=Math.max(J,j))}let F=o.atmosCe.uv_index,B=F?Number(t.states[F]?.state)||0:Number(a.uv_index??0),{value:I,unit:q}=Ce(t,s.precipitation),L=q||"mm",{value:N,unit:O}=Ce(t,s.rain),{value:P,unit:H}=Ce(t,s.showers),{value:V,unit:R}=Ce(t,s.snowfall),D=O||"mm",U=H||"mm",G=R||"cm",{value:tt,entity:et}=Ce(t,s.uv_index_clear_sky),lt=s.dew_point_comfort?t.states[s.dew_point_comfort]:null,vt=s.visibility_category?t.states[s.visibility_category]:null,St=s.feels_like_context?t.states[s.feels_like_context]:null,it=s.pressure_trend?t.states[s.pressure_trend]:null,Mt=new Date,bt=r?t.states[r]:null,jo=bt?.attributes?.next_rising,Go=bt?.attributes?.next_setting,{todaySunrise:Ie,todaySunset:ee,tomorrowSunrise:Ne}=Me(Mt,jo,Go),zt=null;o.atmosCe.cloud_cover&&(zt={total:Number(t.states[o.atmosCe.cloud_cover]?.state)||0,low:Number(t.states[o.atmosCe.cloud_cover_low]?.state)||0,mid:Number(t.states[o.atmosCe.cloud_cover_mid]?.state)||0,high:Number(t.states[o.atmosCe.cloud_cover_high]?.state)||0});let se=s.freezing_level_height?t.states[s.freezing_level_height]:null,Ye=se&&Number(se.state)||0,le=(s.stability_assessment?t.states[s.stability_assessment]:null)?.state||"",ze=s.lifted_index?t.states[s.lifted_index]:null,Lt=ze&&Number(ze.state)||0,Je=S(wc[l]||yc),Xo=Math.max(T-x,1),cp=Math.max(0,Math.min(100,(m-x)/Xo*100)),di=Do(w),Xr=`data-condition="${h(l)}" data-night="${p}" data-cloud='${h(JSON.stringify(zt||""))}'`,Zr=Ge(m,20,42),Kr=Ge(m,15,-10),Zo=Math.max(Zr,Kr),Yr=Qt(m),pp=Zo>.05?`text-shadow: 0 2px 20px rgba(0,0,0,0.3), ${ur(Yr,Zo)}`:"text-shadow: 0 2px 20px rgba(0,0,0,0.3)",ui=mr(Zo),Jr=ui?`<div class="pw-tension-vignette" style="background: ${S(ui)}"></div>`:"",dp=V>0?`<div class="pw-snow-badge" style="color:var(--pw-color-freeze, #5ac8fa)">\u2744 ${h(V.toFixed(1))} ${h(G)}</div>`:"",mi=St?.state||"",ce=St?.attributes?.difference,Qe="";mi==="wind_chill"&&ce!==null&&ce!==void 0?Qe=`<div class="pw-feels-context">Wind chill ${h(String(Math.round(Number(ce))))}\xB0</div>`:mi==="heat_index"&&ce!==null&&ce!==void 0&&(Qe=`<div class="pw-feels-context">Heat index +${h(String(Math.round(Number(ce))))}\xB0</div>`);let Qr=["marginal","slight","enhanced","moderate","high"],ts="";if(le&&Qr.includes(le)){let Y=ri[le];if(Y){let J=S(Y.color),j=`\u26A1 ${h(Y.label)}`;if(ze&&Lt<0){let ct=Ve.find(pt=>Lt>=pt.min)||Ve[Ve.length-1];j+=` \xB7 <span style="color:${S(ct.color)}">LI ${h(String(Lt))}</span>`}ts=` <span class="pw-stability-badge" style="background:${J}33; color:${J}">${j}</span>`}}let Ko=vt?.state||"",up=Ko&&!["unavailable","unknown"].includes(Ko)&&xr[Ko]||"",to=lt?.state||"",mp=to&&!["unavailable","unknown"].includes(to)&&xr[to]||"",hi=it?.attributes?.trend_symbol||"",fi=it?.state==="rising"?"#30d158":it?.state==="falling"?"#ff9f0a":it?.state==="steady"?"#5ac8fa":"",es=et&&Math.abs(tt-B)>=.5,Yo=it?.attributes?.change_3h,Jo=xc(Yo!=null?Number(Yo):null,it?.state||"");if(Jo==="Press"&&it?.state){let Y=it.state;Y==="rising"?Jo="Rising":Y==="falling"&&(Jo="Falling")}let hp=fi||(it?"#5ac8fa":""),os=ir(g),fp=Ho(g),Qo=v>g+5,ns=g>0&&v/g>1.5,is=Qo?ns?` / <b>${h(Math.round(v))}</b>`:` / ${h(Math.round(v))}`:"",as=`<svg width="10" height="10" viewBox="0 0 10 10" style="vertical-align:middle;transform:rotate(${Number(w)||0}deg)"><polygon points="5,0 3,8 5,6 7,8" fill="${S(os)}" opacity="0.8"/></svg>`,gp=`${h(Math.round(g))}${is} ${as}${h(di)}`,vp=`linear-gradient(to right, ${S(Qt(x))}, ${S(Qt(T))})`,rs="";if(se&&Ye<5e3&&x<=0){let Y=Math.max(0,Math.min(100,(0-x)/Xo*100)),J=se?.attributes?.unit_of_measurement||"m";rs=`<div class="pw-arc-freeze" style="left:${Number(Y)}%">
            <div class="pw-arc-freeze-label">\u2744 ${h(String(Math.round(Ye)))}${h(J)}</div>
            <div class="pw-arc-freeze-line"></div>
          </div>`}let gi="",vi=r?t.states[r]:null;if(vi&&Ie&&ee&&Ne){let Y=Mt.getTime(),J=vi.state==="above_horizon",j,ct,pt,Vt,kt;if(J){let nt=Ie.getTime(),xt=ee.getTime(),Gt=Math.max(xt-nt,1);j=Math.max(0,Math.min(100,(Y-nt)/Gt*100)),ct=Bo(Ie),pt=Bo(ee),Vt="background: linear-gradient(to right, #ff9f0a, #ffd60a)",kt="#ff9f0a"}else{let nt=ee.getTime(),xt=Ne.getTime(),Gt=Math.max(xt-nt,1);j=Math.max(0,Math.min(100,(Y-nt)/Gt*100)),ct=Bo(ee),pt=Bo(Ne),Vt="background: linear-gradient(to right, #1a3050, #5ac8fa)",kt="#5ac8fa"}let ot=`left:${Number(j)}%; background:${S(kt)}; box-shadow: 0 0 6px ${S(kt)}66`,jt=` style="color:${S(kt)}"`,st=J?"1":"0.85",Ut=J?"":"\u{1F319}";gi=`
      ...
      </div>`}let ss="",ls="",cs="",eo="",bi=n?.hourly||[];if(bi.length>0){let j=Ro(bi,new Date).slice(0,12),ct=j.some(ot=>Number(ot.precipitation_probability)>0),pt=Sc(I,L,N,D,P,U,V,G);if(I>0)eo=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        <span style="font-size:14px">\u{1F327}</span> ${pt}
      </div>`;else{let ot=_r({now:new Date,cloudCoverNow:zt?zt.total:0,conditionNow:l,slots:j,windSpeed:g,uvIndex:B,stabilityState:le});eo=`
      <div class="pw-weather-summary" style="position:relative; z-index:2">
        ${h(ot.sentence)}
      </div>`}if(ct){let ot=j.map(Ut=>{let nt=Math.min(100,Math.max(0,Number(Ut.precipitation_probability)||0)),xt=Number(Ut.snowfall)||0,Gt=(Number(Ut.rain)||0)+(Number(Ut.showers)||0),Le=xt>0;if(Le&&Gt>0){let _s=xt+Gt,xi=Math.round(nt*xt/_s),xs=nt-xi;return`<div class="pulse-precip-slot"><div class="pulse-precip-fill" style="height:${Number(xs)}%"></div><div class="pulse-precip-fill pw-precip-snow" style="height:${Number(xi)}%"></div></div>`}return`<div class="pulse-precip-slot"><div class="${Le?"pulse-precip-fill pw-precip-snow":"pulse-precip-fill"}" style="height: ${nt}%"></div></div>`}).join(""),st=j[Math.floor(j.length/2)]?`+${Math.floor(j.length/2)}h`:"";ss=`
      ...
      </div>`}if(j.some(ot=>Number(ot.cape)>300)){let st=$c(j,200,24),Ut=st.peakIndex/Math.max(j.length-1,1)*200,nt=st.peakValue>=1e3?`${(st.peakValue/1e3).toFixed(1)}k`:String(Math.round(st.peakValue)),xt=j[st.peakIndex]?.datetime?new Date(j[st.peakIndex].datetime):null,Gt=xt?dt(xt):"",Le=Ue("pw-cape-grad");ls=`
      ...
      </div>`}j.some(ot=>ot.dew_point!==void 0&&ot.dew_point!==null)&&(cs=`
      <div style="position: relative; z-index: 2; margin: 2px var(--pulse-space-card-wide) 0;">
        ...
        <div class="pw-comfort-bar">${j.map(jt=>{let st=Number(jt.dew_point)||0;return`<div class="pw-comfort-slot" style="background:${S(rr(st))}"></div>`}).join("")}</div>
      </div>`)}let bp=Qt(d),wp=zt!==null?ar(zt.total):"",yp=_c(f),_p=`${h(Math.round(_))} ${h(M)}${hi?` <span style="color:${S(fi)}">${h(hi)}</span>`:""}`,xp=`${h(Math.round(B))}${es?` <span style="opacity:0.5">/ ${h(String(Math.round(tt)))}</span>`:""}`;function ps(){return dt(new Date)}let ds=sr(l),us=_t(l,p),ms=e?.location_label||"Now",wi=Qe?Qe.replace(/<[^>]*>/g,"").trim():"",hs=eo?eo.replace(/<[^>]*>/g,"").trim():"",fs=zt?Math.round(zt.total)+"%":"--",gs=`
        <div class="pw-loc-stamp">${h(ms)} \xB7 ${h(ps())}</div>
        <div class="pw-hero-block">
          ${W.display(Math.round(m),{suffix:$})}
          ${W.gloss(`${ds}${wi?" \xB7 "+wi:""}`)}
        </div>`,vs=W.statsRow([W.stat(`${Math.round(x)}/${Math.round(T)}\xB0`,"range"),W.stat(`${Math.round(g)}${Qo?` / ${Math.round(v)}`:""} ${di}`,Qo?"wind / gust":"wind"),W.stat(Math.round(B),"uv"),W.stat(fs,"cloud")],{columns:4}),oo=(n?.daily||[]).slice(0,7),tn="";if(oo.length>=2){let j=oo.map(nt=>Number(nt.temperature)||0),ct=oo.map(nt=>Number(nt.templow??nt.temperature)||0),pt=Math.min(...ct),Vt=Math.max(...j),kt=Math.max(Vt-pt,1),ot=nt=>nt/(oo.length-1)*320,jt=nt=>38-(nt-pt)/kt*34-2,st=j.map((nt,xt)=>`${xt===0?"M":"L"}${ot(xt).toFixed(1)},${jt(nt).toFixed(1)}`).join(" ");tn=`<svg viewBox="0 0 320 38" preserveAspectRatio="none">
    ...
    </svg>`}let bs=tn?`<div class="pw-overview-spark-block">
        ${W.chartCaption("7-day temperature trend")}
        <div class="pw-overview-spark">${tn}</div>
      </div>`:"",yi=vt?.state||"",en=it?.state||"",ws=[Number.isFinite(f)&&f>0,Number.isFinite(b)&&b!==0,!!yi,!!en].filter(Boolean).length>=2,_i="";if(ws){let Y=Number.isFinite(f)&&f>0?W.stat(`${Math.round(f)}%`,to||"humidity"):W.stat("\u2014","humidity"),J=Number.isFinite(b)?W.stat(`${Math.round(b)}${C}`,"dew point"):W.stat("\u2014","dew point"),j=Number.isFinite(_)&&_>0?W.stat(`${Math.round(_)}`,en?`${M} ${en}`:M):W.stat("\u2014","pressure"),ct=Number.isFinite(y)&&y>0?W.stat(`${y.toFixed(y<10?1:0)}${A}`,yi||"visibility"):W.stat("\u2014","visibility");_i=W.statsRow([Y,J,j,ct],{columns:4})}let ys=`
        ${gs}
        ${W.narrative(hs)}
        ${gi}
        ${bs}
        ${vs}
        ${_i}`;return mt({sectionClass:"pw-overview-v2",ariaLabel:"Current weather overview",brandVariant:us,preContent:`${Jr}<div class="pw-fx" ${Xr} role="img" aria-label="${h(l)} weather effects"></div>`,body:ys,pro:e?.pro!==!1})}function kc(t){if(!t||t.length===0)return"Forecast unavailable";let e=0;for(let s=1;s<t.length;s++)Number(t[s].temperature)>Number(t[e].temperature)&&(e=s);let o=t.findIndex(s=>Number(s.precipitation_probability)>=50),i=s=>s===0?"today":new Date(String(t[s].datetime||"")).toLocaleDateString([],{weekday:"short"}).toLowerCase(),n=i(e),a=Math.round(Number(t[e].temperature));return o>=0&&o!==e?`Warmest ${n} (${a}\xB0) \xB7 rain ${i(o)}`:o>=0?`Wet stretch \xB7 warmest ${n} (${a}\xB0)`:`Warmest ${n} (${a}\xB0) \xB7 dry through the week`}function Sr({hass:t,config:e,discovery:o,forecastData:i,weatherEntity:n}){let a=i?.daily||[];if(a.length===0)return null;let s=o.atmosCe,l=(s.temperature?t.states[s.temperature]:null)?.attributes?.unit_of_measurement||"\xB0C",p=a.slice(0,7),c=p.flatMap($=>[ut($.temperature,0),ut($.templow,0)]),u=Math.min(...c),m=Math.max(...c),d=Math.max(m-u,1),f=Number(n?.attributes?.temperature),g=p.map(($,A)=>{let M=ut($.temperature,0),C=ut($.templow,0),E=Math.round(Number($.precipitation_probability)||0),z=A===0,k=z?"today":new Date(String($.datetime||"")).toLocaleDateString([],{weekday:"short"}).toLowerCase(),x=Oo(String($.condition||"")),T=E>=50?`<span class="pw-fc-pop">${h(String(E))}%</span>`:'<span class="pw-fc-pop"></span>',F=(C-u)/d*100,B=(M-C)/d*100,I=z&&Number.isFinite(f)?`<span class="pw-fc-now" style="left:${S(((f-u)/d*100).toFixed(2)+"%")}"></span>`:"";return`
      <div class="pw-fc-row${z?" is-today":""}">
        <span class="pw-fc-day">${h(k)}</span>
        <span class="pw-fc-icon" aria-hidden="true">${x}</span>
        ${T}
        <span class="pw-fc-bar" aria-label="High ${Math.round(M)}${h(l)}, low ${Math.round(C)}${h(l)}">
          <span class="pw-fc-bar-fill" style="left:${S(F.toFixed(2)+"%")};width:${S(B.toFixed(2)+"%")}"></span>
          ${I}
        </span>
      ...
      </div>`}).join(""),{condition:w,isNight:v}=Lo(t,n,o),b=_t(w,v),y=kc(p),_=`
        <div class="pw-fc-list" role="list">
          ${g}
        </div>`;return mt({sectionClass:"pw-forecast-v2",ariaLabel:"Seven-day forecast",brandVariant:b,kicker:"the week ahead",narrative:y,body:_,pro:e?.pro!==!1})}var Ee=240,qt=Ee/2,Wt=Ee/2,Xe=90,kr=.12,qo=6,Wo=.5,Tr=.25,Tc=.3,Ac=6,Ar=.7,Cc=.2,Mc=4,Ec=3.3,Fc=15,Ic=35,Nc=.08,zc=.2,Lc=[{l:"N",a:0},{l:"NE",a:45},{l:"E",a:90},{l:"SE",a:135},{l:"S",a:180},{l:"SW",a:225},{l:"W",a:270},{l:"NW",a:315}];function Cr(t){return(t-90)*Math.PI/180}function Rc(t){let e=t*Math.PI/180;return{x:Math.sin(e),y:-Math.cos(e)}}function te(t,e){return{x:qt+e*Math.cos(t),y:Wt+e*Math.sin(t)}}function Hc(t,e,o,i){let n=Math.min(t/Ae,1)*Xe,a=te(e-Tr,n),s=te(e+Tr,n),r=o>Tc?"pw-gust-sweep":"",l=Math.max(.6,2.5-o*2).toFixed(2),p=(.15+o*.3).toFixed(2),c=`transform-origin:${qt}px ${Wt}px;--gust-dur:${l}s;--gust-peak:${p}`;return Ct("path",{class:r,d:`M${qt},${Wt} L${a.x.toFixed(1)},${a.y.toFixed(1)} L${s.x.toFixed(1)},${s.y.toFixed(1)} Z`,fill:i,opacity:.15,style:c})}function Dc(t,e,o,i){let n=Math.min(t/Ae,1)*Xe,a=te(e,n),s=te(e-kr,n*.7),r=te(e+kr,n*.7),l={x:a.x-qo*Math.cos(e-Wo),y:a.y-qo*Math.sin(e-Wo)},p={x:a.x-qo*Math.cos(e+Wo),y:a.y-qo*Math.sin(e+Wo)},c=o*Ac,u=Math.max(.4,4-o*3.6),m=c>Cc?`animation:pw-arrowSway ${u.toFixed(2)}s ease-in-out infinite;--sway-fwd:${(c*Ar).toFixed(2)}deg;--sway-back:${(-c*(1-Ar)).toFixed(2)}deg`:"",d=`transform-origin:${qt}px ${Wt}px;filter:drop-shadow(0 0 6px ${Xt(i,.38)});${m}`,f=Ct("path",{d:`M${qt},${Wt} L${s.x.toFixed(1)},${s.y.toFixed(1)} L${a.x.toFixed(1)},${a.y.toFixed(1)} L${r.x.toFixed(1)},${r.y.toFixed(1)} Z`,fill:i,opacity:.5}),g=Ct("line",{x1:qt,y1:Wt,x2:a.x.toFixed(1),y2:a.y.toFixed(1),stroke:i,"stroke-width":2.5,"stroke-linecap":"round"}),w=Ct("path",{d:`M${a.x.toFixed(1)},${a.y.toFixed(1)} L${l.x.toFixed(1)},${l.y.toFixed(1)} L${p.x.toFixed(1)},${p.y.toFixed(1)} Z`,fill:i});return Ct("g",{style:d},f+g+w)}function Mr({hass:t,config:e,discovery:o,weatherEntity:i}){let n=i.attributes,a=o.atmosCe,s=e.speed_mode||"speed",r=(R,D)=>zo(t,a,n,R,D),l=r("wind_speed","wind_speed"),p=r("wind_gusts","wind_gust_speed")||r("wind_gusts","wind_gusts")||l,c=r("wind_direction","wind_bearing"),m=(a.wind_speed?t.states[a.wind_speed]:null)?.attributes?.unit_of_measurement||n.wind_speed_unit||"km/h",d=s==="gust"?p:l,f=Math.min(l/Ae,1),g=Ho(d),w=oi(d),v=Te[w]||Te.calm,b=Do(c),y=Cr(c),_=Rc(c),$=Math.round(f*Da),A=Mc-f*Ec,M=Nc+f*zc,C=Fc+f*Ic,E=-_.y,z=_.x,k=[];for(let R=0;R<$;R++){let D=(Math.random()-.5)*400,U=-120-Math.random()*60,G=420+Math.random()*60,tt=(C*(.6+Math.random()*.8)).toFixed(1),et=(A+Math.random()*A*.5).toFixed(2),lt=(Math.random()*3).toFixed(2),vt=(M*(.5+Math.random()*.5)).toFixed(3),St=(U*_.x+D*E).toFixed(1),it=(U*_.y+D*z).toFixed(1),Mt=(G*_.x+D*E).toFixed(1),bt=(G*_.y+D*z).toFixed(1);k.push(`<div class="pw-streak" style="left:50%;top:50%;width:${tt}px;height:1px;transform:rotate(${c-90}deg);animation-duration:${et}s;animation-delay:${lt}s;opacity:${vt};background:linear-gradient(to right, transparent, ${Xt(v,.27)}, transparent);--sx:${St}px;--sy:${it}px;--ex:${Mt}px;--ey:${bt}px"></div>`)}let x=[];for(let R=1;R<=3;R++)x.push(Ct("circle",{cx:qt,cy:Wt,r:R*30,fill:"none",stroke:v,"stroke-width":.5,opacity:.08+R*.02}));for(let R of Lc){let D=Cr(R.a),U=te(D,20),G=te(D,Xe+4),tt=te(D,Xe+16),et=R.l.length===1;x.push(Ct("line",{x1:U.x.toFixed(1),y1:U.y.toFixed(1),x2:G.x.toFixed(1),y2:G.y.toFixed(1),stroke:v,"stroke-width":.5,opacity:.12})),x.push(Ct("text",{x:tt.x.toFixed(1),y:tt.y.toFixed(1),"text-anchor":"middle","dominant-baseline":"central",fill:et?"rgba(255,255,255,0.7)":"rgba(255,255,255,0.3)","font-size":et?11:9,"font-weight":et?600:400},h(R.l)))}x.push(Hc(p,y,f,v)),x.push(Dc(d,y,f,v)),(d>Ae||p>Ae)&&x.push(Ct("circle",{cx:qt,cy:Wt,r:Xe+2,fill:"none",stroke:"#ff453a","stroke-width":1.5,"stroke-dasharray":"4 4",opacity:.7})),x.push(Ct("circle",{cx:qt,cy:Wt,r:18,fill:v,opacity:.06})),x.push(Ct("circle",{cx:qt,cy:Wt,r:3,fill:v}));let F=f>Zn?(f-Zn)*5:0,B=Math.max(.15,.4-f*.25),I="";F>.1&&(I=`--dx:${(F*_.x).toFixed(2)}px;--dy:${(F*_.y).toFixed(2)}px;animation:pw-roseShake ${B.toFixed(2)}s ease-in-out infinite`);let q=Math.round(12+f*50).toString(16).padStart(2,"0"),L=Math.round(6+f*25).toString(16).padStart(2,"0"),N=nr(`radial-gradient(ellipse at 50% 50%, ${v}${q} 0%, ${v}${L} 40%, transparent 85%)`),O=_t(i?.state||"sunny",!1),P=s==="gust",H=P?"wind \xB7 gust":"wind",V=`
        ...
        </div>`;return mt({sectionClass:"pw-wind-v2",ariaLabel:"Wind compass and speed",brandVariant:O,kicker:H,sectionStyle:`background: ${S(N)}`,body:V,proAction:"wind-mode",proInitial:P,proAriaLabel:"Toggle speed and gust mode",pro:e.pro!==!1})}function Oc(t,e,o,i){if(o&&i){let s=(e==="us"?Xn:Gn).find(r=>r.label.toLowerCase()===o.toLowerCase());return{label:o,color:i,desc:s?.desc||""}}let n=e==="us"?Xn:Gn;for(let a of n)if(t<=a.max)return a;return n[n.length-1]}function Pc(t){let e=(t||"").toLowerCase();return e.includes("very unhealthy")||e.includes("hazardous")||e.includes("extremely poor")?"very_unhealthy":e.includes("sensitive")?"unhealthy_sg":e.includes("unhealthy")||e.includes("very poor")?"unhealthy":e.includes("moderate")||e.includes("fair")||e.includes("poor")?"moderate":e.includes("good")?"good":"unknown"}var Er=Object.freeze({good:"var(--pw-good-green)",moderate:"var(--pw-warn-yellow)",unhealthy_sg:"var(--pw-warn-amber)",unhealthy:"var(--pw-warn-red)",very_unhealthy:"#8b0000",unknown:"var(--pw-ink-cream)"});function Fr({hass:t,config:e,discovery:o,weatherEntity:i}){let n=e.scale||"eu",a=n==="us"?"us_aqi":"european_aqi",s=e.aqi_entity||o.atmosCe[a];if(!s||!t.states[s])return null;let r=t.states[s],l=Number(r.state)||0,p=r.attributes?.category||null,c=r.attributes?.color||null,u=Oc(l,n,p,c),m=F=>{let B=o.atmosCe[F];if(!B||!t.states[B])return null;let I=Number(t.states[B].state);return Number.isFinite(I)?I:null},d=m("pm2_5"),f=m("pm10"),g=m("ozone"),w=m("nitrogen_dioxide"),v=m("sulphur_dioxide"),b=m("carbon_monoxide"),y=Pc(u.label),_=Er[y]||Er.unknown,$=_t("cloudy",!1),A=n==="us",C=Math.min(100,Math.max(0,l/(A?300:100)*100)),E=A?"air quality \xB7 us":"air quality",z=W.heroBlock({value:Math.round(l),valueColor:_,tier:u.label,tierFlavor:"aqi",tierColor:_}),k=`
        ...
        <div class="pw-aq-band-labels">
          ...
          <span>unhealthy</span>
          <span>v.unh</span>
        </div>`,x=W.statsRow([d!==null?W.stat(Math.round(d),"PM2.5",{data:!0}):"",f!==null?W.stat(Math.round(f),"PM10",{data:!0}):"",g!==null?W.stat(Math.round(g),"O\u2083",{data:!0}):"",w!==null?W.stat(Math.round(w),"NO\u2082",{data:!0}):"",v!==null?W.stat(Math.round(v),"SO\u2082",{data:!0}):"",b!==null?W.stat(b.toFixed(1),"CO",{data:!0}):""],{columns:3}),T=`
        ${z}
        ${k}
        ${x}`;return mt({sectionClass:"pw-air-quality-v2",ariaLabel:"Air quality index",brandVariant:$,kicker:E,body:T,proAction:"aqi-scale",proInitial:A,proAriaLabel:"Toggle EU and US AQI scale",pro:e.pro!==!1})}function Bc(t){let e=(t%yt+yt)%yt;return Za[Math.floor(e/yt*8)%8]}function qc(t){return(t%yt+yt)%yt<yt/2}var si=864e5;function It(t){return!t||isNaN(t.getTime())?"--:--":t.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!1})}function Wc(t,e,o,i,n){if(i==null)return`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#c8d0e0"/>`;let a=Math.max(0,Math.min(1,i/100)),s=n!=null?qc(n):!0,r=`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#2a2a3a"/>`;if(a>=.99)r+=`<circle cx="${t.toFixed(1)}" cy="${e.toFixed(1)}" r="${o}" fill="#e8e0d0"/>`;else if(a>.01){let l=e-o,p=e+o,c=(o*Math.abs(2*a-1)).toFixed(1),u=a>.5?1:0,m;s?m=`M${t.toFixed(1)},${l.toFixed(1)} A${o},${o} 0 0 1 ${t.toFixed(1)},${p.toFixed(1)} A${c},${o} 0 0 ${u} ${t.toFixed(1)},${l.toFixed(1)} Z`:m=`M${t.toFixed(1)},${l.toFixed(1)} A${o},${o} 0 0 0 ${t.toFixed(1)},${p.toFixed(1)} A${c},${o} 0 0 ${1-u} ${t.toFixed(1)},${l.toFixed(1)} Z`,r+=`<path d="${m}" fill="#e8e0d0"/>`}return r}var Vo="#050510",Ir="#0a1226",Nr="#172b4f",zr="#1f3d6e",Lr="#3a6fa8",Rr="#d97a3a",Hr="#ff9f0a",Dr="#ffc560",Or="#7eaedb",Pr="#2c5a8e",Br="#ffd60a";function Vc(t,e,o,i,n,a,s,r,l,p){let c=new Date(t.getTime());c.setHours(0,0,0,0);let u=t.getTime(),m=e.getTime(),d=(o??new Date(u-35*6e4)).getTime(),f=(i??new Date(u-30*6e4)).getTime(),g=(n??new Date(u-6*6e4)).getTime(),w=(a??new Date(u+30*6e4)).getTime(),v=(s??new Date(m-30*6e4)).getTime(),b=(r??new Date(m+6*6e4)).getTime(),y=(l??new Date(m+30*6e4)).getTime(),_=(p??new Date(m+35*6e4)).getTime(),$=(u+m)/2,A=T=>Math.max(0,Math.min(100,T)),M=T=>A((T-c.getTime())/si*100),C=(T,F)=>M((T+F)/2),E=Math.min(60,(m-u)/8)*6e4,z=$-E,k=$+E;return`linear-gradient(to right, ${[`${Vo} 0%`,`${Vo} ${M(d).toFixed(2)}%`,`${Ir} ${C(d,f).toFixed(2)}%`,`${Nr} ${M(f).toFixed(2)}%`,`${zr} ${C(f,g).toFixed(2)}%`,`${Lr} ${M(g).toFixed(2)}%`,`${Rr} ${C(g,u).toFixed(2)}%`,`${Hr} ${M(u).toFixed(2)}%`,`${Dr} ${C(u,w).toFixed(2)}%`,`${Or} ${M(w).toFixed(2)}%`,`${Pr} ${C(w,z).toFixed(2)}%`,`${Br} ${M(z).toFixed(2)}%`,`${Br} ${M(k).toFixed(2)}%`,`${Pr} ${C(k,v).toFixed(2)}%`,`${Or} ${M(v).toFixed(2)}%`,`${Dr} ${C(v,m).toFixed(2)}%`,`${Hr} ${M(m).toFixed(2)}%`,`${Rr} ${C(m,b).toFixed(2)}%`,`${Lr} ${M(b).toFixed(2)}%`,`${zr} ${C(b,y).toFixed(2)}%`,`${Nr} ${M(y).toFixed(2)}%`,`${Ir} ${C(y,_).toFixed(2)}%`,`${Vo} ${M(_).toFixed(2)}%`,`${Vo} 100%`].join(", ")})`}function qr(t){if(!t||isNaN(t)||t<=0)return"--";let e=Math.round(t/6e4),o=Math.floor(e/60),i=e%60;return`${o}h ${String(i).padStart(2,"0")}m`}function Wr({hass:t,config:e,discovery:o}){let i=new Date,n=o.sunEntityId?t.states[o.sunEntityId]:null;if(!n)return null;let a=n.attributes||{},s=a.next_rising||a.sunrise,r=a.next_setting||a.sunset;if(!s||!r)return null;let l=new Date(i);l.setHours(12,0,0,0);let p=ft(new Date(s),l),c=ft(new Date(r),l);if(!p||!c||isNaN(p.getTime())||isNaN(c.getTime()))return null;let u=o.atmosCe,m=Lt=>u[Lt]?new Date(String(t.states[u[Lt]]?.state)):null,d=ft(m("golden_hour_morning_start"),p),f=ft(m("golden_hour_morning_end"),p),g=ft(m("blue_hour_morning_start"),p),w=ft(m("golden_hour_evening_start"),c),v=ft(m("golden_hour_evening_end"),c),b=ft(m("blue_hour_evening_end"),c),y=a.next_dawn,_=a.next_dusk,$=y?ft(new Date(y),p):null,A=_?ft(new Date(_),c):null,M=u.moon_phase?t.states[u.moon_phase]:null,C=M?.attributes||{},E=C.moon_age!==void 0?Number(C.moon_age):null,z=C.illumination!==void 0?Number(C.illumination):null,k=E!==null?Bc(E):M?.state||null,x=ft(m("moonrise"),i),T=ft(m("moonset"),i),F=i.getTime()>=p.getTime()&&i.getTime()<=c.getTime(),B=It(p),I=It(c),q=(p.getTime()+c.getTime())/2,L=It(new Date(q)),N=c.getTime()-p.getTime(),O=si-N,P=qr(N),H=qr(O),V=F?"Daylight":"Night",R=F?P:H,D=new Date(p.getTime());D.setHours(0,0,0,0);let U=Math.max(0,Math.min(100,(i.getTime()-D.getTime())/si*100)),G=Vc(p,c,$,g,d,f,w,v,b,A),et=`
      ...
      </div>`,lt=z!=null?Math.round(z):null,vt=k||"Moon",St=Wc(24,24,22,z,E),it=lt!==null?`<span class="pw-astro-moon-illum">${h(`${lt}%`)}</span> illuminated`:"",Mt=E!=null?`${E.toFixed(1)}d old`:"",bt=E!=null?(()=>{let Lt=yt/2,Je=(E%yt+yt)%yt;return`${(Je<=Lt?Lt-Je:yt-Je+Lt).toFixed(1)}d to full`})():"",jo=[it,Mt,bt].filter(Boolean).join(" \xB7 "),Go=`
      ...
      ${W.narrative(Ie)}`,Ne=It(x),zt=It(T),se=W.statsRow([W.stat(It($),"civil dawn"),W.stat(It(d),"golden start",{valueColor:"var(--pw-warn-amber)"}),W.stat(It(g),"blue start",{valueColor:"var(--pw-wind)"}),W.stat(Ne,"moonrise")],{columns:4,divided:!0}),Ye=W.statsRow([W.stat(It(A),"civil dusk"),W.stat(It(v),"golden end",{valueColor:"var(--pw-warn-amber)"}),W.stat(It(b),"blue end",{valueColor:"var(--pw-wind)"}),W.stat(zt,"moonset")],{columns:4,divided:!0}),pi=`
      ${ee}
      ${Go}
      ${et}
      ${se}
      ${Ye}`,le=_t(F?"sunny":"clear-night",!F),ze=`<div class="pw-fx" data-astro-stars="${!F}" data-astro-day="${F}" role="img" aria-label="Sky atmospheric effects"></div>`;return mt({sectionClass:"pw-astro-v2",extraSectionClass:F?"":"is-night",ariaLabel:"Astronomy: sun and moon",brandVariant:le,kicker:"today's sky",preContent:ze,body:pi,pro:e?.pro!==!1})}function Uc(t,e){let o=(t?.state||"").toLowerCase();if(!t||o==="none"||o==="no alerts"||o==="unavailable"||o==="0"||o==="off")return[];let i=t.entity_id||"";if(i.endsWith("_alert_count")||i.startsWith("binary_sensor."))return[];let n=t.attributes,a=[],s=n.alert_type||n.type||"wind",r=Number(n.level),l=Number.isFinite(r)&&r>0?r:1,p=n.color||Jn[l]||Jn[1],c=Va[s]||"mdi:alert",u=Number(n.progress)||0,m=Array.isArray(n.locations)?n.locations:[],d=n.end_time??"",f=null,g=null,w=!1;if(d==="")w=!0;else if(d){let v=new Date(d),b=new Date,y=v.getTime()-b.getTime();if(y/(1e3*60*60*24)>qa)w=!0;else if(e)f=Math.max(0,y/(1e3*60*60));else{let $=n.start_time||n.datetime;if($){let A=new Date(String($));g=Math.max(0,(A.getTime()-b.getTime())/(1e3*60*60))}}}return a.push({type:s,icon:c,severity:l,color:p,summary:String(n.headline||n.summary||t.state||""),desc:String(n.description||""),active:e,hoursLeft:f,hoursUntil:g,progress:u,locations:m,link:n.link?String(n.link):null,endTime:String(d),isUntilFurtherNotice:w}),a}function jc(t){let e=t.severity>=4?"red":"amber",o="";t.isUntilFurtherNotice?o="UNTIL FURTHER NOTICE":t.active&&t.hoursLeft!==null?o=`${Math.round(t.hoursLeft)}H LEFT`:t.hoursUntil!==null?o=`IN ${Math.round(t.hoursUntil)}H`:t.active&&(o="ACTIVE");let i=String(t.type||"").toUpperCase(),n=String(t.summary||t.desc||"").toUpperCase().trim(),a=t.locations.length>0?t.locations.join(", ").toUpperCase():"",r=[o,i,n,a].filter(Boolean).join(" \xB7 ");return`
    <div class="pw-alert-ticker pw-alert-${e}">
      <span class="pw-alert-tri">\u25B6</span>
      <span class="pw-alert-text">${h(r)}</span>
    </div>`}function Vr({hass:t,config:e,discovery:o,proPersisted:i=!1}){let n=[];o.atmosCe.active_alert&&t.states[o.atmosCe.active_alert];for(let I of o.alertEntityIds){let q=t.states[I];if(!q)continue;let L=I.includes("active")||q.state==="on";n.push(...Uc(q,L))}let s=n.length>0,r=s?n.reduce((I,q)=>q.severity>I.severity?q:I,n[0]).severity:0,l=s?n.reduce((I,q)=>q.severity>I.severity?q:I,n[0]).color:"#30d158",p=Ge(r,0,4),c=s?Math.min(1.5,1+(n.length-1)*.15):1,u=hr(p,3,1.2).toFixed(2),m=dr(p).toFixed(2),d=s?ai(l,p*c):ai("#30d158",.08),f=140,g=f/2,w=f/2,v=s?{bgInner:r>=4?"#1a0000":r>=3?"#1a0e00":"#1a1500",bgOuter:r>=4?"#0a0000":r>=3?"#0a0500":"#0a0800",ring:S(Xt(l,.15)),line:S(Xt(l,.08)),sweep:S(Xt(l,.4))}:{bgInner:"#001a00",bgOuter:"#000800",ring:"rgba(80,255,0,0.15)",line:"rgba(80,255,0,0.08)",sweep:"rgba(80,255,0,0.35)"},b=n.map((I,q)=>{let L=I.active?18+q*7:40+q*7,N=q*137.5*Math.PI/180,O=g+Math.cos(N)*L,P=w+Math.sin(N)*L,H=(q*137.5%360/360*Number(u)).toFixed(2);return I.active?`<div class="pw-radar-blip" style="left:${O.toFixed(1)}px;top:${P.toFixed(1)}px;--pw-blip-color:${S(I.color)};animation-delay:${H}s"></div>`:`<div style="position:absolute;left:${O.toFixed(1)}px;top:${P.toFixed(1)}px;width:4px;height:4px;border-radius:var(--pulse-radius-circle);background:${S(I.color)};opacity:0.2;transform:translate(-50%,-50%)"></div>`}).join(""),y=`
